...
import laporan.DlgRL42_10BesarPenyakitRawatInap;
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
    DlgRekapPembayaranPerDokter RPP=new DlgRekapPembayaranPerDokter(null,false);
    //                RL.isCek();
    RPP.setSize(internalFrame1.getWidth(),internalFrame1.getHeight());
    RPP.setLocationRelativeTo(internalFrame1);
    ...
    private void prosesCariSemua() {
         try{             
            ...
            try {
                 ...
                 System.out.println("%"+kddokter.getText()+nmdokter.getText()+"%");
                 rs=ps.executeQuery();
                 i=1;
                 totaljm=0;
                 while(rs.next()){
                    ...
                    if(chkRalan.isSelected()==true){
                         ...
                         psrawatjalandr=koneksi.prepareStatement("select pasien.nm_pasien,rawat_jl_dr.tarif_tindakandr,"+
                             "jns_perawatan.nm_perawatan,rawat_jl_dr.tgl_perawatan,rawat_jl_dr.jam_rawat,penjab.png_jawab ,rawat_jl_dr.kd_jenis_prw, "+
                         ...
                         psrawatjalandrpr=koneksi.prepareStatement("select pasien.nm_pasien,rawat_jl_drpr.tarif_tindakandr,"+
                             "jns_perawatan.nm_perawatan,rawat_jl_drpr.tgl_perawatan,rawat_jl_drpr.jam_rawat,penjab.png_jawab ,rawat_jl_drpr.kd_jenis_prw, "+
                             "reg_periksa.no_rawat,reg_periksa.no_rkm_medis from pasien inner join reg_periksa on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                         ...
                         try {
                             ...
                             while(rsrawatjalandr.next()){
                                 tabMode.addRow(new Object[]{"","","     "+rsrawatjalandr.getString("tgl_perawatan")+" "+rsrawatjalandr.getString("jam_rawat"),rsrawatjalandr.getString("no_rawat"),rsrawatjalandr.getString("no_rkm_medis"),rsrawatjalandr.getString("nm_pasien")+" ("+rsrawatjalandr.getString("png_jawab")+")",
                             ...
                             while(rsrawatjalandrpr.next()){
                                 tabMode.addRow(new Object[]{"","","     "+rsrawatjalandrpr.getString("tgl_perawatan")+" "+rsrawatjalandrpr.getString("jam_rawat"),rsrawatjalandrpr.getString("no_rawat"),rsrawatjalandrpr.getString("no_rkm_medis"),rsrawatjalandrpr.getString("nm_pasien")+" ("+rsrawatjalandrpr.getString("png_jawab")+")",
                    ...
                    if(chkRanap.isSelected()==true){
                         ...
                         psrawatinapdr=koneksi.prepareStatement(
                             ...
                             "rawat_inap_dr.tgl_perawatan,rawat_inap_dr.jam_rawat,penjab.png_jawab ,rawat_inap_dr.kd_jenis_prw, " +
                             "reg_periksa.no_rawat,reg_periksa.no_rkm_medis from pasien inner join reg_periksa on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                         ...
                         psrawatinapdrpr=koneksi.prepareStatement(
                             ...
                             "rawat_inap_drpr.tgl_perawatan,rawat_inap_drpr.jam_rawat,penjab.png_jawab ,rawat_inap_drpr.kd_jenis_prw, " +
                             "reg_periksa.no_rawat,reg_periksa.no_rkm_medis from pasien inner join reg_periksa on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                         ...
                         try {                            
                             ...
                             if((rsrawatinapdr.getRow()>0)){
                                 tabMode.addRow(new Object[]{"","","Visite","","","","",""});  
                             }
                             ...
                             while(rsrawatinapdr.next()){ 
                                 tabMode.addRow(new Object[]{
                                     "","","     "+rsrawatinapdr.getString("tgl_perawatan")+" "+rsrawatinapdr.getString("jam_rawat"),rsrawatinapdr.getString("no_rawat"),rsrawatinapdr.getString("no_rkm_medis"),rsrawatinapdr.getString("nm_pasien")+" ("+rsrawatinapdr.getString("png_jawab")+")",
                                 ...
                                 subttl=subttl+rsrawatinapdr.getDouble("tarif_tindakandr");
                             }
                             
                             if((subttl>0)){
                                tabMode.addRow(new Object[]{"",">> ","Total Visite :","","","","",Valid.SetAngka(subttl)});
                             }
                             
                             if((rsrawatinapdrpr.getRow()>0)){
                                 tabMode.addRow(new Object[]{"","","Tindakan","","","","",""});  
                             }
                             subttl = 0;
                             rsrawatinapdrpr.beforeFirst();
                             while(rsrawatinapdrpr.next()){ 
                                 tabMode.addRow(new Object[]{
                                     "","","     "+rsrawatinapdrpr.getString("tgl_perawatan")+" "+rsrawatinapdrpr.getString("jam_rawat"),rsrawatinapdrpr.getString("no_rawat"),rsrawatinapdrpr.getString("no_rkm_medis"),rsrawatinapdrpr.getString("nm_pasien")+" ("+rsrawatinapdrpr.getString("png_jawab")+")",
                                 ...
                                 subttl=subttl+rsrawatinapdrpr.getDouble("tarif_tindakandr");
                             }
                             if((subttl>0)){
                                tabMode.addRow(new Object[]{"",">> ","Total Tindakan :","","","","",Valid.SetAngka(subttl)});
                             }
                         } catch (Exception e) {
                    ...
                    if(chkOperasi.isSelected()==true){
                         psbiayaoperator1=koneksi.prepareStatement(
                             ...
                             "operasi.tgl_operasi,penjab.png_jawab ,operasi.kode_paket,reg_periksa.no_rawat,reg_periksa.no_rkm_medis "+
                         ...
                         try {
                             ...
                             while(rsbiayaoperator1.next()){
                                 tabMode.addRow(new Object[]{
                                     "","","     "+rsbiayaoperator1.getString("tgl_operasi"),rsbiayaoperator1.getString("no_rawat"),rsbiayaoperator1.getString("no_rkm_medis"),rsbiayaoperator1.getString("nm_pasien")+" ("+rsbiayaoperator1.getString("png_jawab")+")",
                             ...
                             while(rsbiayaoperator2.next()){
                                 tabMode.addRow(new Object[]{
                                     "","","     "+rsbiayaoperator2.getString("tgl_operasi"),rsbiayaoperator2.getString("no_rawat"),rsbiayaoperator2.getString("no_rkm_medis"),rsbiayaoperator2.getString("nm_pasien")+" ("+rsbiayaoperator2.getString("png_jawab")+")",
                             ...
                             while(rsbiayaoperator3.next()){
                                 tabMode.addRow(new Object[]{
                                     "","","     "+rsbiayaoperator3.getString("tgl_operasi"),rsbiayaoperator3.getString("no_rawat"),rsbiayaoperator3.getString("no_rkm_medis"),rsbiayaoperator3.getString("nm_pasien")+" ("+rsbiayaoperator3.getString("png_jawab")+")",
                             ...
                             while(rsbiayadokter_anak.next()){
                                 tabMode.addRow(new Object[]{
                                     "","","     "+rsbiayadokter_anak.getString("tgl_operasi"),rsbiayadokter_anak.getString("no_rawat"),rsbiayadokter_anak.getString("no_rkm_medis"),rsbiayadokter_anak.getString("nm_pasien")+" ("+rsbiayadokter_anak.getString("png_jawab")+")",
                             ...
                             while(rsbiayadokter_anestesi.next()){
                                 tabMode.addRow(new Object[]{
                                     "","","     "+rsbiayadokter_anestesi.getString("tgl_operasi"),rsbiayadokter_anestesi.getString("no_rawat"),rsbiayadokter_anestesi.getString("no_rkm_medis"),rsbiayadokter_anestesi.getString("nm_pasien")+" ("+rsbiayadokter_anestesi.getString("png_jawab")+")",
                             ...
                             while(rsbiaya_dokter_pjanak.next()){
                                 tabMode.addRow(new Object[]{
                                     "","","     "+rsbiaya_dokter_pjanak.getString("tgl_operasi"),rsbiaya_dokter_pjanak.getString("no_rawat"),rsbiaya_dokter_pjanak.getString("no_rkm_medis"),rsbiaya_dokter_pjanak.getString("nm_pasien")+" ("+rsbiaya_dokter_pjanak.getString("png_jawab")+")",
                             ...
                             while(rsbiaya_dokter_umum.next()){
                                 tabMode.addRow(new Object[]{
                                     "","","     "+rsbiaya_dokter_umum.getString("tgl_operasi"),rsbiaya_dokter_umum.getString("no_rawat"),rsbiaya_dokter_umum.getString("no_rkm_medis"),rsbiaya_dokter_umum.getString("nm_pasien")+" ("+rsbiaya_dokter_umum.getString("png_jawab")+")",
                    ...
                    if(chkLaborat.isSelected()==true){
                        ...
                        psperiksa_lab=koneksi.prepareStatement(
                             ...
                             "jns_perawatan_lab.nm_perawatan,periksa_lab.tgl_periksa,periksa_lab.jam,periksa_lab.no_rawat,periksa_lab.kd_jenis_prw,penjab.png_jawab  "+
                         ...
                         try {
                             ...
                             while(rsperiksa_lab.next()){                                
                                 tabMode.addRow(new Object[]{
                                     "","","     "+rsperiksa_lab.getString("tgl_periksa")+" "+rsperiksa_lab.getString("jam"),rsperiksa_lab.getString("no_rawat"),rsperiksa_lab.getString("no_rkm_medis"),rsperiksa_lab.getString("nm_pasien")+" ("+rsperiksa_lab.getString("png_jawab")+")",
                         ...
                         psdetaillab=koneksi.prepareStatement(
                             ...
                             "template_laboratorium.Pemeriksaan,penjab.png_jawab ,reg_periksa.no_rawat,reg_periksa.no_rkm_medis, "+
                         ...
                         try {
                             ...
                             while(rsdetaillab.next()){
                                 tabMode.addRow(new Object[]{
                                     ...
                                     rsdetaillab.getString("nm_pasien")+" ("+rsdetaillab.getString("png_jawab")+")",
                    ...
                    if(chkRadiologi.isSelected()==true){
                        //periksa radiologi
                         psperiksa_radiologi=koneksi.prepareStatement("select periksa_radiologi.tarif_tindakan_dokter,pasien.nm_pasien,reg_periksa.no_rawat,reg_periksa.no_rkm_medis,"+
                             "jns_perawatan_radiologi.nm_perawatan,periksa_radiologi.tgl_periksa,periksa_radiologi.jam,periksa_radiologi.no_rawat,periksa_radiologi.kd_jenis_prw,penjab.png_jawab  "+
                         ...
                         try {
                             ...
                             while(rsperiksa_radiologi.next()){
                                 tabMode.addRow(new Object[]{
                                     "","","     "+rsperiksa_radiologi.getString("tgl_periksa")+" "+rsperiksa_radiologi.getString("jam"),rsperiksa_radiologi.getString("no_rawat"),rsperiksa_radiologi.getString("no_rkm_medis"),rsperiksa_radiologi.getString("nm_pasien")+" ("+rsperiksa_radiologi.getString("png_jawab")+")",
                        ...
                        "<tr class='isi'>"+
                            "<td valign='top' align='center'>"+
                                "<table width='100%' border='0' align='center' cellpadding='2px' cellspacing='0' class='tbl_form'>"+
                                    ...
                                    "</tr>"+
                                    "<tr class='isi'>"+
                                         "<td valign='middle' bgcolor='#FFFAF8' align='center' width=''>Tanggal</td>"+
                                         "<td valign='middle' bgcolor='#FFFAF8' align='center' width=''>No.Rawat</td>"+
                                         "<td valign='middle' bgcolor='#FFFAF8' align='center' width=''>No.RM</td>"+
                                         "<td valign='middle' bgcolor='#FFFAF8' align='center' width=''>Nama Pasien</td>"+
                                         "<td valign='middle' bgcolor='#FFFAF8' align='center' width=''>Tindakan Medis</td>"+                                         
                                         "<td valign='middle' bgcolor='#FFFAF8' align='center' width=''>Jasa Medis</td>"+
                                    "</tr>"
                    );
                    if(chkRalan.isSelected()==true){
                         //rawat jalan     
                         ...
                         try {
                             ...
                             while(rsrawatjalandr.next()){
                                 htmlContent.append(
                                    "<tr class='isi'>"+
                                         "<td valign='middle' align='left'>"+rsrawatjalandr.getString("tgl_perawatan")+"</td>"+
                                         ...
                                         "<td valign='middle' align='left'>"+rsrawatjalandr.getString("nm_pasien")+" ("+rsrawatjalandr.getString("png_jawab")+")"+"</td>"+
                             ...
                             while(rsrawatjalandrpr.next()){
                                 htmlContent.append(
                                    "<tr class='isi'>"+
                                         "<td valign='middle' align='left'>"+rsrawatjalandrpr.getString("tgl_perawatan")+"</td>"+
                                         ...
                                         "<td valign='middle' align='left'>"+rsrawatjalandrpr.getString("nm_pasien")+" ("+rsrawatjalandrpr.getString("png_jawab")+")"+"</td>"+
                    ...
                    if(chkRanap.isSelected()==true){
                         ...
                         try {                            
                             ...
                             while(rsrawatinapdr.next()){ 
                                 htmlContent.append(
                                    "<tr class='isi'>"+
                                         "<td valign='middle' align='left'>"+rsrawatinapdr.getString("tgl_perawatan")+"</td>"+
                                         ...
                                         "<td valign='middle' align='left'>"+rsrawatinapdr.getString("nm_pasien")+" ("+rsrawatinapdr.getString("png_jawab")+")"+"</td>"+
                             ...
                             while(rsrawatinapdrpr.next()){ 
                                 htmlContent.append(
                                    "<tr class='isi'>"+
                                         "<td valign='middle' align='left'>"+rsrawatinapdrpr.getString("tgl_perawatan")+"</td>"+
                                         ...
                                         "<td valign='middle' align='left'>"+rsrawatinapdrpr.getString("nm_pasien")+" ("+rsrawatinapdrpr.getString("png_jawab")+")"+"</td>"+
                             ...
                             while(rsbiayaoperator1.next()){
                                 htmlContent.append(
                                    "<tr class='isi'>"+
                                         ...
                                         "<td valign='middle' align='left'>"+rsbiayaoperator1.getString("nm_pasien")+" ("+rsbiayaoperator1.getString("png_jawab")+")"+"</td>"+
                             ...
                             while(rsbiayaoperator2.next()){
                                 htmlContent.append(
                                    "<tr class='isi'>"+
                                         ...
                                         "<td valign='middle' align='left'>"+rsbiayaoperator2.getString("nm_pasien")+" ("+rsbiayaoperator2.getString("png_jawab")+")"+"</td>"+
                             ...
                             while(rsbiayaoperator3.next()){
                                 htmlContent.append(
                                    "<tr class='isi'>"+
                                         ...
                                         "<td valign='middle' align='left'>"+rsbiayaoperator3.getString("nm_pasien")+" ("+rsbiayaoperator3.getString("png_jawab")+")"+"</td>"+
                             ...
                             while(rsbiayadokter_anak.next()){
                                 htmlContent.append(
                                    "<tr class='isi'>"+
                                         ...
                                         "<td valign='middle' align='left'>"+rsbiayadokter_anak.getString("nm_pasien")+" ("+rsbiayadokter_anak.getString("png_jawab")+")"+"</td>"+
                             ...
                             while(rsbiayadokter_anestesi.next()){
                                 htmlContent.append(
                                    "<tr class='isi'>"+
                                         ...
                                         "<td valign='middle' align='left'>"+rsbiayadokter_anestesi.getString("nm_pasien")+" ("+rsbiayadokter_anestesi.getString("png_jawab")+")"+"</td>"+
                             ...
                             while(rsbiaya_dokter_pjanak.next()){
                                 htmlContent.append(
                                    "<tr class='isi'>"+
                                         ...
                                         "<td valign='middle' align='left'>"+rsbiaya_dokter_pjanak.getString("nm_pasien")+" ("+rsbiaya_dokter_pjanak.getString("png_jawab")+")"+"</td>"+
                             ...
                             while(rsbiaya_dokter_umum.next()){
                                 htmlContent.append(
                                    "<tr class='isi'>"+
                                         ...
                                         "<td valign='middle' align='left'>"+rsbiaya_dokter_umum.getString("nm_pasien")+" ("+rsbiaya_dokter_umum.getString("png_jawab")+")"+"</td>"+
                        ...
                        psperiksa_lab=koneksi.prepareStatement(
                         ...
                         try {
                             ...
                             while(rsperiksa_lab.next()){       
                                 htmlContent.append(
                                    "<tr class='isi'>"+
                                         "<td valign='middle' align='left'>"+rsperiksa_lab.getString("tgl_periksa")+"</td>"+
                                         ...
                                         "<td valign='middle' align='left'>"+rsperiksa_lab.getString("nm_pasien")+" ("+rsperiksa_lab.getString("png_jawab")+")"+"</td>"+
                             ...
                             while(rsdetaillab.next()){
                                 htmlContent.append(
                                    "<tr class='isi'>"+
                                         ...
                                         "<td valign='middle' align='left'>"+rsdetaillab.getString("nm_pasien")+" ("+rsdetaillab.getString("png_jawab")+")"+"</td>"+
                             ...
                             while(rsperiksa_radiologi.next()){
                                 htmlContent.append(
                                    "<tr class='isi'>"+
                                         ...
                                         "<td valign='middle' align='left'>"+rsperiksa_radiologi.getString("nm_pasien")+" ("+rsperiksa_radiologi.getString("png_jawab")+")"+"</td>"+
                         ...
                         try {
                             ...
                             while(rsdetaillab.next()){
                                 tabMode.addRow(new Object[]{
                                     ...
                                     rsdetaillab.getString("no_rawat"),rsdetaillab.getString("no_rkm_medis"),rsdetaillab.getString("nm_pasien")+" ("+rsdetaillab.getString("png_jawab")+")",
                                     rsdetaillab.getString("Pemeriksaan")+" ("+rsdetaillab.getString("kd_jenis_prw")+")",Valid.SetAngka(rsdetaillab.getDouble("bagian_dokter"))
                                 });    
                                 total=total+rsdetaillab.getDouble("bagian_dokter");
                             }
            ...
            try {
                 ...
                 while(rs.next()){
                    ...
                    if(chkRalan.isSelected()==true){
                         ...
                         psrawatjalandr=koneksi.prepareStatement("select pasien.nm_pasien,rawat_jl_dr.tarif_tindakandr,"+
                             "jns_perawatan.nm_perawatan,rawat_jl_dr.tgl_perawatan,rawat_jl_dr.jam_rawat,penjab.png_jawab ,rawat_jl_dr.kd_jenis_prw, "+
                             "reg_periksa.no_rawat,reg_periksa.no_rkm_medis, bp.tgl_byr from pasien inner join reg_periksa on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                             "inner join rawat_jl_dr on rawat_jl_dr.no_rawat=reg_periksa.no_rawat "+
                             "inner join jns_perawatan on rawat_jl_dr.kd_jenis_prw=jns_perawatan.kd_jenis_prw "+
                             "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj "+
                             "inner join piutang_pasien on reg_periksa.no_rawat=piutang_pasien.no_rawat "+
                             ...
                             "where reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Lunas' and bp.tgl_byr between ? and ? and rawat_jl_dr.kd_dokter=? "+
                             "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and rawat_jl_dr.tarif_tindakandr>0 order by reg_periksa.tgl_registrasi,jns_perawatan.nm_perawatan");
                         psrawatjalandrpr=koneksi.prepareStatement("select pasien.nm_pasien,rawat_jl_drpr.tarif_tindakandr,"+
                             "jns_perawatan.nm_perawatan,rawat_jl_drpr.tgl_perawatan,rawat_jl_drpr.jam_rawat,penjab.png_jawab ,rawat_jl_drpr.kd_jenis_prw, "+
                             "reg_periksa.no_rawat,reg_periksa.no_rkm_medis, bp.tgl_byr from pasien inner join reg_periksa on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                             ...
                             "inner join piutang_pasien on reg_periksa.no_rawat=piutang_pasien.no_rawat "+
                             "inner join (SELECT max(tgl_bayar) as tgl_byr, no_rawat from bayar_piutang group by no_rawat) as bp on bp.no_rawat = reg_periksa.no_rawat "+
                             "where reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Lunas' and bp.tgl_byr between ? and ? and rawat_jl_drpr.kd_dokter=? "+
                             "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and rawat_jl_drpr.tarif_tindakandr>0 order by reg_periksa.tgl_registrasi,jns_perawatan.nm_perawatan");
                         try {
                             ...
                             if((rsrawatjalandr.getRow()>0)||(rsrawatjalandrpr.getRow()>0)){
                                 z++;
                                 tabMode.addRow(new Object[]{"","Tgl Bayar",z+". Rawat Jalan ","","","","",""});   
                             }

                             rsrawatjalandr.beforeFirst();
                             while(rsrawatjalandr.next()){
                                 tabMode.addRow(new Object[]{"",rsrawatjalandr.getString("tgl_byr"),"     "+rsrawatjalandr.getString("tgl_perawatan")+" "+rsrawatjalandr.getString("jam_rawat"),rsrawatjalandr.getString("no_rawat"),rsrawatjalandr.getString("no_rkm_medis"),rsrawatjalandr.getString("nm_pasien")+" ("+rsrawatjalandr.getString("png_jawab")+")",
                                     rsrawatjalandr.getString("nm_perawatan")+" ("+rsrawatjalandr.getString("kd_jenis_prw")+")",Valid.SetAngka(rsrawatjalandr.getDouble("tarif_tindakandr"))});                   
                                 total=total+rsrawatjalandr.getDouble("tarif_tindakandr");
                             }  
                             ...
                             rsrawatjalandrpr.beforeFirst();
                             while(rsrawatjalandrpr.next()){
                                 tabMode.addRow(new Object[]{"",rsrawatjalandrpr.getString("tgl_byr"),"     "+rsrawatjalandrpr.getString("tgl_perawatan")+" "+rsrawatjalandrpr.getString("jam_rawat"),rsrawatjalandrpr.getString("no_rawat"),rsrawatjalandrpr.getString("no_rkm_medis"),rsrawatjalandrpr.getString("nm_pasien")+" ("+rsrawatjalandrpr.getString("png_jawab")+")",
                                     rsrawatjalandrpr.getString("nm_perawatan")+" ("+rsrawatjalandrpr.getString("kd_jenis_prw")+")",Valid.SetAngka(rsrawatjalandrpr.getDouble("tarif_tindakandr"))});                   
                                 total=total+rsrawatjalandrpr.getDouble("tarif_tindakandr");
                             }
                         } catch (Exception e) {
                    ...
                    if(chkRanap.isSelected()==true){
                         ...
                         psrawatinapdr=koneksi.prepareStatement(
                             ...
                             "inner join piutang_pasien on reg_periksa.no_rawat=piutang_pasien.no_rawat "+
                             "inner join (SELECT max(tgl_bayar) as tgl_byr, no_rawat from bayar_piutang group by no_rawat) as bp on bp.no_rawat = reg_periksa.no_rawat "+
                             "where reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Lunas' and bp.tgl_byr between ? and ? and rawat_inap_dr.kd_dokter=? "+
                             "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and rawat_inap_dr.tarif_tindakandr>0 order by rawat_inap_dr.tgl_perawatan,rawat_inap_dr.jam_rawat,jns_perawatan_inap.nm_perawatan  ");
                         psrawatinapdrpr=koneksi.prepareStatement(
                             "select pasien.nm_pasien,jns_perawatan_inap.nm_perawatan,rawat_inap_drpr.tarif_tindakandr,"+
                             "rawat_inap_drpr.tgl_perawatan,rawat_inap_drpr.jam_rawat,penjab.png_jawab ,rawat_inap_drpr.kd_jenis_prw, " +
                             ...
                             "inner join piutang_pasien on reg_periksa.no_rawat=piutang_pasien.no_rawat "+
                             "inner join (SELECT max(tgl_bayar) as tgl_byr, no_rawat from bayar_piutang group by no_rawat) as bp on bp.no_rawat = reg_periksa.no_rawat "+
                             "where reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Lunas' and bp.tgl_byr between ? and ? and rawat_inap_drpr.kd_dokter=? "+
                             "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and rawat_inap_drpr.tarif_tindakandr>0 order by rawat_inap_drpr.tgl_perawatan,rawat_inap_drpr.jam_rawat,jns_perawatan_inap.nm_perawatan  ");
                         try {                            
                             ...
                             if((rsrawatinapdr.getRow()>0)||(rsrawatinapdrpr.getRow()>0)){
                                 z++; 
                                 tabMode.addRow(new Object[]{"","Tanggal Bayar",z+". Rawat Inap ","","","","",""});  
                             }
                             ...
                             while(rsrawatinapdr.next()){ 
                                 tabMode.addRow(new Object[]{
                                     "",rsrawatinapdr.getString("tgl_byr"),"     "+rsrawatinapdr.getString("tgl_perawatan")+" "+rsrawatinapdr.getString("jam_rawat"),rsrawatinapdr.getString("no_rawat"),rsrawatinapdr.getString("no_rkm_medis"),rsrawatinapdr.getString("nm_pasien")+" ("+rsrawatinapdr.getString("png_jawab")+")",
                                     rsrawatinapdr.getString("nm_perawatan")+" ("+rsrawatinapdr.getString("kd_jenis_prw")+")",Valid.SetAngka(rsrawatinapdr.getDouble("tarif_tindakandr"))
                                 });          
                                 total=total+rsrawatinapdr.getDouble("tarif_tindakandr");
                                 subttl=subttl+rsrawatinapdr.getDouble("tarif_tindakandr");
                             ...
                             while(rsrawatinapdrpr.next()){ 
                                 tabMode.addRow(new Object[]{
                                     "",rsrawatinapdrpr.getString("tgl_byr"),"     "+rsrawatinapdrpr.getString("tgl_perawatan")+" "+rsrawatinapdrpr.getString("jam_rawat"),rsrawatinapdrpr.getString("no_rawat"),rsrawatinapdrpr.getString("no_rkm_medis"),rsrawatinapdrpr.getString("nm_pasien")+" ("+rsrawatinapdrpr.getString("png_jawab")+")",
                                     rsrawatinapdrpr.getString("nm_perawatan")+" ("+rsrawatinapdrpr.getString("kd_jenis_prw")+")",Valid.SetAngka(rsrawatinapdrpr.getDouble("tarif_tindakandr"))
                                 });          
                                 total=total+rsrawatinapdrpr.getDouble("tarif_tindakandr");
                                 subttl=subttl+rsrawatinapdrpr.getDouble("tarif_tindakandr");
                    ...
                    if(chkOperasi.isSelected()==true){
                         psbiayaoperator1=koneksi.prepareStatement(
                             "select pasien.nm_pasien,paket_operasi.nm_perawatan,operasi.biayaoperator1,"+
                             "operasi.tgl_operasi,penjab.png_jawab ,operasi.kode_paket,reg_periksa.no_rawat,reg_periksa.no_rkm_medis, bp.tgl_byr  "+
                             "from operasi inner join reg_periksa on operasi.no_rawat=reg_periksa.no_rawat "+
                             "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                             "inner join paket_operasi on operasi.kode_paket=paket_operasi.kode_paket "+
                             "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj "+
                             "inner join piutang_pasien on reg_periksa.no_rawat=piutang_pasien.no_rawat "+
                             "inner join (SELECT max(tgl_bayar) as tgl_byr, no_rawat from bayar_piutang group by no_rawat) as bp on bp.no_rawat = reg_periksa.no_rawat "+
                             "where reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Lunas' and bp.tgl_byr between ? and ? and operasi.operator1=? "+
                             "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.biayaoperator1>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan  ");
                         psbiayaoperator2=koneksi.prepareStatement(
                             "select pasien.nm_pasien,paket_operasi.nm_perawatan,operasi.biayaoperator2,"+
                             "operasi.tgl_operasi,penjab.png_jawab ,operasi.kode_paket,reg_periksa.no_rawat,reg_periksa.no_rkm_medis, bp.tgl_byr  "+
                             ...
                             "inner join piutang_pasien on reg_periksa.no_rawat=piutang_pasien.no_rawat "+
                             "inner join (SELECT max(tgl_bayar) as tgl_byr, no_rawat from bayar_piutang group by no_rawat) as bp on bp.no_rawat = reg_periksa.no_rawat "+
                             "where reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Lunas' and bp.tgl_byr between ? and ? and operasi.operator2=? "+
                             "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.biayaoperator2>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan  ");
                         psbiayaoperator3=koneksi.prepareStatement(
                             "select pasien.nm_pasien,paket_operasi.nm_perawatan,operasi.biayaoperator3,"+
                             "operasi.tgl_operasi,penjab.png_jawab ,operasi.kode_paket,reg_periksa.no_rawat,reg_periksa.no_rkm_medis , bp.tgl_byr  "+
                             ...
                             "inner join piutang_pasien on reg_periksa.no_rawat=piutang_pasien.no_rawat "+
                             "inner join (SELECT max(tgl_bayar) as tgl_byr, no_rawat from bayar_piutang group by no_rawat) as bp on bp.no_rawat = reg_periksa.no_rawat "+
                             "where reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Lunas' and bp.tgl_byr between ? and ? and operasi.operator3=? "+
                             "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.biayaoperator3>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan  ");
                         psbiayadokter_anak=koneksi.prepareStatement(
                             "select pasien.nm_pasien,paket_operasi.nm_perawatan,operasi.biayadokter_anak,"+
                             "operasi.tgl_operasi,penjab.png_jawab ,operasi.kode_paket,reg_periksa.no_rawat,reg_periksa.no_rkm_medis , bp.tgl_byr  "+
                             ...
                             "inner join piutang_pasien on reg_periksa.no_rawat=piutang_pasien.no_rawat "+
                             "inner join (SELECT max(tgl_bayar) as tgl_byr, no_rawat from bayar_piutang group by no_rawat) as bp on bp.no_rawat = reg_periksa.no_rawat "+
                             "where reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Lunas' and bp.tgl_byr between ? and ? and operasi.dokter_anak=? "+
                             "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.biayadokter_anak>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan  ");
                         psbiaya_dokter_umum=koneksi.prepareStatement(
                             "select pasien.nm_pasien,paket_operasi.nm_perawatan,operasi.biaya_dokter_umum,"+
                             "operasi.tgl_operasi,penjab.png_jawab ,operasi.kode_paket,reg_periksa.no_rawat,reg_periksa.no_rkm_medis, bp.tgl_byr  "+
                             ...
                             "inner join piutang_pasien on reg_periksa.no_rawat=piutang_pasien.no_rawat "+
                             "inner join (SELECT max(tgl_bayar) as tgl_byr, no_rawat from bayar_piutang group by no_rawat) as bp on bp.no_rawat = reg_periksa.no_rawat "+
                             "where reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Lunas' and bp.tgl_byr between ? and ? and operasi.dokter_umum=? "+
                             "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.biaya_dokter_umum>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan  ");
                         psbiaya_dokter_pjanak=koneksi.prepareStatement(
                             "select pasien.nm_pasien,paket_operasi.nm_perawatan,operasi.biaya_dokter_pjanak,"+
                             "operasi.tgl_operasi,penjab.png_jawab ,operasi.kode_paket,reg_periksa.no_rawat,reg_periksa.no_rkm_medis, bp.tgl_byr  "+
                             ...
                             "inner join piutang_pasien on reg_periksa.no_rawat=piutang_pasien.no_rawat "+
                             "inner join (SELECT max(tgl_bayar) as tgl_byr, no_rawat from bayar_piutang group by no_rawat) as bp on bp.no_rawat = reg_periksa.no_rawat "+
                             "where reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Lunas' and bp.tgl_byr between ? and ? and operasi.dokter_pjanak=? "+
                             "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.biaya_dokter_pjanak>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan  ");
                         psbiayadokter_anestesi=koneksi.prepareStatement(
                             "select pasien.nm_pasien,paket_operasi.nm_perawatan,operasi.biayadokter_anestesi,"+
                             "operasi.tgl_operasi,penjab.png_jawab ,operasi.kode_paket,reg_periksa.no_rawat,reg_periksa.no_rkm_medis, bp.tgl_byr  "+
                             ...
                             "inner join piutang_pasien on reg_periksa.no_rawat=piutang_pasien.no_rawat "+
                             "inner join (SELECT max(tgl_bayar) as tgl_byr, no_rawat from bayar_piutang group by no_rawat) as bp on bp.no_rawat = reg_periksa.no_rawat "+
                             "where reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Lunas' and bp.tgl_byr between ? and ? and operasi.dokter_anestesi=? "+
                             "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.biayadokter_anestesi>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan  ");
                         try {
                             psbiayaoperator1.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                             psbiayaoperator1.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
                             psbiayaoperator1.setString(3,rs.getString("kd_dokter"));               
                             psbiayaoperator1.setString(4,"%"+KdCaraBayar.getText()+NmCaraBayar.getText()+"%");
                             rsbiayaoperator1=psbiayaoperator1.executeQuery();
                             rsbiayaoperator1.last();

                             psbiayaoperator2.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                             psbiayaoperator2.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
                             psbiayaoperator2.setString(3,rs.getString("kd_dokter"));               
                             psbiayaoperator2.setString(4,"%"+KdCaraBayar.getText()+NmCaraBayar.getText()+"%");
                             rsbiayaoperator2=psbiayaoperator2.executeQuery();
                             rsbiayaoperator2.last();

                             psbiayaoperator3.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                             psbiayaoperator3.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
                             psbiayaoperator3.setString(3,rs.getString("kd_dokter"));  
                             psbiayaoperator3.setString(4,"%"+KdCaraBayar.getText()+NmCaraBayar.getText()+"%");
                             rsbiayaoperator3=psbiayaoperator3.executeQuery();
                             rsbiayaoperator3.last(); 

                             psbiayadokter_anak.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                             psbiayadokter_anak.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
                             psbiayadokter_anak.setString(3,rs.getString("kd_dokter"));  
                             psbiayadokter_anak.setString(4,"%"+KdCaraBayar.getText()+NmCaraBayar.getText()+"%");
                             rsbiayadokter_anak=psbiayadokter_anak.executeQuery();
                             rsbiayadokter_anak.last();

                             psbiaya_dokter_umum.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                             psbiaya_dokter_umum.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
                             psbiaya_dokter_umum.setString(3,rs.getString("kd_dokter"));  
                             psbiaya_dokter_umum.setString(4,"%"+KdCaraBayar.getText()+NmCaraBayar.getText()+"%");
                             rsbiaya_dokter_umum=psbiaya_dokter_umum.executeQuery();
                             rsbiaya_dokter_umum.last();

                             psbiaya_dokter_pjanak.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                             psbiaya_dokter_pjanak.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
                             psbiaya_dokter_pjanak.setString(3,rs.getString("kd_dokter"));  
                             psbiaya_dokter_pjanak.setString(4,"%"+KdCaraBayar.getText()+NmCaraBayar.getText()+"%");
                             rsbiaya_dokter_pjanak=psbiaya_dokter_pjanak.executeQuery();
                             rsbiaya_dokter_pjanak.last();

                             psbiayadokter_anestesi.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                             psbiayadokter_anestesi.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
                             psbiayadokter_anestesi.setString(3,rs.getString("kd_dokter"));                 
                             psbiayadokter_anestesi.setString(4,"%"+KdCaraBayar.getText()+NmCaraBayar.getText()+"%");
                             rsbiayadokter_anestesi=psbiayadokter_anestesi.executeQuery();
                             rsbiayadokter_anestesi.last();
                             ...
                             while(rsbiayaoperator1.next()){
                                 tabMode.addRow(new Object[]{
                                     "",rsbiayaoperator1.getString("tgl_byr"),"     "+rsbiayaoperator1.getString("tgl_operasi"),rsbiayaoperator1.getString("no_rawat"),rsbiayaoperator1.getString("no_rkm_medis"),rsbiayaoperator1.getString("nm_pasien")+" ("+rsbiayaoperator1.getString("png_jawab")+")",
                                     rsbiayaoperator1.getString("nm_perawatan")+" ("+rsbiayaoperator1.getString("kode_paket")+")(Operator 1)",Valid.SetAngka(rsbiayaoperator1.getDouble("biayaoperator1"))
                                 });      
                                 total=total+rsbiayaoperator1.getDouble("biayaoperator1");
                             }
                             ...
                             while(rsbiayaoperator2.next()){
                                 tabMode.addRow(new Object[]{
                                     "",rsbiayaoperator2.getString("tgl_byr"),"     "+rsbiayaoperator2.getString("tgl_operasi"),rsbiayaoperator2.getString("no_rawat"),rsbiayaoperator2.getString("no_rkm_medis"),rsbiayaoperator2.getString("nm_pasien")+" ("+rsbiayaoperator2.getString("png_jawab")+")",
                                     rsbiayaoperator2.getString("nm_perawatan")+" ("+rsbiayaoperator2.getString("kode_paket")+")(Operator 2)",Valid.SetAngka(rsbiayaoperator2.getDouble("biayaoperator2"))
                                 });  
                                 total=total+rsbiayaoperator2.getDouble("biayaoperator2");
                             }
                             ...
                             while(rsbiayaoperator3.next()){
                                 tabMode.addRow(new Object[]{
                                     "",rsbiayaoperator3.getString("tgl_byr"),"     "+rsbiayaoperator3.getString("tgl_operasi"),rsbiayaoperator3.getString("no_rawat"),rsbiayaoperator3.getString("no_rkm_medis"),rsbiayaoperator3.getString("nm_pasien")+" ("+rsbiayaoperator3.getString("png_jawab")+")",
                                     rsbiayaoperator3.getString("nm_perawatan")+"  ("+rsbiayaoperator3.getString("kode_paket")+")(Operator 3)",Valid.SetAngka(rsbiayaoperator3.getDouble("biayaoperator3"))
                                 });       
                                 total=total+rsbiayaoperator3.getDouble("biayaoperator3");
                             }
                    ...
                    if(chkLaborat.isSelected()==true){
                        ...
                        psperiksa_lab=koneksi.prepareStatement(
                             ...
                             " inner join piutang_pasien on reg_periksa.no_rawat=piutang_pasien.no_rawat "+
                             "inner join (SELECT max(tgl_bayar) as tgl_byr, no_rawat from bayar_piutang group by no_rawat) as bp on bp.no_rawat = reg_periksa.no_rawat "+
                             " where reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Lunas' and bp.tgl_byr between ? and ? and periksa_lab.kd_dokter=? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? "+
                             " and periksa_lab.tarif_tindakan_dokter>0 order by periksa_lab.tgl_periksa,periksa_lab.jam,jns_perawatan_lab.nm_perawatan  ");            
                         try {
                         ...
                         psdetaillab=koneksi.prepareStatement(
                             ...
                             "inner join piutang_pasien on reg_periksa.no_rawat=piutang_pasien.no_rawat "+
                             "inner join (SELECT max(tgl_bayar) as tgl_byr, no_rawat from bayar_piutang group by no_rawat) as bp on bp.no_rawat = reg_periksa.no_rawat "+
                             "where reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Lunas' and bp.tgl_byr between ? and ? "+
                             "and periksa_lab.kd_dokter=? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? "+
                             "and detail_periksa_lab.bagian_dokter>0 order by periksa_lab.tgl_periksa,periksa_lab.jam");
                         try {
                         ...
                         psperiksa_lab2=koneksi.prepareStatement(
                             ...
                             " inner join piutang_pasien on reg_periksa.no_rawat=piutang_pasien.no_rawat "+
                             "inner join (SELECT max(tgl_bayar) as tgl_byr, no_rawat from bayar_piutang group by no_rawat) as bp on bp.no_rawat = reg_periksa.no_rawat "+
                             " where reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Lunas' and bp.tgl_byr between ? and ? and periksa_lab.dokter_perujuk=? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? "+
                             " and periksa_lab.tarif_perujuk>0 order by periksa_lab.tgl_periksa,periksa_lab.jam,jns_perawatan_lab.nm_perawatan  ");            
                         try {
                    ...
                    if(chkRadiologi.isSelected()==true){
                        //periksa radiologi
                         psperiksa_radiologi=koneksi.prepareStatement("select periksa_radiologi.tarif_tindakan_dokter,pasien.nm_pasien,reg_periksa.no_rawat,reg_periksa.no_rkm_medis,"+
                             ...
                             " inner join piutang_pasien on reg_periksa.no_rawat=piutang_pasien.no_rawat "+
                             "inner join (SELECT max(tgl_bayar) as tgl_byr, no_rawat from bayar_piutang group by no_rawat) as bp on bp.no_rawat = reg_periksa.no_rawat "+
                             " where reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Lunas' and bp.tgl_byr between ? and ? and periksa_radiologi.kd_dokter=? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? order by periksa_radiologi.tgl_periksa,periksa_radiologi.jam,jns_perawatan_radiologi.nm_perawatan  ");            
                         try {
                         ...
                         psperiksa_radiologi2=koneksi.prepareStatement("select periksa_radiologi.tarif_perujuk,pasien.nm_pasien,reg_periksa.no_rawat,reg_periksa.no_rkm_medis,"+
                             ...
                             " inner join piutang_pasien on reg_periksa.no_rawat=piutang_pasien.no_rawat "+
                             "inner join (SELECT max(tgl_bayar) as tgl_byr, no_rawat from bayar_piutang group by no_rawat) as bp on bp.no_rawat = reg_periksa.no_rawat "+
                             " where reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Lunas' and bp.tgl_byr between ? and ? and periksa_radiologi.dokter_perujuk=? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? order by periksa_radiologi.tgl_periksa,periksa_radiologi.jam,jns_perawatan_radiologi.nm_perawatan  ");            
                         try {
            ...
            try {
                 ...
                 while(rs.next()){
                    ...
                    if(chkRalan.isSelected()==true){
                         ...
                         psrawatjalandr=koneksi.prepareStatement("select pasien.nm_pasien,rawat_jl_dr.tarif_tindakandr,"+
                             "jns_perawatan.nm_perawatan,rawat_jl_dr.tgl_perawatan,rawat_jl_dr.jam_rawat,penjab.png_jawab ,rawat_jl_dr.kd_jenis_prw, "+
                             "reg_periksa.no_rawat,reg_periksa.no_rkm_medis, billing.tgl_byr from pasien inner join reg_periksa on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                             "inner join rawat_jl_dr on rawat_jl_dr.no_rawat=reg_periksa.no_rawat "+
                             "inner join jns_perawatan on rawat_jl_dr.kd_jenis_prw=jns_perawatan.kd_jenis_prw "+
                             "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj "+
                             "inner join billing on billing.no_rawat = reg_periksa.no_rawat "+
                             "where reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien) and billing.noindex = 0 and billing.tgl_byr between ? and ? and rawat_jl_dr.kd_dokter=? "+
                             "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and rawat_jl_dr.tarif_tindakandr>0 order by reg_periksa.tgl_registrasi,jns_perawatan.nm_perawatan");
                         psrawatjalandrpr=koneksi.prepareStatement("select pasien.nm_pasien,rawat_jl_drpr.tarif_tindakandr,"+
                             "jns_perawatan.nm_perawatan,rawat_jl_drpr.tgl_perawatan,rawat_jl_drpr.jam_rawat,penjab.png_jawab ,rawat_jl_drpr.kd_jenis_prw, "+
                             "reg_periksa.no_rawat,reg_periksa.no_rkm_medis, billing.tgl_byr from pasien inner join reg_periksa on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                             ...
                             "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj "+
                             "inner join billing on billing.no_rawat = reg_periksa.no_rawat "+
                             "where reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien) and billing.noindex = 0 and billing.tgl_byr between ? and ? and rawat_jl_drpr.kd_dokter=? "+
                             "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and rawat_jl_drpr.tarif_tindakandr>0 order by reg_periksa.tgl_registrasi,jns_perawatan.nm_perawatan");
                         try {
                             psrawatjalandr.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                             psrawatjalandr.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
                    ...
                    if(chkRanap.isSelected()==true){
                         ...
                         psrawatinapdr=koneksi.prepareStatement(
                             ...
                             "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj "+
                             "inner join billing on billing.no_rawat = reg_periksa.no_rawat "+
                             "where reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien) and billing.noindex = 0 and billing.tgl_byr between ? and ? and rawat_inap_dr.kd_dokter=? "+
                             "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and rawat_inap_dr.tarif_tindakandr>0 order by rawat_inap_dr.tgl_perawatan,rawat_inap_dr.jam_rawat,jns_perawatan_inap.nm_perawatan  ");
                         psrawatinapdrpr=koneksi.prepareStatement(
                             "select pasien.nm_pasien,jns_perawatan_inap.nm_perawatan,rawat_inap_drpr.tarif_tindakandr,"+
                             "rawat_inap_drpr.tgl_perawatan,rawat_inap_drpr.jam_rawat,penjab.png_jawab ,rawat_inap_drpr.kd_jenis_prw, " +
                             ...
                             "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj "+
                             "inner join billing on billing.no_rawat = reg_periksa.no_rawat "+
                             "where reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien) and billing.noindex = 0 and billing.tgl_byr between ? and ? and rawat_inap_drpr.kd_dokter=? "+
                             "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and rawat_inap_drpr.tarif_tindakandr>0 order by rawat_inap_drpr.tgl_perawatan,rawat_inap_drpr.jam_rawat,jns_perawatan_inap.nm_perawatan  ");
                         try {                            
                             psrawatinapdr.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                             psrawatinapdr.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
                             ...
                             if((rsrawatinapdr.getRow()>0)){
                                 tabMode.addRow(new Object[]{"","Tgl Bayar","Visite","","","","",""});  
                             }
                             ...
                             if((rsrawatinapdrpr.getRow()>0)){
                                 tabMode.addRow(new Object[]{"","Tgl Bayar","Tindakan","","","","",""});  
                             }
                             subttl = 0;
                             rsrawatinapdrpr.beforeFirst();
                             while(rsrawatinapdrpr.next()){ 
                    ...
                    if(chkOperasi.isSelected()==true){
                         psbiayaoperator1=koneksi.prepareStatement(
                             "select pasien.nm_pasien,paket_operasi.nm_perawatan,operasi.biayaoperator1,"+
                             "operasi.tgl_operasi,penjab.png_jawab ,operasi.kode_paket,reg_periksa.no_rawat,reg_periksa.no_rkm_medis, billing.tgl_byr "+
                             "from operasi inner join reg_periksa on operasi.no_rawat=reg_periksa.no_rawat "+
                             "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                             "inner join paket_operasi on operasi.kode_paket=paket_operasi.kode_paket "+
                             "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj "+
                             "inner join billing on billing.no_rawat = reg_periksa.no_rawat "+
                             "where reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien) and billing.noindex = 0 and billing.tgl_byr between ? and ? and operasi.operator1=? "+
                             "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.biayaoperator1>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan  ");
                         psbiayaoperator2=koneksi.prepareStatement(
                             "select pasien.nm_pasien,paket_operasi.nm_perawatan,operasi.biayaoperator2,"+
                             "operasi.tgl_operasi,penjab.png_jawab ,operasi.kode_paket,reg_periksa.no_rawat,reg_periksa.no_rkm_medis, billing.tgl_byr "+
                             ...
                             "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj "+
                             "inner join billing on billing.no_rawat = reg_periksa.no_rawat "+
                             "where reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien) and billing.noindex = 0 and billing.tgl_byr between ? and ? and operasi.operator2=? "+
                             "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.biayaoperator2>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan  ");
                         psbiayaoperator3=koneksi.prepareStatement(
                             "select pasien.nm_pasien,paket_operasi.nm_perawatan,operasi.biayaoperator3,"+
                             "operasi.tgl_operasi,penjab.png_jawab ,operasi.kode_paket,reg_periksa.no_rawat,reg_periksa.no_rkm_medis, billing.tgl_byr "+
                             ...
                             "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj "+
                             "inner join billing on billing.no_rawat = reg_periksa.no_rawat "+
                             "where reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien) and billing.noindex = 0 and billing.tgl_byr between ? and ? and operasi.operator3=? "+
                             "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.biayaoperator3>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan  ");
                         psbiayadokter_anak=koneksi.prepareStatement(
                             "select pasien.nm_pasien,paket_operasi.nm_perawatan,operasi.biayadokter_anak,"+
                             "operasi.tgl_operasi,penjab.png_jawab ,operasi.kode_paket,reg_periksa.no_rawat,reg_periksa.no_rkm_medis, billing.tgl_byr "+
                             ...
                             "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj "+
                             "inner join billing on billing.no_rawat = reg_periksa.no_rawat "+
                             "where reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien) and billing.noindex = 0 and billing.tgl_byr between ? and ? and operasi.dokter_anak=? "+
                             "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.biayadokter_anak>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan  ");
                         psbiaya_dokter_umum=koneksi.prepareStatement(
                             "select pasien.nm_pasien,paket_operasi.nm_perawatan,operasi.biaya_dokter_umum,"+
                             "operasi.tgl_operasi,penjab.png_jawab ,operasi.kode_paket,reg_periksa.no_rawat,reg_periksa.no_rkm_medis, billing.tgl_byr "+
                             ...
                             "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj "+
                             "inner join billing on billing.no_rawat = reg_periksa.no_rawat "+
                             "where reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien) and billing.noindex = 0 and billing.tgl_byr between ? and ? and operasi.dokter_umum=? "+
                             "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.biaya_dokter_umum>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan  ");
                         psbiaya_dokter_pjanak=koneksi.prepareStatement(
                             "select pasien.nm_pasien,paket_operasi.nm_perawatan,operasi.biaya_dokter_pjanak,"+
                             "operasi.tgl_operasi,penjab.png_jawab ,operasi.kode_paket,reg_periksa.no_rawat,reg_periksa.no_rkm_medis, billing.tgl_byr "+
                             ...
                             "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj "+
                             "inner join billing on billing.no_rawat = reg_periksa.no_rawat "+
                             "where reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien) and billing.noindex = 0 and billing.tgl_byr between ? and ? and operasi.dokter_pjanak=? "+
                             "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.biaya_dokter_pjanak>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan  ");
                         psbiayadokter_anestesi=koneksi.prepareStatement(
                             "select pasien.nm_pasien,paket_operasi.nm_perawatan,operasi.biayadokter_anestesi,"+
                             "operasi.tgl_operasi,penjab.png_jawab ,operasi.kode_paket,reg_periksa.no_rawat,reg_periksa.no_rkm_medis, billing.tgl_byr "+
                             ...
                             "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj "+
                             "inner join billing on billing.no_rawat = reg_periksa.no_rawat "+
                             "where reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien) and billing.noindex = 0 and billing.tgl_byr between ? and ? and operasi.dokter_anestesi=? "+
                             "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.biayadokter_anestesi>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan  ");
                         try {
                             psbiayaoperator1.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                             psbiayaoperator1.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
                    ...
                    if(chkLaborat.isSelected()==true){
                        ...
                        psperiksa_lab=koneksi.prepareStatement(
                             ...
                             " inner join penjab on reg_periksa.kd_pj=penjab.kd_pj "+
                             "inner join billing on billing.no_rawat = reg_periksa.no_rawat "+
                             " where reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien) and billing.noindex = 0 and billing.tgl_byr between ? and ? and periksa_lab.kd_dokter=? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? "+
                             " and periksa_lab.tarif_tindakan_dokter>0 order by periksa_lab.tgl_periksa,periksa_lab.jam,jns_perawatan_lab.nm_perawatan  ");            
                         try {
                             psperiksa_lab.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                             psperiksa_lab.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
                         ...
                         psdetaillab=koneksi.prepareStatement(
                             "select detail_periksa_lab.bagian_dokter,pasien.nm_pasien,"+
                             "template_laboratorium.Pemeriksaan,penjab.png_jawab , "+
                             "periksa_lab.tgl_periksa,periksa_lab.jam,periksa_lab.kd_jenis_prw, "+
                             "reg_periksa.no_rawat,reg_periksa.no_rkm_medis, billing.tgl_byr from detail_periksa_lab inner join periksa_lab "+
                             "inner join reg_periksa inner join pasien inner join template_laboratorium "+
                             "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj and periksa_lab.no_rawat=detail_periksa_lab.no_rawat "+
                             "and periksa_lab.kd_jenis_prw=detail_periksa_lab.kd_jenis_prw "+
                             "and periksa_lab.tgl_periksa=detail_periksa_lab.tgl_periksa "+
                             ...
                             "and detail_periksa_lab.id_template=template_laboratorium.id_template "+
                             "inner join billing on billing.no_rawat = reg_periksa.no_rawat "+
                             "where reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien) and billing.noindex = 0 and billing.tgl_byr between ? and ? "+
                             "and periksa_lab.kd_dokter=? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? "+
                             "and detail_periksa_lab.bagian_dokter>0 order by periksa_lab.tgl_periksa,periksa_lab.jam");
                         try {
                             psdetaillab.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                         ...
                         psperiksa_lab2=koneksi.prepareStatement(
                             ...
                             " inner join penjab on reg_periksa.kd_pj=penjab.kd_pj "+
                             "inner join billing on billing.no_rawat = reg_periksa.no_rawat "+
                             " where reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien) and billing.noindex = 0 and billing.tgl_byr between ? and ? and periksa_lab.dokter_perujuk=? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? "+
                             " and periksa_lab.tarif_perujuk>0 order by periksa_lab.tgl_periksa,periksa_lab.jam,jns_perawatan_lab.nm_perawatan  ");            
                         try {
                             psperiksa_lab2.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                             psperiksa_lab2.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
                    ...
                    if(chkRadiologi.isSelected()==true){
                        //periksa radiologi
                         psperiksa_radiologi=koneksi.prepareStatement("select periksa_radiologi.tarif_tindakan_dokter,pasien.nm_pasien,reg_periksa.no_rawat,reg_periksa.no_rkm_medis,"+
                             ...
                             " inner join penjab on reg_periksa.kd_pj=penjab.kd_pj "+
                             "inner join billing on billing.no_rawat = reg_periksa.no_rawat "+
                             " where reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien) and billing.noindex = 0 and billing.tgl_byr between ? and ? and periksa_radiologi.kd_dokter=? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? order by periksa_radiologi.tgl_periksa,periksa_radiologi.jam,jns_perawatan_radiologi.nm_perawatan  ");            
                         try {
                             psperiksa_radiologi.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                             psperiksa_radiologi.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
                             psperiksa_radiologi.setString(3,rs.getString("kd_dokter"));
                         ...
                         psperiksa_radiologi2=koneksi.prepareStatement("select periksa_radiologi.tarif_perujuk,pasien.nm_pasien,reg_periksa.no_rawat,reg_periksa.no_rkm_medis,"+
                             ...
                             " inner join penjab on reg_periksa.kd_pj=penjab.kd_pj "+
                             "inner join billing on billing.no_rawat = reg_periksa.no_rawat "+
                             " where reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien) and billing.noindex = 0 and billing.tgl_byr between ? and ? and periksa_radiologi.dokter_perujuk=? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? order by periksa_radiologi.tgl_periksa,periksa_radiologi.jam,jns_perawatan_radiologi.nm_perawatan  ");            
                         try {
                             psperiksa_radiologi2.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                             psperiksa_radiologi2.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
                             psperiksa_radiologi2.setString(3,rs.getString("kd_dokter"));
