...
public final class DlgPiutangRalan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        R1.setPreferredSize(new java.awt.Dimension(80, 23));
        panelGlass5.add(R1);

        R2.setBorder(javax.swing.BorderFactory.createLineBorder(java.awt.Color.pink));
        buttonGroup.add(R2);
        R2.setText("Tgl. Bayar");
    ...
    if(tabMode.getRowCount()==0){
        ...
        try {            
            ...
            pilihan = (String)JOptionPane.showInputDialog(
                ...
                null,
                new Object[]{"Laporan 1 (HTML)","Laporan 2 (WPS)","Laporan 3 (CSV)","Laporan 4 (Jasper)"},
                "Laporan 1 (HTML)"
            );

            switch (pilihan) {
                // ==============================================================
                // LAPORAN 1 : HTML (REKAP PEMBAYARAN)
                // ==============================================================
                case "Laporan 1 (HTML)":
                    ...
                    htmlContent.append(                             
                        "<tr class='isi'>"+
                            ...
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='5%'>SEP</td>"+ 
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='2%'>No.RM</td>"+
                            ...
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='5%'>Konsul</td>"+
                            ...
                            "<td valign='middle' bgcolor='#FFFAF8' align='center' width='4%'>Tgl Bayar</td>"+ // << kolom baru
                    ...
                    for(i=0;i<tabMode.getRowCount();i++){  
                        htmlContent.append(                             
                            "<tr class='isi'>"+
                                "<td valign='top'>"+tabMode.getValueAt(i,0)+"</td>"+   // Tgl
                                "<td valign='top'>"+tabMode.getValueAt(i,1)+"</td>"+   // No Nota
                                "<td valign='top'>"+tabMode.getValueAt(i,2)+"</td>"+   // SEP
                                "<td valign='top'>"+tabMode.getValueAt(i,3)+"</td>"+   // No RM
                                "<td valign='top'>"+tabMode.getValueAt(i,4)+"</td>"+   // Nama Pasien
                                "<td valign='top' align='right'>"+tabMode.getValueAt(i,5)+"</td>"+   // Registrasi
                                "<td valign='top' align='right'>"+tabMode.getValueAt(i,6)+"</td>"+   // Obat
                                "<td valign='top' align='right'>"+tabMode.getValueAt(i,7)+"</td>"+   // Konsul
                                "<td valign='top' align='right'>"+tabMode.getValueAt(i,8)+"</td>"+   // Tindakan
                                "<td valign='top' align='right'>"+tabMode.getValueAt(i,9)+"</td>"+   // Operasi
                                "<td valign='top' align='right'>"+tabMode.getValueAt(i,10)+"</td>"+  // Laborat
                                "<td valign='top' align='right'>"+tabMode.getValueAt(i,11)+"</td>"+  // Radiologi
                                "<td valign='top' align='right'>"+tabMode.getValueAt(i,12)+"</td>"+  // Tambahan
                                "<td valign='top' align='right'>"+tabMode.getValueAt(i,13)+"</td>"+  // Potongan
                                "<td valign='top' align='right'>"+tabMode.getValueAt(i,14)+"</td>"+  // Total
                                "<td valign='top' align='right'>"+tabMode.getValueAt(i,15)+"</td>"+  // Ekses
                                "<td valign='top' align='right'>"+tabMode.getValueAt(i,16)+"</td>"+  // Sudah Dibayar
                                "<td valign='top' align='center'>"+tabMode.getValueAt(i,17)+"</td>"+ // Tgl Bayar
                                "<td valign='top' align='right'>"+tabMode.getValueAt(i,18)+"</td>"+  // Sisa
                                "<td valign='top'>"+tabMode.getValueAt(i,19)+"</td>"+                // Dokter
                            "</tr>"
                        ); 
                    }            
                                    ...
                                    "<table width='1900px' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"+
                                        "<tr class='isi2'>"+
                                            "<td valign='top' align='center'>"+
                                                ...
                                                "<font size='2' face='Tahoma'>REKAP PEMBAYARAN "+NmPoli.getText().toUpperCase(Locale.US)+
                                                "<br>PERIODE "+Tgl1.getSelectedItem()+" s.d. "+Tgl2.getSelectedItem()+
                                                "<br>"+nmpenjab.getText().toUpperCase(Locale.US)+"</br></font>"+                                                        
                                            "</td>"+
                                       "</tr>"+
                                    "</table>"+
                                    "<table width='1900px' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"+
                ...
                // ==============================================================
                // LAPORAN 2 : HTML untuk WPS (struktur kolom sama)
                // ==============================================================
                case "Laporan 2 (WPS)":
                    htmlContent = new StringBuilder();
                    htmlContent.append(                             
                                    ...
                                    "<table width='1900px' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"+
                                        "<tr class='isi2'>"+
                                            "<td valign='top' align='center'>"+
                                                ...
                                                akses.getalamatrs()+", "+akses.getkabupatenrs()+", "+akses.getpropinsirs()+"<br>"+
                                                akses.getkontakrs()+", E-mail : "+akses.getemailrs()+"<br><br>"+
                                                "<font size='2' face='Tahoma'>DETAIL JM DOKTER PERIODE "+NmPoli.getText()+
                ...
                // ==============================================================
                // LAPORAN 3 : CSV (struktur sama dengan tabMode + Tgl Bayar)
                // ==============================================================
                case "Laporan 3 (CSV)":
                    htmlContent = new StringBuilder();
                    // header CSV (20 kolom)
                    htmlContent.append(
                        "\"Tanggal\";\"No.Nota\";\"No.SEP\";\"No.RM\";\"Nama Pasien\";\"Registrasi\";\"Obat+Emb+Tsl\";\"Konsul\";\"Tindakan\";\"Operasi\";\"Laborat\";\"Radiologi\";\"Tambahan\";\"Potongan\";\"Total\";\"Ekses\";\"Sudah Dibayar\";\"Tgl Bayar\";\"Sisa\";\"Dokter\";\n"
                    ); 
                    for(i=0;i<tabMode.getRowCount();i++){  
                        htmlContent.append(                             
                ...
                // ==============================================================
                // LAPORAN 4 : JASPER (TEMPORARY) – perbaiki mapping kolom
                // ==============================================================
                case "Laporan 4 (Jasper)":
                    ...
                    for(int r=0;r<tabMode.getRowCount();r++){  
                        Sequel.menyimpan(
                            "temporary",
                            "'"+r+"','"+
                            tabMode.getValueAt(r,0).toString().replaceAll("'","`") +"','"+  // tgl_registrasi
                            tabMode.getValueAt(r,1).toString().replaceAll("'","`") +"','"+  // no_nota
                            tabMode.getValueAt(r,2).toString().replaceAll("'","`") +"','"+  // no_sep
                            tabMode.getValueAt(r,3).toString().replaceAll("'","`") +"','"+  // no_rm
                            tabMode.getValueAt(r,4).toString().replaceAll("'","`") +"','"+  // nama pasien
                            tabMode.getValueAt(r,5).toString().replaceAll("'","`") +"','"+  // registrasi
                            tabMode.getValueAt(r,6).toString().replaceAll("'","`") +"','"+  // obat
                            tabMode.getValueAt(r,7).toString().replaceAll("'","`") +"','"+  // konsul
                            tabMode.getValueAt(r,8).toString().replaceAll("'","`") +"','"+  // tindakan
                            tabMode.getValueAt(r,9).toString().replaceAll("'","`") +"','"+  // operasi
                            tabMode.getValueAt(r,10).toString().replaceAll("'","`") +"','"+ // laborat
                            tabMode.getValueAt(r,11).toString().replaceAll("'","`") +"','"+ // radiologi
                            tabMode.getValueAt(r,12).toString().replaceAll("'","`") +"','"+ // tambahan
                            tabMode.getValueAt(r,13).toString().replaceAll("'","`") +"','"+ // potongan
                            tabMode.getValueAt(r,14).toString().replaceAll("'","`") +"','"+ // total
                            tabMode.getValueAt(r,15).toString().replaceAll("'","`") +"','"+ // ekses
                            tabMode.getValueAt(r,16).toString().replaceAll("'","`") +"','"+ // sudah dibayar
                            tabMode.getValueAt(r,17).toString().replaceAll("'","`") +"','"+ // tgl bayar
                            tabMode.getValueAt(r,18).toString().replaceAll("'","`") +"','"+ // sisa
                            tabMode.getValueAt(r,19).toString().replaceAll("'","`") +"','"+ // dokter
                            "','','','','','','','','','','','','','','','','"+akses.getalamatip()+"'",
                            "data"
                        );
                    }
                    ...
                    Valid.MyReportqry(
                        "rptRPiutangRalan.jasper",
                        "report",
                        "::[ Rekap Piutang Ralan Masuk ]::",
                        "select * from temporary where temporary.temp37='"+akses.getalamatip()+"' order by temporary.no",
                        param
                    );
                    break; 
            }                 
        } catch (Exception e) {
            System.out.println("Notif Cetak : "+e);
        }     
    ...
    */
    ...
    try {
        ...
        if (StatusLunas.getSelectedIndex() == 1) {
            // index 1 = Lunas
            status = " AND pp.status='Lunas' ";
        } else if (StatusLunas.getSelectedIndex() == 2) {
            // index 2 = Belum Lunas
            status = " AND pp.status='Belum Lunas' ";
        }

        // ==============================
        // PILIH KOLOM TANGGAL BERDASARKAN RADIOBUTTON
        // R1 = Tgl. Reg, R2 = Tgl. Bayar
        // ==============================
        String kolomTanggal = "rp.tgl_registrasi";  // default pakai tgl_registrasi
        String kolomOrder   = "rp.tgl_registrasi";

        if (R2.isSelected()) { // kalau R2 (Tgl. Bayar) dipilih
            kolomTanggal = "bp.tgl_bayar";
            kolomOrder   = "bp.tgl_bayar";
        }
        // kalau R1 yang aktif, otomatis tetap pakai tgl_registrasi
        ...
        String sql =
            ...
            "       d.nm_dokter, pj.png_jawab, pp.uangmuka, pp.totalpiutang, " +
            "       bs.no_sep, bp.tgl_bayar " +
            "FROM reg_periksa rp " +
            ...
            "INNER JOIN piutang_pasien pp ON pp.no_rawat    = rp.no_rawat " +
            "LEFT  JOIN bridging_sep bs   ON rp.no_rawat    = bs.no_rawat " +
            "LEFT  JOIN ( " +
            "   SELECT no_rawat, MAX(tgl_bayar) AS tgl_bayar " +
            "   FROM bayar_piutang " +
            "   GROUP BY no_rawat " +
            ") bp ON bp.no_rawat = pp.no_rawat " +
            "WHERE rp.status_lanjut='Ralan' " + status +
            "  AND " + kolomTanggal + " BETWEEN ? AND ? " +
            "  AND CONCAT(rp.kd_pj, pj.png_jawab) LIKE ? " +
            "  AND CONCAT(rp.kd_poli, pl.nm_poli) LIKE ? " +
            "ORDER BY " + kolomOrder + " ASC, rp.no_rawat ASC";
        ...
        try {
            ...
            ttlRalan_Dokter = 0; ttlRalan_Paramedis = 0;
            ttlTambahan = 0; ttlPotongan = 0; ttlRegistrasi = 0;
            ttlekses = 0; ttldibayar = 0; ttlsisa = 0;

            while (rs.next()) {
                Operasi = 0; Laborat = 0; Radiologi = 0; Obat = 0;
                Ralan_Dokter = 0; Ralan_Dokter_paramedis = 0; Ralan_Paramedis = 0;
                Tambahan = 0; Potongan = 0; Registrasi = 0;
                ekses = 0; dibayar = 0; sisa = 0;

                ps2 = koneksi.prepareStatement(
                    "SELECT billing.nm_perawatan, billing.totalbiaya, billing.status " +
                    "FROM billing WHERE billing.no_rawat=?"
                );
                try {
                    ...
                    all += Operasi + Laborat + Radiologi + Obat +
                           Ralan_Dokter + Ralan_Dokter_paramedis +
                ...
                dibayar = Sequel.cariIsiAngka(
                    "SELECT SUM(besar_cicilan) FROM bayar_piutang WHERE no_rawat=?",
                ...
                String tglBayar = rs.getString("tgl_bayar"); // dari bp

                tabMode.addRow(new Object[] {
                    rs.getString("tgl_registrasi"),                                             // kolom Tgl. Reg (tetap)
                    ...
                    Valid.SetAngka(Obat),
                    Valid.SetAngka(Ralan_Dokter),
                    Valid.SetAngka(Ralan_Paramedis + Ralan_Dokter_paramedis),
                    Valid.SetAngka(Operasi),
                    Valid.SetAngka(Laborat),
                    Valid.SetAngka(Radiologi),
                    Valid.SetAngka(Tambahan),
                    Valid.SetAngka(Potongan),
                    Valid.SetAngka(Operasi + Laborat + Radiologi + Obat +
                                   Ralan_Dokter + Ralan_Paramedis + Ralan_Dokter_paramedis +
                                   Tambahan + Potongan + Registrasi),
                    Valid.SetAngka(ekses),
                    Valid.SetAngka(dibayar),
                    tglBayar,                       // kolom Tgl. Bayar
                    Valid.SetAngka(sisa),
                    rs.getString("nm_dokter")
                });
            }

            LCount2.setText(String.valueOf(tabMode.getRowCount()));
            if (tabMode.getRowCount() > 0) {
                tabMode.addRow(new Object[] {
                    ">> Total", ":", "", "", "",
                    ...
                    Valid.SetAngka(ttlRalan_Paramedis),
                    ...
                    Valid.SetAngka(ttlLaborat + ttlRadiologi + ttlObat + ttlRalan_Dokter +
                                   ttlRalan_Paramedis + ttlTambahan + ttlPotongan +
                                   ttlRegistrasi + ttlOperasi),
                    Valid.SetAngka(ttlekses),
                    Valid.SetAngka(ttldibayar),
                    "",                 // kolom Tgl. Bayar (total) dikosongkan
                    Valid.SetAngka(ttlsisa),
                    ""
                });
            }
