            ...
            for(i=0;i<row;i++){  
                if(tabMode.getValueAt(i,0).toString().equals("true")&&(Valid.SetAngka(tabMode.getValueAt(i,10).toString())>0)){
                    if(Sequel.menyimpantf("bayar_piutang","?,?,?,?,?,?,?,?,?,?,?","Data",11,new String[]{
                        ...
                        if(sukses==true){
                            double persendokter = 0.5, persenperawat = 0.3;
                            //update RVP Rawat jalan
                            if((Sequel.queryutf("update rawat_jl_pr rjp inner join jns_perawatan jpi on jpi.kd_jenis_prw = rjp.kd_jenis_prw set rjp.tarif_tindakanpr=jpi.tarif_tindakanpr*"+persenperawat+" where no_rawat='"+tabMode.getValueAt(i,1).toString()+"'")==false)){
                                sukses=false;
                            }
                            if((Sequel.queryutf("update rawat_jl_drpr rjp inner join jns_perawatan jpi on jpi.kd_jenis_prw = rjp.kd_jenis_prw set rjp.tarif_tindakandr=jpi.tarif_tindakandr*"+persendokter+",rjp.tarif_tindakanpr=jpi.tarif_tindakanpr*"+persenperawat+" where no_rawat='"+tabMode.getValueAt(i,1).toString()+"'")==false)){
                                sukses=false;
                            }
                            //update RVP Rawat inap
                            if((Sequel.queryutf("update rawat_inap_pr rjp inner join jns_perawatan_inap jpi on jpi.kd_jenis_prw = rjp.kd_jenis_prw set rjp.tarif_tindakanpr=jpi.tarif_tindakanpr*"+persenperawat+", rjp.menejemen = rjp.menejemen*" + persenperawat + " where no_rawat='"+tabMode.getValueAt(i,1).toString()+"'")==false)){
                                sukses=false;
                            }
                            if((Sequel.queryutf("update rawat_inap_drpr rjp inner join jns_perawatan_inap jpi on jpi.kd_jenis_prw = rjp.kd_jenis_prw set rjp.tarif_tindakandr=jpi.tarif_tindakandr*"+persendokter+",rjp.tarif_tindakanpr=jpi.tarif_tindakanpr*"+persenperawat+" where no_rawat='"+tabMode.getValueAt(i,1).toString()+"'")==false)){
                                sukses=false;
                            }
                            //update rvp laborat
                            if(Sequel.queryutf("update periksa_lab set tarif_tindakan_dokter=tarif_tindakan_dokter*"+persendokter+",tarif_tindakan_petugas=tarif_tindakan_petugas*"+persenperawat+" where no_rawat='"+tabMode.getValueAt(i,1).toString()+"'")==false){
                                sukses=false;
                            }

                            if(Sequel.queryutf("update detail_periksa_lab set bagian_dokter=bagian_dokter*"+persendokter+",bagian_laborat=bagian_laborat*"+persenperawat+" where no_rawat='"+tabMode.getValueAt(i,1).toString()+"'")==false){
                                sukses=false;
                            }
                            //update rvp radiologi
                            if(Sequel.queryutf("update periksa_radiologi set tarif_tindakan_dokter=tarif_tindakan_dokter*"+persendokter+",tarif_tindakan_petugas=tarif_tindakan_petugas*"+persenperawat+" where no_rawat='"+tabMode.getValueAt(i,1).toString()+"'")==false){
                                sukses=false;
                            }
                            //update rvp operasi
                            double totalbayar = Valid.SetAngka(tabMode.getValueAt(i,10).toString());
                            String ujicoba = "update operasi o set o.biayaoperator1 = (CASE WHEN o.biayaoperator1 > 0 THEN " +totalbayar+ " *   0.2 ELSE 0 END),\n" +
                                    " o.biayaoperator2  = (CASE WHEN o.biayaoperator2 > 0 THEN " +totalbayar+ " *   0.2 ELSE 0 END),\n" +
                                    " o.biayaoperator3 = (CASE WHEN o.biayaoperator3 > 0 THEN " +totalbayar+ " * 0.2 ELSE 0 END),\n" +
                                    " o.biayadokter_anestesi  = (case when o.biayadokter_anestesi > 0 THEN " +totalbayar+ " * 0.07 ELSE 0 END),\n" +
                                    " o.biayaasisten_operator1 = (case when o.biayaasisten_operator1 > 0 THEN " +totalbayar+ " * 0.01 ELSE 0 END),\n" +
                                    " o.biayaasisten_operator2 = (case when o.biayaasisten_operator2 > 0 THEN " +totalbayar+ " * 0.01 ELSE 0 END),\n" +
                                    " o.biayaasisten_operator3 = (case when o.biayaasisten_operator3 > 0 THEN " +totalbayar+ " * 0.01 ELSE 0 END),\n" +
                                    " o.biaya_omloop  = (case when o.biaya_omloop > 0 THEN " +totalbayar+ " * 0.01 ELSE 0 END),\n" +
                                    " o.biaya_omloop2 = (case when o.biaya_omloop2 > 0 THEN " +totalbayar+ " * 0.01 ELSE 0 END),\n" +
                                    " o.biaya_omloop3 = (case when o.biaya_omloop3 > 0 THEN " +totalbayar+ " * 0.01 ELSE 0 END),\n" +
                                    " o.biaya_omloop4 = (case when o.biaya_omloop4 > 0 THEN " +totalbayar+ " * 0.01 ELSE 0 END),\n" +
                                    " o.biaya_omloop5 = (case when o.biaya_omloop5 > 0 THEN " +totalbayar+ " * 0.01 ELSE 0 END),\n" +
                                    " o.biayaperawaat_resusitas = case when o.biayaperawaat_resusitas > 0 THEN " +totalbayar+ " * 0.01 else 0 end\n" +
                                    " where no_rawat='"+tabMode.getValueAt(i,1).toString()+"'";
                            if(Sequel.queryutf("update operasi o set o.biayaoperator1 = (CASE WHEN o.biayaoperator1 > 0 THEN " +totalbayar+ " *   0.2 ELSE 0 END),\n" +
                                    " o.biayaoperator2  = (CASE WHEN o.biayaoperator2 > 0 THEN " +totalbayar+ " *   0.2 ELSE 0 END),\n" +
                                    " o.biayaoperator3 = (CASE WHEN o.biayaoperator3 > 0 THEN " +totalbayar+ " * 0.2 ELSE 0 END),\n" +
                                    " o.biayadokter_anestesi  = (case when o.biayadokter_anestesi > 0 THEN " +totalbayar+ " * 0.07 ELSE 0 END),\n" +
                                    " o.biayaasisten_operator1 = (case when o.biayaasisten_operator1 > 0 THEN " +totalbayar+ " * 0.01 ELSE 0 END),\n" +
                                    ...
                                    " o.biaya_omloop5 = (case when o.biaya_omloop5 > 0 THEN " +totalbayar+ " * 0.01 ELSE 0 END),\n" +
                                    " o.biayaperawaat_resusitas = case when o.biayaperawaat_resusitas > 0 THEN " +totalbayar+ " * 0.01 else 0 end\n" +
                                    " where no_rawat='"+tabMode.getValueAt(i,1).toString()+"'")==false){
                                sukses=false;

//                            String no_rawat = tabMode.getValueAt(i, 1).toString();
//                            String kode_paket = tabMode.getValueAt(i, 11).toString(); // misalnya kolom 11 berisi kode_paket
//                            double totalbayar = Valid.SetAngka(tabMode.getValueAt(i, 10).toString());
//
//                            String queryUpdate = 
//                                "UPDATE operasi o SET " +
//                                "o.biayaoperator1 = (CASE WHEN o.biayaoperator1 > 0 THEN " + totalbayar + " * 0.2 ELSE 0 END), " +
//                                "o.biayaoperator2 = (CASE WHEN o.biayaoperator2 > 0 THEN " + totalbayar + " * 0.2 ELSE 0 END), " +
//                                "o.biayaoperator3 = (CASE WHEN o.biayaoperator3 > 0 THEN " + totalbayar + " * 0.2 ELSE 0 END), " +
//                                "o.biayadokter_anestesi = (CASE WHEN o.biayadokter_anestesi > 0 THEN " + totalbayar + " * 0.07 ELSE 0 END), " +
//                                "o.biayaasisten_operator1 = (CASE WHEN o.biayaasisten_operator1 > 0 THEN " + totalbayar + " * 0.01 ELSE 0 END), " +
...
//                                "o.biaya_omloop5 = (CASE WHEN o.biaya_omloop5 > 0 THEN " + totalbayar + " * 0.01 ELSE 0 END), " +
//                                "o.biayaperawaat_resusitas = (CASE WHEN o.biayaperawaat_resusitas > 0 THEN " + totalbayar + " * 0.01 ELSE 0 END) " +
//                                "WHERE o.no_rawat='" + no_rawat + "' AND o.kode_paket='" + kode_paket + "'";
//
//                            if(Sequel.queryutf(queryUpdate)==false){
//                                sukses=false;
