...
public final class KeuanganBayarPemesananFarmasi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MnCetakKuitansi.setBackground(new java.awt.Color(255, 255, 254));
        MnCetakKuitansi.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnCetakKuitansi.setForeground(new java.awt.Color(50, 50, 50));
        MnCetakKuitansi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnCetakKuitansi.setText("Cetak Bukti Pengeluaran Bank");
        MnCetakKuitansi.setComponentPopupMenu(jPopupMenu1);
        MnCetakKuitansi.setName("MnCetakKuitansi"); // NOI18N
        MnCetakKuitansi.setPreferredSize(new java.awt.Dimension(250, 26));
        ...
        panelisi4.setPreferredSize(new java.awt.Dimension(100, 250));
        ...
        no_faktur.setBounds(110, 10, 290, 23);
        ...
        label36.setBounds(15, 100, 90, 23);
        ...
        no_bukti.setBounds(110, 130, 290, 23);
        ...
        label35.setBounds(15, 70, 70, 23);

        besar_bayar.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        ...
        besar_bayar.setBounds(110, 70, 90, 23);
        ...
        label16.setBounds(15, 190, 90, 23);
        ...
        nama_petugas.setBounds(205, 190, 195, 23);
        ...
        tgl_bayar.setBounds(110, 40, 90, 23);

        sisa_hutang.setEditable(false);
        sisa_hutang.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        ...
        sisa_hutang.setBounds(310, 70, 90, 23);

        BtnPetugas.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        BtnPetugas.setMnemonic('1');
        BtnPetugas.setText("Cari Petugas");
        ...
        AkunBayar.setBounds(110, 160, 290, 23);
        ...
        keterangan.setBounds(110, 100, 600, 23);
        ...
        label39.setBounds(15, 130, 77, 23);

        BtnAll1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/refresh.png"))); // NOI18N
        BtnAll1.setMnemonic('M');
        BtnAll1.setText("Refres Akun Bayar");
        BtnAll1.setToolTipText("Alt+M");
        BtnAll1.setHideActionText(true);
        BtnAll1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnAll1.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        BtnAll1.setName("BtnAll1"); // NOI18N
        BtnAll1.setPreferredSize(new java.awt.Dimension(50, 23));
        ...
        BtnAll1.setBounds(408, 160, 150, 23);
        ...
        label38.setBounds(225, 70, 80, 23);
        ...
        BtnAll.setPreferredSize(new java.awt.Dimension(90, 23));
        ...
        BtnPrintBPB.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/b_print.png"))); // NOI18N
        BtnPrintBPB.setMnemonic('T');
        BtnPrintBPB.setText("Cetak BPB");
        BtnPrintBPB.setToolTipText("Alt+T");
        BtnPrintBPB.setIconTextGap(8);
        BtnPrintBPB.setName("BtnPrintBPB"); // NOI18N
        BtnPrintBPB.setPreferredSize(new java.awt.Dimension(110, 30));
        BtnPrintBPB.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnPrintBPBActionPerformed(evt);
            }
        });
        BtnPrintBPB.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnPrintBPBKeyPressed(evt);
            }
        });
        panelisi1.add(BtnPrintBPB);
...
private void BtnPetugasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPetugasActionPerformed
    ...
    private void MnCetakKuitansiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakKuitansiActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReportqry("rptBayarPemesananPenerimaan.jasper","report","::[ Bayar Pemesanan ]::",
                    "select bayar_pemesanan.tgl_bayar,pemesanan.tgl_faktur,pemesanan.tgl_pesan,"+
                    "pemesanan.tgl_tempo, bayar_pemesanan.no_faktur,"+
                    "datasuplier.nama_suplier,bayar_pemesanan.nama_bayar,bayar_pemesanan.no_bukti,"+
                    "bayar_pemesanan.besar_bayar,bayar_pemesanan.keterangan,"+
    ...
    private void BtnPrintBPBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintBPBActionPerformed
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        BtnCariActionPerformed(evt);
        if(tabMode.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, data sudah habis. Tidak ada data yang bisa anda print...!!!!");
        ...
        this.setCursor(Cursor.getDefaultCursor());
    }//GEN-LAST:event_BtnPrintBPBActionPerformed

    private void BtnPrintBPBKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnPrintBPBKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnPrintBPBKeyPressed
    ...
    */
    ...
    private widget.Button BtnPrintBPB;
