...
public final class DlgKamar extends javax.swing.JDialog {
    ...
    public DlgKamar(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new String[]{
                "P","Nomer Bed","Kode Kamar","Nama Kamar","Kelas","Tarif Kamar","Status Kamar","Kode Ruang"
            }){
    ...
    public void tampil() {
        ...
        try{     
            ps=koneksi.prepareStatement("select kamar.kd_kamar,kamar.kd_bangsal,bangsal.nm_bangsal, "+
                       "kamar.kelas,kamar.trf_kamar,kamar.status,kamar_tt.kd_ruang from bangsal inner join kamar "+
                       "on kamar.kd_bangsal=bangsal.kd_bangsal left join kamar_tt on kamar_tt.kd_kamar=kamar.kd_kamar where "+
