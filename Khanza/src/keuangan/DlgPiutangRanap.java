...
public final class DlgPiutangRanap extends javax.swing.JDialog {
    ...
    public DlgPiutangRanap(java.awt.Frame parent, boolean modal) {
        ...
        Object[] rowRwJlDr={"Tgl.Pulang","No.Nota","No.SEP","No.RM","Nama Pasien","Administrasi","Tindakan","Obt+Emb+Tsl","Retur Obat","Resep Pulang",
            ...
            try {            
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                            ...
                            htmlContent.append(                             
                                "<tr class='isi'>"+
                                    ...
                                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='5%'>No.SEP</td>"+    
                                    ...
                                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='3%'>Administrasi</td>"+
                                            ...
                                            "<table width='2000px' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"+
                                                "<tr class='isi2'>"+
                                                    "<td valign='top' align='center'>"+
                                                        ...
                                                        "<font size='2' face='Tahoma'>REKAP PEMBAYARAN RAWAT INAP" +
                    ...
                    case "Laporan 3 (CSV)":
                            htmlContent = new StringBuilder();
                            htmlContent.append(                             
                                "\"Tgl.Pulang\";\"No.Nota\";\"No.RM\";\"Nama Pasien\";\"Jenis Bayar\";\"Perujuk\";\"Administrasi\";\"Tindakan\";\"Obt+Emb+Tsl\";\"Retur Obat\";\"Resep Pulang\";\"Laborat\";\"Radiologi\";\"Potongan\";\"Tambahan\";\"Kamar+Service\";\"Operasi\";\"Harian\";\"Total\";\"Ekses\";\"Sudah Dibayar\";\"Sisa\";\"Nama Kamar\"\n"
                            ); 
                            for(i=0;i<tabMode.getRowCount();i++){  
                                htmlContent.append(                             
    ...
    public void tampil(){
        ...
        try{      
            ...
            ps= koneksi.prepareStatement(
                ...
                "penjab.png_jawab,kamar_inap.stts_pulang,kamar.kd_kamar, bangsal.nm_bangsal,piutang_pasien.uangmuka,piutang_pasien.totalpiutang,bridging_sep.no_sep "+
