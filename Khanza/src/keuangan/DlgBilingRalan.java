...
public class DlgBilingRalan extends javax.swing.JDialog {
    ...
    private final DefaultTableModel tabModeTambahan,tabModePotongan,tabModeAkunBayar,tabModeAkunPiutang,tabModeLab,tabModeRad,tabModeApotek,tabModePermintaan;
    ...
    /*
     * Clinical Service Board - Status Permintaan Rawat Jalan.
     * Tiga model lama tetap menjadi sumber data agar seluruh query dan fungsi
     * Laboratorium, Radiologi, serta Resep tetap berjalan seperti sebelumnya.
     */
    ...
    public DlgCariPoli poli=new DlgCariPoli(null,true);   
    public DlgCariCaraBayar penjab=new DlgCariCaraBayar(null,true);
    ...
    private static final Set<String> USER_KEUANGAN = Set.of("151839","181865",
            "19890776","19910847","19991385","20021490",
            "20021493","20031522","20051597","20061638",
            "20111817","20161833","20111819","211921","K231972","K231973");
    ...
    public DlgBilingRalan(java.awt.Frame parent, boolean modal) {
        ...
        /*
         * Model gabungan hanya dipakai oleh tampilan Clinical Service Board.
         * Datanya disalin dari tabModeLab, tabModeRad, dan tabModeApotek
         * setelah ketiga query rawat jalan lama selesai dijalankan.
         */
        ...
        try {
            ...
            // hilangkan border luar JTabbedPane
    ...
    private void initComponents() {
        ...
        WindowGantiDokterPoli.setTitle("Ganti Dokter Poli");
        WindowGantiDokterPoli.setMinimumSize(new java.awt.Dimension(625, 120));
        WindowGantiDokterPoli.setName("WindowGantiDokterPoli"); // NOI18N
        WindowGantiDokterPoli.setResizable(false);
        WindowGantiDokterPoli.setSize(new java.awt.Dimension(625, 120));
        WindowGantiDokterPoli.setType(java.awt.Window.Type.POPUP);
        ...
        internalFrame3.setMinimumSize(new java.awt.Dimension(625, 100));
        ...
        BtnCloseIn1.setBounds(510, 10, 100, 30);
        ...
        BtnSimpan1.setBounds(410, 10, 100, 30);

        jLabel13.setText("Dr Dituju :");
        jLabel13.setName("jLabel13"); // NOI18N
        internalFrame3.add(jLabel13);
        jLabel13.setBounds(0, 10, 77, 23);
        ...
        kddokter.setBounds(80, 10, 100, 23);
        ...
        TDokter.setBounds(180, 10, 181, 23);
        ...
        btnCariDokter.setBounds(370, 10, 28, 23);
        ...
        WindowObatLangsung.setTitle("Input Total BHP & Obat");
        WindowObatLangsung.setName("WindowObatLangsung"); // NOI18N
        WindowObatLangsung.setResizable(false);
        WindowObatLangsung.setSize(new java.awt.Dimension(620, 100));
        WindowObatLangsung.setType(java.awt.Window.Type.POPUP);
        ...
        internalFrame2.setMinimumSize(new java.awt.Dimension(620, 100));
        ...
        WindowGantiPoli.setTitle("Ganti Poliklinik");
        WindowGantiPoli.setMinimumSize(new java.awt.Dimension(625, 120));
        WindowGantiPoli.setName("WindowGantiPoli"); // NOI18N
        WindowGantiPoli.setResizable(false);
        WindowGantiPoli.setSize(new java.awt.Dimension(625, 120));
        WindowGantiPoli.setType(java.awt.Window.Type.POPUP);
        ...
        BtnCloseIn4.setBounds(510, 10, 100, 30);
        ...
        BtnSimpan4.setBounds(410, 10, 100, 30);

        jLabel14.setText("Poli Dituju :");
        jLabel14.setName("jLabel14"); // NOI18N
        internalFrame5.add(jLabel14);
        jLabel14.setBounds(0, 10, 77, 23);
        ...
        kdpoli.setBounds(80, 10, 100, 23);

        nmpoli.setEditable(false);
        nmpoli.setName("nmpoli"); // NOI18N
        internalFrame5.add(nmpoli);
        nmpoli.setBounds(190, 10, 181, 23);
        ...
        btnCariPoli.setBounds(370, 10, 28, 23);
        ...
        WindowGantiPenjab.setTitle("Ganti Jenis Bayar");
        WindowGantiPenjab.setMinimumSize(new java.awt.Dimension(625, 120));
        WindowGantiPenjab.setName("WindowGantiPenjab"); // NOI18N
        WindowGantiPenjab.setResizable(false);
        WindowGantiPenjab.setSize(new java.awt.Dimension(625, 120));
        WindowGantiPenjab.setType(java.awt.Window.Type.POPUP);
        ...
        internalFrame7.setMinimumSize(new java.awt.Dimension(625, 100));
        ...
        BtnCloseIn5.setBounds(510, 10, 100, 30);
        ...
        BtnSimpan5.setBounds(400, 10, 100, 30);

        jLabel17.setText("Jenis Bayar :");
        jLabel17.setName("jLabel17"); // NOI18N
        internalFrame7.add(jLabel17);
        jLabel17.setBounds(0, 10, 77, 23);
        ...
        kdpenjab.setBounds(80, 10, 100, 23);

        nmpenjab.setEditable(false);
        nmpenjab.setName("nmpenjab"); // NOI18N
        internalFrame7.add(nmpenjab);
        nmpenjab.setBounds(180, 10, 181, 23);
        ...
        btnPenjab.setBounds(370, 10, 28, 23);
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "22-04-2026 09:20:34" }));
        ...
        TabRawat.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        ...
        scrollPane8.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        scrollPane8.setComponentPopupMenu(PopupBayar);
        scrollPane8.setName("scrollPane8"); // NOI18N

        panelBayar.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)));
        ...
        TKembali.setBounds(130, 390, 160, 26);
        ...
        chkRadiologi.setBounds(150, 10, 81, 23);

        chkTambahan.setSelected(true);
        chkTambahan.setText("Tambahan");
        chkTambahan.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        chkTambahan.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        chkTambahan.setIconTextGap(10);
        ...
        chkTambahan.setBounds(370, 10, 89, 23);

        chkObat.setSelected(true);
        chkObat.setText("Obat");
        chkObat.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        chkObat.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        chkObat.setIconTextGap(10);
        ...
        chkObat.setBounds(590, 10, 56, 23);
        ...
        chkSarpras.setBounds(930, 10, 70, 23);
        ...
        chkAdministrasi.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        chkAdministrasi.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        chkAdministrasi.setIconTextGap(10);
        ...
        chkAdministrasi.setBounds(810, 10, 100, 23);
        ...
        scrollPane3.setBounds(20, 170, 627, 210);
        ...
        jLabel6.setBounds(20, 390, 110, 23);
        ...
        scrollPane4.setBounds(680, 170, 627, 210);
        ...
        TCari1.setBounds(820, 130, 400, 26);
        ...
        btnCariPiutang.setBounds(1230, 130, 25, 23);
        ...
        BtnAll1.setBounds(1260, 130, 25, 23);
        ...
        jLabel18.setBounds(680, 90, 120, 35);

        scrollPane8.setViewportView(panelBayar);

        TabRawat.addTab("Pembayaran", scrollPane8);

        panelPermintaan.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        ...
        scrollPane5.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)), "1. Permintaan Laborat : ", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI Semibold", 0, 14), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        scrollPane7.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)), "3. Permintaan Resep : ", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI Semibold", 0, 14), new java.awt.Color(50, 50, 50))); // NOI18N
        scrollPane7.setComponentPopupMenu(PopupBayar);
        scrollPane7.setName("scrollPane7"); // NOI18N
        scrollPane7.setPreferredSize(new java.awt.Dimension(460, 800));
        ...
        scrollPane6.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)), "2. Permintaan Radiologi : ", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI Semibold", 0, 14), new java.awt.Color(50, 50, 50))); // NOI18N
...
//        }
        ...
        if(TNoRw.getText().trim().equals("")||TNoRM.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            // validasi cetak
            }else if(Sequel.cariInteger("select count(cetak_billing.no_rawat) from cetak_billing where no_rawat ='"+ TNoRw.getText()+"'")>0){
            String norawat_sekarang = Sequel.cariIsi("select cetak_billing.no_rawat from cetak_billing where no_rawat ='" + TNoRw.getText()+"'");
            String petugas_sekarang = Sequel.cariIsi("select cetak_billing.petugas from cetak_billing where no_rawat ='" + TNoRw.getText()+"'");
            String jam_sekarang = Sequel.cariIsi("select cetak_billing.waktu from cetak_billing where no_rawat ='" + TNoRw.getText()+"'");
            JOptionPane.showMessageDialog(null,"Maaf, Kuitansi ini sudah di cetak oleh '" + petugas_sekarang + "' pada jam '" + jam_sekarang + "' dengan No. Rawat '" + norawat_sekarang + "'. Hubungi Kasir jika ingin mencetak kembali");
            //tutup validasi               
                ...
                try{
                    ...
                    if(i>0){       
                        if(Sequel.menyimpantf("cetak_billing","?,?,NOW()","No.Rawat",2,new String[]{
                                TNoRw.getText(),akses.getkode()})==true){
                                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                                kd_pj=Sequel.cariIsi("select reg_periksa.kd_pj from reg_periksa where reg_periksa.no_rawat=?",TNoRw.getText());
                                if(i==1){
                                    if (USER_KEUANGAN.contains(akses.getkode())){
                                        Valid.panggilUrl("billing/LaporanBillingKeu.php?petugas="+akses.getkode().replaceAll(" ","_")+"&tanggal="+DTPTgl.getSelectedItem().toString().replaceAll(" ","_")+"&usere="+koneksiDB.USERHYBRIDWEB()+"&passwordte="+koneksiDB.PASHYBRIDWEB());
                                    }
                                    else {
        ...
        if(i>0){
            if(!tbBilling.getValueAt(0,1).toString().trim().contains("No.Nota")){
                ...
                if(sukses==true){
                    ...
                    Sequel.meghapus("cetak_billing", "no_rawat", TNoRw.getText());
...
//            JOptionPane.showMessageDialog(null, "Maaf, SKDP belum diterbitkan...!!!");    
    ...
    */
    ...
    // Query rawat jalan lama tidak dipindahkan atau diubah agar fungsi sumber data tetap aman.
    ...
    private static Icon muatIkonLayanan(String lokasi,String jenisCadangan,Color warnaCadangan){
        java.net.URL sumber=DlgBilingRalan.class.getResource(lokasi);
        if(sumber==null){
...
//    if (i <= 0) {
//        prosesCariReg();
//        if (chkLaborat.isSelected() || chkTarifDokter.isSelected() || chkTarifPrm.isSelected() || chkRadiologi.isSelected()) {
//            tabModeRwJlDr.addRow(new Object[]{true, "Tindakan", ":", "", null, null, null, null, "Ralan Dokter"});
//        }
//        if (chkTarifDokter.isSelected()) {
//            prosesCariRwJlDr();
//            prosesCariRwJlDrPr();
//        }
//        if (chkTarifPrm.isSelected()) {
//            prosesCariRwJlPr();
//        }
...
//        prosesCariOperasi();
//
//        if (chkSarpras.isSelected() && detailjs > 0) {
//            tabModeRwJlDr.addRow(new Object[]{true, "", "Jasa Sarana dan Prasarana", ":", null, null, null, detailjs, "Ralan Dokter"});
//        }
//
...
//                    rstambahan.beforeFirst();
//                    while (rstambahan.next()) {
//                        tabModeRwJlDr.addRow(new Object[]{true, "", rstambahan.getString("nama_biaya"), ":", rstambahan.getDouble("besar_biaya"), 1, null, rstambahan.getDouble("besar_biaya"), "Tambahan"});
//                    }
//                } finally {
//                    if (rstambahan != null) rstambahan.close();
//                    if (pstambahan != null) pstambahan.close();
//                }
//            } catch (SQLException ex) {
//                System.out.println("Notifikasi : " + ex);
//            }
...
//                    rspotongan.beforeFirst();
//                    while (rspotongan.next()) {
//                        tabModeRwJlDr.addRow(new Object[]{true, "", rspotongan.getString("nama_pengurangan"), ":", rspotongan.getDouble("besar_pengurangan"), 1, null, (-1 * rspotongan.getDouble("besar_pengurangan")), "Potongan"});
//                    }
//                } finally {
//                    if (rspotongan != null) rspotongan.close();
//                    if (pspotongan != null) pspotongan.close();
//                }
//            } catch (Exception ex) {
//                System.out.println("Notifikasi : " + ex);
//            }
...
//                            rsbilling.getString("status")});
//
//                        // Tambahan: rincian untuk tindakan Haemodialisa berdasarkan kd_jenis_prw
//                        String kdJenis = rsbilling.getString("kd_jenis_prw");
//                        if (kdJenis != null && !kdJenis.isEmpty()) {
//                            PreparedStatement pstindakan = koneksi.prepareStatement(
//                                "SELECT nm_perawatan, material, tarif_tindakandr, tarif_tindakandrpr, tarif_tindakanpr, total_byrdr " +
//                                "FROM jns_perawatan WHERE kd_jenis_prw=?");
//                            pstindakan.setString(1, kdJenis);
//                            ResultSet rstindakan = pstindakan.executeQuery();
//                            while (rstindakan.next()) {
//                                if (rstindakan.getString("nm_perawatan").toLowerCase().contains("haemodialisa")) {
//                                    tabModeRwJlDr.addRow(new Object[]{true, "", "Detail: " + rstindakan.getString("nm_perawatan"), ":", null, null, null, null, "Rincian"});
//                                    if (rstindakan.getDouble("material") > 0) {
//                                        tabModeRwJlDr.addRow(new Object[]{true, "", "Material", ":", rstindakan.getDouble("material"), 1, null, rstindakan.getDouble("material"), "Rincian"});
//                                    }
//                                    if (rstindakan.getDouble("tarif_tindakandr") > 0) {
//                                        tabModeRwJlDr.addRow(new Object[]{true, "", "Tarif Dokter", ":", rstindakan.getDouble("tarif_tindakandr"), 1, null, rstindakan.getDouble("tarif_tindakandr"), "Rincian"});
//                                    }
//                                    if (rstindakan.getDouble("tarif_tindakandrpr") > 0) {
//                                        tabModeRwJlDr.addRow(new Object[]{true, "", "Tarif Dr. Pr", ":", rstindakan.getDouble("tarif_tindakandrpr"), 1, null, rstindakan.getDouble("tarif_tindakandrpr"), "Rincian"});
//                                    }
//                                    if (rstindakan.getDouble("tarif_tindakanpr") > 0) {
//                                        tabModeRwJlDr.addRow(new Object[]{true, "", "Tarif Perawat", ":", rstindakan.getDouble("tarif_tindakanpr"), 1, null, rstindakan.getDouble("tarif_tindakanpr"), "Rincian"});
//                                    }
//                                }
//                            }
//                            rstindakan.close();
...
//    isKembali();
    ...
    public void isRawat2() {
        ...
        {prosesCariPeriksaLab();}
        if(chkRadiologi.isSelected()==true)
            tabModeRwJlDr.addRow(new Object[]{true,"Radiolgi",":","",null,null,null,null,"Radiologi"});
        {prosesCariRadiologi();}             
        if(chkSarpras.isSelected()==true){
            if(detailjs>0){
               tabModeRwJlDr.addRow(new Object[]{true,"","Jasa Sarana dan Prasarana",":",null,null,null,detailjs,"Ralan Dokter"});
...
//                        tabModeRwJlDr.addRow(new Object[]{true,"","          Registrasi :   "+Valid.SetAngka3(subttl),":",null,null,null,null,"Registrasi"});
    ...
    private void prosesCariRwJlDr() {
        try{  
            ...
            try {
                ...
                if(subttl > 0){
                    tabModeRwJlDr.addRow(new Object[]{true,"","          Total Konsul :   "+Valid.SetAngka3(subttl),":",null,null,null,null,"TtlRalan Dokter"});                                                           
                }
            } catch (Exception e) {
                System.out.println("Notifikasi : "+e);
            } finally{
    ...
    private void prosesCariRwJlDrPr() {
        try{            
            ...
            try {
                ...
                System.out.println(subttl);
                if(subttl > 0){
                    tabModeRwJlDr.addRow(new Object[]{true,"","          Total Tindakan :   "+Valid.SetAngka3(subttl),":",null,null,null,null,"TtlRalan Paramedis"});                                        
                }
            } catch (Exception e) {
                System.out.println("Notifikasi : "+e); 
            } finally{
    ...
    private void prosesCariRwJlPr() {
        try{        
            ...
            try {
                ...
                System.out.println(subttl);
                if(subttl > 0){
                    tabModeRwJlDr.addRow(new Object[]{true,"","          Total Ralan Perawat :   "+Valid.SetAngka3(subttl),":",null,null,null,null,"TtlRalan Paramedis"});                    
                }
            } catch (Exception e) {
                System.out.println("Notifikasi : "+e); 
            } finally{
...
//                System.out.println(subttl);
//                if(subttl > 0){
//                    tabModeRwJlDr.addRow(new Object[]{true,"","          Total Laborat :   "+Valid.SetAngka3(subttl),":",null,null,null,null,"TtlLaborat"});                    
//                }
//            } catch (Exception e) {
//                System.out.println("Notifikasi : "+e); 
//            } finally{
...
//    // Rincian per item (hanya yang > 0) + hitung jumlah item (jml)
//    final String SQL_RINCI =
...
//
//    try {
//        pscarilab = koneksi.prepareStatement(sqlpscarilab); // parent: nm_perawatan & kd_jenis_prw
//        try {
//            pscarilab.setString(1, TNoRw.getText());
//            rscarilab = pscarilab.executeQuery();
//
//            subttl = 0; // subtotal Laborat dari DETAIL saja
//
//            while (rscarilab.next()) {
//                final String kdJenis = rscarilab.getString("kd_jenis_prw");
//
//                // HEADER parent TANPA nominal
...
//                    null,   // Tambahan
//                    null,   // Total Biaya
//                    "Laborat"  // tag dikenali
//                });
//                                
//                // RINCIAN: isi Jml & Tambahan sehingga Jml*Tambahan = Total Biaya
//                try (PreparedStatement psRinci = koneksi.prepareStatement(SQL_RINCI)) {
//                    psRinci.setString(1, TNoRw.getText());
...
//                                });                            
//                            
//                            subttl += total;   // akumulasi subtotal dari DETAIL
//                        }
//                    }
//                } catch (Exception e) {
//                    System.out.println("Notifikasi (rincian lab): " + e);
//                }
//            }
//
...
//                tabModeRwJlDr.addRow(new Object[]{
//                    true, "",
//                    "          Total Laborat :   " + Valid.SetAngka3(subttl),
//                    ":", null, null, null, null,
//                    "TtlLaborat"
//                });
//            }
...
//            System.out.println("Notifikasi : " + e);
//        } finally {
//            if (rscarilab != null) try { rscarilab.close(); } catch (Exception ignored) {}
//            if (pscarilab != null) try { pscarilab.close(); } catch (Exception ignored) {}
//        }
//    } catch (Exception e) {
//        System.out.println("Notifikasi : " + e);
//    }
//    
    ...
    // Rincian per item (hanya yang > 0) + hitung jumlah item (jml) untuk PK/MB
    final String SQL_RINCI =
        "SELECT tl.Pemeriksaan AS pemeriksaan, " +
        "       COUNT(*) AS jml, " +
        "       SUM(dpl.biaya_item) AS total " +
    ...
    // Ambil kategori & total_byr untuk kd_jenis_prw (menentukan PA vs PK/MB)
    final String SQL_KATEGORI =
        "SELECT kategori, total_byr FROM jns_perawatan_lab WHERE kd_jenis_prw = ?";

    try {
        pscarilab = koneksi.prepareStatement(sqlpscarilab); // parent: nm_perawatan, jml, biaya, total, kd_jenis_prw
        try {
            pscarilab.setString(1, TNoRw.getText());
            rscarilab = pscarilab.executeQuery();

            subttl = 0; // subtotal Laborat (PA dihitung di header; PK/MB dari detail)

            while (rscarilab.next()) {
                final String kdJenis = rscarilab.getString("kd_jenis_prw");
                final String nmPerawatan = rscarilab.getString("nm_perawatan");
                final double jmlHeader   = rscarilab.getDouble("jml");

                String kategori = null;
                double totalByrPA = 0.0;

                // cek kategori & total_byr dari jns_perawatan_lab
                try (PreparedStatement psKat = koneksi.prepareStatement(SQL_KATEGORI)) {
                    psKat.setString(1, kdJenis);
                    try (ResultSet rsKat = psKat.executeQuery()) {
                        if (rsKat.next()) {
                            kategori   = rsKat.getString("kategori"); // "PA", "PK", "MB", dll
                            totalByrPA = rsKat.getDouble("total_byr");
                        }
                    }
                } catch (Exception e) {
                    System.out.println("Notifikasi (kategori lab): " + e);
                }

                // === KATEGORI PA: biaya ada di header (total_byr), tidak ada rincian ===
                if ("PA".equalsIgnoreCase(kategori)) {
                    ...
                    tabModeRwJlDr.addRow(new Object[]{
                        ...
                        total,          // Total Biaya = jml * total_byr
                        "Laborat"
                    });

                    if (total != null) subttl += total; // PA ditambahkan dari header
                    continue; // lanjut ke jenis berikutnya (tidak render detail)
                }

                // === KATEGORI PK/MB (atau lainnya): header tanpa nominal + render detail > 0 ===
                tabModeRwJlDr.addRow(new Object[]{
                    true, "",
                    nmPerawatan,
                    ":",
                ...
                try (PreparedStatement psRinci = koneksi.prepareStatement(SQL_RINCI)) {
                    ...
                    try (ResultSet rsRinci = psRinci.executeQuery()) {
                        while (rsRinci.next()) {
                            ...
                            tabModeRwJlDr.addRow(new Object[]{
                                true,
                                "                           ",            // indent di kolom Keterangan
                                "    " + rsRinci.getString("pemeriksaan"),
                                "",
                                null,         // Biaya (detail tidak pakai kolom ini)
                                jml,          // Jml
                                tambahan,     // Tambahan (unit price)
                                total,        // Total Biaya
                                "Laborat"     // tag dikenali sistem
                            });

                            subttl += total; // subtotal dari DETAIL
                        }
                    }
                } catch (Exception e) {
                    System.out.println("Notifikasi (rincian lab): " + e);
    ...
    private void prosesCariRadiologi() {
        try{
            ...
            try {
                ...
                System.out.println(subttl);
                if(subttl > 0){
                    tabModeRwJlDr.addRow(new Object[]{true,"","          Total Radiologi :   "+Valid.SetAngka3(subttl),":",null,null,null,null,"TtlRadiologi"});                
                }
