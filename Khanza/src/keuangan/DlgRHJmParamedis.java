...
public class DlgRHJmParamedis extends javax.swing.JDialog {
    ...
    public DlgRHJmParamedis(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"No.","Nama Paramedis/Tgl.Bayar","Tgl.Tindakan","No. Rawat","No. RM", "Nama Pasien","Tindakan Medis","Jasa Medis"};
    ...
    private void initComponents() {
        ...
        label11.setText("Tgl.Tindakan/Bayar:");
        label11.setName("label11"); // NOI18N
        label11.setPreferredSize(new java.awt.Dimension(75, 23));
        FormInput.add(label11);
        label11.setBounds(27, 10, 110, 23);
        ...
        label18.setBounds(240, 10, 25, 23);
        ...
        NmDepartemen.setBounds(143, 40, 200, 23);
        ...
        BtnDepartemen.setBounds(340, 40, 28, 23);
               ...
               while(rs.next()){ 
                  ...
                  if(chkRalan.isSelected()==true){
                       pstindakanprjalan=koneksi.prepareStatement(
                           ...
                           "jns_perawatan.nm_perawatan,reg_periksa.tgl_registrasi,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis "+
                           ...
                           "inner join billing on billing.no_rawat=reg_periksa.no_rawat " +
                       ...
                       try {
                           ...
                           while(rstindakanprjalan.next()){
                               tabMode.addRow(new Object[]{
                                   "","","     "+rstindakanprjalan.getString("tgl_registrasi"),rstindakanprjalan.getString("no_rawat"),rstindakanprjalan.getString("no_rkm_medis"),rstindakanprjalan.getString("nm_pasien")+" ("+rstindakanprjalan.getString("kd_pj")+")",
                           ...
                           while(rstindakandrprjalan.next()){
                               tabMode.addRow(new Object[]{
                                   "","","     "+rstindakandrprjalan.getString("tgl_registrasi"),rstindakandrprjalan.getString("no_rawat"),rstindakandrprjalan.getString("no_rkm_medis"),rstindakandrprjalan.getString("nm_pasien")+" ("+rstindakandrprjalan.getString("kd_pj")+")",
                  ...
                  if(chkRanap.isSelected()==true){
                       pstindakanprinap=koneksi.prepareStatement(
                           ...
                           "rawat_inap_pr.tgl_perawatan,rawat_inap_pr.jam_rawat,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis " +
                       ...
                       pstindakandrprinap=koneksi.prepareStatement(
                           ...
                           "rawat_inap_drpr.tgl_perawatan,rawat_inap_drpr.jam_rawat,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis " +
                       ...
                       try {
                           ...
                           while(rstindakanprinap.next()){
                               tabMode.addRow(new Object[]{
                                   "","","     "+rstindakanprinap.getString("tgl_perawatan")+" "+rstindakanprinap.getString("jam_rawat"),rstindakanprinap.getString("no_rawat"),rstindakanprinap.getString("no_rkm_medis"),rstindakanprinap.getString("nm_pasien")+" ("+rstindakanprinap.getString("kd_pj")+")",
                           ...
                           while(rstindakandrprinap.next()){
                               tabMode.addRow(new Object[]{
                                   "","","     "+rstindakandrprinap.getString("tgl_perawatan")+" "+rstindakandrprinap.getString("jam_rawat"),rstindakandrprinap.getString("no_rawat"),rstindakandrprinap.getString("no_rkm_medis"),rstindakandrprinap.getString("nm_pasien")+" ("+rstindakandrprinap.getString("kd_pj")+")",
                  ...
                  if(chkOperasi.isSelected()==true){
                       psasisten_operator1=koneksi.prepareStatement("select operasi.biayaasisten_operator1,pasien.nm_pasien,paket_operasi.nm_perawatan,"+
                              "operasi.tgl_operasi,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis from operasi inner join reg_periksa inner join pasien inner join paket_operasi "+
                       ...
                       try {
                           ...
                           while(rsasisten_operator1.next()){
                               tabMode.addRow(new Object[]{
                                   "","","     "+rsasisten_operator1.getString("tgl_operasi"),rsasisten_operator1.getString("no_rawat"),rsasisten_operator1.getString("no_rkm_medis"),rsasisten_operator1.getString("nm_pasien")+" ("+rsasisten_operator1.getString("kd_pj")+")",
                           ...
                           while(rsasisten_operator2.next()){
                               tabMode.addRow(new Object[]{
                                   "","","     "+rsasisten_operator2.getString("tgl_operasi"),rsasisten_operator2.getString("no_rawat"),rsasisten_operator2.getString("no_rkm_medis"),rsasisten_operator2.getString("nm_pasien")+" ("+rsasisten_operator2.getString("kd_pj")+")",
                           ...
                           while(rsasisten_operator3.next()){
                               tabMode.addRow(new Object[]{
                                   "","","     "+rsasisten_operator3.getString("tgl_operasi"),rsasisten_operator3.getString("no_rawat"),rsasisten_operator3.getString("no_rkm_medis"),rsasisten_operator3.getString("nm_pasien")+" ("+rsasisten_operator3.getString("kd_pj")+")",
                           ...
                           while(rsperawaat_resusitas.next()){
                               tabMode.addRow(new Object[]{
                                   "","","     "+rsperawaat_resusitas.getString("tgl_operasi"),rsperawaat_resusitas.getString("no_rawat"),rsperawaat_resusitas.getString("no_rkm_medis"),rsperawaat_resusitas.getString("nm_pasien")+" ("+rsperawaat_resusitas.getString("kd_pj")+")",
                           ...
                           while(rsasisten_anestesi.next()){
                               tabMode.addRow(new Object[]{
                                   "","","     "+rsasisten_anestesi.getString("tgl_operasi"),rsasisten_anestesi.getString("no_rawat"),rsasisten_anestesi.getString("no_rkm_medis"),rsasisten_anestesi.getString("nm_pasien")+" ("+rsasisten_anestesi.getString("kd_pj")+")",
                           ...
                           while(rsbidan.next()){
                               tabMode.addRow(new Object[]{
                                   "","","     "+rsbidan.getString("tgl_operasi"),rsbidan.getString("no_rawat"),rsbidan.getString("no_rkm_medis"),rsbidan.getString("nm_pasien")+" ("+rsbidan.getString("kd_pj")+")",
                           ...
                           while(rsbidan2.next()){
                               tabMode.addRow(new Object[]{
                                   "","","     "+rsbidan2.getString("tgl_operasi"),rsbidan2.getString("no_rawat"),rsbidan2.getString("no_rkm_medis"),rsbidan2.getString("nm_pasien")+" ("+rsbidan2.getString("kd_pj")+")",
                           ...
                           while(rsbidan3.next()){
                               tabMode.addRow(new Object[]{
                                   "","","     "+rsbidan3.getString("tgl_operasi"),rsbidan3.getString("no_rawat"),rsbidan3.getString("no_rkm_medis"),rsbidan3.getString("nm_pasien")+" ("+rsbidan3.getString("kd_pj")+")",
                           ...
                           while(rsomloop.next()){
                               tabMode.addRow(new Object[]{
                                   "","","     "+rsomloop.getString("tgl_operasi"),rsomloop.getString("no_rawat"),rsomloop.getString("no_rkm_medis"),rsomloop.getString("nm_pasien")+" ("+rsomloop.getString("kd_pj")+")",
                           ...
                           while(rsomloop2.next()){
                               tabMode.addRow(new Object[]{
                                   "","","     "+rsomloop2.getString("tgl_operasi"),rsomloop2.getString("no_rawat"),rsomloop2.getString("no_rkm_medis"),rsomloop2.getString("nm_pasien")+" ("+rsomloop2.getString("kd_pj")+")",
                           ...
                           while(rsomloop4.next()){
                               tabMode.addRow(new Object[]{
                                   "","","     "+rsomloop4.getString("tgl_operasi"),rsomloop4.getString("no_rawat"),rsomloop4.getString("no_rkm_medis"),rsomloop4.getString("nm_pasien")+" ("+rsomloop4.getString("kd_pj")+")",
                           ...
                           while(rsomloop5.next()){
                               tabMode.addRow(new Object[]{
                                   "","","     "+rsomloop5.getString("tgl_operasi"),rsomloop5.getString("no_rawat"),rsomloop5.getString("no_rkm_medis"),rsomloop5.getString("nm_pasien")+" ("+rsomloop5.getString("kd_pj")+")",
                           ...
                           while(rsperawatluar.next()){
                               tabMode.addRow(new Object[]{
                                   "","","     "+rsperawatluar.getString("tgl_operasi"),rsperawatluar.getString("no_rawat"),rsperawatluar.getString("no_rkm_medis"),rsperawatluar.getString("nm_pasien")+" ("+rsperawatluar.getString("kd_pj")+")",
                  ...
                  if(chkLaborat.isSelected()==true){   
                       psperiksa_lab=koneksi.prepareStatement("select periksa_lab.tarif_tindakan_petugas,pasien.nm_pasien,"+
                           "jns_perawatan_lab.nm_perawatan,periksa_lab.tgl_periksa,periksa_lab.jam,periksa_lab.no_rawat,periksa_lab.kd_jenis_prw,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis "+
                  ...
                  if(chkRadiologi.isSelected()==true){
                       psperiksa_radiologi=koneksi.prepareStatement("select periksa_radiologi.tarif_tindakan_petugas,pasien.nm_pasien,"+
                           "jns_perawatan_radiologi.nm_perawatan,periksa_radiologi.tgl_periksa,periksa_radiologi.jam,periksa_radiologi.no_rawat,periksa_radiologi.kd_jenis_prw,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis "+
            ...
            try {
               ...
               while(rs.next()){ 
                  ...
                  if(chkRalan.isSelected()==true){
                       pstindakanprjalan=koneksi.prepareStatement(
                           "select pasien.nm_pasien,rawat_jl_pr.tarif_tindakanpr,"+
                           "jns_perawatan.nm_perawatan,reg_periksa.tgl_registrasi,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis, bp.tgl_byr "+
                           "from pasien inner join reg_periksa  "+
                           "inner join jns_perawatan inner join rawat_jl_pr "+
                           "inner join penjab inner join piutang_pasien on reg_periksa.no_rawat=piutang_pasien.no_rawat and reg_periksa.kd_pj=penjab.kd_pj and rawat_jl_pr.no_rawat=reg_periksa.no_rawat "+
                           "and reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                           "and rawat_jl_pr.kd_jenis_prw=jns_perawatan.kd_jenis_prw "+
                           "inner join (SELECT max(tgl_bayar) as tgl_byr, no_rawat from bayar_piutang group by no_rawat) as bp on bp.no_rawat = reg_periksa.no_rawat "+
                           "where reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Lunas' and bp.tgl_byr between ? and ? and rawat_jl_pr.nip=? "+
                           "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and rawat_jl_pr.tarif_tindakanpr>0 order by reg_periksa.tgl_registrasi,jns_perawatan.nm_perawatan");
                       pstindakandrprjalan=koneksi.prepareStatement(
                           "select pasien.nm_pasien,rawat_jl_drpr.tarif_tindakanpr,"+
                           "jns_perawatan.nm_perawatan,reg_periksa.tgl_registrasi,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis, bp.tgl_byr "+
                           ...
                           "and rawat_jl_drpr.kd_jenis_prw=jns_perawatan.kd_jenis_prw "+
                           "inner join (SELECT max(tgl_bayar) as tgl_byr, no_rawat from bayar_piutang group by no_rawat) as bp on bp.no_rawat = reg_periksa.no_rawat "+
                           "where reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Lunas' and bp.tgl_byr between ? and ? and rawat_jl_drpr.nip=? "+
                           "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and rawat_jl_drpr.tarif_tindakanpr>0 order by reg_periksa.tgl_registrasi,jns_perawatan.nm_perawatan");
                       try {
                           pstindakanprjalan.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                           pstindakanprjalan.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
                           ...
                           while(rstindakanprjalan.next()){
                               tabMode.addRow(new Object[]{
                                   "",rstindakanprjalan.getString("tgl_byr"),"     "+rstindakanprjalan.getString("tgl_registrasi"),rstindakanprjalan.getString("no_rawat"),rstindakanprjalan.getString("no_rkm_medis"),rstindakanprjalan.getString("nm_pasien")+" ("+rstindakanprjalan.getString("kd_pj")+")",
                                   rstindakanprjalan.getString("nm_perawatan"),Valid.SetAngka(rstindakanprjalan.getDouble("tarif_tindakanpr"))
                               });     
                               total=total+rstindakanprjalan.getDouble("tarif_tindakanpr");
                           }
                           ...
                           while(rstindakandrprjalan.next()){
                               tabMode.addRow(new Object[]{
                                   "",rstindakandrprjalan.getString("tgl_byr"),"     "+rstindakandrprjalan.getString("tgl_registrasi"),rstindakandrprjalan.getString("no_rawat"),rstindakandrprjalan.getString("no_rkm_medis"),rstindakandrprjalan.getString("nm_pasien")+" ("+rstindakandrprjalan.getString("kd_pj")+")",
                                   rstindakandrprjalan.getString("nm_perawatan"),Valid.SetAngka(rstindakandrprjalan.getDouble("tarif_tindakanpr"))
                               });     
                               total=total+rstindakandrprjalan.getDouble("tarif_tindakanpr");
                           }
                  ...
                  if(chkRanap.isSelected()==true){
                       pstindakanprinap=koneksi.prepareStatement(
                            "select rawat_inap_pr.tarif_tindakanpr,pasien.nm_pasien,jns_perawatan_inap.nm_perawatan,"+
                           "rawat_inap_pr.tgl_perawatan,rawat_inap_pr.jam_rawat,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis, bp.tgl_byr " +
                           "from pasien inner join reg_periksa inner join jns_perawatan_inap inner join rawat_inap_pr "+
                           "inner join penjab inner join piutang_pasien on reg_periksa.no_rawat=piutang_pasien.no_rawat and reg_periksa.kd_pj=penjab.kd_pj and rawat_inap_pr.no_rawat=reg_periksa.no_rawat "+
                           "and reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                           "and rawat_inap_pr.kd_jenis_prw=jns_perawatan_inap.kd_jenis_prw "+
                           "inner join (SELECT max(tgl_bayar) as tgl_byr, no_rawat from bayar_piutang group by no_rawat) as bp on bp.no_rawat = reg_periksa.no_rawat "+
                           "where reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Lunas' and bp.tgl_byr between ? and ? and rawat_inap_pr.nip=? "+
                           "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and rawat_inap_pr.tarif_tindakanpr>0 order by rawat_inap_pr.tgl_perawatan,rawat_inap_pr.jam_rawat,jns_perawatan_inap.nm_perawatan  ");
                       pstindakandrprinap=koneksi.prepareStatement(
                           "select rawat_inap_drpr.tarif_tindakanpr,pasien.nm_pasien,jns_perawatan_inap.nm_perawatan,"+
                           "rawat_inap_drpr.tgl_perawatan,rawat_inap_drpr.jam_rawat,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis, bp.tgl_byr " +
                           "from pasien inner join reg_periksa inner join jns_perawatan_inap inner join rawat_inap_drpr "+
                           "inner join penjab inner join piutang_pasien on reg_periksa.no_rawat=piutang_pasien.no_rawat and reg_periksa.kd_pj=penjab.kd_pj and rawat_inap_drpr.no_rawat=reg_periksa.no_rawat "+
                           "and reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                           "and rawat_inap_drpr.kd_jenis_prw=jns_perawatan_inap.kd_jenis_prw "+
                           "inner join (SELECT max(tgl_bayar) as tgl_byr, no_rawat from bayar_piutang group by no_rawat) as bp on bp.no_rawat = reg_periksa.no_rawat "+
                           "where reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Lunas' and bp.tgl_byr between ? and ? and rawat_inap_drpr.nip=? "+
                           "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and rawat_inap_drpr.tarif_tindakanpr>0 order by rawat_inap_drpr.tgl_perawatan,rawat_inap_drpr.jam_rawat,jns_perawatan_inap.nm_perawatan  ");
                       try {
                           pstindakanprinap.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                           pstindakanprinap.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
                           ...
                           while(rstindakanprinap.next()){
                               tabMode.addRow(new Object[]{
                                   "",rstindakanprinap.getString("tgl_byr"),"     "+rstindakanprinap.getString("tgl_perawatan")+" "+rstindakanprinap.getString("jam_rawat"),rstindakanprinap.getString("no_rawat"),rstindakanprinap.getString("no_rkm_medis"),rstindakanprinap.getString("nm_pasien")+" ("+rstindakanprinap.getString("kd_pj")+")",
                                   rstindakanprinap.getString("nm_perawatan"),Valid.SetAngka(rstindakanprinap.getDouble("tarif_tindakanpr"))
                               }); 
                               total=total+rstindakanprinap.getDouble("tarif_tindakanpr");
                           }
                           ...
                           while(rstindakandrprinap.next()){
                               tabMode.addRow(new Object[]{
                                   "",rstindakandrprinap.getString("tgl_byr"),"     "+rstindakandrprinap.getString("tgl_perawatan")+" "+rstindakandrprinap.getString("jam_rawat"),rstindakandrprinap.getString("no_rawat"),rstindakandrprinap.getString("no_rkm_medis"),rstindakandrprinap.getString("nm_pasien")+" ("+rstindakandrprinap.getString("kd_pj")+")",
                                   rstindakandrprinap.getString("nm_perawatan"),Valid.SetAngka(rstindakandrprinap.getDouble("tarif_tindakanpr"))
                               }); 
                               total=total+rstindakandrprinap.getDouble("tarif_tindakanpr");
                           }
                  ...
                  if(chkOperasi.isSelected()==true){
                       psasisten_operator1=koneksi.prepareStatement("select operasi.biayaasisten_operator1,pasien.nm_pasien,paket_operasi.nm_perawatan,"+
                              "operasi.tgl_operasi,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis, bp.tgl_byr from operasi inner join reg_periksa inner join pasien inner join paket_operasi "+
                              "inner join penjab inner join piutang_pasien on reg_periksa.no_rawat=piutang_pasien.no_rawat and reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "+
                              "inner join (SELECT max(tgl_bayar) as tgl_byr, no_rawat from bayar_piutang group by no_rawat) as bp on bp.no_rawat = reg_periksa.no_rawat "+
                              "where  reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Lunas' and bp.tgl_byr between ? and ? and operasi.asisten_operator1=? "+
                              "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.biayaasisten_operator1>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan");  
                       psasisten_operator2=koneksi.prepareStatement("select operasi.biayaasisten_operator2,pasien.nm_pasien,paket_operasi.nm_perawatan,"+
                              "operasi.tgl_operasi,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis, bp.tgl_byr from operasi inner join reg_periksa inner join pasien inner join paket_operasi "+
                              "inner join penjab inner join piutang_pasien on reg_periksa.no_rawat=piutang_pasien.no_rawat and reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "+
                              "inner join (SELECT max(tgl_bayar) as tgl_byr, no_rawat from bayar_piutang group by no_rawat) as bp on bp.no_rawat = reg_periksa.no_rawat "+
                              "where reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Lunas' and bp.tgl_byr between ? and ? and operasi.asisten_operator2=? "+
                              "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.biayaasisten_operator2>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan");
                       psasisten_operator3=koneksi.prepareStatement("select operasi.biayaasisten_operator3,pasien.nm_pasien,paket_operasi.nm_perawatan,"+
                              "operasi.tgl_operasi,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis, bp.tgl_byr from operasi inner join reg_periksa inner join pasien inner join paket_operasi "+
                              "inner join penjab inner join piutang_pasien on reg_periksa.no_rawat=piutang_pasien.no_rawat and reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "+
                              "inner join (SELECT max(tgl_bayar) as tgl_byr, no_rawat from bayar_piutang group by no_rawat) as bp on bp.no_rawat = reg_periksa.no_rawat "+
                           "where reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Lunas' and bp.tgl_byr between ? and ? and operasi.asisten_operator3=? "+
                              "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.biayaasisten_operator3>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan");
                       psinstrumen=koneksi.prepareStatement("select operasi.biayainstrumen,pasien.nm_pasien,paket_operasi.nm_perawatan,"+
                              "operasi.tgl_operasi,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis, bp.tgl_byr from operasi inner join reg_periksa inner join pasien inner join paket_operasi "+
                              "inner join penjab inner join piutang_pasien on reg_periksa.no_rawat=piutang_pasien.no_rawat and reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "+
                              "inner join (SELECT max(tgl_bayar) as tgl_byr, no_rawat from bayar_piutang group by no_rawat) as bp on bp.no_rawat = reg_periksa.no_rawat "+
                           "where reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Lunas' and bp.tgl_byr between ? and ? and operasi.instrumen=? "+
                              "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.biayainstrumen>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan");
                       psperawaat_resusitas=koneksi.prepareStatement("select operasi.biayaperawaat_resusitas,pasien.nm_pasien,paket_operasi.nm_perawatan,"+
                              "operasi.tgl_operasi,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis, bp.tgl_byr from operasi inner join reg_periksa inner join pasien inner join paket_operasi "+
                              "inner join penjab inner join piutang_pasien on reg_periksa.no_rawat=piutang_pasien.no_rawat and reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "+
                              "inner join (SELECT max(tgl_bayar) as tgl_byr, no_rawat from bayar_piutang group by no_rawat) as bp on bp.no_rawat = reg_periksa.no_rawat "+
                           "where reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Lunas' and bp.tgl_byr between ? and ? and operasi.perawaat_resusitas=? "+
                              "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.biayaperawaat_resusitas>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan");   
                       psasisten_anestesi=koneksi.prepareStatement("select operasi.biayaasisten_anestesi,pasien.nm_pasien,paket_operasi.nm_perawatan,"+
                              "operasi.tgl_operasi,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis, bp.tgl_byr from operasi inner join reg_periksa inner join pasien inner join paket_operasi "+
                              "inner join penjab inner join piutang_pasien on reg_periksa.no_rawat=piutang_pasien.no_rawat and reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "+
                              "inner join (SELECT max(tgl_bayar) as tgl_byr, no_rawat from bayar_piutang group by no_rawat) as bp on bp.no_rawat = reg_periksa.no_rawat "+
                           "where reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Lunas' and bp.tgl_byr between ? and ? and operasi.asisten_anestesi=? "+
                              "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.biayaasisten_anestesi>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan");
                       psasisten_anestesi2=koneksi.prepareStatement("select operasi.biayaasisten_anestesi2,pasien.nm_pasien,paket_operasi.nm_perawatan,"+
                              "operasi.tgl_operasi,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis, bp.tgl_byr from operasi inner join reg_periksa inner join pasien inner join paket_operasi "+
                              "inner join penjab inner join piutang_pasien on reg_periksa.no_rawat=piutang_pasien.no_rawat and reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "+
                              "inner join (SELECT max(tgl_bayar) as tgl_byr, no_rawat from bayar_piutang group by no_rawat) as bp on bp.no_rawat = reg_periksa.no_rawat "+
                           "where reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Lunas' and bp.tgl_byr between ? and ? and operasi.asisten_anestesi2=? "+
                              "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.biayaasisten_anestesi2>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan");
                       psbidan=koneksi.prepareStatement("select operasi.biayabidan,pasien.nm_pasien,paket_operasi.nm_perawatan,"+
                              "operasi.tgl_operasi,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis, bp.tgl_byr from operasi inner join reg_periksa inner join pasien inner join paket_operasi "+
                              "inner join penjab inner join piutang_pasien on reg_periksa.no_rawat=piutang_pasien.no_rawat and reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "+
                              "inner join (SELECT max(tgl_bayar) as tgl_byr, no_rawat from bayar_piutang group by no_rawat) as bp on bp.no_rawat = reg_periksa.no_rawat "+
                           "where reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Lunas' and bp.tgl_byr between ? and ? and operasi.bidan=? "+
                              "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.biayabidan>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan");
                       psbidan2=koneksi.prepareStatement("select operasi.biayabidan2,pasien.nm_pasien,paket_operasi.nm_perawatan,"+
                              "operasi.tgl_operasi,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis, bp.tgl_byr from operasi inner join reg_periksa inner join pasien inner join paket_operasi "+
                              "inner join penjab inner join piutang_pasien on reg_periksa.no_rawat=piutang_pasien.no_rawat and reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "+
                              "inner join (SELECT max(tgl_bayar) as tgl_byr, no_rawat from bayar_piutang group by no_rawat) as bp on bp.no_rawat = reg_periksa.no_rawat "+
                           "where reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Lunas' and bp.tgl_byr between ? and ? and operasi.bidan2=? "+
                              "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.biayabidan2>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan");
                       psbidan3=koneksi.prepareStatement("select operasi.biayabidan3,pasien.nm_pasien,paket_operasi.nm_perawatan,"+
                              "operasi.tgl_operasi,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis, bp.tgl_byr from operasi inner join reg_periksa inner join pasien inner join paket_operasi "+
                              "inner join penjab inner join piutang_pasien on reg_periksa.no_rawat=piutang_pasien.no_rawat and reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "+
                              "inner join (SELECT max(tgl_bayar) as tgl_byr, no_rawat from bayar_piutang group by no_rawat) as bp on bp.no_rawat = reg_periksa.no_rawat "+
                           "where reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Lunas' and bp.tgl_byr between ? and ? and operasi.bidan3=? "+
                              "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.biayabidan3>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan");
                       psperawatluar=koneksi.prepareStatement("select operasi.biayaperawat_luar,pasien.nm_pasien,paket_operasi.nm_perawatan,"+
                              "operasi.tgl_operasi,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis, bp.tgl_byr from operasi inner join reg_periksa inner join pasien inner join paket_operasi "+
                              "inner join penjab inner join piutang_pasien on reg_periksa.no_rawat=piutang_pasien.no_rawat and reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "+
                              "inner join (SELECT max(tgl_bayar) as tgl_byr, no_rawat from bayar_piutang group by no_rawat) as bp on bp.no_rawat = reg_periksa.no_rawat "+
                           "where reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Lunas' and bp.tgl_byr between ? and ? and operasi.perawat_luar=? "+
                              "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.biayaperawat_luar>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan");
                       psomloop=koneksi.prepareStatement("select operasi.biaya_omloop,pasien.nm_pasien,paket_operasi.nm_perawatan,"+
                              "operasi.tgl_operasi,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis, bp.tgl_byr from operasi inner join reg_periksa inner join pasien inner join paket_operasi "+
                              "inner join penjab inner join piutang_pasien on reg_periksa.no_rawat=piutang_pasien.no_rawat and reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "+
                              "inner join (SELECT max(tgl_bayar) as tgl_byr, no_rawat from bayar_piutang group by no_rawat) as bp on bp.no_rawat = reg_periksa.no_rawat "+
                           "where reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Lunas' and bp.tgl_byr between ? and ? and operasi.omloop=? "+
                              "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.biaya_omloop>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan");
                       psomloop2=koneksi.prepareStatement("select operasi.biaya_omloop2,pasien.nm_pasien,paket_operasi.nm_perawatan,"+
                              "operasi.tgl_operasi,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis, bp.tgl_byr from operasi inner join reg_periksa inner join pasien inner join paket_operasi "+
                              "inner join penjab inner join piutang_pasien on reg_periksa.no_rawat=piutang_pasien.no_rawat and reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "+
                              "inner join (SELECT max(tgl_bayar) as tgl_byr, no_rawat from bayar_piutang group by no_rawat) as bp on bp.no_rawat = reg_periksa.no_rawat "+
                           "where reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Lunas' and bp.tgl_byr between ? and ? and operasi.omloop2=? "+
                              "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.biaya_omloop2>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan");
                       psomloop3=koneksi.prepareStatement("select operasi.biaya_omloop3,pasien.nm_pasien,paket_operasi.nm_perawatan,"+
                              "operasi.tgl_operasi,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis, bp.tgl_byr from operasi inner join reg_periksa inner join pasien inner join paket_operasi "+
                              "inner join penjab inner join piutang_pasien on reg_periksa.no_rawat=piutang_pasien.no_rawat and reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "+
                              "inner join (SELECT max(tgl_bayar) as tgl_byr, no_rawat from bayar_piutang group by no_rawat) as bp on bp.no_rawat = reg_periksa.no_rawat "+
                           "where reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Lunas' and bp.tgl_byr between ? and ? and operasi.omloop3=? "+
                              "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.biaya_omloop3>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan");
                       psomloop4=koneksi.prepareStatement("select operasi.biaya_omloop4,pasien.nm_pasien,paket_operasi.nm_perawatan,"+
                              "operasi.tgl_operasi,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis, bp.tgl_byr from operasi inner join reg_periksa inner join pasien inner join paket_operasi "+
                              "inner join penjab inner join piutang_pasien on reg_periksa.no_rawat=piutang_pasien.no_rawat and reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "+
                              "inner join (SELECT max(tgl_bayar) as tgl_byr, no_rawat from bayar_piutang group by no_rawat) as bp on bp.no_rawat = reg_periksa.no_rawat "+
                           "where reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Lunas' and bp.tgl_byr between ? and ? and operasi.omloop4=? "+
                              "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.biaya_omloop4>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan");
                       psomloop5=koneksi.prepareStatement("select operasi.biaya_omloop5,pasien.nm_pasien,paket_operasi.nm_perawatan,"+
                              "operasi.tgl_operasi,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis, bp.tgl_byr from operasi inner join reg_periksa inner join pasien inner join paket_operasi "+
                              "inner join penjab inner join piutang_pasien on reg_periksa.no_rawat=piutang_pasien.no_rawat and reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "+
                              "inner join (SELECT max(tgl_bayar) as tgl_byr, no_rawat from bayar_piutang group by no_rawat) as bp on bp.no_rawat = reg_periksa.no_rawat "+
                           "where reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Lunas' and bp.tgl_byr between ? and ? and operasi.omloop5=? "+
                              "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.biaya_omloop5>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan");
                       try {
                           psasisten_operator1.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+"")+" 00:00:00");
                           psasisten_operator1.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+"")+" 23:59:59");
                           ...
                           while(rsasisten_operator1.next()){
                               tabMode.addRow(new Object[]{
                                   "",rsasisten_operator1.getString("tgl_byr"),"     "+rsasisten_operator1.getString("tgl_operasi"),rsasisten_operator1.getString("no_rawat"),rsasisten_operator1.getString("no_rkm_medis"),rsasisten_operator1.getString("nm_pasien")+" ("+rsasisten_operator1.getString("kd_pj")+")",
                                   rsasisten_operator1.getString("nm_perawatan")+" (Asisten Operator 1)",Valid.SetAngka(rsasisten_operator1.getDouble("biayaasisten_operator1"))
                               });        
                               total=total+rsasisten_operator1.getDouble("biayaasisten_operator1");
                           }
                           ...
                           while(rsasisten_operator2.next()){
                               tabMode.addRow(new Object[]{
                                   "",rsasisten_operator2.getString("tgl_byr"),"     "+rsasisten_operator2.getString("tgl_operasi"),rsasisten_operator2.getString("no_rawat"),rsasisten_operator2.getString("no_rkm_medis"),rsasisten_operator2.getString("nm_pasien")+" ("+rsasisten_operator2.getString("kd_pj")+")",
                                   rsasisten_operator2.getString("nm_perawatan")+" (Asisten Operator 2)",Valid.SetAngka(rsasisten_operator2.getDouble("biayaasisten_operator2"))
                               });  
                               total=total+rsasisten_operator2.getDouble("biayaasisten_operator2");
                           }
                           ...
                           while(rsasisten_operator3.next()){
                               tabMode.addRow(new Object[]{
                                   "",rsasisten_operator3.getString("tgl_byr"),"     "+rsasisten_operator3.getString("tgl_operasi"),rsasisten_operator3.getString("no_rawat"),rsasisten_operator3.getString("no_rkm_medis"),rsasisten_operator3.getString("nm_pasien")+" ("+rsasisten_operator3.getString("kd_pj")+")",
                                   rsasisten_operator3.getString("nm_perawatan")+" (Asisten Operator 3)",Valid.SetAngka(rsasisten_operator3.getDouble("biayaasisten_operator3"))
                               });  
                               total=total+rsasisten_operator3.getDouble("biayaasisten_operator3");
                           }
                           ...
                           while(rsinstrumen.next()){
                               tabMode.addRow(new Object[]{
                                   "",rsinstrumen.getString("tgl_byr"),"     "+rsinstrumen.getString("tgl_operasi"),rsinstrumen.getString("nm_pasien")+" ("+rsinstrumen.getString("kd_pj")+")",
                                   rsinstrumen.getString("nm_perawatan")+" (Instrumen)",Valid.SetAngka(rsinstrumen.getDouble("biayainstrumen"))
                               });             
                               total=total+rsinstrumen.getDouble("biayainstrumen");
                           }
                           ...
                           while(rsperawaat_resusitas.next()){
                               tabMode.addRow(new Object[]{
                                   "",rsperawaat_resusitas.getString("tgl_byr"),"     "+rsperawaat_resusitas.getString("tgl_operasi"),rsperawaat_resusitas.getString("no_rawat"),rsperawaat_resusitas.getString("no_rkm_medis"),rsperawaat_resusitas.getString("nm_pasien")+" ("+rsperawaat_resusitas.getString("kd_pj")+")",
                                   rsperawaat_resusitas.getString("nm_perawatan")+" (Perawat Resusitas)",Valid.SetAngka(rsperawaat_resusitas.getDouble("biayaperawaat_resusitas"))
                               });          
                               total=total+rsperawaat_resusitas.getDouble("biayaperawaat_resusitas");
                           }
                           ...
                           while(rsasisten_anestesi.next()){
                               tabMode.addRow(new Object[]{
                                   "",rsasisten_anestesi.getString("tgl_byr"),"     "+rsasisten_anestesi.getString("tgl_operasi"),rsasisten_anestesi.getString("no_rawat"),rsasisten_anestesi.getString("no_rkm_medis"),rsasisten_anestesi.getString("nm_pasien")+" ("+rsasisten_anestesi.getString("kd_pj")+")",
                                   rsasisten_anestesi.getString("nm_perawatan")+" (Asisten Anestesi 1)",Valid.SetAngka(rsasisten_anestesi.getDouble("biayaasisten_anestesi"))
                               });      
                               total=total+rsasisten_anestesi.getDouble("biayaasisten_anestesi");
                           }
                           ...
                           while(rsasisten_anestesi2.next()){
                               tabMode.addRow(new Object[]{
                                   "",rsasisten_anestesi2.getString("tgl_byr"),"     "+rsasisten_anestesi2.getString("tgl_operasi"),rsasisten_anestesi2.getString("nm_pasien")+" ("+rsasisten_anestesi2.getString("kd_pj")+")",
                                   rsasisten_anestesi2.getString("nm_perawatan")+" (Asisten Anestesi 2)",Valid.SetAngka(rsasisten_anestesi2.getDouble("biayaasisten_anestesi2"))
                               });      
                               total=total+rsasisten_anestesi2.getDouble("biayaasisten_anestesi2");
                           }
                           ...
                           while(rsbidan.next()){
                               tabMode.addRow(new Object[]{
                                   "",rsbidan.getString("tgl_byr"),"     "+rsbidan.getString("tgl_operasi"),rsbidan.getString("no_rawat"),rsbidan.getString("no_rkm_medis"),rsbidan.getString("nm_pasien")+" ("+rsbidan.getString("kd_pj")+")",
                                   rsbidan.getString("nm_perawatan")+" (Bidan 1)",Valid.SetAngka(rsbidan.getDouble("biayabidan"))
                               }); 
                               total=total+rsbidan.getDouble("biayabidan");
                           }
                           ...
                           while(rsbidan2.next()){
                               tabMode.addRow(new Object[]{
                                   "",rsbidan2.getString("tgl_byr"),"     "+rsbidan2.getString("tgl_operasi"),rsbidan2.getString("no_rawat"),rsbidan2.getString("no_rkm_medis"),rsbidan2.getString("nm_pasien")+" ("+rsbidan2.getString("kd_pj")+")",
                                   rsbidan2.getString("nm_perawatan")+" (Bidan 2)",Valid.SetAngka(rsbidan2.getDouble("biayabidan2"))
                               }); 
                               total=total+rsbidan2.getDouble("biayabidan2");
                           }
                           ...
                           while(rsbidan3.next()){
                               tabMode.addRow(new Object[]{
                                   "",rsbidan3.getString("tgl_byr"),"     "+rsbidan3.getString("tgl_operasi"),rsbidan3.getString("no_rawat"),rsbidan3.getString("no_rkm_medis"),rsbidan3.getString("nm_pasien")+" ("+rsbidan3.getString("kd_pj")+")",
                                   rsbidan3.getString("nm_perawatan")+" (Bidan 3)",Valid.SetAngka(rsbidan3.getDouble("biayabidan3"))
                               }); 
                               total=total+rsbidan3.getDouble("biayabidan3");
                           }
                           ...
                           while(rsomloop.next()){
                               tabMode.addRow(new Object[]{
                                   "",rsomloop.getString("tgl_byr"),"     "+rsomloop.getString("tgl_operasi"),rsomloop.getString("no_rawat"),rsomloop.getString("no_rkm_medis"),rsomloop.getString("nm_pasien")+" ("+rsomloop.getString("kd_pj")+")",
                                   rsomloop.getString("nm_perawatan")+" (Onloop 1)",Valid.SetAngka(rsomloop.getDouble("biaya_omloop"))
                               }); 
                               total=total+rsomloop.getDouble("biaya_omloop");
                           }
                           ...
                           while(rsomloop2.next()){
                               tabMode.addRow(new Object[]{
                                   "",rsomloop2.getString("tgl_byr"),"     "+rsomloop2.getString("tgl_operasi"),rsomloop2.getString("no_rawat"),rsomloop2.getString("no_rkm_medis"),rsomloop2.getString("nm_pasien")+" ("+rsomloop2.getString("kd_pj")+")",
                                   rsomloop2.getString("nm_perawatan")+" (Onloop 2)",Valid.SetAngka(rsomloop2.getDouble("biaya_omloop2"))
                               }); 
                               total=total+rsomloop2.getDouble("biaya_omloop2");
                           }
                           ...
                           while(rsomloop3.next()){
                               tabMode.addRow(new Object[]{
                                   "",rsomloop3.getString("tgl_byr"),"     "+rsomloop3.getString("tgl_operasi"),rsomloop3.getString("nm_pasien")+" ("+rsomloop3.getString("kd_pj")+")",
                                   rsomloop3.getString("nm_perawatan")+" (Onloop 3)",Valid.SetAngka(rsomloop3.getDouble("biaya_omloop3"))
                               }); 
                               total=total+rsomloop3.getDouble("biaya_omloop3");
                           }
                           ...
                           while(rsomloop4.next()){
                               tabMode.addRow(new Object[]{
                                   "",rsomloop4.getString("tgl_byr"),"     "+rsomloop4.getString("tgl_operasi"),rsomloop4.getString("no_rawat"),rsomloop4.getString("no_rkm_medis"),rsomloop4.getString("nm_pasien")+" ("+rsomloop4.getString("kd_pj")+")",
                                   rsomloop4.getString("nm_perawatan")+" (Onloop 4)",Valid.SetAngka(rsomloop4.getDouble("biaya_omloop4"))
                               }); 
                               total=total+rsomloop4.getDouble("biaya_omloop4");
                           }
                           ...
                           while(rsomloop5.next()){
                               tabMode.addRow(new Object[]{
                                   "",rsomloop5.getString("tgl_byr"),"     "+rsomloop5.getString("tgl_operasi"),rsomloop5.getString("no_rawat"),rsomloop5.getString("no_rkm_medis"),rsomloop5.getString("nm_pasien")+" ("+rsomloop5.getString("kd_pj")+")",
                                   rsomloop5.getString("nm_perawatan")+" (Onloop 5)",Valid.SetAngka(rsomloop5.getDouble("biaya_omloop5"))
                               }); 
                               total=total+rsomloop5.getDouble("biaya_omloop5");
                           }
                           ...
                           while(rsperawatluar.next()){
                               tabMode.addRow(new Object[]{
                                   "",rsperawatluar.getString("tgl_byr"),"     "+rsperawatluar.getString("tgl_operasi"),rsperawatluar.getString("nm_pasien")+" ("+rsperawatluar.getString("kd_pj")+")",
                                   rsperawatluar.getString("nm_perawatan")+" (Perawat Luar)",Valid.SetAngka(rsperawatluar.getDouble("biayaperawat_luar"))
                               });             
                               total=total+rsperawatluar.getDouble("biayaperawat_luar");
                           }
                  ...
                  if(chkLaborat.isSelected()==true){   
                       psperiksa_lab=koneksi.prepareStatement("select periksa_lab.tarif_tindakan_petugas,pasien.nm_pasien,"+
                           "jns_perawatan_lab.nm_perawatan,periksa_lab.tgl_periksa,periksa_lab.jam,periksa_lab.no_rawat,periksa_lab.kd_jenis_prw,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis, bp.tgl_byr "+
                           " from periksa_lab inner join reg_periksa inner join pasien inner join petugas inner join jns_perawatan_lab "+
                           " inner join penjab inner join piutang_pasien on reg_periksa.no_rawat=piutang_pasien.no_rawat and reg_periksa.kd_pj=penjab.kd_pj and periksa_lab.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                           " and periksa_lab.nip=petugas.nip and periksa_lab.kd_jenis_prw=jns_perawatan_lab.kd_jenis_prw "+
                           " inner join (SELECT max(tgl_bayar) as tgl_byr, no_rawat from bayar_piutang group by no_rawat) as bp on bp.no_rawat = reg_periksa.no_rawat "+
                       ...
                       try {
                           ...
                           while(rsperiksa_lab.next()){
                               ...
                               try {
                                   ...
                                   tabMode.addRow(new Object[]{
                                       "",rsperiksa_lab.getString("tgl_byr"),"     "+rsperiksa_lab.getString("tgl_periksa")+" "+rsperiksa_lab.getString("jam"),rsperiksa_lab.getString("no_rawat"),rsperiksa_lab.getString("no_rkm_medis"),rsperiksa_lab.getString("nm_pasien")+" ("+rsperiksa_lab.getString("kd_pj")+")",
                                       rsperiksa_lab.getString("nm_perawatan"),Valid.SetAngka(rsperiksa_lab.getDouble("tarif_tindakan_petugas")+detaillab)
                                   });      
                                   total=total+rsperiksa_lab.getDouble("tarif_tindakan_petugas")+detaillab;
                               } catch (Exception e) {
                  ...
                  if(chkRadiologi.isSelected()==true){
                       psperiksa_radiologi=koneksi.prepareStatement("select periksa_radiologi.tarif_tindakan_petugas,pasien.nm_pasien,"+
                           "jns_perawatan_radiologi.nm_perawatan,periksa_radiologi.tgl_periksa,periksa_radiologi.jam,periksa_radiologi.no_rawat,periksa_radiologi.kd_jenis_prw,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis, bp.tgl_byr "+
                           " from periksa_radiologi inner join reg_periksa inner join pasien inner join petugas inner join jns_perawatan_radiologi "+
                           " inner join penjab inner join piutang_pasien on reg_periksa.no_rawat=piutang_pasien.no_rawat and reg_periksa.kd_pj=penjab.kd_pj and periksa_radiologi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                           " and periksa_radiologi.nip=petugas.nip and periksa_radiologi.kd_jenis_prw=jns_perawatan_radiologi.kd_jenis_prw "+
                           " inner join (SELECT max(tgl_bayar) as tgl_byr, no_rawat from bayar_piutang group by no_rawat) as bp on bp.no_rawat = reg_periksa.no_rawat "+
                           " where  reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Lunas' and bp.tgl_byr between ? and ? and periksa_radiologi.nip=? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? order by periksa_radiologi.tgl_periksa,periksa_radiologi.jam,jns_perawatan_radiologi.nm_perawatan  ");
                       try {
                           psperiksa_radiologi.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                           psperiksa_radiologi.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
                           psperiksa_radiologi.setString(3,rs.getString("nip"));
                           ...
                           while(rsperiksa_radiologi.next()){
                               tabMode.addRow(new Object[]{
                                   "",rsperiksa_radiologi.getString("tgl_byr"),"     "+rsperiksa_radiologi.getString("tgl_periksa")+" "+rsperiksa_radiologi.getString("jam"),rsperiksa_radiologi.getString("no_rawat"),rsperiksa_radiologi.getString("no_rkm_medis"),rsperiksa_radiologi.getString("nm_pasien")+" ("+rsperiksa_radiologi.getString("kd_pj")+")",
                                   rsperiksa_radiologi.getString("nm_perawatan"),Valid.SetAngka(rsperiksa_radiologi.getDouble("tarif_tindakan_petugas"))
                               });       
                               total=total+rsperiksa_radiologi.getDouble("tarif_tindakan_petugas");
                           }
            ...
            try {
               ...
               while(rs.next()){ 
                  ...
                  if(chkRalan.isSelected()==true){
                       pstindakanprjalan=koneksi.prepareStatement(
                           "select pasien.nm_pasien,rawat_jl_pr.tarif_tindakanpr,"+
                           "jns_perawatan.nm_perawatan,reg_periksa.tgl_registrasi,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis, billing.tgl_byr  "+
                           "from pasien inner join reg_periksa  "+
                           "inner join jns_perawatan inner join rawat_jl_pr "+
                           "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj and rawat_jl_pr.no_rawat=reg_periksa.no_rawat "+
                           "and reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                           "and rawat_jl_pr.kd_jenis_prw=jns_perawatan.kd_jenis_prw "+
                           "inner join billing on billing.no_rawat = reg_periksa.no_rawat and billing.noindex=0 " +
                           "where reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien) and billing.tgl_byr between ? and ? and rawat_jl_pr.nip=? "+
                           "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and rawat_jl_pr.tarif_tindakanpr>0 order by reg_periksa.tgl_registrasi,jns_perawatan.nm_perawatan");
                       pstindakandrprjalan=koneksi.prepareStatement(
                           "select pasien.nm_pasien,rawat_jl_drpr.tarif_tindakanpr,"+
                           "jns_perawatan.nm_perawatan,reg_periksa.tgl_registrasi,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis, billing.tgl_byr  "+
                           ...
                           "and rawat_jl_drpr.kd_jenis_prw=jns_perawatan.kd_jenis_prw "+
                           "inner join billing on billing.no_rawat = reg_periksa.no_rawat and billing.noindex=0 " +
                           "where reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien) and billing.tgl_byr between ? and ? and rawat_jl_drpr.nip=? "+
                           "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and rawat_jl_drpr.tarif_tindakanpr>0 order by reg_periksa.tgl_registrasi,jns_perawatan.nm_perawatan");
                       try {
                           pstindakanprjalan.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                           pstindakanprjalan.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
                  ...
                  if(chkRanap.isSelected()==true){
                       pstindakanprinap=koneksi.prepareStatement(
                            "select rawat_inap_pr.tarif_tindakanpr,pasien.nm_pasien,jns_perawatan_inap.nm_perawatan,"+
                           "rawat_inap_pr.tgl_perawatan,rawat_inap_pr.jam_rawat,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis, billing.tgl_byr " +
                           "from pasien inner join reg_periksa inner join jns_perawatan_inap inner join rawat_inap_pr "+
                           "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj and rawat_inap_pr.no_rawat=reg_periksa.no_rawat "+
                           "and reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                           "and rawat_inap_pr.kd_jenis_prw=jns_perawatan_inap.kd_jenis_prw "+
                           "inner join billing on billing.no_rawat = reg_periksa.no_rawat and billing.noindex=0 " +
                           "where reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien) and billing.tgl_byr between ? and ? and rawat_inap_pr.nip=? "+
                           "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and rawat_inap_pr.tarif_tindakanpr>0 order by rawat_inap_pr.tgl_perawatan,rawat_inap_pr.jam_rawat,jns_perawatan_inap.nm_perawatan  ");
                       pstindakandrprinap=koneksi.prepareStatement(
                           "select rawat_inap_drpr.tarif_tindakanpr,pasien.nm_pasien,jns_perawatan_inap.nm_perawatan,"+
                           "rawat_inap_drpr.tgl_perawatan,rawat_inap_drpr.jam_rawat,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis, billing.tgl_byr" +
                           "from pasien inner join reg_periksa inner join jns_perawatan_inap inner join rawat_inap_drpr "+
                           "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj and rawat_inap_drpr.no_rawat=reg_periksa.no_rawat "+
                           "and reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                           "and rawat_inap_drpr.kd_jenis_prw=jns_perawatan_inap.kd_jenis_prw "+
                           "inner join billing on billing.no_rawat = reg_periksa.no_rawat and billing.noindex=0 " +
                           "where reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien) and billing.tgl_byr between ? and ? and rawat_inap_drpr.nip=? "+
                           "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and rawat_inap_drpr.tarif_tindakanpr>0 order by rawat_inap_drpr.tgl_perawatan,rawat_inap_drpr.jam_rawat,jns_perawatan_inap.nm_perawatan  ");
                       try {
                           pstindakanprinap.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                           pstindakanprinap.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
                  ...
                  if(chkOperasi.isSelected()==true){
                       psasisten_operator1=koneksi.prepareStatement("select operasi.biayaasisten_operator1,pasien.nm_pasien,paket_operasi.nm_perawatan,"+
                              "operasi.tgl_operasi,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis, billing.tgl_byr  from operasi inner join reg_periksa inner join pasien inner join paket_operasi "+
                              "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "+
                              "inner join billing on billing.no_rawat = reg_periksa.no_rawat and billing.noindex=0 " +
                              "where reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien) and billing.tgl_byr between ? and ? and operasi.asisten_operator1=? "+
                              "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.biayaasisten_operator1>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan");  
                       psasisten_operator2=koneksi.prepareStatement("select operasi.biayaasisten_operator2,pasien.nm_pasien,paket_operasi.nm_perawatan,"+
                              "operasi.tgl_operasi,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis, billing.tgl_byr  from operasi inner join reg_periksa inner join pasien inner join paket_operasi "+
                              "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "+
                              "inner join billing on billing.no_rawat = reg_periksa.no_rawat and billing.noindex=0 " +
                              "where reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien) and billing.tgl_byr between ? and ? and operasi.asisten_operator2=? "+
                              "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.biayaasisten_operator2>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan");
                       psasisten_operator3=koneksi.prepareStatement("select operasi.biayaasisten_operator3,pasien.nm_pasien,paket_operasi.nm_perawatan,"+
                              "operasi.tgl_operasi,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis, billing.tgl_byr  from operasi inner join reg_periksa inner join pasien inner join paket_operasi "+
                              "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "+
                              "inner join billing on billing.no_rawat = reg_periksa.no_rawat and billing.noindex=0 " +
                              "where reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien) and billing.tgl_byr between ? and ? and operasi.asisten_operator3=? "+
                              "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.biayaasisten_operator3>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan");
                       psinstrumen=koneksi.prepareStatement("select operasi.biayainstrumen,pasien.nm_pasien,paket_operasi.nm_perawatan,"+
                              "operasi.tgl_operasi,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis, billing.tgl_byr  from operasi inner join reg_periksa inner join pasien inner join paket_operasi "+
                              "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "+
                              "inner join billing on billing.no_rawat = reg_periksa.no_rawat and billing.noindex=0 " +
                              "where reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien) and billing.tgl_byr between ? and ? and operasi.instrumen=? "+
                              "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.biayainstrumen>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan");
                       psperawaat_resusitas=koneksi.prepareStatement("select operasi.biayaperawaat_resusitas,pasien.nm_pasien,paket_operasi.nm_perawatan,"+
                              "operasi.tgl_operasi,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis, billing.tgl_byr  from operasi inner join reg_periksa inner join pasien inner join paket_operasi "+
                              "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "+
                              "inner join billing on billing.no_rawat = reg_periksa.no_rawat and billing.noindex=0 " +
                              "where reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien) and billing.tgl_byr between ? and ? and operasi.perawaat_resusitas=? "+
                              "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.biayaperawaat_resusitas>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan");   
                       psasisten_anestesi=koneksi.prepareStatement("select operasi.biayaasisten_anestesi,pasien.nm_pasien,paket_operasi.nm_perawatan,"+
                              "operasi.tgl_operasi,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis, billing.tgl_byr  from operasi inner join reg_periksa inner join pasien inner join paket_operasi "+
                              "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "+
                              "inner join billing on billing.no_rawat = reg_periksa.no_rawat and billing.noindex=0 " +
                              "where reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien) and billing.tgl_byr between ? and ? and operasi.asisten_anestesi=? "+
                              "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.biayaasisten_anestesi>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan");
                       psasisten_anestesi2=koneksi.prepareStatement("select operasi.biayaasisten_anestesi2,pasien.nm_pasien,paket_operasi.nm_perawatan,"+
                              "operasi.tgl_operasi,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis, billing.tgl_byr  from operasi inner join reg_periksa inner join pasien inner join paket_operasi "+
                              "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "+
                              "inner join billing on billing.no_rawat = reg_periksa.no_rawat and billing.noindex=0 " +
                              "where reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien) and billing.tgl_byr between ? and ? and operasi.asisten_anestesi2=? "+
                              "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.biayaasisten_anestesi2>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan");
                       psbidan=koneksi.prepareStatement("select operasi.biayabidan,pasien.nm_pasien,paket_operasi.nm_perawatan,"+
                              "operasi.tgl_operasi,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis, billing.tgl_byr  from operasi inner join reg_periksa inner join pasien inner join paket_operasi "+
                              "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "+
                              "inner join billing on billing.no_rawat = reg_periksa.no_rawat and billing.noindex=0 " +
                              "where reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien) and billing.tgl_byr between ? and ? and operasi.bidan=? "+
                              "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.biayabidan>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan");
                       psbidan2=koneksi.prepareStatement("select operasi.biayabidan2,pasien.nm_pasien,paket_operasi.nm_perawatan,"+
                              "operasi.tgl_operasi,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis, billing.tgl_byr  from operasi inner join reg_periksa inner join pasien inner join paket_operasi "+
                              "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "+
                              "inner join billing on billing.no_rawat = reg_periksa.no_rawat and billing.noindex=0 " +
                              "where reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien) and billing.tgl_byr between ? and ? and operasi.bidan2=? "+
                              "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.biayabidan2>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan");
                       psbidan3=koneksi.prepareStatement("select operasi.biayabidan3,pasien.nm_pasien,paket_operasi.nm_perawatan,"+
                              "operasi.tgl_operasi,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis, billing.tgl_byr  from operasi inner join reg_periksa inner join pasien inner join paket_operasi "+
                              "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "+
                              "inner join billing on billing.no_rawat = reg_periksa.no_rawat and billing.noindex=0 " +
                              "where reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien) and billing.tgl_byr between ? and ? and operasi.bidan3=? "+
                              "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.biayabidan3>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan");
                       psperawatluar=koneksi.prepareStatement("select operasi.biayaperawat_luar,pasien.nm_pasien,paket_operasi.nm_perawatan,"+
                              "operasi.tgl_operasi,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis, billing.tgl_byr  from operasi inner join reg_periksa inner join pasien inner join paket_operasi "+
                              "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "+
                              "inner join billing on billing.no_rawat = reg_periksa.no_rawat and billing.noindex=0 " +
                              "where reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien) and billing.tgl_byr between ? and ? and operasi.perawat_luar=? "+
                              "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.biayaperawat_luar>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan");
                       psomloop=koneksi.prepareStatement("select operasi.biaya_omloop,pasien.nm_pasien,paket_operasi.nm_perawatan,"+
                              "operasi.tgl_operasi,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis, billing.tgl_byr  from operasi inner join reg_periksa inner join pasien inner join paket_operasi "+
                              "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "+
                              "inner join billing on billing.no_rawat = reg_periksa.no_rawat and billing.noindex=0 " +
                              "where reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien) and billing.tgl_byr between ? and ? and operasi.omloop=? "+
                              "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.biaya_omloop>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan");
                       psomloop2=koneksi.prepareStatement("select operasi.biaya_omloop2,pasien.nm_pasien,paket_operasi.nm_perawatan,"+
                              "operasi.tgl_operasi,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis, billing.tgl_byr  from operasi inner join reg_periksa inner join pasien inner join paket_operasi "+
                              "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "+
                              "inner join billing on billing.no_rawat = reg_periksa.no_rawat and billing.noindex=0 " +
                              "where reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien) and billing.tgl_byr between ? and ? and operasi.omloop2=? "+
                              "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.biaya_omloop2>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan");
                       psomloop3=koneksi.prepareStatement("select operasi.biaya_omloop3,pasien.nm_pasien,paket_operasi.nm_perawatan,"+
                              "operasi.tgl_operasi,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis, billing.tgl_byr  from operasi inner join reg_periksa inner join pasien inner join paket_operasi "+
                              "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "+
                              "inner join billing on billing.no_rawat = reg_periksa.no_rawat and billing.noindex=0 " +
                              "where reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien) and billing.tgl_byr between ? and ? and operasi.omloop3=? "+
                              "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.biaya_omloop3>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan");
                       psomloop4=koneksi.prepareStatement("select operasi.biaya_omloop4,pasien.nm_pasien,paket_operasi.nm_perawatan,"+
                              "operasi.tgl_operasi,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis, billing.tgl_byr  from operasi inner join reg_periksa inner join pasien inner join paket_operasi "+
                              "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "+
                              "inner join billing on billing.no_rawat = reg_periksa.no_rawat and billing.noindex=0 " +
                              "where reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien) and billing.tgl_byr between ? and ? and operasi.omloop4=? "+
                              "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.biaya_omloop4>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan");
                       psomloop5=koneksi.prepareStatement("select operasi.biaya_omloop5,pasien.nm_pasien,paket_operasi.nm_perawatan,"+
                              "operasi.tgl_operasi,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis, billing.tgl_byr  from operasi inner join reg_periksa inner join pasien inner join paket_operasi "+
                              "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj and operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and operasi.kode_paket=paket_operasi.kode_paket "+
                              "inner join billing on billing.no_rawat = reg_periksa.no_rawat and billing.noindex=0 " +
                              "where reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien) and billing.tgl_byr between ? and ? and operasi.omloop5=? "+
                              "and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and operasi.biaya_omloop5>0 order by operasi.tgl_operasi,paket_operasi.nm_perawatan");
                       try {
                           psasisten_operator1.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+"")+" 00:00:00");
                           psasisten_operator1.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+"")+" 23:59:59");
                  ...
                  if(chkLaborat.isSelected()==true){   
                       psperiksa_lab=koneksi.prepareStatement("select periksa_lab.tarif_tindakan_petugas,pasien.nm_pasien,"+
                           "jns_perawatan_lab.nm_perawatan,periksa_lab.tgl_periksa,periksa_lab.jam,periksa_lab.no_rawat,periksa_lab.kd_jenis_prw,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis, billing.tgl_byr  "+
                           " from periksa_lab inner join reg_periksa inner join pasien inner join petugas inner join jns_perawatan_lab "+
                           " inner join penjab on reg_periksa.kd_pj=penjab.kd_pj and periksa_lab.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                           " and periksa_lab.nip=petugas.nip and periksa_lab.kd_jenis_prw=jns_perawatan_lab.kd_jenis_prw "+
                           " inner join billing on billing.no_rawat = reg_periksa.no_rawat and billing.noindex=0 " +
                  ...
                  if(chkRadiologi.isSelected()==true){
                       psperiksa_radiologi=koneksi.prepareStatement("select periksa_radiologi.tarif_tindakan_petugas,pasien.nm_pasien,"+
                           "jns_perawatan_radiologi.nm_perawatan,periksa_radiologi.tgl_periksa,periksa_radiologi.jam,periksa_radiologi.no_rawat,periksa_radiologi.kd_jenis_prw,penjab.png_jawab as kd_pj, reg_periksa.no_rawat, reg_periksa.no_rkm_medis, billing.tgl_byr  "+
                           " from periksa_radiologi inner join reg_periksa inner join pasien inner join petugas inner join jns_perawatan_radiologi "+
                           " inner join penjab on reg_periksa.kd_pj=penjab.kd_pj and periksa_radiologi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                           " and periksa_radiologi.nip=petugas.nip and periksa_radiologi.kd_jenis_prw=jns_perawatan_radiologi.kd_jenis_prw "+
                           " inner join billing on billing.no_rawat = reg_periksa.no_rawat and billing.noindex=0 " +
               ...
               while(rs.next()){ 
                  ...
                  if(chkLaborat.isSelected()==true){   
                       psperiksa_lab=koneksi.prepareStatement("select periksa_lab.tarif_tindakan_petugas,pasien.nm_pasien,"+
                           ...
                           " inner join penjab on reg_periksa.kd_pj=penjab.kd_pj and periksa_lab.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                           " and periksa_lab.nip=petugas.nip and periksa_lab.kd_jenis_prw=jns_perawatan_lab.kd_jenis_prw "+
                           " where reg_periksa.status_bayar='Belum Bayar' and billing.tgl_byr between ? and ? and periksa_lab.nip=? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? "+
                           "order by periksa_lab.tgl_periksa,periksa_lab.jam,jns_perawatan_lab.nm_perawatan  ");
                       try {
                           psperiksa_lab.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                           psperiksa_lab.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
                  ...
                  if(chkRadiologi.isSelected()==true){
                       psperiksa_radiologi=koneksi.prepareStatement("select periksa_radiologi.tarif_tindakan_petugas,pasien.nm_pasien,"+
                           ...
                           " inner join penjab on reg_periksa.kd_pj=penjab.kd_pj and periksa_radiologi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                           " and periksa_radiologi.nip=petugas.nip and periksa_radiologi.kd_jenis_prw=jns_perawatan_radiologi.kd_jenis_prw "+
                           " where reg_periksa.status_bayar='Belum Bayar' and billing.tgl_byr between ? and ? and periksa_radiologi.nip=? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? order by periksa_radiologi.tgl_periksa,periksa_radiologi.jam,jns_perawatan_radiologi.nm_perawatan  ");
                       try {
                           psperiksa_radiologi.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                           psperiksa_radiologi.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
                           psperiksa_radiologi.setString(3,rs.getString("nip"));
