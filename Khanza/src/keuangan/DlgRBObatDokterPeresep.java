...
public class DlgRBObatDokterPeresep extends javax.swing.JDialog {
    ...
    private PreparedStatement psdokter,psresep,psresep2,psresep3,psresep4;
    ...
    public DlgRBObatDokterPeresep(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"No.","Dokter","Tanggal","Nama Obat","Tgl. Lunas","Jenis Bayar","Status","Jml","Biaya Obat","Embalase","Tuslah"};
        ...
        try {
             ...
             psresep=koneksi.prepareStatement(
                     ...
                     "tagihan_sadewa.tgl_bayar,penjab.png_jawab,reg_periksa.status_lanjut, "+
                     ...
                     "databarang.kode_brng from resep_obat inner join reg_periksa "+
                     "inner join pasien "+        
                     "inner join detail_pemberian_obat "+
                     "inner join tagihan_sadewa "+ 
                     "inner join penjab "+        
                     ...
                     "and resep_obat.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and "+
                     "reg_periksa.no_rkm_medis=tagihan_sadewa.no_rkm_medis and reg_periksa.kd_pj=penjab.kd_pj where detail_pemberian_obat.tgl_perawatan=resep_obat.tgl_perawatan and detail_pemberian_obat.jam=resep_obat.jam "+                             
                     "and tagihan_sadewa.jenis_bayar='Pelunasan' and resep_obat.kd_dokter=? and tagihan_sadewa.tgl_bayar between ? and ? and reg_periksa.kd_pj like ? order by tagihan_sadewa.tgl_bayar");
             psresep2=koneksi.prepareStatement(
                     ...
                     "reg_periksa.no_rkm_medis=tagihan_sadewa.no_rkm_medis and reg_periksa.kd_pj=penjab.kd_pj where detail_pemberian_obat.tgl_perawatan=resep_obat.tgl_perawatan and detail_pemberian_obat.jam=resep_obat.jam "+
                     "and tagihan_sadewa.jenis_bayar='Pelunasan' and resep_obat.kd_dokter=? and tagihan_sadewa.tgl_bayar between ? and ? and reg_periksa.kd_pj like ? order by tagihan_sadewa.tgl_bayar");
             psresep3=koneksi.prepareStatement(
                     "select resep_obat.no_resep,resep_obat.tgl_perawatan,resep_obat.jam,"+
                     "tagihan_sadewa.tgl_bayar,penjab.png_jawab,reg_periksa.status_lanjut, "+
                     "resep_obat.no_rawat,pasien.nm_pasien,resep_obat.kd_dokter,databarang.nama_brng,"+
                     "detail_pemberian_obat.jml,detail_pemberian_obat.biaya_obat,detail_pemberian_obat.embalase,"+
                     ...
                     "and resep_obat.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and "+
                     "reg_periksa.no_rkm_medis=tagihan_sadewa.no_rkm_medis and reg_periksa.kd_pj=penjab.kd_pj where detail_pemberian_obat.tgl_perawatan=resep_obat.tgl_perawatan and detail_pemberian_obat.jam=resep_obat.jam "+                             
                     "and reg_periksa.status_lanjut='Ralan' and tagihan_sadewa.jenis_bayar='Pelunasan' and resep_obat.kd_dokter=? and tagihan_sadewa.tgl_bayar between ? and ? and reg_periksa.kd_pj like ? order by tagihan_sadewa.tgl_bayar");
             psresep4=koneksi.prepareStatement(
                     "select resep_obat.no_resep,resep_obat.tgl_perawatan,resep_obat.jam,"+
                     "tagihan_sadewa.tgl_bayar,penjab.png_jawab,reg_periksa.status_lanjut, "+
                     "resep_obat.no_rawat,pasien.nm_pasien,resep_obat.kd_dokter,databarang.nama_brng,"+
                     "detail_pemberian_obat.jml,detail_pemberian_obat.biaya_obat,detail_pemberian_obat.embalase,"+
                     ...
                     "and resep_obat.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and "+
                     "reg_periksa.no_rkm_medis=tagihan_sadewa.no_rkm_medis and reg_periksa.kd_pj=penjab.kd_pj where detail_pemberian_obat.tgl_perawatan=resep_obat.tgl_perawatan and detail_pemberian_obat.jam=resep_obat.jam "+                             
                     "and reg_periksa.status_lanjut='Ranap' and tagihan_sadewa.jenis_bayar='Pelunasan' and resep_obat.kd_dokter=? and tagihan_sadewa.tgl_bayar between ? and ? and reg_periksa.kd_pj like ? order by tagihan_sadewa.tgl_bayar");
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        MnUrut3 = new javax.swing.JMenuItem();
        MnUrut4 = new javax.swing.JMenuItem();
        ...
        MnUrut3.setBackground(new java.awt.Color(255, 255, 254));
        MnUrut3.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnUrut3.setForeground(new java.awt.Color(50, 50, 50));
        MnUrut3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnUrut3.setText("Tampilkan Pasien Rawat Jalan");
        MnUrut3.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnUrut3.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnUrut3.setName("MnUrut3"); // NOI18N
        MnUrut3.setPreferredSize(new java.awt.Dimension(250, 26));
        MnUrut3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnUrut3ActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnUrut3);

        MnUrut4.setBackground(new java.awt.Color(255, 255, 254));
        MnUrut4.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnUrut4.setForeground(new java.awt.Color(50, 50, 50));
        MnUrut4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnUrut4.setText("Tampilkan Pasien Rawat Inap");
        MnUrut4.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnUrut4.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnUrut4.setName("MnUrut4"); // NOI18N
        MnUrut4.setPreferredSize(new java.awt.Dimension(250, 26));
        MnUrut4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnUrut4ActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnUrut4);
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    private void MnUrut3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnUrut3ActionPerformed
    prosesCari3();
        // TODO add your handling code here:
    }//GEN-LAST:event_MnUrut3ActionPerformed

    private void MnUrut4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnUrut4ActionPerformed
    prosesCari4();
        // TODO add your handling code here:
    }//GEN-LAST:event_MnUrut4ActionPerformed
    ...
    */
    ...
    private javax.swing.JMenuItem MnUrut3;
    private javax.swing.JMenuItem MnUrut4;
           ...
           while(rsdokter.next()){
               ...
               while(rsresep.next()){
                   ...
                   tabMode.addRow(new Object[]{
                       ...
                       rsresep.getString("tgl_perawatan")+" "+rsresep.getString("jam"),rsresep.getString("kode_brng")+" "+rsresep.getString("nama_brng"),rsresep.getString("tgl_bayar"),rsresep.getString("png_jawab"),rsresep.getString("status_lanjut"),
...
private void prosesCari3() {             
        try{   
           ...
           while(rsdokter.next()){
               tabMode.addRow(new Object[]{i+". ",rsdokter.getString("nm_dokter"),"","",null,null,null});
               psresep3.setString(1,rsdokter.getString("kd_dokter"));
               psresep3.setString(2,Valid.SetTgl(Tgl1.getSelectedItem()+""));
               psresep3.setString(3,Valid.SetTgl(Tgl2.getSelectedItem()+""));
               psresep3.setString(4,"%"+pilihancarabayar+"%");
               a=1;
               rsresep=psresep3.executeQuery();               
               subtotal=0;
               embalase=0;
               tuslah=0;
               //Object[] row={"No.","Dokter","Tanggal","Nama Obat","Jml","Biaya Obat","Embalase","Tuslah"};
...
private void prosesCari4() {             
        try{   
           ...
           while(rsdokter.next()){
               tabMode.addRow(new Object[]{i+". ",rsdokter.getString("nm_dokter"),"","",null,null,null});
               psresep4.setString(1,rsdokter.getString("kd_dokter"));
               psresep4.setString(2,Valid.SetTgl(Tgl1.getSelectedItem()+""));
               psresep4.setString(3,Valid.SetTgl(Tgl2.getSelectedItem()+""));
               psresep4.setString(4,"%"+pilihancarabayar+"%");
               a=1;
               rsresep=psresep4.executeQuery();               
               subtotal=0;
               embalase=0;
               tuslah=0;
               //Object[] row={"No.","Dokter","Tanggal","Nama Obat","Jml","Biaya Obat","Embalase","Tuslah"};
