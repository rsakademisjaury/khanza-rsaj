...
public final class InventarisBarang extends javax.swing.JDialog {
    ...
    public InventarisBarang(java.awt.Frame parent, boolean modal) {
        ...
        thn_produksi.setSelectedItem("2026"); // baru isi nilai dari data
    ...
    private void initComponents() {
        ...
        kode_barang.setBounds(103, 10, 110, 23);
        ...
        nama_barang.setBounds(103, 40, 380, 23);
        ...
        jml_barang.setBounds(103, 70, 50, 23);

        label7.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        label7.setText("Tahun Pengadaan :");
        label7.setName("label7"); // NOI18N
        FormInput.add(label7);
        label7.setBounds(185, 70, 110, 23);
        ...
        thn_produksi.setBounds(294, 70, 70, 23);
        ...
        label19.setBounds(15, 100, 90, 23);
        ...
        kode_produsen.setBounds(103, 100, 80, 23);
        ...
        nama_produsen.setBounds(188, 100, 300, 23);
        ...
        btnProdusen.setBounds(490, 100, 30, 23);
        ...
        label20.setBounds(579, 10, 70, 23);
        ...
        id_merk.setBounds(652, 10, 80, 23);
        ...
        nm_merk.setBounds(735, 10, 300, 23);
        ...
        btnMerk.setBounds(1040, 10, 28, 23);
        ...
        label21.setBounds(579, 70, 70, 23);
        ...
        id_kategori.setBounds(652, 70, 80, 23);
        ...
        nm_kategori.setBounds(735, 70, 300, 23);
        ...
        btnKategori.setBounds(1040, 70, 28, 23);
        ...
        label22.setBounds(579, 100, 70, 23);
        ...
        id_jenis.setBounds(652, 100, 80, 23);
        ...
        nm_jenis.setBounds(735, 100, 300, 23);
        ...
        btnJenis.setBounds(1040, 100, 28, 23);
        ...
        label16.setBounds(15, 130, 80, 23);
        ...
        btnSuplier.setBounds(490, 130, 30, 23);
        ...
        if(kode_barang.getText().trim().equals("")){
            ...
            Valid.textKosong(id_kategori,"Kategori");
                ...
                Sequel.menyimpan("inventaris_barang","'"+kode_barang.getText()+"','"+nama_barang.getText()+"','"+jml_barang.getText()+"','"+
                        ...
                        id_kategori.getText()+"','"+id_jenis.getText()+"','"+kdsup.getText()+"'","Kode Barang");
                //----------------------------------------------------------
        ...
        if(kode_barang.getText().trim().equals("")){
            ...
            Valid.textKosong(id_kategori,"Kategori");
                ...
                Sequel.mengedit("inventaris_barang","kode_barang='"+tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),0) +"'",
                        ...
                        id_kategori.getText()+"',id_jenis='"+id_jenis.getText()+"',kode_suplier='"+kdsup.getText()+"'");
                //----------------------------------------------------------
                kode_barang.requestFocus();
            tampil();
            emptTeks();
...
private void btnJenisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnJenisActionPerformed
    ...
    */
    ...
    private void tampil() {
        String sql="SELECT inventaris_barang.kode_barang, "
        + "inventaris_barang.nama_barang, "
        + "inventaris_barang.jml_barang, "
        ...
        + "OR inventaris_suplier.nama_suplier LIKE '%" + TCari.getText().trim() + "%' "
...
//                               + "inventaris_barang.nama_barang, "
//                               + "inventaris_barang.jml_barang, "
//                               + "inventaris_barang.kode_produsen, "
//                               + "inventaris_barang.kode_suplier, "
//                               + "inventaris_barang.id_merk, "
//                               + "inventaris_barang.thn_produksi, "
//                               + "inventaris_barang.isbn, "
//                               + "inventaris_barang.id_kategori, "
//                               + "inventaris_barang.id_jenis "
//                               + "from inventaris_barang "
...
//                nmsup.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),4).toString());
//                nm_merk.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),5).toString());
//                thn_produksi.setSelectedItem(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),6).toString());                
...
//        }
    ...
    if (tbJnsPerawatan.getSelectedRow() != -1) {
        try {
            PreparedStatement ps = koneksiDB.condb().prepareStatement(
                "SELECT ib.kode_barang, ib.nama_barang, ib.jml_barang, " +
                "       ib.kode_produsen, p.nama_produsen, " +
                "       ib.kode_suplier, s.nama_suplier, " +
                "       ib.id_merk, m.nama_merk, " +
                "       ib.thn_produksi, ib.isbn, " +
                "       ib.id_kategori, k.nama_kategori, " +
                "       ib.id_jenis, j.nama_jenis " +
                "FROM inventaris_barang ib " +
                "LEFT JOIN inventaris_produsen p ON ib.kode_produsen = p.kode_produsen " +
                "LEFT JOIN inventaris_suplier s ON ib.kode_suplier = s.kode_suplier " +
                "LEFT JOIN inventaris_merk m ON ib.id_merk = m.id_merk " +
                "LEFT JOIN inventaris_kategori k ON ib.id_kategori = k.id_kategori " +
                "LEFT JOIN inventaris_jenis j ON ib.id_jenis = j.id_jenis " +
                "WHERE ib.kode_barang = ?"
            );
            ...
            if (rs.next()) {
                ...
                jml_barang.setText(rs.getString("jml_barang"));
                kode_produsen.setText(rs.getString("kode_produsen"));
                nama_produsen.setText(rs.getString("nama_produsen"));
                kdsup.setText(rs.getString("kode_suplier"));
