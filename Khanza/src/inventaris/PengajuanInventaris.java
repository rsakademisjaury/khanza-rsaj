...
public final class PengajuanInventaris extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnPrint1.setText("Cetak Pengajuan");
        ...
        PanelInput.setPreferredSize(new java.awt.Dimension(1600, 430));
        ...
        jLabel8.setBounds(5, 55, 145, 26);

        Tanggal.setForeground(new java.awt.Color(50, 70, 50));
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "28-07-2025" }));
        ...
        Tanggal.setBounds(160, 55, 90, 26);

        jLabel5.setText("Latar Belakang   : ");
        jLabel5.setName("jLabel5"); // NOI18N
        FormInput.add(jLabel5);
        jLabel5.setBounds(5, 195, 145, 26);

        KdPetugas.setEditable(false);
        KdPetugas.setText("20101730");
        ...
        KdPetugas.setBounds(760, 20, 100, 26);
        ...
        btnPetugas.setBounds(1280, 20, 30, 26);
        ...
        NmPetugas.setBounds(865, 20, 410, 26);
        ...
        scrollPane1.setBounds(160, 195, 400, 75);

        jLabel9.setText("Diajukan Oleh   : ");
        jLabel9.setName("jLabel9"); // NOI18N
        FormInput.add(jLabel9);
        jLabel9.setBounds(600, 20, 145, 26);
        ...
        Urgensi.setBounds(160, 125, 90, 26);

        jLabel4.setText("Nama Barang   : ");
        jLabel4.setName("jLabel4"); // NOI18N
        FormInput.add(jLabel4);
        jLabel4.setBounds(5, 90, 145, 26);
        ...
        NamaBarang.setBounds(160, 90, 400, 26);

        jLabel11.setText("Jumlah Pengajuan   : ");
        jLabel11.setName("jLabel11"); // NOI18N
        FormInput.add(jLabel11);
        jLabel11.setBounds(5, 160, 145, 26);
        ...
        Jumlah.setBounds(160, 160, 90, 26);
        ...
        FormInput.add(Harga);
        Harga.setBounds(340, 550, 120, 26);

        jLabel12.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel12.setText("Harga :");
        jLabel12.setName("jLabel12"); // NOI18N
        FormInput.add(jLabel12);
        jLabel12.setBounds(280, 550, 50, 26);

        jLabel13.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel13.setText("Total Pengajuan :");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(470, 550, 90, 26);

        Total.setEditable(false);
        Total.setHighlighter(null);
        Total.setName("Total"); // NOI18N
        FormInput.add(Total);
        Total.setBounds(570, 550, 150, 26);

        jLabel14.setText("Keterangan   : ");
        jLabel14.setName("jLabel14"); // NOI18N
        FormInput.add(jLabel14);
        jLabel14.setBounds(5, 365, 145, 26);
        ...
        Keterangan.setBounds(160, 365, 400, 26);

        jLabel15.setText("Bidang   : ");
        jLabel15.setName("jLabel15"); // NOI18N
        FormInput.add(jLabel15);
        jLabel15.setBounds(600, 55, 145, 26);
        ...
        Bidang.setBounds(760, 55, 515, 26);

        jLabel16.setText("Departemen   : ");
        jLabel16.setName("jLabel16"); // NOI18N
        FormInput.add(jLabel16);
        jLabel16.setBounds(600, 90, 145, 26);
        ...
        Departemen.setBounds(760, 90, 515, 26);

        jLabel17.setText("Penanggung jawab   : ");
        jLabel17.setName("jLabel17"); // NOI18N
        FormInput.add(jLabel17);
        jLabel17.setBounds(600, 125, 145, 26);
        ...
        KdPetugasPJ.setBounds(760, 125, 100, 26);
        ...
        NmPetugasPJ.setBounds(865, 125, 410, 26);
        ...
        btnPetugasPJ.setBounds(1280, 125, 30, 26);

        jSeparator1.setForeground(new java.awt.Color(204, 204, 204));
        jSeparator1.setOrientation(javax.swing.SwingConstants.VERTICAL);
        jSeparator1.setName("jSeparator1"); // NOI18N
        FormInput.add(jSeparator1);
        jSeparator1.setBounds(600, 20, 10, 380);
...
private void NmPetugasKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NmPetugasKeyPressed
    ...
    private void BtnPrint1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint1ActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            param.put("finger","Ditandatangani secara elektronik oleh "+tbObat.getValueAt(tbObat.getSelectedRow(),3).toString()+"\nID "+(finger.equals("")?tbObat.getValueAt(tbObat.getSelectedRow(),4).toString():finger)+"\n"+Tanggal); 
            
            Valid.MyReportqry("rptPengajuanAset.jasper","report","::[ Data Pengajuan Inventaris ]::",
                   "select pengajuan_inventaris.no_pengajuan,pengajuan_inventaris.tanggal,pengajuan_inventaris.nik,peg1.nama as namapengaju,"+
                   "peg1.bidang,peg1.departemen,pengajuan_inventaris.urgensi,pengajuan_inventaris.latar_belakang,pengajuan_inventaris.nama_barang,"+
                   "pengajuan_inventaris.spesifikasi,pengajuan_inventaris.jumlah,pengajuan_inventaris.harga,pengajuan_inventaris.total,"+
                   "pengajuan_inventaris.keterangan,pengajuan_inventaris.nik_pj,peg2.nama as namapj,pengajuan_inventaris.status "+
