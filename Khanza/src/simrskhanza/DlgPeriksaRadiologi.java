...
public final class DlgPeriksaRadiologi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        ChkBhpHasil.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/143.png"))); // NOI18N
        ChkBhpHasil.setMnemonic('H');
        ChkBhpHasil.setSelected(false);
        ChkBhpHasil.setText("Tampilkan BHP/Hasil Periksa");
        ChkBhpHasil.setToolTipText("Alt+H");
        ChkBhpHasil.setBorderPainted(true);
        ChkBhpHasil.setBorderPaintedFlat(true);
        ChkBhpHasil.setFocusable(false);
        ChkBhpHasil.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ChkBhpHasil.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ChkBhpHasil.setName("ChkBhpHasil"); // NOI18N
        ChkBhpHasil.setPreferredSize(new java.awt.Dimension(191, 30));
        ChkBhpHasil.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/143.png"))); // NOI18N
        ChkBhpHasil.setRolloverSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/145.png"))); // NOI18N
        ChkBhpHasil.setSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/145.png"))); // NOI18N
        ChkBhpHasil.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ChkBhpHasilActionPerformed(evt);
            }
        });
        panelGlass8.add(ChkBhpHasil);
...
private void ChkJlnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkJlnActionPerformed
    ...
    private void ChkBhpHasilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkBhpHasilActionPerformed
        aturTampilanBhpHasil();
    }//GEN-LAST:event_ChkBhpHasilActionPerformed
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        }else if(!validasiParameterPemeriksaan()){
            return;
        }else{
            jmlparsial=0;
    ...
    */
    ...
    private widget.CekBox ChkBhpHasil;
    ...
    private void aturTampilanBhpHasil(){
        boolean tampil=ChkBhpHasil.isSelected();
        if(tampil){
            if(jPanel2.getParent()!=jPanel1){
                jPanel1.add(jPanel2);
            }
            if(jPanel4.getParent()!=jPanel1){
                jPanel1.add(jPanel4);
            }
        }else{
        ...
        jPanel2.setVisible(tampil);
        jPanel4.setVisible(tampil);
        jPanel1.revalidate();
        jPanel1.repaint();
    }

    private boolean validasiParameterPemeriksaan(){
        if(tbPemeriksaan.isEditing()&&tbPemeriksaan.getCellEditor()!=null){
            tbPemeriksaan.getCellEditor().stopCellEditing();
        }

        for(int baris=0;baris<tbPemeriksaan.getRowCount();baris++){
