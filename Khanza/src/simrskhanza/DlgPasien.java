...
public class DlgPasien extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        WindowGabungRM.setTitle("Gabungkan ke Nomor RM");
        WindowGabungRM.setModal(true);
        WindowGabungRM.setName("WindowGabungRM"); // NOI18N
        WindowGabungRM.setResizable(false);
        WindowGabungRM.setSize(new java.awt.Dimension(450, 120));
        WindowGabungRM.setType(java.awt.Window.Type.POPUP);

        internalFrame8.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(230, 235, 225)), "", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        internalFrame8.setMinimumSize(new java.awt.Dimension(450, 120));
        ...
        BtnCloseIn6.setBounds(130, 70, 100, 30);
        ...
        NoRmTujuan.setBounds(110, 10, 100, 23);
        ...
        BtnCari1.setBounds(210, 10, 28, 23);
        ...
        DTPLahir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "08-10-2024" }));
        ...
        TNo.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                TNoPropertyChange(evt);
            }
        });
        ...
        DTPDaftar.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "08-10-2024" }));
        ...
        BtnKelurahanPj.setEnabled(false);
        ...
        ChkRM.setText("Lepas centang untuk input RM lama");
        ChkRM.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        ChkRM.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ChkRM.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ChkRM.setIconTextGap(8);
        ...
        jLabel40.setText("NIK Karyawan :");
        jLabel40.setName("jLabel40"); // NOI18N
        FormInput.add(jLabel40);
        jLabel40.setBounds(679, 342, 90, 23);
        ...
        CmbKeluarga.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "AYAH", "IBU", "SUAMI", "ISTRI", "SAUDARA", "SEPUPU", "ANAK", "CUCU", "KAKEK", "NENEK", "PAMAN", "BIBI", "TEMAN", "REKAN KERJA", "MERTUA", "MENANTU", "KEMANAKAN", "TETANGGA", "DIRI SENDIRI", "-" }));
        ...
        jLabel43.setText("Wajib diisi jika karyawan RSAJ");
        jLabel43.setName("jLabel43"); // NOI18N
        FormInput.add(jLabel43);
        jLabel43.setBounds(693, 369, 170, 14);
...
//        }else if(Sequel.cariInteger("select count(pasien.no_rkm_medis) from pasien where no_ktp = ? and no_rkm_medis !=" + TNo.getText().trim(),TKtp.getText())>0){
//            String rm_sekarang = Sequel.cariString("select no_rkm_medis from pasien where no_ktp =" + TKtp.getText());
//            JOptionPane.showMessageDialog(null,"Nomor KTP sudah terdaftar di RM " + rm_sekarang);
            
            // Validasi no_ktp
        } else {
            // Validasi nomor KTP
            if (Sequel.cariInteger("select count(pasien.no_rkm_medis) from pasien where no_ktp = ? and no_rkm_medis !=" + TNo.getText().trim(),TKtp.getText())>0){
                String rm_sekarang = Sequel.cariString("select no_rkm_medis from pasien where no_ktp =" + TKtp.getText());
                JOptionPane.showMessageDialog(null, "Nomor KTP sudah terdaftar di RM " + rm_sekarang);
                TKtp.requestFocus();
            }
            // Validasi nomor peserta
                ...
                if (Sequel.cariInteger("select count(pasien.no_rkm_medis) from pasien where no_peserta = ? and no_rkm_medis !=" + TNo.getText().trim(),TNoPeserta.getText())>0){
                    String rm_sekarang = Sequel.cariString("select no_rkm_medis from pasien where no_peserta =" + TNoPeserta.getText());
                    JOptionPane.showMessageDialog(null, "Nomor Peserta sudah terdaftar di RM " + rm_sekarang);
                    TNoPeserta.requestFocus();
        } else {
            // Lanjutkan logika jika validasi nomor peserta lolos
...
private void KabupatenMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_KabupatenMouseMoved
    ...
    private void ChkRMItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_ChkRMItemStateChanged
        if(ChkRM.isSelected()==true){
            ...
            TNo.setBackground(new Color(255,255,255));
            TNo.setText("");
            TNo.requestFocus();
        }
    ...
    private void TNoPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_TNoPropertyChange
        // TODO add your handling code here:
    }//GEN-LAST:event_TNoPropertyChange
    ...
    public boolean GeneralConsentSatuSehat(String string) {
