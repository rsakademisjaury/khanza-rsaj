...
// RSAJ V45 - pencarian otomatis ditahan hanya selama setNoRm mengisi filter.
// Data pasien tetap dimuat satu kali di akhir proses dengan fungsi tampil lama.
...
import rekammedis.DlgSBARRanap;
...
import rekammedis.ValidasiSBARRanap;
import rekammedis.ValidasiSOAP;
import rekammedis.DlgPEWS;
import rekammedis.DlgEWS;
import rekammedis.DlgEOWS;
import rekammedis.DlgImplementasi;
...
public final class DlgRawatInap extends javax.swing.JDialog {
    ...
    // Source lokal memasang listener pencarian di constructor. Penanda ini
    // menyamakan efeknya dengan source resmi: setNoRm memuat tabel satu kali.
    private boolean sedangMengisiNoRawat=false;
    // V52 - hanya aktif saat initial load dari setNoRm(); pencarian manual tetap memakai alur lama.
    private boolean memuatNoRawatExactV52=false;
...
//    public class PlaceholdersearchField;
    ...
    public DlgRawatInap(java.awt.Frame parent, boolean modal) {
        ...
        tabModePemeriksaanSbar=new DefaultTableModel(null,new Object[]{
            ...
            "Situation","Background","Assesment","Recommendation","NIP","Dokter/Paramedis","Profesi/Jabatan","Tulis","Baca","Konfirmasi","DPJP"}){
             @Override public boolean isCellEditable(int rowIndex, int colIndex){
                boolean a = false;
                if (colIndex==0) {
                    a=true;
        ...
        if(koneksiDB.CARICEPAT().equals("aktif")){
            TCari.getDocument().addDocumentListener(new javax.swing.event.DocumentListener(){
                ...
                public void insertUpdate(DocumentEvent e) {
                    if(!sedangMengisiNoRawat&&TCari.getText().length()>2){
            ...
            if(akses.getform().equals("DlgRawatInap")){
                    if(akses.getform().equals("DlgRawatInap")){
                        if(perawatan.dokter.getTable().getSelectedRow()!= -1){  
                            if(TabRawat.getSelectedIndex()==6){
                            KdDPJP.setText(perawatan.dokter.getTable().getValueAt(perawatan.dokter.getTable().getSelectedRow(),0).toString());
                            NmDPJP.setText(perawatan.dokter.getTable().getValueAt(perawatan.dokter.getTable().getSelectedRow(),1).toString());                            
                            KdDPJP.requestFocus();                    
                            }   
                        }
                    }
    ...
    private void initComponents() {
        ...
        BtnSimpanSoap1 = new widget.Button();
        ...
        BtnLihatStatus = new widget.Button();
        ...
        BtnImplementasiKep = new widget.Button();
        ...
        panelGlass10Layout.setHorizontalGroup(
            ...
            .addGroup(panelGlass10Layout.createSequentialGroup()
                ...
                .addComponent(TCariPasien, javax.swing.GroupLayout.PREFERRED_SIZE, 63, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        panelGlass10Layout.setVerticalGroup(
            ...
            .addGroup(panelGlass10Layout.createSequentialGroup()
                .addGap(10, 10, 10)
                .addGroup(panelGlass10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                    .addComponent(jLabel19, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(DTPCari1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel21, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(DTPCari2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        TabRawat.setMinimumSize(new java.awt.Dimension(1200, 375));
        TabRawat.setName("TabRawat"); // NOI18N
        TabRawat.setPreferredSize(new java.awt.Dimension(1200, 375));
        ...
        BtnSeekDokter.setBounds(490, 10, 130, 23);

        TDokter.setEditable(false);
        TDokter.setHighlighter(null);
        TDokter.setName("TDokter"); // NOI18N
        panelGlass7.add(TDokter);
        TDokter.setBounds(186, 10, 300, 23);
        ...
        TKdPrw.setBounds(108, 40, 90, 23);

        TNmPrw.setEditable(false);
        TNmPrw.setName("TNmPrw"); // NOI18N
        panelGlass7.add(TNmPrw);
        TNmPrw.setBounds(200, 40, 460, 23);

        btnTindakan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        btnTindakan.setMnemonic('3');
        btnTindakan.setText("Pilih Tindakan ");
        btnTindakan.setToolTipText("Alt+3");
        btnTindakan.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        btnTindakan.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ...
        btnTindakan.setBounds(660, 40, 130, 23);
        ...
        btnTindakan3.setBounds(780, 40, 28, 23);
        ...
        BtnSeekPetugas.setBounds(490, 10, 130, 23);
        ...
        TPerawat.setBounds(186, 10, 300, 23);
        ...
        btnTindakan4.setBounds(660, 40, 130, 23);
        ...
        btnTindakan5.setBounds(780, 40, 28, 23);
        ...
        BtnSeekPetugas2.setText("Pilh Petugas");
        ...
        BtnSeekPetugas2.setBounds(490, 40, 130, 23);
        ...
        TPerawat2.setBounds(186, 40, 300, 23);
        ...
        BtnSeekDokter2.setBounds(490, 10, 130, 23);
        ...
        TKdPrwDokterPetugas.setBounds(108, 70, 90, 23);
        ...
        TNmPrwDokterPetugas.setBounds(200, 70, 460, 23);

        btnTindakan6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        btnTindakan6.setMnemonic('3');
        btnTindakan6.setText("Pilih Tindakan");
        btnTindakan6.setToolTipText("Alt+3");
        btnTindakan6.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        btnTindakan6.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ...
        btnTindakan6.setBounds(660, 70, 130, 23);
        ...
        btnTindakan7.setBounds(780, 70, 28, 23);
        ...
        internalFrame5.setMinimumSize(new java.awt.Dimension(1200, 380));
        internalFrame5.setName("internalFrame5"); // NOI18N
        internalFrame5.setPreferredSize(new java.awt.Dimension(1200, 380));
        ...
        PanelInput1.setMinimumSize(new java.awt.Dimension(1200, 380));
        PanelInput1.setName("PanelInput1"); // NOI18N
        PanelInput1.setOpaque(false);
        PanelInput1.setPreferredSize(new java.awt.Dimension(1200, 380));
        ...
        panelGlass12.setMinimumSize(new java.awt.Dimension(1200, 380));
        ...
        jLabel7.setBounds(460, 10, 80, 23);
        ...
        TSuhu.setBounds(540, 10, 50, 23);

        jLabel4.setText("Tensi :  ");
        jLabel4.setName("jLabel4"); // NOI18N
        panelGlass12.add(jLabel4);
        jLabel4.setBounds(490, 40, 50, 23);
        ...
        TBerat.setBounds(1005, 40, 40, 23);

        jLabel25.setText("Berat (Kg) : ");
        jLabel25.setName("jLabel25"); // NOI18N
        panelGlass12.add(jLabel25);
        jLabel25.setBounds(920, 40, 80, 23);
        ...
        TTinggi.setBounds(1005, 10, 40, 23);

        jLabel16.setText("Tinggi Badan (Cm) : ");
        jLabel16.setName("jLabel16"); // NOI18N
        panelGlass12.add(jLabel16);
        jLabel16.setBounds(880, 10, 120, 23);
        ...
        TAlergi.setBounds(150, 40, 250, 23);

        jLabel24.setText("Nadi (/mnt) : ");
        jLabel24.setName("jLabel24"); // NOI18N
        panelGlass12.add(jLabel24);
        jLabel24.setBounds(620, 10, 80, 23);
        ...
        TRespirasi.setBounds(700, 40, 55, 23);

        jLabel23.setText("Respirasi (/mnt) : ");
        jLabel23.setName("jLabel23"); // NOI18N
        panelGlass12.add(jLabel23);
        jLabel23.setBounds(600, 40, 100, 23);

        scrollPane1.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(204, 204, 204), 1, true));
        scrollPane1.setToolTipText("SUBJEK");
        ...
        scrollPane2.setToolTipText("OBJEK");
        ...
        jLabel37.setBounds(430, 70, 80, 23);
        ...
        scrollPane4.setBounds(640, 90, 200, 160);
        ...
        TPegawai.setBounds(150, 10, 250, 23);
        ...
        SpO2.setBounds(840, 10, 40, 23);

        jLabel56.setText("SpO2 (%) : ");
        jLabel56.setName("jLabel56"); // NOI18N
        panelGlass12.add(jLabel56);
        jLabel56.setBounds(760, 10, 80, 23);
        ...
        jLabel59.setBounds(1060, 70, 80, 20);
        ...
        Btn5Soap.setBounds(1840, 270, 28, 23);

        BtnBukaTemplateSoap.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/search_page.png"))); // NOI18N
        BtnBukaTemplateSoap.setMnemonic('B');
        BtnBukaTemplateSoap.setToolTipText("Alt+B");
        BtnBukaTemplateSoap.setEnabled(false);
        BtnBukaTemplateSoap.setFont(new java.awt.Font("SansSerif", 1, 11)); // NOI18N
        BtnBukaTemplateSoap.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnBukaTemplateSoap.setLabel("Lihat Data Template SOAP");
        ...
        BtnBukaTemplateSoap.setBounds(1840, 210, 70, 30);

        BtnSimpanSoap1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/095.png"))); // NOI18N
        BtnSimpanSoap1.setMnemonic('S');
        BtnSimpanSoap1.setToolTipText("Alt+S");
        BtnSimpanSoap1.setEnabled(false);
        BtnSimpanSoap1.setFont(new java.awt.Font("SansSerif", 1, 11)); // NOI18N
        BtnSimpanSoap1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnSimpanSoap1.setLabel("Simpan Sebagai Template");
        BtnSimpanSoap1.setName("BtnSimpanSoap1"); // NOI18N
        BtnSimpanSoap1.setPreferredSize(new java.awt.Dimension(100, 30));
        BtnSimpanSoap1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnSimpanSoap1ActionPerformed(evt);
            }
        });
        BtnSimpanSoap1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnSimpanSoap1KeyPressed(evt);
            }
        });
        panelGlass12.add(BtnSimpanSoap1);
        BtnSimpanSoap1.setBounds(1840, 250, 60, 30);
        ...
        BtnSeekPegawai3.setPreferredSize(new java.awt.Dimension(137, 26));
        ...
        BtnSeekPegawai3.setBounds(10, 40, 140, 26);
        ...
        jLabel92.setBounds(160, 20, 60, 24);
        ...
        TPegawai2.setBounds(300, 20, 260, 24);
        ...
        BtnSeekPegawai1.setBounds(560, 20, 28, 24);

        NmDPJP.setEditable(false);
        NmDPJP.setHighlighter(null);
        NmDPJP.setName("NmDPJP"); // NOI18N
        panelGlass17.add(NmDPJP);
        NmDPJP.setBounds(760, 20, 260, 24);
        ...
        panelGlass17.add(KdDPJP);
        KdDPJP.setBounds(685, 20, 70, 24);
        ...
        Konfirmasi.setBounds(400, 440, 70, 26);
        ...
        Baca.setBounds(400, 410, 70, 26);

        jLabel85.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel85.setText("Dokter DPJP");
        jLabel85.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel85.setName("jLabel85"); // NOI18N
        panelGlass17.add(jLabel85);
        jLabel85.setBounds(610, 20, 70, 24);

        BtnLihatStatus.setBackground(new java.awt.Color(249, 249, 249));
        BtnLihatStatus.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/question 1.png"))); // NOI18N
        BtnLihatStatus.setMnemonic('4');
        BtnLihatStatus.setText("Lihat Status");
        BtnLihatStatus.setToolTipText("ALt+4");
        BtnLihatStatus.setIconTextGap(10);
        BtnLihatStatus.setName("BtnLihatStatus"); // NOI18N
        BtnLihatStatus.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnLihatStatusActionPerformed(evt);
            }
        });
        panelGlass17.add(BtnLihatStatus);
        BtnLihatStatus.setBounds(1070, 130, 120, 30);

        jLabel15.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel15.setText("Situation :");
        jLabel15.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel15.setName("jLabel15"); // NOI18N
        panelGlass17.add(jLabel15);
        jLabel15.setBounds(10, 70, 70, 23);

        jLabel17.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel17.setText("Background :");
        jLabel17.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel17.setName("jLabel17"); // NOI18N
        panelGlass17.add(jLabel17);
        jLabel17.setBounds(220, 70, 160, 23);
        ...
        scrollPane6.setViewportView(TSituation);

        panelGlass17.add(scrollPane6);
        scrollPane6.setBounds(10, 90, 200, 170);

        jLabel41.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel41.setText("Asesmen :");
        jLabel41.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel41.setName("jLabel41"); // NOI18N
        panelGlass17.add(jLabel41);
        jLabel41.setBounds(430, 70, 110, 23);

        jLabel63.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel63.setText("Recomendation :");
        jLabel63.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel63.setName("jLabel63"); // NOI18N
        panelGlass17.add(jLabel63);
        jLabel63.setBounds(640, 70, 190, 23);

        scrollPane13.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(204, 204, 204), 1, true));
        ...
        scrollPane13.setViewportView(TBackground);

        panelGlass17.add(scrollPane13);
        scrollPane13.setBounds(220, 90, 200, 170);

        scrollPane14.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(204, 204, 204), 1, true));
        ...
        scrollPane14.setViewportView(TAssesment);

        panelGlass17.add(scrollPane14);
        scrollPane14.setBounds(430, 90, 200, 170);

        scrollPane15.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(204, 204, 204), 1, true));
        scrollPane15.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
        ...
        scrollPane15.setBounds(640, 90, 200, 170);

        jLabel65.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel65.setText("Advis Dokter :");
        jLabel65.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel65.setName("jLabel65"); // NOI18N
        panelGlass17.add(jLabel65);
        jLabel65.setBounds(850, 70, 100, 23);

        scrollPane16.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(204, 204, 204), 1, true));
        scrollPane16.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
        ...
        scrollPane16.setViewportView(Tulis);

        panelGlass17.add(scrollPane16);
        scrollPane16.setBounds(850, 90, 200, 170);

        BtnSeekDPJP.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        BtnSeekDPJP.setMnemonic('4');
        BtnSeekDPJP.setToolTipText("ALt+4");
        ...
        panelGlass17.add(BtnSeekDPJP);
        BtnSeekDPJP.setBounds(1020, 20, 30, 24);

        jLabel66.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel66.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/online (2).png"))); // NOI18N
        jLabel66.setText("SBAR");
        jLabel66.setFont(new java.awt.Font("Segoe UI Semibold", 1, 36)); // NOI18N
        ...
        jLabel66.setBounds(10, 10, 150, 40);

        BtnVerifikasi.setBackground(new java.awt.Color(249, 249, 249));
        BtnVerifikasi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/check.png"))); // NOI18N
        BtnVerifikasi.setMnemonic('4');
        BtnVerifikasi.setText("Verifikasi SBAR");
        BtnVerifikasi.setToolTipText("ALt+4");
        BtnVerifikasi.setIconTextGap(10);
        BtnVerifikasi.setName("BtnVerifikasi"); // NOI18N
        BtnVerifikasi.setPreferredSize(new java.awt.Dimension(122, 30));
        BtnVerifikasi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnVerifikasiActionPerformed(evt);
            }
        });
        panelGlass17.add(BtnVerifikasi);
        BtnVerifikasi.setBounds(1070, 90, 122, 30);
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "07-05-2025" }));
        ...
        PanelAccor.setPreferredSize(new java.awt.Dimension(240, 3060));
        ...
        ScrollMenu.setPreferredSize(new java.awt.Dimension(240, 3060));
        ScrollMenu.setRowHeaderView(null);

        FormMenu.setBackground(new java.awt.Color(255, 255, 255));
        FormMenu.setBorder(null);
        FormMenu.setAutoscrolls(true);
        FormMenu.setName("FormMenu"); // NOI18N
        FormMenu.setPreferredSize(new java.awt.Dimension(240, 3060));
        ...
        BtnRiwayat.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnResepObat.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnCopyResep.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnInputObat.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnObatBhp.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnResume.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnTransferAntarRuang.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnPermintaanStok.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/open.png"))); // NOI18N
        ...
        BtnPermintaanResepPulang.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/open.png"))); // NOI18N
        ...
        BtnPermintaanResepPulang.setIconTextGap(8);
        ...
        BtnPermintaanResepPulang.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnImplementasiKep.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/open.png"))); // NOI18N
        BtnImplementasiKep.setText("Implementasi Keperawatan");
        BtnImplementasiKep.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnImplementasiKep.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnImplementasiKep.setIconTextGap(8);
        BtnImplementasiKep.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnImplementasiKep.setName("BtnImplementasiKep"); // NOI18N
        BtnImplementasiKep.setPreferredSize(new java.awt.Dimension(190, 30));
        BtnImplementasiKep.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnImplementasiKepActionPerformed(evt);
            }
        });
        FormMenu.add(BtnImplementasiKep);
        ...
        BtnBerkasDigital.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnKonsultasi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/open.png"))); // NOI18N
        BtnKonsultasi.setText("Konsultasi Medik");
        ...
        BtnPermintaanLab.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnPermintaanRad.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnJadwalOperasi.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnSKDP.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnRujukKeluar.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnDiagnosa.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/open.png"))); // NOI18N
        ...
        BtnDiagnosa.setIconTextGap(8);
        BtnDiagnosa.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnDiagnosa.setName("BtnDiagnosa"); // NOI18N
        BtnDiagnosa.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnVerifikasiSOAP.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnPEWS.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnEWS2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/open.png"))); // NOI18N
        BtnEWS2.setText("EWS");
        BtnEWS2.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnEWS2.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnEWS2.setIconTextGap(8);
        BtnEWS2.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnEWS2.setName("BtnEWS2"); // NOI18N
        BtnEWS2.setPreferredSize(new java.awt.Dimension(190, 30));
        BtnEWS2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnEWS2ActionPerformed(evt);
            }
        });
        FormMenu.add(BtnEWS2);

        BtnMEOWS2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/open.png"))); // NOI18N
        BtnMEOWS2.setText("MEOWS");
        BtnMEOWS2.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnMEOWS2.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnMEOWS2.setIconTextGap(8);
        BtnMEOWS2.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnMEOWS2.setName("BtnMEOWS2"); // NOI18N
        BtnMEOWS2.setPreferredSize(new java.awt.Dimension(190, 30));
        BtnMEOWS2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnMEOWS2ActionPerformed(evt);
            }
        });
        FormMenu.add(BtnMEOWS2);

        BtnKonsulDPJP.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/open.png"))); // NOI18N
        BtnKonsulDPJP.setText("Konsul / Jawab Konsul DPJP");
        BtnKonsulDPJP.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnKonsulDPJP.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnKonsulDPJP.setIconTextGap(8);
        BtnKonsulDPJP.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnKonsulDPJP.setName("BtnKonsulDPJP"); // NOI18N
        BtnKonsulDPJP.setPreferredSize(new java.awt.Dimension(190, 30));
        BtnKonsulDPJP.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnKonsulDPJPActionPerformed(evt);
            }
        });
        FormMenu.add(BtnKonsulDPJP);

        BtnGrafikTTV.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/open.png"))); // NOI18N
        ...
        BtnGrafikTTV.setIconTextGap(8);
        BtnGrafikTTV.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnGrafikTTV.setName("BtnGrafikTTV"); // NOI18N
        BtnGrafikTTV.setPreferredSize(new java.awt.Dimension(190, 30));
        BtnGrafikTTV.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnGrafikTTVActionPerformed(evt);
            }
        });
        FormMenu.add(BtnGrafikTTV);
        ...
        BtnVitalSign.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnStatusVerifikasiSoap.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/open.png"))); // NOI18N
        BtnStatusVerifikasiSoap.setText("Status Verifikasi SOAP/CPPT");
        ...
        BtnStatusVerifikasiSoap.setIconTextGap(8);
        BtnStatusVerifikasiSoap.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnStatusVerifikasiSoap.setName("BtnStatusVerifikasiSoap"); // NOI18N
        BtnStatusVerifikasiSoap.setPreferredSize(new java.awt.Dimension(190, 30));
        BtnStatusVerifikasiSoap.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnStatusVerifikasiSoapActionPerformed(evt);
            }
        });
        FormMenu.add(BtnStatusVerifikasiSoap);

        BtnAntarFaskes2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/open.png"))); // NOI18N
        BtnAntarFaskes2.setText("Antar Faskes");
        BtnAntarFaskes2.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnAntarFaskes2.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnAntarFaskes2.setIconTextGap(8);
        BtnAntarFaskes2.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnAntarFaskes2.setName("BtnAntarFaskes2"); // NOI18N
        BtnAntarFaskes2.setPreferredSize(new java.awt.Dimension(190, 30));
        BtnAntarFaskes2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnAntarFaskes2ActionPerformed(evt);
            }
        });
        FormMenu.add(BtnAntarFaskes2);

        BtnAwalKeperawatanUmum.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/open.png"))); // NOI18N
        ...
        BtnAwalKeperawatanKandungan.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnAwalFisioterapi.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnAwalMedis.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnAwalMedisKandungan.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnAwalMedisHemodialisa.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnChecklistPreOperasi.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnSignInSebelumAnestesi.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnTimeOutSebelumInsisi.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnSignOutSebelumMenutupLuka.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnChecklistPostOperasi.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnPenilaianPreOperasi.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnPenilaianPreAnestesi.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnPenilaianPsikolog.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnPerencanaanPemulangan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/open.png"))); // NOI18N
        ...
        BtnPerencanaanPemulangan.setIconTextGap(8);
        ...
        BtnPerencanaanPemulangan.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnPenilaianLanjutanResikoJatuhDewasa.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/open.png"))); // NOI18N
        ...
        BtnPenilaianLanjutanResikoJatuhDewasa.setIconTextGap(8);
        ...
        BtnPenilaianLanjutanResikoJatuhDewasa.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnPenilaianLanjutanResikoJatuhAnak.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/open.png"))); // NOI18N
        ...
        BtnPenilaianLanjutanResikoJatuhAnak.setIconTextGap(8);
        ...
        BtnPenilaianLanjutanResikoJatuhAnak.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnPenilaianLanjutanResikoJatuhLansia.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/open.png"))); // NOI18N
        ...
        BtnPenilaianLanjutanResikoJatuhLansia.setIconTextGap(8);
        ...
        BtnPenilaianLanjutanResikoJatuhLansia.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnPenilaianLanjutanResikoJatuhNeonatus.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/open.png"))); // NOI18N
        ...
        BtnPenilaianLanjutanResikoJatuhNeonatus.setIconTextGap(8);
        ...
        BtnPenilaianLanjutanResikoJatuhNeonatus.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnPenilaianLanjutanResikoJatuhGeriatri.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/open.png"))); // NOI18N
        ...
        BtnPenilaianLanjutanResikoJatuhGeriatri.setIconTextGap(8);
        ...
        BtnPenilaianLanjutanResikoJatuhGeriatri.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnPenilaianLanjutanResikoJatuhPsikiatri.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/open.png"))); // NOI18N
        ...
        BtnPenilaianLanjutanResikoJatuhPsikiatri.setIconTextGap(8);
        ...
        BtnPenilaianLanjutanResikoJatuhPsikiatri.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnPenilaianLanjutanSkriningFungsional.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnPenilaianResikoDekubitus.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/open.png"))); // NOI18N
        ...
        BtnPenilaianResikoDekubitus.setIconTextGap(8);
        ...
        BtnPenilaianResikoDekubitus.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnHasilPemeriksaanUSG.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnDokumentasiESWL.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnCatatan.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnCatatanObservasiRanap.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/open.png"))); // NOI18N
        ...
        BtnCatatanObservasiRanap.setIconTextGap(8);
        ...
        BtnCatatanObservasiRanap.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnCatatanObservasiRanapKebidanan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/open.png"))); // NOI18N
        ...
        BtnCatatanObservasiRanapKebidanan.setIconTextGap(8);
        ...
        BtnCatatanObservasiRanapKebidanan.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnCatatanObservasiRanapPostPartum.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/open.png"))); // NOI18N
        ...
        BtnCatatanObservasiRanapPostPartum.setIconTextGap(8);
        ...
        BtnCatatanObservasiRanapPostPartum.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnFollowUpDBD.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/open.png"))); // NOI18N
        ...
        BtnCatatanKeperawatan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/open.png"))); // NOI18N
        ...
        BtnCatatanCekGDS.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnPemantauanPEWSAnak.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnPemantauanPEWSDewasa.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnPemantauanMEOWS.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnPemantauanEWSNeonatus.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnChecklistKriteriaMasukHCU.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnChecklistKriteriaKeluarHCU.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/open.png"))); // NOI18N
        ...
        BtnChecklistKriteriaKeluarHCU.setIconTextGap(8);
        ...
        BtnChecklistKriteriaKeluarHCU.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnChecklistKriteriaMasukICU.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnChecklistKriteriaKeluarICU.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/open.png"))); // NOI18N
        ...
        BtnChecklistKriteriaKeluarICU.setIconTextGap(8);
        ...
        BtnChecklistKriteriaKeluarICU.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnMonitoringReaksiTranfusi.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnSkriningNutrisiDewasa.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnSkriningNutrisiLansia.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnSkriningNutrisiAnak.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnSkriningGiziLanjut.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnAsuhanGizi.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnMonitoringAsuhanGizi.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnCatatanADIMEGizi.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnKonselingFarmasi.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnInformasiObat.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnRekonsiliasiObat.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnPenilaianPasienTerminal.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnPenilaianKorbanKekerasan.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnPenilaianKecemasanAnak.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/open.png"))); // NOI18N
        ...
        BtnPenilaianKecemasanAnak.setIconTextGap(8);
        ...
        BtnPenilaianKecemasanAnak.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnPenilaianPasienPenyakitMenular.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnPenilaianTambahanGeriatri.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnPenilaianTambahanBunuhDiri.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnPenilaianTambahanPerilakuKekerasan.setPreferredSize(new java.awt.Dimension(190, 30));
        ...
        BtnPenilaianTambahanMelarikanDiri.setPreferredSize(new java.awt.Dimension(190, 30));
            ...
            switch (TabRawat.getSelectedIndex()) {
                ...
                if((!TSituation.getText().trim().equals(""))||(!TBackground.getText().trim().equals(""))||(!TAssesment.getText().trim().equals(""))||
                    ...
                    if(KdPeg2.getText().trim().equals("")||TPegawai2.getText().trim().equals("")){
                        ...
                        if(akses.getkode().equals("Admin Utama")){
                            Sequel.menyimpan("pemeriksaan_ranap_sbar","?,?,?,?,?,?,?,?,?,?,?,?","Data",12,new String[]{
                                TNoRw.getText(),//1
                                Valid.SetTgl(DTPTgl.getSelectedItem()+""),//2
                                cmbJam.getSelectedItem()+":"+cmbMnt.getSelectedItem()+":"+cmbDtk.getSelectedItem(),//3
                                TSituation.getText(),//4
                                TBackground.getText(),//5
                                TAssesment.getText(),//6
                                TRecommendation.getText(),//7
                                KdPeg2.getText(),//8
                                Tulis.getText(),//9
                                Baca.getSelectedItem().toString(),//10
                                Konfirmasi.getSelectedItem().toString(),//11
                                KdDPJP.getText()//12                                     
                            });
    ...
    private void BtnVerifSbarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnVerifSbarActionPerformed
        if(TNoRw.getText().trim().equals("") ){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            DlgSBARRanap soap=new DlgSBARRanap(null,false);
    ...
    private void BtnLihatStatusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnLihatStatusActionPerformed
        if(TNoRw.getText().trim().equals("") ){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
    ...
    }//GEN-LAST:event_BtnLihatStatusActionPerformed
...
if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
    ...
    private void BtnSimpanSoap1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanSoap1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnSimpanSoap1ActionPerformed

    private void BtnSimpanSoap1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnSimpanSoap1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnSimpanSoap1KeyPressed

    private void BtnKonsulDPJPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKonsulDPJPActionPerformed
        if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
...
//                        tbKamIn.getValueAt(tbKamIn.getSelectedRow(),2).toString(),internalFrame1.getWidth(),internalFrame1.getHeight());
        ...
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnKonsulDPJPActionPerformed
    ...
    private void BtnMEOWS2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnMEOWS2ActionPerformed
        if(TNoRw.getText().trim().equals("") ){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            DlgEOWS eows=new DlgEOWS(null,false);
            eows.setNoRawat(TNoRw.getText(),TNoRw.getText());
            eows.setSize(internalFrame1.getWidth(),internalFrame1.getHeight());
            eows.setLocationRelativeTo(internalFrame1);
            eows.setVisible(true);
            this.setCursor(Cursor.getDefaultCursor());
        }
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnMEOWS2ActionPerformed

    private void BtnImplementasiKepActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnImplementasiKepActionPerformed
        if(TNoRw.getText().trim().equals("") ){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            DlgImplementasi dlgimplementasi=new DlgImplementasi(null,false);
            dlgimplementasi.setNoRawat(TNoRw.getText(),TNoRw.getText());
            dlgimplementasi.setSize(internalFrame1.getWidth(),internalFrame1.getHeight());
            dlgimplementasi.setLocationRelativeTo(internalFrame1);
            dlgimplementasi.setVisible(true);
            this.setCursor(Cursor.getDefaultCursor());
        }
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnImplementasiKepActionPerformed

    private void BtnGrafikTTVActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnGrafikTTVActionPerformed
        //       tampilPemeriksaan();
        //       grafikttv kas=new grafikttv("Grafik TTV Pasien "+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+" S.D. "+Valid.SetTgl(DTPCari2.getSelectedItem()+""),"where pemeriksaan_ranap.tgl_perawatan between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' ");
        //       kas.setSize(this.getWidth(), this.getHeight());
        //       kas.setLocationRelativeTo(this);
        //       kas.setVisible(true);
        String teststr = TNoRw.getText();
        String strurl="http://192.168.0.1/webapps/sirs/grafik/?url=suhu/"+teststr;
    ...
    private void BtnStatusVerifikasiSoapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnStatusVerifikasiSoapActionPerformed
        if(TNoRw.getText().trim().equals("") ){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
    ...
    }//GEN-LAST:event_BtnStatusVerifikasiSoapActionPerformed

    private void BtnAntarFaskes2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAntarFaskes2ActionPerformed
        if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            DataPasienIntegration iemr=new DataPasienIntegration(null,false);
    ...
    }//GEN-LAST:event_BtnAntarFaskes2ActionPerformed
    ...
    int selectedRow = tbPemeriksaanSbar.getSelectedRow();
    
    if (selectedRow == -1) {
        JOptionPane.showMessageDialog(null, "Silakan pilih salah satu data SBAR yang ingin diverifikasi.");
        return;
    }

    String noRawat = getValueAt(selectedRow, 1); // no_rawat
    String tglPerawatan = getValueAt(selectedRow, 4); // tgl_perawatan
    String jamRawat = getValueAt(selectedRow, 5); // jam_rawat
    

    if (noRawat.isEmpty() || tglPerawatan.isEmpty() || jamRawat.isEmpty()) {
        JOptionPane.showMessageDialog(null, "Data SBAR tidak lengkap.");
        return;
    }

    String kdDpjp = getKodeDPJP(noRawat, tglPerawatan, jamRawat);

    if (kdDpjp == null) {
        JOptionPane.showMessageDialog(null, "Data pemeriksaan SBAR tidak ditemukan.");
        return;
    }

    if (!akses.getkode().equals(kdDpjp)) {
        JOptionPane.showMessageDialog(null, "Hanya DPJP yang dapat membuka form verifikasi SBAR ini.");
        return;
    }

    this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
    try {
        if (simpanValidasi(noRawat, tglPerawatan, jamRawat)) {
            Baca.setSelectedItem("Sudah");
            Konfirmasi.setSelectedItem("Sudah");

            JOptionPane.showMessageDialog(null, "SBAR berhasil diverifikasi.");
    ...
    JOptionPane.showMessageDialog(null, "Gagal menyimpan data verifikasi.");
}
    } finally {
        this.setCursor(Cursor.getDefaultCursor());
    }
...
// Ambil nilai dari tabel dengan aman
private String getValueAt(int row, int col) {
    Object value = tbPemeriksaanSbar.getValueAt(row, col);
    return value != null ? value.toString().trim() : "";
}

// Ambil kode DPJP dari database
private String getKodeDPJP(String noRawat, String tgl, String jam) {
    PreparedStatement ps = null;
    ResultSet rs = null;
    try {
        ps = koneksi.prepareStatement(
            "SELECT kd_dpjp FROM pemeriksaan_ranap_sbar WHERE no_rawat=? AND tgl_perawatan=? AND jam_rawat=?"
        );
        ...
        rs = ps.executeQuery();
        if (rs.next()) {
            return rs.getString("kd_dpjp");
        }
    } catch (Exception e) {
        System.out.println("Notifikasi getKodeDPJP: " + e);
    } finally {
        try {
            if (rs != null) rs.close();
            if (ps != null) ps.close();
        } catch (Exception ex) {
            System.out.println("Notifikasi close rs/ps: " + ex);
        }
    }
    return null;
}

// Simpan validasi SBAR
private boolean simpanValidasi(String noRawat, String tglPerawatan, String jamRawat) {
    String tanggalValidasi = Valid.SetTgl(DTPTgl.getSelectedItem() + "");
    String jamValidasi = cmbJam.getSelectedItem() + ":" + cmbMnt.getSelectedItem() + ":" + cmbDtk.getSelectedItem();

    return Sequel.menyimpantf("validasi_pemeriksaan_sbar_ranap", 
        "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", 
        "No.Rawat", 15, new String[]{
            noRawat,                        // 1
            tglPerawatan,                  // 2
            jamRawat,                      // 3
            TSituation.getText(),          // 4
    ...
    */
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRawatInap dialog = new DlgRawatInap(null, true);
    ...
    private widget.Button BtnAntarFaskes2;
    ...
    private widget.Button BtnImplementasiKep;
    ...
    private widget.Button BtnKonsulDPJP;
    private widget.Button BtnKonsultasi;
    private widget.Button BtnLihatStatus;
    private widget.Button BtnMEOWS2;
    ...
    private widget.Button BtnSimpanSoap1;
    ...
    public void tampilDr() {
        ...
        final boolean pencarianNoRawatExactV52=memuatNoRawatExactV52&&
                TNoRw.getText()!=null&&!TNoRw.getText().trim().equals("");
        final long mulaiExactV52=pencarianNoRawatExactV52?System.nanoTime():0L;
        try{
            if(pencarianNoRawatExactV52){
                // V52 - initial load dari DlgKamarInap sudah memiliki no_rawat pasti.
                // Jalur ini menghindari LIKE '%...%' + OR yang berat tanpa mengubah pencarian manual.
                ps=koneksi.prepareStatement("select rawat_inap_dr.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                   ...
                   "and rawat_inap_dr.kd_jenis_prw=jns_perawatan_inap.kd_jenis_prw "+
                   "and rawat_inap_dr.kd_dokter=dokter.kd_dokter "+
                   "where rawat_inap_dr.no_rawat=? and rawat_inap_dr.tgl_perawatan between ? and ? "+
                   "order by rawat_inap_dr.tgl_perawatan,rawat_inap_dr.jam_rawat desc");
            }else if(TCari.getText().equals("")&&TCariPasien.getText().equals("")){
                ps=koneksi.prepareStatement("select rawat_inap_dr.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                   "concat(rawat_inap_dr.kd_jenis_prw,' ',jns_perawatan_inap.nm_perawatan),rawat_inap_dr.kd_dokter,dokter.nm_dokter,"+
                   "rawat_inap_dr.tgl_perawatan,rawat_inap_dr.jam_rawat,rawat_inap_dr.biaya_rawat,rawat_inap_dr.kd_jenis_prw, " +
                   "rawat_inap_dr.tarif_tindakandr,rawat_inap_dr.kso,rawat_inap_dr.material,rawat_inap_dr.bhp,rawat_inap_dr.menejemen "+
        ...
        LCount.setText(""+tabModeDr.getRowCount());
        if(pencarianNoRawatExactV52){
            System.out.println("[PERFORMA RAWAT INAP V52] tampilDr exact no_rawat: "+
                    ((System.nanoTime()-mulaiExactV52)/1_000_000L)+" ms | baris="+tabModeDr.getRowCount());
        }
    }
    ...
    public void setNoRm(String norwt,Date awal,Date akhir) {
        ...
        try{
            ...
            sedangMengisiNoRawat=false;
        }
        // Satu-satunya pemuatan tabel saat pasien disiapkan melalui setNoRm.
        // V52: khusus initial load, tampilDr memakai no_rawat exact; pencarian manual tetap lama.
        final long mulaiSetNoRmV52=System.nanoTime();
        memuatNoRawatExactV52=true;
        try{
            TabRawatMouseClicked(null);
        }finally{
            memuatNoRawatExactV52=false;
        }
        System.out.println("[PERFORMA RAWAT INAP V52] load tabel setNoRm: "+
                ((System.nanoTime()-mulaiSetNoRmV52)/1_000_000L)+" ms");
    }
    ...
    private void isForm(){
        if(ChkInput.isSelected()==true){
            ...
            PanelInput1.setPreferredSize(new Dimension(WIDTH,282));
...
/*        BtnPenilaianUlangNyeri.setVisible(akses.getpenilaian_ulang_nyeri()); 
        ...
        buttonList.add(BtnPermintaanStok);
        buttonList.add(BtnPermintaanResepPulang);
        buttonList.add(BtnImplementasiKep);
        buttonList.add(BtnBerkasDigital);
        buttonList.add(BtnKonsultasi);
        ...
        buttonList.add(BtnDiagnosa);
        buttonList.add(BtnVerifikasiSOAP);        
        buttonList.add(BtnPEWS);
        buttonList.add(BtnEWS2);
        buttonList.add(BtnMEOWS2);
        buttonList.add(BtnKonsulDPJP);
        buttonList.add(BtnGrafikTTV);
        buttonList.add(BtnVitalSign);
        buttonList.add(BtnStatusVerifikasiSoap);
        buttonList.add(BtnAntarFaskes2);
        buttonList.add(BtnAwalKeperawatanUmum);
        ...
        buttonList.add(BtnPerencanaanPemulangan);
        buttonList.add(BtnPenilaianLanjutanResikoJatuhDewasa);
        buttonList.add(BtnPenilaianLanjutanResikoJatuhAnak);
        buttonList.add(BtnPenilaianLanjutanResikoJatuhLansia);
        buttonList.add(BtnPenilaianLanjutanResikoJatuhNeonatus);
        buttonList.add(BtnPenilaianLanjutanResikoJatuhGeriatri);
        buttonList.add(BtnPenilaianLanjutanResikoJatuhPsikiatri);
        buttonList.add(BtnPenilaianLanjutanSkriningFungsional);
        buttonList.add(BtnPenilaianResikoDekubitus);
        buttonList.add(BtnHasilPemeriksaanUSG);
        buttonList.add(BtnDokumentasiESWL);
        buttonList.add(BtnCatatan);
        buttonList.add(BtnCatatanObservasiRanap);
        buttonList.add(BtnCatatanObservasiRanapKebidanan);
        buttonList.add(BtnCatatanObservasiRanapPostPartum);
        buttonList.add(BtnFollowUpDBD);
        ...
        buttonList.add(BtnChecklistKriteriaKeluarHCU);
        buttonList.add(BtnChecklistKriteriaMasukICU);
        buttonList.add(BtnChecklistKriteriaKeluarICU);
        ...
        buttonList.add(BtnPenilaianKecemasanAnak);
    ...
    private void isForm3(){
        if(ChkInput2.isSelected()==true){
            ...
            PanelInput3.setPreferredSize(new Dimension(WIDTH,738));
...
//                "pemeriksaan_ranap_sbar.tulis,pemeriksaan_ranap_sbar.baca,pemeriksaan_ranap_sbar.konfirmasi from pasien inner join reg_periksa on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
...
//        LCount.setText(""+tabModePemeriksaanSbar.getRowCount());
    ...
    String query =
        "SELECT psbar.no_rawat, reg.no_rkm_medis, p.nm_pasien, " +
        "psbar.tgl_perawatan, psbar.jam_rawat, psbar.situation, psbar.background, " +
        "psbar.assesment, psbar.recommendation, psbar.nip, pg.nama, pg.jbtn, " +
        "psbar.tulis, psbar.baca, psbar.konfirmasi,psbar.kd_dpjp " +
        "FROM pasien p " +
        "INNER JOIN reg_periksa reg ON reg.no_rkm_medis = p.no_rkm_medis " +
        "INNER JOIN pemeriksaan_ranap_sbar psbar ON psbar.no_rawat = reg.no_rawat " +
        "INNER JOIN pegawai pg ON psbar.nip = pg.nik " +
        "WHERE psbar.tgl_perawatan BETWEEN ? AND ? " +
        "AND reg.no_rkm_medis LIKE ? ";

    if (!TCari.getText().trim().equals("")) {
        query += "AND (psbar.no_rawat LIKE ? OR reg.no_rkm_medis LIKE ? OR p.nm_pasien LIKE ? OR " +
                 "psbar.situation LIKE ? OR psbar.background LIKE ? OR psbar.assesment LIKE ? OR " +
                 "psbar.recommendation LIKE ?) ";
    }

    query += "ORDER BY psbar.no_rawat, psbar.tgl_perawatan, psbar.jam_rawat DESC";

    try {
        ps7 = koneksi.prepareStatement(query);
        ps7.setString(1, Valid.SetTgl(DTPCari1.getSelectedItem() + ""));
        ps7.setString(2, Valid.SetTgl(DTPCari2.getSelectedItem() + ""));
        ps7.setString(3, "%" + TCariPasien.getText().trim() + "%");

        if (!TCari.getText().trim().equals("")) {
            String cari = "%" + TCari.getText().trim() + "%";
            ps7.setString(4, cari);
            ps7.setString(5, cari);
            ps7.setString(6, cari);
            ps7.setString(7, cari);
            ps7.setString(8, cari);
            ps7.setString(9, cari);
            ps7.setString(10, cari);
        }
        ...
        while (rs.next()) {
            tabModePemeriksaanSbar.addRow(new Object[]{
                ...
                rs.getString("tulis"), 
                rs.getString("baca"),
                rs.getString("konfirmasi"),
                rs.getString("kd_dpjp")
            });
        }
    } catch (Exception e) {
        System.out.println("Notifikasi tampilPemeriksaanSbar: " + e);
    } finally {
        try {
            if (rs != null) rs.close();
            if (ps7 != null) ps7.close();
        } catch (Exception e) {
            System.out.println("Notifikasi close ps7/rs: " + e);
        }
    }
