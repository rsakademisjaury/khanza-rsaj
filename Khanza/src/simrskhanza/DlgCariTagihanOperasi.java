...
public class DlgCariTagihanOperasi extends javax.swing.JDialog {
    ...
    private String Suspen_Piutang_Operasi_Ranap="",Operasi_Ranap="",Beban_Jasa_Medik_Dokter_Operasi_Ranap="",Utang_Jasa_Medik_Dokter_Operasi_Ranap="",
            ...
            finger="",kodeoperator="",komplikasi="",pendarahan="",transfusi="",implant="",residen="",tindakan="",operator1="",FileName = "", kodeberkas = "";
    ...
    public DlgCariTagihanOperasi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
                ...
                "Laporan Operasi","Komplikasi","Pendarahan","Transfusi","Implant","Residen","Tindakan Operasi"
            }){
        ...
        Transfusi.setDocument(new batasInput((int)100).getKata(Transfusi));
        Residen.setDocument(new batasInput((int)100).getKata(Residen));
    ...
    private void initComponents() {
        ...
        label14.setText("Dokter Bedah 1 :");
        ...
        label19.setText("Dokter Bedah 2 :");
        ...
        label20.setText("Dokter Bedah 3 :");
        ...
        label31.setText("Perawat Sirkular 1 :");
        ...
        label38.setText("Perawat Sirkular 4 :");
        ...
        label39.setText("Perawat Sirkular 5 :");
        ...
        Scroll3.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1), "Laporan Operasi :", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        panelGlass7.setPreferredSize(new java.awt.Dimension(1000, 200));
        ...
        label12.setBounds(15, 40, 130, 23);
        ...
        jLabel6.setBounds(15, 100, 180, 23);
        ...
        jLabel7.setBounds(15, 130, 180, 23);
        ...
        jLabel8.setBounds(15, 160, 180, 23);
        ...
        jLabel9.setBounds(15, 70, 130, 23);
        ...
        jLabel19.setBounds(590, 10, 120, 23);
        ...
        jLabel20.setBounds(590, 40, 120, 23);
        ...
        jLabel21.setBounds(590, 70, 120, 23);
        ...
        jLabel23.setBounds(590, 100, 120, 23);
        ...
        jLabel16.setBounds(590, 130, 120, 23);
        ...
        jLabel24.setBounds(590, 160, 120, 23);
        ...
        label16.setHorizontalTextPosition(javax.swing.SwingConstants.LEFT);
        label16.setName("label16"); // NOI18N
        label16.setPreferredSize(new java.awt.Dimension(70, 23));
        panelGlass7.add(label16);
        label16.setBounds(15, 10, 130, 23);
    ...
    if(tbDokter.getSelectedRow()>-1){
        if(!tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString().equals("")){
            if(Sequel.cariRegistrasi(tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString())>0){
                ...
                JOptionPane.showMessageDialog(rootPane,"Akun Dokter Tidak Bisa Menghapus..!!");
                TCari.requestFocus();
            }else{
    ...
    private void MnLaporanOperasiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanOperasiActionPerformed
        if(tbDokter.getSelectedRow()>-1){
            if(!tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString().equals("")){
                ...
                //tanda tangan dokter
                operator1=Sequel.cariIsi("select operasi.operator1 from operasi where operasi.no_rawat='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString()+"' and tgl_operasi='"+tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString()+"'");
                param.put("kd_dokter",Sequel.cariIsi("select nm_dokter from dokter where kd_dokter=?",operator1));            
                param.put("ttd","http://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/tandatangandokter/pages/upload/"+operator1+".png");
...
//                param.put("finger","Dikeluarkan di "+akses.getnamars()+", Kabupaten/Kota "+akses.getkabupatenrs()+"\nDitandatangani secara elektronik oleh "+tbDokter.getValueAt(tbDokter.getSelectedRow()+1,5).toString()+"\nID "+(finger.equals("")?kodeoperator:finger)+"\n"+Valid.SetTgl3(tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString()));  
    ...
    private void MnUbahLaporanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnUbahLaporanActionPerformed
        if(tbDokter.getSelectedRow()>-1){
            if(!tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString().equals("")){
                try {
                    rs2=koneksi.prepareStatement(
                        "select diagnosa_preop, diagnosa_postop, jaringan_dieksekusi, selesaioperasi, permintaan_pa, laporan_operasi, komplikasi, pendarahan, transfusi, implant, residen, tindakan from laporan_operasi "+
                    ...
                    if(rs2.next()){
                        ...
                        Transfusi.setText(rs2.getString("transfusi"));
                        Implant.setText(rs2.getString("implant"));
                        Residen.setText(rs2.getString("residen"));
                        Tindakan.setText(rs2.getString("tindakan"));
                    }
                    if(rs2!=null){
                        rs2.close();
                    }
    ...
    private void BtnUploadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnUploadActionPerformed
        ...
        FileName = timestamp + "_" + tbDokter.getValueAt(tbDokter.getSelectedRow(), 1).toString().replace("/", "") + "_LaporanOperasi";
    ...
    private void prosesCari(String sql) {
       Valid.tabelKosong(tabMode);
        try{
            ...
            while(rs.next()){
                total=0;
                diagnosa_preop="";diagnosa_postop="";jaringan_dieksekusi="";selesaioperasi="";permintaan_pa="";laporan_operasi="";komplikasi="";pendarahan="";transfusi="";implant="";residen="";tindakan="";
                rs2=koneksi.prepareStatement(
                        "select diagnosa_preop, diagnosa_postop, jaringan_dieksekusi, selesaioperasi, permintaan_pa, laporan_operasi, komplikasi, pendarahan, transfusi, implant, residen, tindakan "+
                ...
                if(rs2.next()){
                    ...
                    pendarahan=rs2.getString("pendarahan");
                    transfusi=rs2.getString("transfusi");
                    implant=rs2.getString("implant");
                    residen=rs2.getString("residen");
                ...
                tabMode.addRow(new Object[]{
                    ...
                    "Perawatan","Dokter Bedah 1","Dokter Bedah 2","Dokter Bedah 3","Perawat Scrub 1","Perawat Scrub 2","Perawat Scrub 3","Assisten","Dokter Anak",
                    "Perawat Resusitas","Dokter Anestesi","Asisten Anestesi 1","Asisten Anestesi 2","Bidan 1","Bidan 2","Bidan 3","Perawat Luar","Perawat Sirkuler 1",
                    "Perawat Sirkuler 2","Perawat Sirkuler 3","Perawat Sirkuler 4","Perawat Sirkuler 5","Sewa OK/VK","Alat","Akomodasi","N.M.S.","Sarpras","Dokter PJ Anak","Dokter Umum","Biaya Perawatan",
                    diagnosa_preop,diagnosa_postop,jaringan_dieksekusi,permintaan_pa,selesaioperasi,laporan_operasi,komplikasi,pendarahan,transfusi,implant,residen,tindakan
                });     
                rs2=koneksi.prepareStatement(
                        "select operasi.operator1, operasi.operator2, operasi.operator3, operasi.asisten_operator1,"+
                        "operasi.asisten_operator2,operasi.asisten_operator3, operasi.instrumen, operasi.dokter_anak, operasi.perawaat_resusitas, "+
...
private void CreatePDF(String FileName) {
    if (tbDokter.getSelectedRow() == -1) {
        ...
        // Mengambil data dari tabel dan database untuk dijadikan parameter laporan
        String noRawat = tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString();
        String tglOperasi = tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString();
//        String kdDokter = Sequel.cariIsi("select operasi.operator1 from operasi where operasi.no_rawat=? and operasi.tgl_operasi=?", noRawat, tglOperasi);
        param.put("kd_dokter",Sequel.cariIsi("select nm_dokter from dokter where kd_dokter=?",operator1));
        param.put("namars",akses.getnamars());
                param.put("alamatrs",akses.getalamatrs());
                param.put("kotars",akses.getkabupatenrs());
...
//                param.put("finger","Dikeluarkan di "+akses.getnamars()+", Kabupaten/Kota "+akses.getkabupatenrs()+"\nDitandatangani secara elektronik oleh "+tbDokter.getValueAt(tbDokter.getSelectedRow()+1,5).toString()+"\nID "+(finger.equals("")?kodeoperator:finger)+"\n"+Valid.SetTgl3(tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString()));  
        ...
        // Menyiapkan dan menjalankan laporan
        Valid.MyReportPDFqryUpload("rptLaporanOperasi.jasper", "report", "::[ Laporan Operasi ]::",
             "SELECT "
             + "operasi.no_rawat,"
             ...
             + "laporan_operasi.residen,laporan_operasi.komplikasi,laporan_operasi.pendarahan,laporan_operasi.transfusi,"
             + "laporan_operasi.implant,laporan_operasi.tindakan,"
             ...
             + "( SELECT nama FROM petugas WHERE petugas.nip = operasi.asisten_operator1 ) as asistenoperator1,"
             + "( SELECT nama FROM petugas WHERE petugas.nip = operasi.asisten_operator2 ) as asistenoperator2,"
             + "( SELECT nama FROM petugas WHERE petugas.nip = operasi.asisten_operator3 ) as asistenoperator3,"
             + "( SELECT nama FROM petugas WHERE petugas.nip = operasi.instrumen ) as instrumen,"
             + "( SELECT nm_dokter FROM dokter WHERE dokter.kd_dokter = operasi.dokter_anak ) as dokteranak,"
             + "( SELECT nama FROM petugas WHERE petugas.nip = operasi.perawaat_resusitas )as perawatresusitas,"
             + "( SELECT nm_dokter FROM dokter WHERE dokter.kd_dokter = operasi.dokter_anestesi ) as anastesi,"
             + "( SELECT nama FROM petugas WHERE petugas.nip = operasi.asisten_anestesi ) as asistenanastesi,"
             + "( SELECT nama FROM petugas WHERE petugas.nip = operasi.asisten_anestesi2 ) as asistenanastesi2,"
             + "( SELECT nama FROM petugas WHERE petugas.nip = operasi.bidan ) as bidan1,"
             + "( SELECT nama FROM petugas WHERE petugas.nip = operasi.bidan2 ) as bidan2,"
             + "( SELECT nama FROM petugas WHERE petugas.nip = operasi.bidan3 ) as bidan3,"
             + "( SELECT nama FROM petugas WHERE petugas.nip = operasi.perawat_luar ) as perawatluar,"
             ...
             + "( SELECT nm_dokter FROM dokter WHERE dokter.kd_dokter = operasi.dokter_pjanak ) as pjanak,"
             + "( SELECT nm_dokter FROM dokter WHERE dokter.kd_dokter = operasi.dokter_umum ) as dokumum "
             + "from operasi inner join reg_periksa on operasi.no_rawat=reg_periksa.no_rawat "
             + "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join laporan_operasi "
             + "on operasi.no_rawat=laporan_operasi.no_rawat and operasi.tgl_operasi=laporan_operasi.tanggal "
            + "WHERE operasi.no_rawat = '" + noRawat + "' AND operasi.tgl_operasi = '" + tglOperasi + "'",
            FileName, param);
    ...
    try {
        ...
        for (File jpgFile : jpgFiles) {
            ...
            try {
                ...
                boolean uploadSuccess = false;
                kodeberkas = Sequel.cariIsi("SELECT kode FROM master_berkas_digital WHERE nama LIKE '%LAPORAN OPERASI%'");
                ...
                if (Sequel.cariInteger("SELECT COUNT(no_rawat) AS jumlah FROM berkas_digital_perawatan WHERE lokasi_file='" + filePath + "'") > 0) {
                    uploadSuccess = Sequel.mengedittf("berkas_digital_perawatan", "lokasi_file=?", "no_rawat=?,kode=?, lokasi_file=?", 4, new String[]{
                        tbDokter.getValueAt(tbDokter.getSelectedRow(), 1).toString().trim(), kodeberkas, filePath, filePath
                    });
                } else {
                    uploadSuccess = Sequel.menyimpantf("berkas_digital_perawatan", "?,?,?", "No.Rawat", 3, new String[]{
                        tbDokter.getValueAt(tbDokter.getSelectedRow(), 1).toString().trim(), kodeberkas, filePath
                    });
                }
                ...
                if (uploadSuccess) {
                    ...
                    MetadataBerkas.simpan(
                        koneksi,
                        tbDokter.getValueAt(tbDokter.getSelectedRow(), 1).toString().trim(),
                        kodeberkas,
                        filePath,
                        jpgFile.getName(),
                        akses.getkode()
...
//            uploadSuccess = Sequel.mengedittf("berkas_digital_perawatan", "lokasi_file=?", "no_rawat=?,kode=?, lokasi_file=?", 4, new String[]{
//                tbDokter.getValueAt(tbDokter.getSelectedRow(), 1).toString().trim(), kodeberkas, "pages/upload/" + FileName + ".jpg", "pages/upload/" + FileName + ".jpg"
//            });
//        } else {
//            uploadSuccess = Sequel.menyimpantf("berkas_digital_perawatan", "?,?,?", "No.Rawat", 3, new String[]{
//                tbDokter.getValueAt(tbDokter.getSelectedRow(), 1).toString().trim(), kodeberkas, "pages/upload/" + FileName + ".jpg"
//            });
//        }
//        
//        if (uploadSuccess) {
