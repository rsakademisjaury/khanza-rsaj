 ...
 * @author dosen
 */
public final class DlgPeriksaEcho extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgPeriksaEcho(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPeriksaEcho dialog = new DlgPeriksaEcho(new javax.swing.JFrame(), true);
