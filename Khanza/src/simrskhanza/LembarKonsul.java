...
//        
    ...
    private void initComponents() {
        ...
        jMenuItem1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/resumeri.png"))); // NOI18N
        jMenuItem1.setText("Cetak Lembar Permintaan");
        jMenuItem1.setName("jMenuItem1"); // NOI18N
        jMenuItem1.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/resumeri.png"))); // NOI18N
        ...
        jMenuItem2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/resumeri.png"))); // NOI18N
        jMenuItem2.setText("Cetak Lembar Jawaban Konsul");
        jMenuItem2.setName("jMenuItem2"); // NOI18N
        jMenuItem2.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/resumeri.png"))); // NOI18N
        ...
        setTitle("Form Konsultasi Antar Poliklinik");
        setMaximumSize(new java.awt.Dimension(1135, 600));
        setMinimumSize(new java.awt.Dimension(1135, 572));
        setPreferredSize(new java.awt.Dimension(1135, 572));
        setResizable(false);
        setSize(new java.awt.Dimension(1135, 572));
        ...
        internalFrame1.setMinimumSize(new java.awt.Dimension(1135, 572));
        internalFrame1.setName("internalFrame1"); // NOI18N
        internalFrame1.setPreferredSize(new java.awt.Dimension(1135, 572));
        internalFrame1.setLayout(new java.awt.BorderLayout());

        TabRawat.setBackground(new java.awt.Color(254, 255, 254));
        TabRawat.setMaximumSize(new java.awt.Dimension(1135, 600));
        TabRawat.setMinimumSize(new java.awt.Dimension(1135, 600));
        TabRawat.setName("TabRawat"); // NOI18N
        TabRawat.setPreferredSize(new java.awt.Dimension(1135, 600));
        ...
        internalFrame2.setMinimumSize(new java.awt.Dimension(1150, 500));
        internalFrame2.setName("internalFrame2"); // NOI18N
        internalFrame2.setPreferredSize(new java.awt.Dimension(1150, 500));
        ...
        tbKomplikasiKehamilanSebelumnya.setMinimumSize(new java.awt.Dimension(1150, 300));
        tbKomplikasiKehamilanSebelumnya.setName("tbKomplikasiKehamilanSebelumnya"); // NOI18N
        tbKomplikasiKehamilanSebelumnya.setPreferredSize(new java.awt.Dimension(1150, 300));
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "14-06-2024 10:26:25" }));
        ...
        scrollPane2.setBounds(380, 370, 350, 100);

        jLabel31.setForeground(new java.awt.Color(0, 0, 0));
        jLabel31.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel31.setText("Jawab Konsultasi Antar Poliklinik");
        jLabel31.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel31.setName("jLabel31"); // NOI18N
        tbKomplikasiKehamilanSebelumnya.add(jLabel31);
        jLabel31.setBounds(20, 240, 330, 40);
        ...
        jLabel32.setBounds(380, 350, 100, 23);
        ...
        scrollPane3.setBounds(740, 370, 370, 100);
        ...
        jLabel33.setBounds(740, 350, 100, 23);
        ...
        jLabel15.setBounds(20, 290, 70, 23);
        ...
        kd_poli.setBounds(90, 70, 108, 24);
        ...
        TglAsuhan1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "14-06-2024 10:26:26" }));
        ...
        TglAsuhan1.setBounds(80, 290, 140, 20);
        ...
        scrollPane7.setBounds(20, 370, 350, 100);
        ...
        jLabel35.setBounds(20, 350, 130, 23);
        ...
        label19.setBounds(20, 320, 70, 23);
        ...
        diagnosa_jawaban.setBounds(80, 320, 890, 23);
        ...
        BtnCopirawat.setBounds(970, 320, 140, 20);

        internalFrame2.add(tbKomplikasiKehamilanSebelumnya, java.awt.BorderLayout.WEST);
        ...
        Scroll.setMinimumSize(new java.awt.Dimension(1135, 600));
        Scroll.setName("Scroll"); // NOI18N
        Scroll.setPreferredSize(new java.awt.Dimension(1135, 600));
        ...
        internalFrame1.add(TabRawat, java.awt.BorderLayout.WEST);

        panelGlass8.setMinimumSize(new java.awt.Dimension(1150, 50));
        panelGlass8.setName("panelGlass8"); // NOI18N
        panelGlass8.setPreferredSize(new java.awt.Dimension(1150, 50));
        ...
        BtnSimpan.setBounds(10, 10, 100, 30);
        ...
        BtnPrint.setBounds(120, 10, 100, 30);
        ...
        BtnAll.setBounds(220, 10, 100, 30);
        ...
        BtnKeluar.setBounds(330, 10, 100, 30);
...
//                if(Sequel.mengedittf("rujukan_internal_poli",
//                        "no_rawat=?",
//                        "no_rawat=?,"
//                        +"kd_dokter=?,"
//                        +"kd_poli=?,"
...
Valid.editTable(tabMode,"rujukan_internal_poli","no_rawat",TNoRw," hasil='"+hasil.getText()+"'");
Valid.editTable(tabMode,"rujukan_internal_poli","no_rawat",TNoRw," diagnosa_jawaban='"+diagnosa_jawaban.getText()+"'");
...
//+ "rujukan_internal_poli.kd_dokter,dokter.nm_dokter,rujukan_internal_poli.kd_dokter2,rujukan_internal_poli.nama_dokter2,rujukan_internal_poli.catatan,rujukan_internal_poli.isi_permintaan,rujukan_internal_poli.hasil,rujukan_internal_poli.diagnosa_jawaban,"
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                    ...
                    + "rujukan_internal_poli.isi_permintaan,"//19
                    + "rujukan_internal_poli.hasil,"//20        
                    + "rujukan_internal_poli.diagnosa_jawaban "//21
...
//        ChkInput.setSelected(true);      
    ...
    public void isCek(){
        if(akses.getjml2()>=1){
            ...
            Sequel.cariIsi("select isi_permintaan from rujukan_internal_poli where no_rawat=?", isi_permintaan, TNoRw.getText());
            Sequel.cariIsi("select jawab_permintaan from rujukan_internal_poli where no_rawat=?", jawab_permintaan, TNoRw.getText());
            Sequel.cariIsi("select saran_tindakan from rujukan_internal_poli where no_rawat=?", saran_tindakan, TNoRw.getText());
            Sequel.cariIsi("select hasil from rujukan_internal_poli where no_rawat=?", hasil, TNoRw.getText());
            Sequel.cariIsi("select diagnosa_jawaban from rujukan_internal_poli where no_rawat=?", diagnosa_jawaban, TNoRw.getText());
//            getData();
//            getKehamilanSebelumnya();
