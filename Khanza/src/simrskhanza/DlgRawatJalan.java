...
import rekammedis.RMRiwayatLaborat;
...
import rekammedis.RMRiwayatPerawatanKlaim;
...
public final class DlgRawatJalan extends javax.swing.JDialog {
    ...
    // PATCH PERFORMA RSAJ - ikon yang sama dipakai bersama.
    // Menghindari pembacaan file open.png/item.png berulang kali saat constructor berjalan.
    private static final javax.swing.ImageIcon IKON_OPEN_RALAN = muatIkonRalan("/picture/open.png");
    private static final javax.swing.ImageIcon IKON_ITEM_RALAN = muatIkonRalan("/picture/item.png");

    private static javax.swing.ImageIcon muatIkonRalan(String lokasi) {
        java.net.URL url = DlgRawatJalan.class.getResource(lokasi);
        return url == null ? new javax.swing.ImageIcon() : new javax.swing.ImageIcon(url);
    }
    
    akses aksesInstance = new akses();
...
//    private Connection koneksi=koneksiDB.condb();
    ...
    public  DlgDataAlergiPasien form=new DlgDataAlergiPasien(null,false);
    public  DlgCariSoap soap=new DlgCariSoap(null,false);
    public  GambarOdontogram cobadisplay=new GambarOdontogram(null,false);
    ...
    // PATCH PERFORMA RSAJ - cegah pencarian otomatis berjalan saat TCari diisi oleh setNoRm().
    private boolean sedangSetNoRm=false;
    // PATCH PERFORMA RSAJ - simpan Timer agar dapat dihentikan saat dialog di-dispose.
    ...
    public DlgRawatJalan(java.awt.Frame parent, boolean modal) {
        ...
        try {
            ...
            javax.swing.JOptionPane.showMessageDialog(this, "Koneksi Putus : " + e.getMessage());
        }
        ...
        if(koneksiDB.CARICEPAT().equals("aktif")){
            TCari.getDocument().addDocumentListener(new javax.swing.event.DocumentListener(){
                ...
                public void insertUpdate(DocumentEvent e) {
                    if(!sedangSetNoRm && TCari.getText().length()>2){
                        TampilkanData();
                    }
                }
                @Override
            ...
            searchField.getDocument().addDocumentListener(new javax.swing.event.DocumentListener() {
                @Override
                public void insertUpdate(DocumentEvent e) {
                            filterButtonsActionPerformed(null);
                }
        ...
        searchField.setText("Pencarian Cepat");
        isMenu();         
        jam();
    ...
    private void initComponents() {
        ...
        BtnResumeIcon = new widget.Button();
        ...
        BtnKonsulAntarPoli = new widget.Button();
        ...
        BtnRiwayatRad = new widget.Button();
        BtnVitalSign = new widget.Button();
        BtnRiwayatCPPT = new widget.Button();
        BtnAntarFaskes = new widget.Button();
        BtnEWS = new widget.Button();
        BtnPEWS = new widget.Button();
        BtnPermintaanKonsultasiMedik = new widget.Button();
        jPanel1 = new javax.swing.JPanel();
        searchField = new widget.TextBox();
        filterButtons = new widget.Button();
        ...
        BtnResumeIcon.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnResumeIcon.setMnemonic('6');
        BtnResumeIcon.setText("Resume Pasien");
        BtnResumeIcon.setToolTipText("Alt+6");
        BtnResumeIcon.setName("BtnResumeIcon"); // NOI18N
        BtnResumeIcon.setPreferredSize(new java.awt.Dimension(125, 30));
        BtnResumeIcon.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnResumeIconActionPerformed(evt);
            }
        });
        BtnResumeIcon.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnResumeIconKeyPressed(evt);
            }
        });
        panelGlass8.add(BtnResumeIcon);

        BtnRiwayatPasien.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnRiwayatPasien.setMnemonic('6');
        BtnRiwayatPasien.setText("Riwayat Perawatan ");
        BtnRiwayatPasien.setToolTipText("Alt+6");
        BtnRiwayatPasien.setName("BtnRiwayatPasien"); // NOI18N
        BtnRiwayatPasien.setPreferredSize(new java.awt.Dimension(150, 30));
        BtnRiwayatPasien.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnRiwayatPasienActionPerformed(evt);
            }
        });
        BtnRiwayatPasien.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnRiwayatPasienKeyPressed(evt);
            }
        });
        panelGlass8.add(BtnRiwayatPasien);
        ...
        TCariPasien.setText("123456");
        TCariPasien.setMinimumSize(new java.awt.Dimension(30, 24));
        TCariPasien.setName("TCariPasien"); // NOI18N
        TCariPasien.setPreferredSize(new java.awt.Dimension(60, 23));
        ...
        TCari.setText("2024/05/28/000198");
        ...
        BtnRiwayatSOAP.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnRiwayatSOAP.setMnemonic('6');
        BtnRiwayatSOAP.setText("Riwayat SOAPIE");
        BtnRiwayatSOAP.setToolTipText("Alt+6");
        BtnRiwayatSOAP.setName("BtnRiwayatSOAP"); // NOI18N
        BtnRiwayatSOAP.setPreferredSize(new java.awt.Dimension(28, 30));
        ...
        jLabel84.setText("NIK/No.Kartu :");
        jLabel84.setName("jLabel84"); // NOI18N
        jLabel84.setPreferredSize(new java.awt.Dimension(80, 23));

        NoKartu.setText("7371082502150001");
        NoKartu.setName("NoKartu"); // NOI18N
        NoKartu.setPreferredSize(new java.awt.Dimension(75, 23));
        ...
        panelGlass9Layout.setHorizontalGroup(
            ...
            .addGroup(panelGlass9Layout.createSequentialGroup()
                ...
                .addComponent(TCariPasien, javax.swing.GroupLayout.PREFERRED_SIZE, 64, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(BtnRiwayatSOAP, javax.swing.GroupLayout.PREFERRED_SIZE, 127, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(65, 65, 65)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(NoKartu, javax.swing.GroupLayout.PREFERRED_SIZE, 116, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(LabelPoli8, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(KdDPJPLayanan, javax.swing.GroupLayout.PREFERRED_SIZE, 75, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(BtnCari3, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        panelGlass9Layout.setVerticalGroup(
            ...
            .addGroup(panelGlass9Layout.createSequentialGroup()
                ...
                .addGroup(panelGlass9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                    ...
                    .addComponent(BtnCari, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(BtnTambahTindakan, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(BtnRiwayatSOAP, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel84, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addComponent(LabelPoli8, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(KdDPJPLayanan, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(BtnCari3, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        KdDok.setBounds(58, 10, 75, 23);

        BtnSeekDokter.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        BtnSeekDokter.setMnemonic('4');
        BtnSeekDokter.setText("Pilih Dokter");
        BtnSeekDokter.setToolTipText("ALt+4");
        BtnSeekDokter.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnSeekDokter.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ...
        BtnSeekDokter.setBounds(440, 10, 110, 23);

        TDokter.setEditable(false);
        TDokter.setHighlighter(null);
        TDokter.setName("TDokter"); // NOI18N
        panelGlass7.add(TDokter);
        TDokter.setBounds(136, 10, 300, 23);
        ...
        kdptg.setBounds(66, 10, 75, 23);

        BtnSeekPetugas.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        BtnSeekPetugas.setMnemonic('5');
        BtnSeekPetugas.setText("Pilih Petugas");
        BtnSeekPetugas.setToolTipText("ALt+5");
        BtnSeekPetugas.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnSeekPetugas.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ...
        BtnSeekPetugas.setBounds(450, 10, 120, 23);
        ...
        TPerawat.setBounds(146, 10, 300, 23);
        ...
        BtnSeekPetugas2.setText("Pilih Petugas");
        BtnSeekPetugas2.setToolTipText("ALt+5");
        BtnSeekPetugas2.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnSeekPetugas2.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ...
        BtnSeekPetugas2.setBounds(450, 40, 120, 23);
        ...
        TPerawat2.setBounds(146, 40, 300, 23);
        ...
        BtnSeekDokter2.setBounds(450, 10, 120, 23);
        ...
        panelGlass12.setMinimumSize(new java.awt.Dimension(1177, 282));
        panelGlass12.setName("panelGlass12"); // NOI18N
        panelGlass12.setPreferredSize(new java.awt.Dimension(1177, 282));
        ...
        jLabel9.setBounds(220, 70, 70, 23);

        jLabel20.setText("Respirasi (/mnt) : ");
        jLabel20.setName("jLabel20"); // NOI18N
        panelGlass12.add(jLabel20);
        jLabel20.setBounds(590, 40, 100, 23);

        jLabel22.setText("GCS (E,V,M) :");
        jLabel22.setName("jLabel22"); // NOI18N
        panelGlass12.add(jLabel22);
        jLabel22.setBounds(750, 40, 70, 23);
        ...
        scrollPane1.setBounds(10, 90, 200, 160);
        scrollPane1.getAccessibleContext().setAccessibleDescription("SUBJEK");
        ...
        jLabel28.setBounds(430, 70, 110, 23);
        ...
        jLabel26.setBounds(640, 70, 60, 23);
        ...
        scrollPane2.setBounds(220, 90, 200, 160);
        ...
        TTinggi.setBounds(990, 10, 55, 23);
        ...
        TRespirasi.setBounds(690, 40, 55, 23);
        ...
        TAlergi.setBounds(260, 40, 133, 23);
        ...
        scrollPane3.setBounds(430, 90, 200, 160);
        scrollPane3.getAccessibleContext().setAccessibleDescription("ASESMEN");
        ...
        scrollPane6.setBounds(640, 90, 200, 160);
        scrollPane6.getAccessibleContext().setAccessibleDescription("PLAN");

        jLabel29.setText("Kesadaran : ");
        jLabel29.setName("jLabel29"); // NOI18N
        panelGlass12.add(jLabel29);
        jLabel29.setBounds(1050, 40, 70, 23);
        ...
        cmbKesadaran.setBounds(1120, 40, 140, 23);
        ...
        jLabel53.setBounds(850, 70, 100, 23);

        scrollPane7.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(204, 204, 204), 1, true));
        scrollPane7.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
        ...
        scrollPane7.setBounds(850, 90, 200, 160);
        scrollPane7.getAccessibleContext().setAccessibleDescription("INSTRUKSI");

        jLabel54.setText("SpO2 (%) :");
        jLabel54.setName("jLabel54"); // NOI18N
        panelGlass12.add(jLabel54);
        jLabel54.setBounds(750, 10, 70, 23);
        ...
        jLabel56.setBounds(1060, 70, 80, 23);
        ...
        scrollPane8.setBounds(1060, 90, 200, 160);
        scrollPane8.getAccessibleContext().setAccessibleDescription("EVALUASI");
        ...
        LingkarPerut.setBounds(1160, 10, 55, 23);

        BtnSeekPegawai2.setBackground(new java.awt.Color(249, 249, 249));
        BtnSeekPegawai2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/inventaris.png"))); // NOI18N
        BtnSeekPegawai2.setMnemonic('4');
        BtnSeekPegawai2.setText("Ambil Data");
        BtnSeekPegawai2.setToolTipText("ALt+4");
        BtnSeekPegawai2.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ...
        panelGlass12.add(BtnSeekPegawai2);
        BtnSeekPegawai2.setBounds(10, 40, 100, 26);

        BtnSeekPegawai3.setBackground(new java.awt.Color(249, 249, 249));
        BtnSeekPegawai3.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnSeekPegawai3.setMnemonic('4');
        BtnSeekPegawai3.setText("Input Alergi Pasien");
        BtnSeekPegawai3.setToolTipText("ALt+4");
        BtnSeekPegawai3.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnSeekPegawai3.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ...
        panelGlass12.add(BtnSeekPegawai3);
        BtnSeekPegawai3.setBounds(115, 40, 140, 26);
        ...
        panelGlass17.setPreferredSize(new java.awt.Dimension(350, 400));
        panelGlass17.setLayout(null);

        scrollPane5.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(102, 102, 102)));
        ...
        scrollPane5.setBounds(20, 80, 380, 50);

        scrollPane9.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(102, 102, 102)));
        ...
        scrollPane9.setBounds(20, 150, 380, 50);

        jLabel88.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel88.setText("Situation :");
        jLabel88.setName("jLabel88"); // NOI18N
        panelGlass17.add(jLabel88);
        jLabel88.setBounds(20, 60, 50, 23);

        jLabel89.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel89.setText("Background :");
        jLabel89.setName("jLabel89"); // NOI18N
        panelGlass17.add(jLabel89);
        jLabel89.setBounds(20, 130, 70, 23);

        scrollPane10.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(102, 102, 102)));
        ...
        scrollPane10.setBounds(450, 80, 380, 50);

        jLabel90.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel90.setText("Asesmen :");
        jLabel90.setName("jLabel90"); // NOI18N
        panelGlass17.add(jLabel90);
        jLabel90.setBounds(450, 60, 90, 23);
        ...
        scrollPane11.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(102, 102, 102)));
        ...
        scrollPane11.setBounds(450, 150, 380, 50);
        ...
        TPegawai2.setBounds(142, 10, 260, 23);
        ...
        KdPeg3.setBounds(450, 40, 100, 23);
        ...
        jLabel70.setBounds(50, 200, 90, 23);
        ...
        BtnVerifSbar.setBounds(560, 200, 28, 23);

        scrollPane12.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(102, 102, 102)));
        ...
        jLabel85.setBounds(450, 10, 130, 23);
        ...
        BtnVerifSbar1.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        ...
        BtnVerifSbar1.setBounds(620, 220, 40, 40);

        jLabel68.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel68.setText("SBAR");
        jLabel68.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel68.setIconTextGap(0);
        jLabel68.setName("jLabel68"); // NOI18N
        panelGlass17.add(jLabel68);
        jLabel68.setBounds(670, 240, 100, 20);

        jLabel69.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel69.setText("Status Verifikasi");
        jLabel69.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel69.setIconTextGap(0);
        jLabel69.setName("jLabel69"); // NOI18N
        panelGlass17.add(jLabel69);
        jLabel69.setBounds(670, 220, 100, 20);

        PanelInput4.add(panelGlass17, java.awt.BorderLayout.PAGE_START);
        ...
        internalFrame9.add(PanelContent, java.awt.BorderLayout.CENTER);

        TabRawat.addTab("Riwayat Icare Bpjs", internalFrame9);
        ...
        FormMenu.setPreferredSize(new java.awt.Dimension(135, 2000));
        ...
        BtnResepObat.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnResepObat.setText("Input Resep");
        BtnResepObat.setAutoscrolls(true);
        ...
        BtnCopyResep.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnCopyResep.setText("Copy Resep");
        BtnCopyResep.setAutoscrolls(true);
        ...
        BtnKonsulAntarPoli.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnKonsulAntarPoli.setText("Rujukan Antar Poli");
        BtnKonsulAntarPoli.setAutoscrolls(true);
        BtnKonsulAntarPoli.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnKonsulAntarPoli.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnKonsulAntarPoli.setIconTextGap(8);
        BtnKonsulAntarPoli.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnKonsulAntarPoli.setName("BtnKonsulAntarPoli"); // NOI18N
        BtnKonsulAntarPoli.setPreferredSize(new java.awt.Dimension(1000, 30));
        BtnKonsulAntarPoli.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnKonsulAntarPoliActionPerformed(evt);
            }
        });
        FormMenu.add(BtnKonsulAntarPoli);

        BtnPermintaanLab.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnPermintaanLab.setText("Permintaan Lab");
        BtnPermintaanLab.setAutoscrolls(true);
        ...
        BtnPermintaanRad.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnPermintaanRad.setText("Permintaan Rad");
        BtnPermintaanRad.setAutoscrolls(true);
        ...
        BtnResepLuar.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnResepLuar.setText("Resep Luar");
        BtnResepLuar.setAutoscrolls(true);
        ...
        BtnInputObat.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnInputObat.setText("Input Obat & BHP");
        BtnInputObat.setAutoscrolls(true);
        ...
        BtnTriaseIGD.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnTriaseIGD.setText("Triase IGD");
        BtnTriaseIGD.setAutoscrolls(true);
        ...
        BtnAwalKeperawatanIGD.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnAwalKeperawatanIGD.setText("Awal Keperawatan IGD");
        BtnAwalKeperawatanIGD.setAutoscrolls(true);
        ...
        BtnAwalMedisIGD.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnAwalMedisIGD.setText("Awal Medis IGD");
        BtnAwalMedisIGD.setAutoscrolls(true);
        ...
        BtnAwalMedisIGDPsikiatri.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnAwalMedisIGDPsikiatri.setText("Awal Medis IGD Psikiatri");
        BtnAwalMedisIGDPsikiatri.setAutoscrolls(true);
        ...
        BtnAwalMedisIGDPsikiatri.setIconTextGap(8);
        ...
        BtnAwalMedisIGDPsikiatri.setPreferredSize(new java.awt.Dimension(1000, 30));
        ...
        BtnCatatanObservasiIGD.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnCatatanObservasiIGD.setText("Observasi IGD");
        BtnCatatanObservasiIGD.setAutoscrolls(true);
        ...
        BtnPemantauanPEWSAnak.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnPemantauanPEWSAnak.setText("Pemantauan PEWS Anak");
        BtnPemantauanPEWSAnak.setAutoscrolls(true);
        ...
        BtnPemantauanPEWSDewasa.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnPemantauanPEWSDewasa.setText("Pemantauan EWS Dewasa");
        BtnPemantauanPEWSDewasa.setAutoscrolls(true);
        ...
        BtnPemantauanPEWSDewasa.setIconTextGap(8);
        ...
        BtnPemantauanPEWSDewasa.setPreferredSize(new java.awt.Dimension(1000, 30));
        ...
        BtnTransferAntarRuang.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnTransferAntarRuang.setText("Transfer Antar Ruang");
        BtnTransferAntarRuang.setAutoscrolls(true);
        ...
        BtnVerifikasiSOAP.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnVerifikasiSOAP.setText("Verifikasi SOAP/CPPT");
        BtnVerifikasiSOAP.setAutoscrolls(true);
        ...
        BtnVerifikasiSBAR.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnVerifikasiSBAR.setText("Verifikasi SBAR");
        BtnVerifikasiSBAR.setAutoscrolls(true);
        ...
        BtnBerkasDigital.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnBerkasDigital.setText("Berkas Digital");
        BtnBerkasDigital.setAutoscrolls(true);
        ...
        BtnJadwalOperasi.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnJadwalOperasi.setText("Jadwal Operasi");
        BtnJadwalOperasi.setAutoscrolls(true);
        ...
        BtnKamar.setIcon(IKON_OPEN_RALAN); // NOI18N
        ...
        BtnKamar.setIconTextGap(8);
        BtnKamar.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnKamar.setName("BtnKamar"); // NOI18N
        BtnKamar.setPreferredSize(new java.awt.Dimension(1000, 30));
        ...
        BtnRujukInternal.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnRujukInternal.setText("Konsul Antar Poliklinik");
        BtnRujukInternal.setAutoscrolls(true);
        ...
        BtnAwalKeperawatan.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnAwalKeperawatan.setText("Awal Keperawatan Umum");
        BtnAwalKeperawatan.setAutoscrolls(true);
        ...
        BtnAwalKeperawatanGigi.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnAwalKeperawatanGigi.setText("Awal Keperawatan Gigi");
        BtnAwalKeperawatanGigi.setAutoscrolls(true);
        ...
        BtnAwalKeperawatanKandungan.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnAwalKeperawatanKandungan.setText("Awal Keperawatan Kandungan");
        BtnAwalKeperawatanKandungan.setAutoscrolls(true);
        ...
        BtnAwalKeperawatanKandungan.setIconTextGap(8);
        ...
        BtnAwalKeperawatanKandungan.setPreferredSize(new java.awt.Dimension(1000, 30));
        ...
        BtnAwalKeperawatanAnak.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnAwalKeperawatanAnak.setText("Awal Keperawatan Bayi/Anak");
        BtnAwalKeperawatanAnak.setAutoscrolls(true);
        ...
        BtnAwalKeperawatanPsikiatri.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnAwalKeperawatanPsikiatri.setText("Awal Keperawatan Psikiatri");
        BtnAwalKeperawatanPsikiatri.setAutoscrolls(true);
        ...
        BtnAwalKeperawatanPsikiatri.setIconTextGap(8);
        ...
        BtnAwalKeperawatanPsikiatri.setPreferredSize(new java.awt.Dimension(1000, 30));
        ...
        BtnAwalKeperawatanGeriatri.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnAwalKeperawatanGeriatri.setText("Awal Keperawatan Geriatri");
        BtnAwalKeperawatanGeriatri.setAutoscrolls(true);
        ...
        BtnAwalKeperawatanGeriatri.setIconTextGap(8);
        ...
        BtnAwalKeperawatanGeriatri.setPreferredSize(new java.awt.Dimension(1000, 30));
        ...
        BtnAwalFisioterapi.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnAwalFisioterapi.setText("Awal Fisioterapi");
        BtnAwalFisioterapi.setAutoscrolls(true);
        ...
        BtnAwalMedis.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnAwalMedis.setText("Awal Medis Umum");
        BtnAwalMedis.setAutoscrolls(true);
        ...
        BtnAwalMedisKandungan.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnAwalMedisKandungan.setText("Awal Medis Kandungan");
        BtnAwalMedisKandungan.setAutoscrolls(true);
        ...
        BtnAwalMedisAnak.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnAwalMedisAnak.setText("Awal Medis Bayi/Anak");
        BtnAwalMedisAnak.setAutoscrolls(true);
        ...
        BtnAwalMedisTHT.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnAwalMedisTHT.setText("Awal Medis THT");
        BtnAwalMedisTHT.setAutoscrolls(true);
        ...
        BtnAwalMedisPsikiatri.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnAwalMedisPsikiatri.setText("Awal Medis Psikiatri");
        BtnAwalMedisPsikiatri.setAutoscrolls(true);
        ...
        BtnAwalMedisPenyakitDalam.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnAwalMedisPenyakitDalam.setText("Awal Medis Penyakit Dalam");
        BtnAwalMedisPenyakitDalam.setAutoscrolls(true);
        ...
        BtnAwalMedisPenyakitDalam.setIconTextGap(8);
        ...
        BtnAwalMedisPenyakitDalam.setPreferredSize(new java.awt.Dimension(1000, 30));
        ...
        BtnAwalMedisMata.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnAwalMedisMata.setText("Awal Medis Mata");
        BtnAwalMedisMata.setAutoscrolls(true);
        ...
        BtnAwalMedisNeurologi.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnAwalMedisNeurologi.setText("Awal Medis Neurologi");
        BtnAwalMedisNeurologi.setAutoscrolls(true);
        ...
        BtnAwalMedisOrthopedi.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnAwalMedisOrthopedi.setText("Awal Medis Orthopedi");
        BtnAwalMedisOrthopedi.setAutoscrolls(true);
        ...
        BtnAwalMedisBedah.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnAwalMedisBedah.setText("Awal Medis Bedah");
        BtnAwalMedisBedah.setAutoscrolls(true);
        ...
        BtnAwalMedisBedahMulut.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnAwalMedisBedahMulut.setText("Awal Medis Bedah Mulut");
        BtnAwalMedisBedahMulut.setAutoscrolls(true);
        ...
        BtnAwalMedisGeriatri.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnAwalMedisGeriatri.setText("Awal Medis Geriatri");
        BtnAwalMedisGeriatri.setAutoscrolls(true);
        ...
        BtnAwalMedisKulitKelamin.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnAwalMedisKulitKelamin.setText("Awal Medis Kulit & Kelamin");
        BtnAwalMedisKulitKelamin.setAutoscrolls(true);
        ...
        BtnAwalMedisKulitKelamin.setIconTextGap(8);
        ...
        BtnAwalMedisKulitKelamin.setPreferredSize(new java.awt.Dimension(1000, 30));
        ...
        BtnAwalMedisRehabMedik.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnAwalMedisRehabMedik.setText("Awal Medis Fisik & Rehabilitasi");
        BtnAwalMedisRehabMedik.setAutoscrolls(true);
        ...
        BtnAwalMedisHemodialisa.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnAwalMedisHemodialisa.setText("Awal Medis Hemodialisa");
        BtnAwalMedisHemodialisa.setAutoscrolls(true);
        ...
        BtnAwalMedisHemodialisa.setIconTextGap(8);
        ...
        BtnAwalMedisHemodialisa.setPreferredSize(new java.awt.Dimension(1000, 30));
        ...
        BtnRujukKeluar.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnRujukKeluar.setText("Rujuk Keluar");
        BtnRujukKeluar.setAutoscrolls(true);
        ...
        BtnCatatanCekGDS.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnCatatanCekGDS.setText("Catatan Cek GDS");
        BtnCatatanCekGDS.setAutoscrolls(true);
        ...
        BtnPenilaianUlangNyeri.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnPenilaianUlangNyeri.setText("Penilaian Ulang Nyeri");
        BtnPenilaianUlangNyeri.setAutoscrolls(true);
        ...
        BtnPemantauanMEOWS.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnPemantauanMEOWS.setText("Pemantauan MEOWS Obstetri");
        BtnPemantauanMEOWS.setAutoscrolls(true);
        ...
        BtnPemantauanEWSNeonatus.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnPemantauanEWSNeonatus.setText("Pemantauan EWS Neonatus");
        BtnPemantauanEWSNeonatus.setAutoscrolls(true);
        ...
        BtnPemantauanEWSNeonatus.setIconTextGap(8);
        ...
        BtnPemantauanEWSNeonatus.setPreferredSize(new java.awt.Dimension(1000, 30));
        ...
        BtnMonitoringReaksiTranfusi.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnMonitoringReaksiTranfusi.setText("Monitoring Reaksi Tranfusi");
        BtnMonitoringReaksiTranfusi.setAutoscrolls(true);
        ...
        BtnMonitoringReaksiTranfusi.setIconTextGap(8);
        ...
        BtnMonitoringReaksiTranfusi.setPreferredSize(new java.awt.Dimension(1000, 30));
        ...
        BtnUjiFungsiKFR.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnUjiFungsiKFR.setText("Uji Fungsi/Prosedur KFR");
        BtnUjiFungsiKFR.setAutoscrolls(true);
        ...
        BtnChecklistKriteriaMasukHCU.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnChecklistKriteriaMasukHCU.setText("Check List Masuk HCU");
        BtnChecklistKriteriaMasukHCU.setAutoscrolls(true);
        ...
        BtnChecklistKriteriaMasukHCU.setIconTextGap(8);
        ...
        BtnChecklistKriteriaMasukHCU.setPreferredSize(new java.awt.Dimension(1000, 30));
        ...
        BtnChecklistKriteriaMasukICU.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnChecklistKriteriaMasukICU.setText("Check List Masuk ICU");
        BtnChecklistKriteriaMasukICU.setAutoscrolls(true);
        ...
        BtnChecklistKriteriaMasukICU.setIconTextGap(8);
        ...
        BtnChecklistKriteriaMasukICU.setPreferredSize(new java.awt.Dimension(1000, 30));
        ...
        BtnChecklistPreOperasi.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnChecklistPreOperasi.setText("Check List Pre Operasi");
        BtnChecklistPreOperasi.setAutoscrolls(true);
        ...
        BtnSignInSebelumAnestesi.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnSignInSebelumAnestesi.setText("Sign-In Sebelum Anestesi");
        BtnSignInSebelumAnestesi.setAutoscrolls(true);
        ...
        BtnSignInSebelumAnestesi.setIconTextGap(8);
        ...
        BtnSignInSebelumAnestesi.setPreferredSize(new java.awt.Dimension(1000, 30));
        ...
        BtnTimeOutSebelumInsisi.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnTimeOutSebelumInsisi.setText("Time-Out Sebelum Insisi");
        BtnTimeOutSebelumInsisi.setAutoscrolls(true);
        ...
        BtnTimeOutSebelumInsisi.setIconTextGap(8);
        ...
        BtnTimeOutSebelumInsisi.setPreferredSize(new java.awt.Dimension(1000, 30));
        ...
        BtnSignOutSebelumMenutupLuka.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnSignOutSebelumMenutupLuka.setText("Sign-Out Sebelum Menutup Luka");
        BtnSignOutSebelumMenutupLuka.setAutoscrolls(true);
        ...
        BtnSignOutSebelumMenutupLuka.setIconTextGap(8);
        ...
        BtnSignOutSebelumMenutupLuka.setPreferredSize(new java.awt.Dimension(1000, 30));
        ...
        BtnChecklistPostOperasi.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnChecklistPostOperasi.setText("Check List Post Operasi");
        BtnChecklistPostOperasi.setAutoscrolls(true);
        ...
        BtnChecklistPostOperasi.setIconTextGap(8);
        ...
        BtnChecklistPostOperasi.setPreferredSize(new java.awt.Dimension(1000, 30));
        ...
        BtnPenilaianPreOperasi.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnPenilaianPreOperasi.setText("Penilaian Pre Operasi");
        BtnPenilaianPreOperasi.setAutoscrolls(true);
        ...
        BtnPenilaianPreAnestesi.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnPenilaianPreAnestesi.setText("Penilaian Pre Anestesi");
        BtnPenilaianPreAnestesi.setAutoscrolls(true);
        ...
        BtnPenilaianPreAnestesi.setIconTextGap(8);
        ...
        BtnPenilaianPreAnestesi.setPreferredSize(new java.awt.Dimension(1000, 30));
        ...
        BtnMedicalCheckUp.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnMedicalCheckUp.setText("Medical Check Up");
        BtnMedicalCheckUp.setAutoscrolls(true);
        ...
        BtnPenilaianPsikolog.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnPenilaianPsikolog.setText("Penilaian Psikolog");
        BtnPenilaianPsikolog.setAutoscrolls(true);
        ...
        BtnPenilaianLanjutanRisikoJatuhDewasa.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnPenilaianLanjutanRisikoJatuhDewasa.setText("Lanjutan Risiko Jatuh Dewasa");
        BtnPenilaianLanjutanRisikoJatuhDewasa.setAutoscrolls(true);
        ...
        BtnPenilaianLanjutanRisikoJatuhDewasa.setIconTextGap(8);
        ...
        BtnPenilaianLanjutanRisikoJatuhDewasa.setPreferredSize(new java.awt.Dimension(1000, 30));
        ...
        BtnPenilaianLanjutanRisikoJatuhAnak.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnPenilaianLanjutanRisikoJatuhAnak.setText("Lanjutan Risiko Jatuh Anak");
        BtnPenilaianLanjutanRisikoJatuhAnak.setAutoscrolls(true);
        ...
        BtnPenilaianLanjutanRisikoJatuhAnak.setIconTextGap(8);
        ...
        BtnPenilaianLanjutanRisikoJatuhAnak.setPreferredSize(new java.awt.Dimension(1000, 30));
        ...
        BtnPenilaianLanjutanRisikoJatuhLansia.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnPenilaianLanjutanRisikoJatuhLansia.setText("Lanjutan Risiko Jatuh Lansia");
        BtnPenilaianLanjutanRisikoJatuhLansia.setAutoscrolls(true);
        ...
        BtnPenilaianLanjutanRisikoJatuhLansia.setIconTextGap(8);
        ...
        BtnPenilaianLanjutanRisikoJatuhLansia.setPreferredSize(new java.awt.Dimension(1000, 30));
        ...
        BtnPenilaianLanjutanRisikoJatuhNeonatus.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnPenilaianLanjutanRisikoJatuhNeonatus.setText("Lanjutan Risiko Jatuh Neonatus");
        BtnPenilaianLanjutanRisikoJatuhNeonatus.setAutoscrolls(true);
        ...
        BtnPenilaianLanjutanRisikoJatuhNeonatus.setIconTextGap(8);
        ...
        BtnPenilaianLanjutanRisikoJatuhNeonatus.setPreferredSize(new java.awt.Dimension(1000, 30));
        ...
        BtnPenilaianLanjutanRisikoJatuhGeriatri.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnPenilaianLanjutanRisikoJatuhGeriatri.setText("Lanjutan Risiko Jatuh Geriatri");
        BtnPenilaianLanjutanRisikoJatuhGeriatri.setAutoscrolls(true);
        ...
        BtnPenilaianLanjutanRisikoJatuhGeriatri.setIconTextGap(8);
        ...
        BtnPenilaianLanjutanRisikoJatuhGeriatri.setPreferredSize(new java.awt.Dimension(1000, 30));
        ...
        BtnPenilaianLanjutanRisikoJatuhPsikiatri.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnPenilaianLanjutanRisikoJatuhPsikiatri.setText("Lanjutan Risiko Jatuh Psikiatri");
        BtnPenilaianLanjutanRisikoJatuhPsikiatri.setAutoscrolls(true);
        ...
        BtnPenilaianLanjutanRisikoJatuhPsikiatri.setIconTextGap(8);
        ...
        BtnPenilaianLanjutanRisikoJatuhPsikiatri.setPreferredSize(new java.awt.Dimension(1000, 30));
        ...
        BtnPenilaianLanjutanSkriningFungsional.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnPenilaianLanjutanSkriningFungsional.setText("Lanjutan Skrining Fungsional");
        BtnPenilaianLanjutanSkriningFungsional.setAutoscrolls(true);
        ...
        BtnPenilaianLanjutanSkriningFungsional.setIconTextGap(8);
        ...
        BtnPenilaianLanjutanSkriningFungsional.setPreferredSize(new java.awt.Dimension(1000, 30));
        ...
        BtnHasilPemeriksaanUSG.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnHasilPemeriksaanUSG.setText("Hasil Pemeriksaan USG");
        BtnHasilPemeriksaanUSG.setAutoscrolls(true);
        ...
        BtnDokumentasiESWL.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnDokumentasiESWL.setText("Dokumentasi Tindakan ESWL");
        BtnDokumentasiESWL.setAutoscrolls(true);
        ...
        BtnSkriningNutrisiDewasa.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnSkriningNutrisiDewasa.setText("Skrining Nutrisi Dewasa");
        BtnSkriningNutrisiDewasa.setAutoscrolls(true);
        ...
        BtnSkriningNutrisiDewasa.setIconTextGap(8);
        ...
        BtnSkriningNutrisiDewasa.setPreferredSize(new java.awt.Dimension(1000, 30));
        ...
        BtnSkriningNutrisiLansia.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnSkriningNutrisiLansia.setText("Skrining Nutrisi Lansia");
        BtnSkriningNutrisiLansia.setAutoscrolls(true);
        ...
        BtnSkriningNutrisiLansia.setIconTextGap(8);
        ...
        BtnSkriningNutrisiLansia.setPreferredSize(new java.awt.Dimension(1000, 30));
        ...
        BtnSkriningNutrisiAnak.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnSkriningNutrisiAnak.setText("Skrining Nutrisi Anak");
        BtnSkriningNutrisiAnak.setAutoscrolls(true);
        ...
        BtnSkriningGiziLanjut.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnSkriningGiziLanjut.setText("Skrining Gizi Lanjut");
        BtnSkriningGiziLanjut.setAutoscrolls(true);
        ...
        BtnAsuhanGizi.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnAsuhanGizi.setText("Asuhan Gizi");
        BtnAsuhanGizi.setAutoscrolls(true);
        ...
        BtnMonitoringAsuhanGizi.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnMonitoringAsuhanGizi.setText("Monitoring Gizi");
        BtnMonitoringAsuhanGizi.setAutoscrolls(true);
        ...
        BtnMonitoringAsuhanGizi.setIconTextGap(8);
        ...
        BtnMonitoringAsuhanGizi.setPreferredSize(new java.awt.Dimension(1000, 30));
        ...
        BtnCatatanADIMEGizi.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnCatatanADIMEGizi.setText("Catatan ADIME Gizi");
        BtnCatatanADIMEGizi.setAutoscrolls(true);
        ...
        BtnKonselingFarmasi.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnKonselingFarmasi.setText("Konseling Farmasi");
        BtnKonselingFarmasi.setAutoscrolls(true);
        ...
        BtnInformasiObat.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnInformasiObat.setText("Informasi Obat");
        BtnInformasiObat.setAutoscrolls(true);
        ...
        BtnRekonsiliasiObat.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnRekonsiliasiObat.setText("Rekonsiliasi Obat");
        BtnRekonsiliasiObat.setAutoscrolls(true);
        ...
        BtnEdukasiPasienKeluarga.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnEdukasiPasienKeluarga.setText("Edukasi Pasien & Keluarga");
        BtnEdukasiPasienKeluarga.setAutoscrolls(true);
        ...
        BtnEdukasiPasienKeluarga.setIconTextGap(8);
        ...
        BtnEdukasiPasienKeluarga.setPreferredSize(new java.awt.Dimension(1000, 30));
        ...
        BtnPenilaianPasienTerminal.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnPenilaianPasienTerminal.setText("Penilaian Pasien Terminal");
        BtnPenilaianPasienTerminal.setAutoscrolls(true);
        ...
        BtnPenilaianPasienTerminal.setIconTextGap(8);
        ...
        BtnPenilaianPasienTerminal.setPreferredSize(new java.awt.Dimension(1000, 30));
        ...
        BtnPenilaianKorbanKekerasan.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnPenilaianKorbanKekerasan.setText("Penilaian Korban Kekerasan");
        BtnPenilaianKorbanKekerasan.setAutoscrolls(true);
        ...
        BtnPenilaianKorbanKekerasan.setIconTextGap(8);
        ...
        BtnPenilaianKorbanKekerasan.setPreferredSize(new java.awt.Dimension(1000, 30));
        ...
        BtnPenilaianPasienPenyakitMenular.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnPenilaianPasienPenyakitMenular.setText("Pasien Penyakit Menular");
        BtnPenilaianPasienPenyakitMenular.setAutoscrolls(true);
        ...
        BtnPenilaianPasienPenyakitMenular.setIconTextGap(8);
        ...
        BtnPenilaianPasienPenyakitMenular.setPreferredSize(new java.awt.Dimension(1000, 30));
        ...
        BtnPenilaianPasienKeracunan.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnPenilaianPasienKeracunan.setText("Pasien Keracunan");
        BtnPenilaianPasienKeracunan.setAutoscrolls(true);
        ...
        BtnPenilaianPasienKeracunan.setIconTextGap(8);
        ...
        BtnPenilaianPasienKeracunan.setPreferredSize(new java.awt.Dimension(1000, 30));
        ...
        BtnPenilaianTambahanGeriatri.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnPenilaianTambahanGeriatri.setText("Tambahan Pasien Geriatri");
        BtnPenilaianTambahanGeriatri.setAutoscrolls(true);
        ...
        BtnPenilaianTambahanGeriatri.setIconTextGap(8);
        ...
        BtnPenilaianTambahanGeriatri.setPreferredSize(new java.awt.Dimension(1000, 30));
        ...
        BtnPenilaianTambahanBunuhDiri.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnPenilaianTambahanBunuhDiri.setText("Tambahan Bunuh Diri");
        BtnPenilaianTambahanBunuhDiri.setAutoscrolls(true);
        ...
        BtnPenilaianTambahanBunuhDiri.setIconTextGap(8);
        ...
        BtnPenilaianTambahanBunuhDiri.setPreferredSize(new java.awt.Dimension(1000, 30));
        ...
        BtnPenilaianTambahanPerilakuKekerasan.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnPenilaianTambahanPerilakuKekerasan.setText("Tambahan Perilaku Kekerasan");
        BtnPenilaianTambahanPerilakuKekerasan.setAutoscrolls(true);
        ...
        BtnPenilaianTambahanPerilakuKekerasan.setIconTextGap(8);
        ...
        BtnPenilaianTambahanPerilakuKekerasan.setPreferredSize(new java.awt.Dimension(1000, 30));
        ...
        BtnPenilaianTambahanMelarikanDiri.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnPenilaianTambahanMelarikanDiri.setText("Tambahan Melarikan Diri");
        BtnPenilaianTambahanMelarikanDiri.setAutoscrolls(true);
        ...
        BtnPenilaianTambahanMelarikanDiri.setIconTextGap(8);
        ...
        BtnPenilaianTambahanMelarikanDiri.setPreferredSize(new java.awt.Dimension(1000, 30));
        ...
        BtnRiwayatLab.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnRiwayatLab.setText("Riwayat Laboratorium");
        BtnRiwayatLab.setAutoscrolls(true);
        BtnRiwayatLab.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnRiwayatLab.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnRiwayatLab.setIconTextGap(8);
        BtnRiwayatLab.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnRiwayatLab.setName("BtnRiwayatLab"); // NOI18N
        BtnRiwayatLab.setPreferredSize(new java.awt.Dimension(1000, 30));
        BtnRiwayatLab.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnRiwayatLabActionPerformed(evt);
            }
        });
        FormMenu.add(BtnRiwayatLab);

        BtnRiwayatRad.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnRiwayatRad.setText("Riwayat Radiologi");
        BtnRiwayatRad.setAutoscrolls(true);
        BtnRiwayatRad.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnRiwayatRad.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnRiwayatRad.setIconTextGap(8);
        BtnRiwayatRad.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnRiwayatRad.setName("BtnRiwayatRad"); // NOI18N
        BtnRiwayatRad.setPreferredSize(new java.awt.Dimension(1000, 30));
        BtnRiwayatRad.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnRiwayatRadActionPerformed(evt);
            }
        });
        FormMenu.add(BtnRiwayatRad);

        BtnVitalSign.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnVitalSign.setText("Vital Sign (TTV)");
        BtnVitalSign.setAutoscrolls(true);
        BtnVitalSign.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnVitalSign.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnVitalSign.setIconTextGap(8);
        BtnVitalSign.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnVitalSign.setName("BtnVitalSign"); // NOI18N
        BtnVitalSign.setPreferredSize(new java.awt.Dimension(1000, 30));
        BtnVitalSign.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnVitalSignActionPerformed(evt);
            }
        });
        FormMenu.add(BtnVitalSign);

        BtnRiwayatCPPT.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnRiwayatCPPT.setText("Riwayat CPPT/SOAP");
        BtnRiwayatCPPT.setAutoscrolls(true);
        BtnRiwayatCPPT.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnRiwayatCPPT.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnRiwayatCPPT.setIconTextGap(8);
        BtnRiwayatCPPT.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnRiwayatCPPT.setName("BtnRiwayatCPPT"); // NOI18N
        BtnRiwayatCPPT.setPreferredSize(new java.awt.Dimension(1000, 30));
        BtnRiwayatCPPT.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnRiwayatCPPTActionPerformed(evt);
            }
        });
        FormMenu.add(BtnRiwayatCPPT);

        BtnAntarFaskes.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnAntarFaskes.setText("Antar Faskes");
        BtnAntarFaskes.setAutoscrolls(true);
        BtnAntarFaskes.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnAntarFaskes.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnAntarFaskes.setIconTextGap(8);
        BtnAntarFaskes.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnAntarFaskes.setName("BtnAntarFaskes"); // NOI18N
        BtnAntarFaskes.setPreferredSize(new java.awt.Dimension(1000, 30));
        BtnAntarFaskes.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnAntarFaskesActionPerformed(evt);
            }
        });
        FormMenu.add(BtnAntarFaskes);

        BtnEWS.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnEWS.setText("EWS");
        BtnEWS.setAutoscrolls(true);
        BtnEWS.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnEWS.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnEWS.setIconTextGap(8);
        BtnEWS.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnEWS.setName("BtnEWS"); // NOI18N
        BtnEWS.setPreferredSize(new java.awt.Dimension(1000, 30));
        ...
        BtnPEWS.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnPEWS.setText("PEWS");
        BtnPEWS.setAutoscrolls(true);
        BtnPEWS.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnPEWS.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnPEWS.setIconTextGap(8);
        BtnPEWS.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnPEWS.setName("BtnPEWS"); // NOI18N
        BtnPEWS.setPreferredSize(new java.awt.Dimension(1000, 30));
        BtnPEWS.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnPEWSActionPerformed(evt);
            }
        });
        FormMenu.add(BtnPEWS);

        BtnPermintaanKonsultasiMedik.setIcon(IKON_OPEN_RALAN); // NOI18N
        BtnPermintaanKonsultasiMedik.setText("Konsultasi Medik");
        BtnPermintaanKonsultasiMedik.setAutoscrolls(true);
        ...
        BtnPermintaanKonsultasiMedik.setIconTextGap(8);
        ...
        BtnPermintaanKonsultasiMedik.setPreferredSize(new java.awt.Dimension(1000, 30));
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(250, 65));
        ...
        searchField.setBounds(10, 30, 185, 26);

        filterButtons.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Search-16x16.png"))); // NOI18N
        filterButtons.setName("filterButtons"); // NOI18N
        filterButtons.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                filterButtonsActionPerformed(evt);
            }
        });
        jPanel1.add(filterButtons);
        filterButtons.setBounds(200, 30, 30, 26);

        jLabel58.setForeground(new java.awt.Color(102, 102, 102));
        jLabel58.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel58.setText("Pencarian Menu");
        jLabel58.setVerticalAlignment(javax.swing.SwingConstants.TOP);
        jLabel58.setName("jLabel58"); // NOI18N
        jPanel1.add(jLabel58);
        jLabel58.setBounds(10, 10, 120, 20);

        PanelAccor.add(jPanel1, java.awt.BorderLayout.PAGE_START);
    ...
    final String noRw = (TNoRw.getText() == null) ? "" : TNoRw.getText().trim();
    if (noRw.isEmpty()) {
        // Tidak ada konteks kunjungan → langsung close
        dispose();
        return;
    }

    try {
        // Cek apakah resume sudah diisi
        int adaResume = Sequel.cariInteger("SELECT COUNT(*) FROM resume_pasien WHERE no_rawat=?", noRw);

        if (adaResume > 0) {
            // Resume terisi → cek status
            String stts = Sequel.cariIsi("SELECT stts FROM reg_periksa WHERE no_rawat=?", noRw);
            stts = (stts == null) ? "" : stts.trim();

            if (!"Sudah".equalsIgnoreCase(stts)) {
                // Otomatis set status menjadi "Sudah"
                Sequel.mengedittf(
                    "reg_periksa", "no_rawat=?", "stts=?", 2,
                    new String[]{"Sudah", noRw}
                );

                // Simpan mutasi berkas (insert-or-update via util menyimpan kamu)
                Sequel.menyimpan(
                    "mutasi_berkas",
                    "'" + noRw + "','Sudah Kembali',now(),'0000-00-00 00:00:00',now(),'0000-00-00 00:00:00','0000-00-00 00:00:00'",
                    "status='Sudah Kembali',kembali=now()",
                    "no_rawat='" + noRw + "'"
                );
            }

            // Resume ada & status sudah "Sudah" (sebelumnya atau barusan di-set) → langsung keluar
            try { petugas.dispose(); } catch (Exception ex) {}
            try { dokter.dispose(); } catch (Exception ex) {}
            try { pasien.dispose(); } catch (Exception ex) {}
            dispose();
            return;
        }

        // Resume BELUM diisi → tanya dulu
        int i = JOptionPane.showConfirmDialog(
            null,
            "Anda belum mengisi Resume Pasien, ingin tetap keluar dari menu ini?\n" +
            "Pilih Yes untuk keluar, No untuk membatalkan.",
            "Konfirmasi",
        ...
        if (i == JOptionPane.YES_OPTION) {
            ...
            // No → batal keluar, biarkan form tetap terbuka
        }

    } catch (Exception e) {
        System.out.println("Err BtnKeluarActionPerformed: " + e);
        // Dalam kondisi error, jangan paksa tutup; biar user bisa coba lagi
    }
                ...
                case 3:
                    if(KdPeg.getText().trim().equals("")||TPegawai.getText().trim().equals("")){
                        ...
                        if(tbPemeriksaan.getSelectedRow()>-1){
                            if(aksesInstance.isAdminUtama()||(akses.getkode().equals("20101731"))||(akses.getkode().equals("20031546"))||(akses.getkode().equals("20031546B"))){
                                ...
                                if(akses.getkode().equals(tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),23).toString())|| akses.getkode().equals("20101731")|| akses.getkode().equals("20031546")){
...
//                getDataPemeriksaanSbar();
    ...
    private void BtnKonsulAntarPoliActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKonsulAntarPoliActionPerformed
        if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{   
        ...
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnKonsulAntarPoliActionPerformed

    private void BtnRiwayatCPPTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnRiwayatCPPTActionPerformed
    if(TNoRw.getText().trim().equals("") ){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
        ...
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnRiwayatCPPTActionPerformed

    private void BtnRiwayatRadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnRiwayatRadActionPerformed
        if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu pasien...!!!");
            TCari.requestFocus();
        }else{
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMRiwayatRadiologi resume=new RMRiwayatRadiologi(null,false);
        ...
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnRiwayatRadActionPerformed

    private void BtnRiwayatLabActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnRiwayatLabActionPerformed
        if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu pasien...!!!");
            TCari.requestFocus();
        }else{
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMRiwayatLaborat resume=new RMRiwayatLaborat(null,false);
            resume.setNoRm(TNoRM.getText(),TPasien.getText());
            resume.setSize(internalFrame1.getWidth(),internalFrame1.getHeight());
            resume.setLocationRelativeTo(internalFrame1);
            resume.setVisible(true);
        ...
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnRiwayatLabActionPerformed
    ...
    private void BtnVitalSignActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnVitalSignActionPerformed
        if(TNoRw.getText().trim().equals("") ){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            DlgTTV ttv=new DlgTTV(null,false);
            ttv.setNoRawat(TNoRw.getText(),TNoRw.getText(),TNoRM.getText());
    ...
    private void BtnPEWSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPEWSActionPerformed
        if(TNoRw.getText().trim().equals("") ){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
        ...
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnPEWSActionPerformed
    ...
    if(TNoRw.getText().trim().equals("")){
       JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
        ...
        if (!(Sequel.cariInteger("select count(pemeriksaan_ralan.no_rawat) from pemeriksaan_ralan where no_rawat='"+TNoRw.getText()+"'")==0)){        
            if(Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?",TNoRw.getText())>0){
                JOptionPane.showMessageDialog(null,"Maaf, Pasien sudah masuk Kamar Inap. Gunakan billing Ranap..!!!");
            }else {
                jmlparsial=0;
                ...
                if (Sequel.cariInteger("select count(pemeriksaan_ralan.no_rawat) from pemeriksaan_ralan where no_rawat='"+TNoRw.getText()+"'")==0){
                    JOptionPane.showMessageDialog(null,"Maaf, SOAP belum diisi, silahkan menyelesaikan SOAP terlebih dahulu.");
                }else{
                    if(jmlparsial>0){                        
                        inputResep();
                    }else{
...
private void BtnTemplatePemeriksaanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnTemplatePemeriksaanActionPerformed
    ...
    private void filterButtonsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_filterButtonsActionPerformed
     isCek();
        Collections.sort(buttonList, Comparator.comparing(JButton::getText));
        String filterText = searchField.getText().toLowerCase();
        FormMenu.removeAll();
        
        List<JButton> filteredButtons = new ArrayList<>();
        for (JButton button : buttonList) {
            if (button.isVisible() && button.getText().toLowerCase().contains(filterText)) {
//            if (button.getText().toLowerCase().contains(filterText)) {
                filteredButtons.add(button);
            }
        }
       
        filteredButtons.forEach(FormMenu::add);
        FormMenu.revalidate();
        FormMenu.repaint();
    }//GEN-LAST:event_filterButtonsActionPerformed

    private void searchFieldFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_searchFieldFocusGained
    searchField.getText().equals("Pencarian Cepat");
    searchField.setText("");
    }//GEN-LAST:event_searchFieldFocusGained

    private void BtnResumeIconActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnResumeIconActionPerformed
            if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
    ...
    }//GEN-LAST:event_BtnResumeIconActionPerformed

    private void BtnResumeIconKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnResumeIconKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnResumeIconKeyPressed
    ...
    private void BtnSeekPegawai2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSeekPegawai2ActionPerformed
        TSuhu.setText(Sequel.cariIsi("Select pemeriksaan_ralan.suhu_tubuh from pemeriksaan_ralan where no_rawat=?",TNoRw.getText()));    
        TTensi.setText(Sequel.cariIsi("Select pemeriksaan_ralan.tensi from pemeriksaan_ralan where no_rawat=?",TNoRw.getText()));    
        TAlergi.setText(Sequel.cariIsi("Select pemeriksaan_ralan.alergi from pemeriksaan_ralan where no_rawat=?",TNoRw.getText()));    
        TBerat.setText(Sequel.cariIsi("Select pemeriksaan_ralan.berat from pemeriksaan_ralan where no_rawat=?",TNoRw.getText()));    
        TTinggi.setText(Sequel.cariIsi("Select pemeriksaan_ralan.tinggi from pemeriksaan_ralan where no_rawat=?",TNoRw.getText()));    
        TNadi.setText(Sequel.cariIsi("Select pemeriksaan_ralan.nadi from pemeriksaan_ralan where no_rawat=?",TNoRw.getText()));    
        TRespirasi.setText(Sequel.cariIsi("Select pemeriksaan_ralan.respirasi from pemeriksaan_ralan where no_rawat=?",TNoRw.getText()));    
        TGCS.setText(Sequel.cariIsi("Select pemeriksaan_ralan.gcs from pemeriksaan_ralan where no_rawat=?",TNoRw.getText()));    
        SpO2.setText(Sequel.cariIsi("Select pemeriksaan_ralan.spo2 from pemeriksaan_ralan where no_rawat=?",TNoRw.getText()));    
        LingkarPerut.setText(Sequel.cariIsi("Select pemeriksaan_ralan.lingkar_perut from pemeriksaan_ralan where no_rawat=?",TNoRw.getText()));    
    ...
    private void BtnRiwayatPasienActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnRiwayatPasienActionPerformed
        if(TNoRw.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMRiwayatPerawatanKlaim resume=new RMRiwayatPerawatanKlaim(null,false);
    ...
    private void BtnRiwayatPasienKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnRiwayatPasienKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnRiwayatPasienKeyPressed
...
private void isPsien(){
    ...
    @Override
    public void dispose() {
        // PATCH PERFORMA RSAJ - Timer Swing yang tetap hidup akan menahan instance form lama
        // dan terus mengeksekusi event setiap detik setelah form ditutup.
        if(timerJam!=null){
            timerJam.stop();
        }
        super.dispose();
    ...
    */
    ...
    private widget.Button BtnKonsulAntarPoli;
    ...
    private widget.Button BtnResumeIcon;
    private widget.Button BtnRiwayat;
    private widget.Button BtnRiwayatCPPT;
    private widget.Button BtnRiwayatLab;
    private widget.Button BtnRiwayatPasien;
    private widget.Button BtnRiwayatRad;
    ...
    private widget.Button BtnVitalSign;
    ...
    private widget.Button filterButtons;
    ...
    private widget.TextBox searchField;
    ...
    public void setNoRm(String norwt,Date tgl1,Date tgl2) {
        // DIAGNOSTIK PERFORMA RSAJ - hanya mengukur waktu, tidak mengubah alur/fungsi.
        final long perfTotalSetNoRm = System.nanoTime();
        long perfTahapSetNoRm = perfTotalSetNoRm;
        ...
        System.out.println("[PERFORMA RAWAT JALAN] setNoRm - persiapan field: "+
                ((System.nanoTime()-perfTahapSetNoRm)/1_000_000L)+" ms");

        // isRawat() sudah mengisi No.RM, nama pasien, kode dokter dan nama dokter.
        // Sebelumnya data pasien/dokter dibaca ulang sehingga pembukaan form melakukan query ganda.
        perfTahapSetNoRm = System.nanoTime();
        isRawat();
        System.out.println("[PERFORMA RAWAT JALAN] setNoRm - isRawat: "+
                ((System.nanoTime()-perfTahapSetNoRm)/1_000_000L)+" ms");
        ...
        ChkInput3.setSelected(true);
        isForm4();
        System.out.println("[PERFORMA RAWAT JALAN] setNoRm - konfigurasi panel: "+
                ((System.nanoTime()-perfTahapSetNoRm)/1_000_000L)+" ms");

        perfTahapSetNoRm = System.nanoTime();
        TabRawatMouseClicked(null);
        System.out.println("[PERFORMA RAWAT JALAN] setNoRm - load tab aktif: "+
                ((System.nanoTime()-perfTahapSetNoRm)/1_000_000L)+" ms");
        System.out.println("[PERFORMA RAWAT JALAN] setNoRm - TOTAL: "+
                ((System.nanoTime()-perfTotalSetNoRm)/1_000_000L)+" ms");
    }
    
    private void isForm(){
        if(ChkInput.isSelected()==true){
            ChkInput.setVisible(false);
            PanelInput.setPreferredSize(new Dimension(WIDTH, 282));
    ...
    private void isMenu(){
        if(ChkAccor.isSelected()==true){
            ...
            PanelAccor.setPreferredSize(new Dimension(235,HEIGHT));
    ...
    public void isCek(){
        final long perfIsCek = System.nanoTime();
        tinggi=0;
        BtnSimpan.setEnabled(akses.gettindakan_ralan());
...
//        DTPTgl.setEnabled(akses.getadmin());
//        cmbJam.setEnabled(akses.getadmin());
//        cmbMnt.setEnabled(akses.getadmin());
//        cmbDtk.setEnabled(akses.getadmin());
//        ChkJln.setEnabled(akses.getadmin());        
...
//        BtnSkorStewardPascaAnestesi.setVisible(akses.getskor_steward_pasca_anestesi()); 
        ...
        // Tambahkan tombol ke daftar buttonList
        buttonList = new ArrayList<>();
        buttonList.add(BtnRiwayat);
        buttonList.add(BtnResepObat);
        buttonList.add(BtnCopyResep);
        buttonList.add(BtnResepLuar);
        buttonList.add(BtnInputObat);
        buttonList.add(BtnObatBhp);
        buttonList.add(BtnBerkasDigital);
        buttonList.add(BtnPermintaanLab);
        buttonList.add(BtnPermintaanRad);
        buttonList.add(BtnJadwalOperasi);
        buttonList.add(BtnSKDP);
        buttonList.add(BtnKamar);
        buttonList.add(BtnTriaseIGD);
        buttonList.add(BtnRujukInternal);
        buttonList.add(BtnResume);
        buttonList.add(BtnAwalKeperawatanIGD);
        buttonList.add(BtnAwalKeperawatan);
        buttonList.add(BtnAwalKeperawatanGigi);
        buttonList.add(BtnAwalKeperawatanKandungan);
        buttonList.add(BtnAwalKeperawatanAnak);
        buttonList.add(BtnAwalKeperawatanPsikiatri);
        buttonList.add(BtnAwalKeperawatanGeriatri);
        buttonList.add(BtnAwalFisioterapi);
//        buttonList.add(BtnAwalTerapiWicara);
        buttonList.add(BtnPenatalaksanaanTerapiOkupasi);
        buttonList.add(BtnAwalMedisIGD);
        buttonList.add(BtnAwalMedisIGDPsikiatri);
        buttonList.add(BtnAwalMedis);
        buttonList.add(BtnAwalMedisKandungan);
        buttonList.add(BtnAwalMedisAnak);
        buttonList.add(BtnAwalMedisTHT);
        buttonList.add(BtnAwalMedisPsikiatri);
        buttonList.add(BtnAwalMedisPenyakitDalam);
        buttonList.add(BtnAwalMedisMata);
        buttonList.add(BtnAwalMedisNeurologi);
        buttonList.add(BtnAwalMedisOrthopedi);
        buttonList.add(BtnAwalMedisBedah);
        buttonList.add(BtnAwalMedisBedahMulut);
        buttonList.add(BtnAwalMedisGeriatri);
        buttonList.add(BtnAwalMedisKulitKelamin);
//        buttonList.add(BtnAwalMedisParu);
        buttonList.add(BtnAwalMedisRehabMedik);
        buttonList.add(BtnAwalMedisHemodialisa);
        buttonList.add(BtnRujukKeluar);
        buttonList.add(BtnCatatan);
        buttonList.add(BtnCatatanObservasiIGD);
        buttonList.add(BtnCatatanObservasiCHBP);
        buttonList.add(BtnCatatanObservasiInduksiPersalinan);
        buttonList.add(BtnCatatanCekGDS);
//        buttonList.add(BtnCatatanKeperawatan);
        buttonList.add(BtnCatatanKeseimbanganCairan);
        buttonList.add(BtnPenilaianUlangNyeri);
        buttonList.add(BtnPemantauanPEWSAnak);
        buttonList.add(BtnPemantauanPEWSDewasa);
        buttonList.add(BtnPemantauanMEOWS);
        buttonList.add(BtnPemantauanEWSNeonatus);
        buttonList.add(BtnMonitoringReaksiTranfusi);
        buttonList.add(BtnUjiFungsiKFR);
        buttonList.add(BtnChecklistKriteriaMasukHCU);
        buttonList.add(BtnChecklistKriteriaMasukICU);
        buttonList.add(BtnPenilaianPreInduksi);
        buttonList.add(BtnChecklistPreOperasi);
        buttonList.add(BtnSignInSebelumAnestesi);
        buttonList.add(BtnTimeOutSebelumInsisi);
        buttonList.add(BtnSignOutSebelumMenutupLuka);
        buttonList.add(BtnChecklistPostOperasi);
        buttonList.add(BtnPenilaianPreOperasi);
        buttonList.add(BtnPenilaianPreAnestesi);
//        buttonList.add(BtnSkorAldrettePascaAnestesi);
//        buttonList.add(BtnSkorStewardPascaAnestesi);
        buttonList.add(BtnSkorBromagePascaAnestesi);
        buttonList.add(BtnMedicalCheckUp);
        buttonList.add(BtnPenilaianPsikolog);
        buttonList.add(BtnPenilaianLanjutanRisikoJatuhDewasa);
        buttonList.add(BtnPenilaianLanjutanRisikoJatuhAnak);
        buttonList.add(BtnPenilaianLanjutanRisikoJatuhLansia);
        buttonList.add(BtnPenilaianLanjutanRisikoJatuhNeonatus);
        buttonList.add(BtnPenilaianLanjutanRisikoJatuhGeriatri);
        buttonList.add(BtnPenilaianLanjutanRisikoJatuhPsikiatri);
        buttonList.add(BtnPenilaianLanjutanSkriningFungsional);
        buttonList.add(BtnHasilPemeriksaanUSG);
        buttonList.add(BtnHasilPemeriksaanUSGUrologi);
        buttonList.add(BtnHasilPemeriksaanUSGNeonatus);
        buttonList.add(BtnHasilPemeriksaanUSGGynecologi);
        buttonList.add(BtnHasilPemeriksaanEKG);
        buttonList.add(BtnHasilEndoskopiFaringLaring);
        buttonList.add(BtnHasilEndoskopiHidung);
        buttonList.add(BtnHasilEndoskopiTelinga);
        buttonList.add(BtnDokumentasiESWL);
//        buttonList.add(BtnCatatanPersalinanan);
        buttonList.add(BtnSkriningNutrisiDewasa);
        buttonList.add(BtnSkriningNutrisiLansia);
        buttonList.add(BtnSkriningNutrisiAnak);
        buttonList.add(BtnSkriningGiziLanjut);
        buttonList.add(BtnAsuhanGizi);
        buttonList.add(BtnMonitoringAsuhanGizi);
        buttonList.add(BtnCatatanADIMEGizi);
        buttonList.add(BtnKonselingFarmasi);
        buttonList.add(BtnInformasiObat);
        buttonList.add(BtnRekonsiliasiObat);
        buttonList.add(BtnTransferAntarRuang);
        buttonList.add(BtnEdukasiPasienKeluarga);
//        buttonList.add(BtnPengkajianRestrain);
        buttonList.add(BtnPenilaianPasienTerminal);
        buttonList.add(BtnPenilaianKorbanKekerasan);
        buttonList.add(BtnPenilaianPasienPenyakitMenular);
        buttonList.add(BtnPenilaianPasienImunitasRendah);
        buttonList.add(BtnPenilaianPasienKeracunan);
        buttonList.add(BtnPenilaianTambahanGeriatri);
        buttonList.add(BtnPenilaianTambahanBunuhDiri);
        buttonList.add(BtnPenilaianTambahanPerilakuKekerasan);
        buttonList.add(BtnPenilaianTambahanMelarikanDiri);   
        buttonList.add(BtnPermintaanKonsultasiMedik);
        ...
        if(TANGGALMUNDUR.equals("no")){
            if(!akses.getkode().equals("Admin Utama")||(akses.getkode().equals("20101731"))||(akses.getkode().equals("20031546"))||(akses.getkode().equals("20031546B"))){
        ...
        System.out.println("[PERFORMA RAWAT JALAN] isCek selesai dalam "+
                ((System.nanoTime()-perfIsCek)/1_000_000L)+" ms");
    }

    private void tampilPemeriksaan() {
        final long perfTampilPemeriksaan = System.nanoTime();
        ...
        LCount.setText(""+tabModePemeriksaan.getRowCount());
        System.out.println("[PERFORMA RAWAT JALAN] tampilPemeriksaan selesai dalam "+
                ((System.nanoTime()-perfTampilPemeriksaan)/1_000_000L)+" ms ("+
                tabModePemeriksaan.getRowCount()+" baris)");
    }
    ...
    private void getDataPemeriksaan() {
        if(tbPemeriksaan.getSelectedRow()!= -1){
            ...
            if (akses.getkode().equals("20101731") || akses.getkode().equals("Admin Utama") ||
                akses.getkode().equals("20031546") || 
                akses.getkode().equals("20031546B")) {

                KdPeg.setText(tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),23).toString()); 
                TPegawai.setText(tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),24).toString());         
                Jabatan.setText(tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),25).toString());         
            }
    ...
    private void jam(){
        ...
        // PATCH PERFORMA RSAJ - hanya satu Timer per instance dan dapat dihentikan saat dispose.
        if(timerJam==null){
    ...
    public void setNoRm(String norwt,Date tgl1,Date tgl2,String kodedokter, String namadokter) {
        ...
        DTPCari1.setDate(tgl1);
        DTPCari2.setDate(tgl2);        
        System.out.println("[PERFORMA RAWAT JALAN] setNoRm(dokter) - persiapan field: "+
                ((System.nanoTime()-perfTahapSetNoRm)/1_000_000L)+" ms");

        // isRawat() sudah mengisi identitas pasien, jadi isPsien() tidak perlu dijalankan ulang.
        perfTahapSetNoRm = System.nanoTime();
        isRawat();
        System.out.println("[PERFORMA RAWAT JALAN] setNoRm(dokter) - isRawat: "+
                ((System.nanoTime()-perfTahapSetNoRm)/1_000_000L)+" ms");
        ...
        System.out.println("[PERFORMA RAWAT JALAN] setNoRm(dokter) - konfigurasi panel/dokter: "+
                ((System.nanoTime()-perfTahapSetNoRm)/1_000_000L)+" ms");

        perfTahapSetNoRm = System.nanoTime();
        TabRawatMouseClicked(null);
        System.out.println("[PERFORMA RAWAT JALAN] setNoRm(dokter) - load tab aktif: "+
                ((System.nanoTime()-perfTahapSetNoRm)/1_000_000L)+" ms");
        System.out.println("[PERFORMA RAWAT JALAN] setNoRm(dokter) - TOTAL: "+
                ((System.nanoTime()-perfTotalSetNoRm)/1_000_000L)+" ms");
    }
...
//                if(tbTindakan.getValueAt(i,0).toString().equals("true")){  
            ...
            //modif CEK DOBEL INPUT      
            
            for(i=0;i<tbTindakan.getRowCount();i++){ 
                if(tbTindakan.getValueAt(i,0).toString().equals("true")){  
                    String kdTindakan = tbTindakan.getValueAt(i,1).toString();
                    String tglPeriksa = Sequel.cariIsi("Select tgl_registrasi from reg_periksa where no_rawat = ?", TNoRw.getText());

                    // --- CEK DUPLIKASI SEBELUM SIMPAN
                    boolean sudahAda = Sequel.cariInteger(
                        "SELECT COUNT(*) FROM rawat_jl_dr WHERE no_rawat=? AND kd_jenis_prw=? AND kd_dokter=? AND tgl_perawatan=?",
                        TNoRw.getText(), kdTindakan, KdDok.getText(), tglPeriksa
                    ) > 0;
                    ...
                    if (sudahAda) {
                        ...
                        int opsi = JOptionPane.showConfirmDialog(
                            null,
                            "Tindakan \"" + tbTindakan3.getValueAt(i, 2).toString() + 
                            "\" sudah pernah disimpan untuk pasien ini.\n" +
                            "Klik Yes untuk tetap menyimpan dan tindakan akan dobel, No untuk membatalkan.",
                            "Duplikasi Tindakan",
                            JOptionPane.YES_NO_OPTION,
                        ...
                        // kalau opsi == YES_OPTION, jatuh ke blok simpan
                    }

                    // blok penyimpanan — dijalankan baik untuk data baru, atau duplikat jika user pilih Yes
            ...
            if(sukses==true){
                ...
                TabRawatTindakanDokter.setSelectedIndex(1); // pindah tab
                tampilDr();                   // refresh tabel
                LCount.setText(""+tabModeDr.getRowCount()); // update jumlah (kalau kamu pakai LCount)
            }    
            }else{
                sukses=false;
                JOptionPane.showMessageDialog(null,"Terjadi kesalahan saat pemrosesan data, transaksi dibatalkan.\nPeriksa kembali data sebelum melanjutkan menyimpan..!!");
        ...
        try {
            ...
            for(i=0;i<tbTindakan2.getRowCount();i++){ 
                if(tbTindakan2.getValueAt(i,0).toString().equals("true")){                      
                    String kdTindakan = tbTindakan2.getValueAt(i,1).toString();
                    String tglPeriksa = Sequel.cariIsi("Select tgl_registrasi from reg_periksa where no_rawat = ?", TNoRw.getText());

                    // --- CEK DUPLIKASI SEBELUM SIMPAN
                    boolean sudahAda = Sequel.cariInteger(
                        "SELECT COUNT(*) FROM rawat_jl_pr WHERE no_rawat=? AND kd_jenis_prw=? AND kd_dokter=? AND tgl_perawatan=?",
                        TNoRw.getText(), kdTindakan, KdDok.getText(), tglPeriksa
                    ) > 0;
                    ...
                    if (sudahAda) {
                        ...
                        int opsi = JOptionPane.showConfirmDialog(
                            null,
                            "Tindakan \"" + tbTindakan2.getValueAt(i, 2).toString() + 
                            "\" sudah pernah disimpan untuk pasien ini.\n" +
                            "Klik Yes untuk tetap menyimpan dan tindakan akan dobel, No untuk membatalkan.",
                            "Duplikasi Tindakan",
                            JOptionPane.YES_NO_OPTION,
...
//modif CEK DOBEL INPUT      
            ...
            for(i=0;i<tbTindakan3.getRowCount();i++){ 
                if(tbTindakan3.getValueAt(i,0).toString().equals("true")){  
                    String kdTindakan = tbTindakan3.getValueAt(i,1).toString();
                    String tglPeriksa = Sequel.cariIsi("Select tgl_registrasi from reg_periksa where no_rawat = ?", TNoRw.getText());

                    // --- CEK DUPLIKASI SEBELUM SIMPAN
                    boolean sudahAda = Sequel.cariInteger(
                        "SELECT COUNT(*) FROM rawat_jl_drpr WHERE no_rawat=? AND kd_jenis_prw=? AND kd_dokter=? AND tgl_perawatan=?",
                        TNoRw.getText(), kdTindakan, KdDok.getText(), tglPeriksa
                    ) > 0;
            ...
            if(sukses==true){
                ...
                TabRawatTindakanDokterPetugas.setSelectedIndex(1); // pindah tab
                tampilDrPr();                   // refresh tabel
                LCount.setText(""+tabModeDrPr.getRowCount()); // update jumlah (kalau kamu pakai LCount)                  
    ...
    private void initRawatJalan(){
        ...
        BtnSkorBromagePascaAnestesi.setIcon(IKON_ITEM_RALAN); 
        ...
        BtnPenilaianPreInduksi.setIcon(IKON_ITEM_RALAN); 
        ...
        BtnHasilPemeriksaanUSGUrologi.setIcon(IKON_ITEM_RALAN);
        ...
        BtnHasilPemeriksaanUSGGynecologi.setIcon(IKON_ITEM_RALAN);
        ...
        BtnHasilPemeriksaanUSGNeonatus.setIcon(IKON_ITEM_RALAN);
        ...
        BtnHasilPemeriksaanEKG.setIcon(IKON_ITEM_RALAN);
        ...
        BtnPenatalaksanaanTerapiOkupasi.setIcon(IKON_ITEM_RALAN);
        ...
        BtnPenilaianPsikolog = new widget.Button();
        BtnPenilaianPsikolog.setIcon(IKON_ITEM_RALAN); 
        BtnPenilaianPsikolog.setText("Penilaian Psikolog");
        ...
        BtnHasilEndoskopiFaringLaring.setIcon(IKON_ITEM_RALAN);
        ...
        BtnHasilEndoskopiHidung.setIcon(IKON_ITEM_RALAN);
        ...
        BtnHasilEndoskopiTelinga.setIcon(IKON_ITEM_RALAN);
        ...
        BtnPenilaianPasienImunitasRendah.setIcon(IKON_ITEM_RALAN); 
        ...
        BtnCatatanKeseimbanganCairan.setIcon(IKON_ITEM_RALAN); 
        ...
        BtnCatatanObservasiCHBP.setIcon(IKON_ITEM_RALAN); 
        ...
        BtnCatatanObservasiInduksiPersalinan.setIcon(IKON_ITEM_RALAN); 
    ...
    private void simpan() {
        switch (TabRawat.getSelectedIndex()) {
            ...
            case 2:
                ...
                break;
            case 3:
                // Cek apakah login sebagai Admin Utama
                if (!akses.getkode().equals("Admin Utama")) {
                    // Validasi input TSuhu
                    if (TSuhu.getText().trim().equals("") || TSuhu.getText().trim().equals("-")) {
                        JOptionPane.showMessageDialog(null, "Maaf, kolom Suhu tidak boleh dikosongkan silahkan isikan data real pasien");
                        TSuhu.requestFocus();
                        return;
                    }

                    // Validasi input TTensi
                    if (TTensi.getText().trim().equals("") || TTensi.getText().trim().equals("-")) {
                        JOptionPane.showMessageDialog(null, "Maaf, kolom Tensi tidak boleh dikosongkan silahkan isikan data real pasien");
                        TTensi.requestFocus();
                        return;
                    }

                    // Validasi input TNadi
                    if (TNadi.getText().trim().equals("") || TNadi.getText().trim().equals("-")) {
                        JOptionPane.showMessageDialog(null, "Maaf, kolom Nadi tidak boleh dikosongkan silahkan isikan data real pasien");
                        TNadi.requestFocus();
                        return;
                    }

                    // Validasi input TRespirasi
                    if (TRespirasi.getText().trim().equals("") || TRespirasi.getText().trim().equals("-")) {
                        JOptionPane.showMessageDialog(null, "Maaf, kolom Respirasi tidak boleh dikosongkan silahkan isikan data real pasien");
                        TRespirasi.requestFocus();
                        return;
                    }

                    // Validasi input SpO2
                    if (SpO2.getText().trim().equals("") || SpO2.getText().trim().equals("-")) {
                        JOptionPane.showMessageDialog(null, "Maaf, kolom SpO2 tidak boleh dikosongkan silahkan isikan data real pasien");
                        SpO2.requestFocus();
                        return;
                    }

                    // Validasi input TGCS
                    if (TGCS.getText().trim().equals("") || TGCS.getText().trim().equals("-")) {
                        JOptionPane.showMessageDialog(null, "Maaf, kolom GCS tidak boleh dikosongkan silahkan isikan data real pasien");
                        TGCS.requestFocus();
                        return;
                    } else if (TGCS.getText().contains(",")) {
                        JOptionPane.showMessageDialog(null, "Maaf, Kolom GCS tidak usah dirincikan, isikan Total saja");
                        TGCS.requestFocus();
                        return;
                    }

                    // Validasi input TTinggi
                    if (TTinggi.getText().trim().equals("") || TTinggi.getText().trim().equals("-")) {
                        JOptionPane.showMessageDialog(null, "Maaf, kolom Tinggi tidak boleh dikosongkan silahkan isikan data real pasien");
                        TTinggi.requestFocus();
                        return;
                    }

                    // Validasi input TBerat
                    if (TBerat.getText().trim().equals("") || TBerat.getText().trim().equals("-")) {
                        JOptionPane.showMessageDialog(null, "Maaf, kolom Berat tidak boleh dikosongkan silahkan isikan data real pasien");
                        TBerat.requestFocus();
                        return;
                    }

                    // Validasi input LingkarPerut
                    if (LingkarPerut.getText().trim().equals("") || LingkarPerut.getText().trim().equals("-")) {
                        JOptionPane.showMessageDialog(null, "Maaf, kolom Berat tidak boleh dikosongkan silahkan isikan data real pasien");
                        LingkarPerut.requestFocus();
                        return;
                    }

                    // Validasi input TAlergi
                    if (TAlergi.getText().trim().equals("")) {
                        JOptionPane.showMessageDialog(null, "Maaf, kolom Alergi tidak boleh dikosongkan silahkan isikan data real pasien");
                        TAlergi.requestFocus();
                        return;
                    }
                }

                // Jika validasi lolos atau login sebagai Admin Utama, lanjutkan penyimpanan data
                if (KdPeg.getText().trim().equals("") || TPegawai.getText().trim().equals("")) {
                    Valid.textKosong(KdPeg,"Dokter/Paramedis masih kosong...!!");
                } else {
                    if (Sequel.menyimpantf("pemeriksaan_ralan", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "Data", 21, 
                        new String[]{
                            ...
                            LingkarPerut.getText(),TindakLanjut.getText(),TPenilaian.getText(),TInstruksi.getText(),TEvaluasi.getText(),KdPeg.getText()
                        }
                    ) == true) {
                        tabModePemeriksaan.addRow(new Object[]{
...
public boolean cekDuplikasiTindakan(String noRawat, String kdDokter, String kdTindakan, String tglPeriksa) {
    ...
    try {
        ps = koneksi.prepareStatement(
            "SELECT COUNT(*) FROM nama_tabel_tindakan WHERE no_rawat = ? AND kd_dokter = ? AND kd_jenis_prw = ? AND tgl_periksa = ?"
        );
        ps.setString(1, noRawat);
        ps.setString(2, kdDokter);
        ps.setString(3, kdTindakan);
        ps.setString(4, tglPeriksa); // Format harus disesuaikan 'yyyy-MM-dd' atau dengan waktu jika diperlukan

        rs = ps.executeQuery();
        if (rs.next()) {
            duplikat = rs.getInt(1) > 0;
        }
    } catch (Exception e) {
        System.out.println("Error cek duplikasi: " + e.getMessage());
    } finally {
