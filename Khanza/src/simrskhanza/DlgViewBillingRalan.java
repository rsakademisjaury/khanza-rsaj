...
public class DlgViewBillingRalan extends javax.swing.JDialog {
    static {
    ...
    public DlgViewBillingRalan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        initFx();
        setTitle("Laporan Billing Ralan (Web)");
        setDefaultCloseOperation(DISPOSE_ON_CLOSE);
        setSize(1100, 700);
        setLocationRelativeTo(parent);
    }
    public DlgViewBillingRalan(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
        initFx();
        setTitle("Laporan Billing Ralan (Web)");
    ...
    private void tampilByNoRawat(String nr) {
        ...
        String raw = baseWebapps + "/billing/proxy_view.php"
                + "?target=" + urlenc("LaporanBillingRalan.php")
    ...
    private void simpanGambarKeBerkas() {
        ...
        new Thread(() -> {
            try{
                int sukses = fetchPdfAndUploadAsJpg(nr, false);
