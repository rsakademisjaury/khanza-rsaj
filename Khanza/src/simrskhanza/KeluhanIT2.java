 ...
 * @author dosen
 */
public final class KeluhanIT2 extends javax.swing.JDialog {
...
//    private InventarisRuang ruang=new InventarisRuang(null,false); 
     ...
     * @param parent
     * @param modal */
    public KeluhanIT2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        isiDataLogin(); 
        
        JComboBox<String> cmbListKeluhan;
    JButton btnPC, btnMonitor, btnPrinter, btnKeyboardMouse, btnJaringan;

    String[] keluhanPC = {"Tidak bisa nyala", "Lambat", "Bluescreen"};
    String[] keluhanMonitor = {"Tidak tampil", "Kedip-kedip", "Resolusi salah"};
    String[] keluhanPrinter = {"Tidak bisa print", "Kertas macet", "Tinta habis"};
    String[] keluhanKeyboardMouse = {"Keyboard error", "Mouse tidak bergerak", "Tombol rusak"};
    String[] keluhanJaringan = {"Tidak ada koneksi", "Internet lambat", "IP conflict"};

    
        setTitle("Form Pengaduan IT");
        setSize(400, 300);
        ...
        btnKeyboardMouse = new JButton("Keyboard/Mouse");
        btnJaringan = new JButton("Jaringan");

        panelTombol.add(btnPC);
        panelTombol.add(btnMonitor);
        panelTombol.add(btnPrinter);
        panelTombol.add(btnKeyboardMouse);
        panelTombol.add(btnJaringan);

        // ComboBox keluhan
        cmbListKeluhan = new JComboBox<>();
        JPanel panelCombo = new JPanel();
        panelCombo.add(new JLabel("Keluhan:"));
        panelCombo.add(cmbListKeluhan);

        add(panelTombol, BorderLayout.NORTH);
        add(panelCombo, BorderLayout.CENTER);

        // Action Listener
        btnPC.addActionListener((ActionEvent e) -> setKeluhanList(keluhanPC));
        btnMonitor.addActionListener((ActionEvent e) -> setKeluhanList(keluhanMonitor));
        btnPrinter.addActionListener((ActionEvent e) -> setKeluhanList(keluhanPrinter));
        btnKeyboardMouse.addActionListener((ActionEvent e) -> setKeluhanList(keluhanKeyboardMouse));
        btnJaringan.addActionListener((ActionEvent e) -> setKeluhanList(keluhanJaringan));
...
//    unit.setText(unitLogin); 
    ...
    private void initComponents() {
        ...
        labelstatus1 = new widget.Label();
        cmbListKeluhan = new widget.ComboBox();
        btnPC = new widget.Button();
        btnMonitor = new widget.Button();
        btnPrinter = new widget.Button();
        btnJaringan = new widget.Button();
        btnKeyboardMouse = new widget.Button();
        ...
        labeltglpermintaan.setBounds(220, 20, 60, 26);

        tgl_permintaan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "23-05-2025 02:01:43" }));
        ...
        tgl_permintaan.setBounds(280, 20, 140, 26);
        ...
        labelkategori1.setBounds(60, 460, 110, 26);
        ...
        comboKategori.setBounds(170, 460, 140, 26);
        ...
        combojenis.setBounds(170, 490, 140, 26);
        ...
        labeljenis.setBounds(60, 490, 100, 26);
        ...
        jScrollPane1.setBounds(20, 370, 620, 60);
        ...
        labeldetailkeluhan.setBounds(20, 340, 100, 23);
        ...
        labelketkategori.setBounds(320, 460, 380, 26);
        ...
        labelurgensi.setBounds(60, 520, 110, 26);
        ...
        combourgensi.setBounds(170, 520, 140, 26);
        ...
        statuskeluhan.setBounds(70, 20, 140, 26);

        tgl_selesai.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "23-05-2025 02:01:44" }));
        ...
        labelketurgensi.setBounds(320, 520, 140, 26);
        ...
        tgl_onproses.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "23-05-2025 02:01:44" }));
        ...
        labelstatus1.setName("labelstatus1"); // NOI18N
        FormInput.add(labelstatus1);
        labelstatus1.setBounds(20, 20, 100, 26);

        cmbListKeluhan.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        cmbListKeluhan.setName("cmbListKeluhan"); // NOI18N
        cmbListKeluhan.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                cmbListKeluhanKeyPressed(evt);
            }
        });
        FormInput.add(cmbListKeluhan);
        cmbListKeluhan.setBounds(30, 200, 590, 40);

        btnPC.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/keluhan/pc.png"))); // NOI18N
        btnPC.setMnemonic('S');
        btnPC.setToolTipText("Alt+S");
        btnPC.setName("btnPC"); // NOI18N
        btnPC.setPreferredSize(new java.awt.Dimension(100, 100));
        btnPC.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnPCActionPerformed(evt);
            }
        });
        btnPC.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                btnPCKeyPressed(evt);
            }
        });
        FormInput.add(btnPC);
        btnPC.setBounds(30, 80, 100, 100);

        btnMonitor.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/keluhan/monitor.png"))); // NOI18N
        btnMonitor.setMnemonic('S');
        btnMonitor.setToolTipText("Alt+S");
        btnMonitor.setName("btnMonitor"); // NOI18N
        btnMonitor.setPreferredSize(new java.awt.Dimension(100, 100));
        btnMonitor.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnMonitorActionPerformed(evt);
            }
        });
        btnMonitor.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                btnMonitorKeyPressed(evt);
            }
        });
        FormInput.add(btnMonitor);
        btnMonitor.setBounds(150, 80, 110, 100);

        btnPrinter.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/keluhan/printer (1).png"))); // NOI18N
        btnPrinter.setMnemonic('S');
        btnPrinter.setToolTipText("Alt+S");
        btnPrinter.setName("btnPrinter"); // NOI18N
        btnPrinter.setPreferredSize(new java.awt.Dimension(100, 100));
        btnPrinter.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnPrinterActionPerformed(evt);
            }
        });
        btnPrinter.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                btnPrinterKeyPressed(evt);
            }
        });
        FormInput.add(btnPrinter);
        btnPrinter.setBounds(280, 80, 100, 100);

        btnJaringan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/keluhan/wifi-router.png"))); // NOI18N
        btnJaringan.setMnemonic('S');
        btnJaringan.setToolTipText("Alt+S");
        btnJaringan.setName("btnJaringan"); // NOI18N
        btnJaringan.setPreferredSize(new java.awt.Dimension(100, 100));
        btnJaringan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnJaringanActionPerformed(evt);
            }
        });
        btnJaringan.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                btnJaringanKeyPressed(evt);
            }
        });
        FormInput.add(btnJaringan);
        btnJaringan.setBounds(520, 80, 100, 100);

        btnKeyboardMouse.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/keluhan/keyboard-and-mouse.png"))); // NOI18N
        btnKeyboardMouse.setMnemonic('S');
        btnKeyboardMouse.setToolTipText("Alt+S");
        btnKeyboardMouse.setName("btnKeyboardMouse"); // NOI18N
        btnKeyboardMouse.setPreferredSize(new java.awt.Dimension(100, 100));
        btnKeyboardMouse.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnKeyboardMouseActionPerformed(evt);
            }
        });
        btnKeyboardMouse.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                btnKeyboardMouseKeyPressed(evt);
            }
        });
        FormInput.add(btnKeyboardMouse);
        btnKeyboardMouse.setBounds(400, 80, 100, 100);
...
//    }    
    ...
    private void BtnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCariActionPerformed
        try {
            ...
            Logger.getLogger(KeluhanIT2.class.getName()).log(Level.SEVERE, null, ex);
        }
...
private String hitungDurasi(java.util.Date mulai, java.util.Date selesai) {
    ...
    private void cmbListKeluhanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cmbListKeluhanKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_cmbListKeluhanKeyPressed
    ...
    private void btnPCKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnPCKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnPCKeyPressed
    ...
    private void btnMonitorKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnMonitorKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnMonitorKeyPressed
    ...
    private void btnPrinterKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnPrinterKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnPrinterKeyPressed

    private void btnJaringanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnJaringanActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnJaringanActionPerformed

    private void btnJaringanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnJaringanKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnJaringanKeyPressed

    private void btnKeyboardMouseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnKeyboardMouseActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnKeyboardMouseActionPerformed

    private void btnKeyboardMouseKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnKeyboardMouseKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnKeyboardMouseKeyPressed
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            KeluhanIT2 dialog = new KeluhanIT2(new javax.swing.JFrame(), true);
    ...
    private widget.Button btnJaringan;
    private widget.Button btnKeyboardMouse;
    private widget.Button btnMonitor;
    private widget.Button btnPC;
    private widget.Button btnPrinter;
    private widget.ComboBox cmbListKeluhan;
    ...
    private widget.Label labelstatus1;
...
private String getStringValue(Object obj) {
    ...
    private void setKeluhanList(String[] keluhan) {
        cmbListKeluhan.removeAllItems();
        for (String k : keluhan) {
            cmbListKeluhan.addItem(k);
        }
    }
