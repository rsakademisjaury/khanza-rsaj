 ...
 */
public class WarnaTableSelectedRanap extends DefaultTableCellRenderer {
    ...
    public WarnaTableSelectedRanap() {
        this(8, 10, 0, 11);
    }

    public WarnaTableSelectedRanap(int colStatusBayar, int colStatusCoding, int colStart, int colEnd) {
