...
public class DlgRL43_10BesarKematianRawatInap extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgRL43_10BesarKematianRawatInap(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        TabRawat.setTitleAt(0, "Berdasar Pasien Keluar");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("RL 4.3 - 10 Besar Kematian Penyakit Pasien Rawat Inap ");
                            ...
                            "<table width='100%' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"+
                                "<tr class='isi2'>"+
                                    "<td valign='top' align='center'>"+
                                        ...
                                        "<font size='2' face='Tahoma'>RL 4.3 10 BESAR KEMATIAN PENYAKIT RAWAT INAP<br>PERIODE "+Tgl1.getSelectedItem()+" s.d. "+Tgl2.getSelectedItem()+"<br><br></font>"+        
                                    "</td>"+
                               "</tr>"+
                            "</table>")
                );
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRL43_10BesarKematianRawatInap dialog = new DlgRL43_10BesarKematianRawatInap(new javax.swing.JFrame(), true);
...
private void prosesCari() {
    ...
    try {
        ...
        htmlContent.append("<tr class='header'>"
            + "<td bgcolor='#F7F7F7' align='center' width='4%' rowspan='2'>No.</td>"
            + "<td bgcolor='#F7F7F7' align='center' width='8%' rowspan='2'>Kelompok ICD-10</td>"
            + "<td bgcolor='#F7F7F7' align='center' rowspan='2'>Kelompok Diagnosis Penyakit</td>"
        ...
        String query = "SELECT dp.kelompok_icd, SUBSTRING(pyk.nm_penyakit,1,80) AS nm_penyakit, b.jk, b.meninggal " +
                       "FROM ( " +
                       "   SELECT rp.no_rawat, pasien.jk, MAX(CASE WHEN ki.stts_pulang = 'Meninggal' THEN 1 ELSE 0 END) AS meninggal " +
                       "   FROM reg_periksa rp " +
                       "   INNER JOIN pasien ON pasien.no_rkm_medis = rp.no_rkm_medis " +
                       "   INNER JOIN kamar_inap ki ON ki.no_rawat = rp.no_rawat " +
                       "   WHERE rp.status_lanjut = 'Ranap' AND rp.stts <> 'Batal' " +
                       "   AND ki.tgl_keluar BETWEEN ? AND ? " +
                       "   AND ki.stts_pulang NOT IN ('Pindah Kamar','pindah kamar','-') " +
                       "   GROUP BY rp.no_rawat, pasien.jk " +
                       ") b " +
                       "INNER JOIN ( " +
                       "   SELECT no_rawat, LEFT(MIN(kd_penyakit),3) AS kelompok_icd, MIN(kd_penyakit) AS kd_penyakit " +
                       "   FROM diagnosa_pasien WHERE status = 'Ranap' AND prioritas = '1' GROUP BY no_rawat " +
                       ") dp ON dp.no_rawat = b.no_rawat " +
                       "INNER JOIN penyakit pyk ON pyk.kd_penyakit = dp.kd_penyakit " +
                       "WHERE dp.kelompok_icd NOT IN ('O80','O82') " +
                       "AND LEFT(dp.kelompok_icd,1) NOT IN ('R','V','W','X','Y','Z')";
        ...
        kodeList.sort((a, b) -> {
            int totalB = meninggalLakiMap.getOrDefault(b, 0) + meninggalPerempuanMap.getOrDefault(b, 0);
            int totalA = meninggalLakiMap.getOrDefault(a, 0) + meninggalPerempuanMap.getOrDefault(a, 0);
        ...
        for (String kode : kodeList.stream().limit(10).collect(Collectors.toList())) {
            ...
            int matiL = meninggalLakiMap.getOrDefault(kode, 0);
            int matiP = meninggalPerempuanMap.getOrDefault(kode, 0);
            int totalMati = matiL + matiP;
            ...
            htmlContent.append("<tr class='isi'>")
                ...
                .append("<td align='center'>").append(laki).append("</td>")
                .append("<td align='center'>").append(perempuan).append("</td>")
                .append("<td align='center'>").append(total).append("</td>")
                .append("<td align='center'>").append(matiL).append("</td>")
                .append("<td align='center'>").append(matiP).append("</td>")
                .append("<td align='center'>").append(totalMati).append("</td></tr>");
        }

        htmlContent.append("</table></body></html>");
        LoadHTML.setText(htmlContent.toString());
    } catch (Exception e) {
        System.out.println("Notifikasi prosesCari RL4.3 SIRS 6.3 : " + e);
    } finally {
