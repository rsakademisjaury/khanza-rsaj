...
public final class DlgKunjunganRadRanap extends javax.swing.JDialog {
    ...
    public DlgKunjunganRadRanap(java.awt.Frame parent, boolean modal) {
        ...
        Object[] rowRwJlDr={
            ...
            "Kode",//11
            "Diagnosa",//12
            "Jenis Pemeriksaan",//13
            "Dokter Perujuk/Pengirim",//14
            "Asal Ruang",//15
            "Total Bayar"//16
        };
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    tabMode.addRow(new Object[]{
                        ...
                        umurlk,//8
                        umurpr,//9
                        rs.getString("almt_pj"),//10
                        kddiangnosa,//11
                        diagnosa,//12
                        tindakan,//13
                        rs.getString("nm_dokter"),//14
                        rs.getString("kd_kamar")+" "+rs.getString("nm_bangsal"),//15
                        rs.getDouble("total_bayar") //16     
                    });                
                    i++;
                }
                if(i>1){
