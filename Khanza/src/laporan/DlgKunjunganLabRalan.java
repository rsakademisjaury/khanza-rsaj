        ...
        try{   
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    // No. SEP (ganti nama tabel sesuai skema Anda: bridging_sep / brigding_sep)
                    String no_sep = Sequel.cariIsi(
                        "select no_sep from bridging_sep where no_rawat='" + rs.getString("no_rawat") + "' and jnspelayanan='2'"
                    );
                    ...
                    tabMode.addRow(new Object[]{
                        i, rs.getString("tgl_periksa")+" "+rs.getString("jam"), no_lab, no_sep, rs.getString("no_rkm_medis"),
