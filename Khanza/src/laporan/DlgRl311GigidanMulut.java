 ...
 * @author perpustakaan
 */
public final class DlgRl311GigidanMulut extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgRl311GigidanMulut(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("RL 3.11 - Gigi dan Mulut");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRl311GigidanMulut dialog = new DlgRl311GigidanMulut(new javax.swing.JFrame(), true);
...
//        ps = koneksi.prepareStatement(
//                "select poliklinik.kd_poli, poliklinik.nm_poli from poliklinik " +
//                "where poliklinik.kd_poli = '3' order by poliklinik.nm_poli");
//        try {
//            rs = ps.executeQuery();
//            i = 1;
//            ttl = 0;
//            while (rs.next()) {
//                pstindakan = koneksi.prepareStatement("select jns_perawatan.nm_perawatan, count(jns_perawatan.nm_perawatan) as jumlah " +
//                    "from rawat_jl_drpr " +
...
//                        "where reg_periksa.kd_poli=? and reg_periksa.tgl_registrasi between ? and ? and jns_perawatan.nm_perawatan like ? group by jns_perawatan.nm_perawatan ");
            ...
            pstindakan = koneksi.prepareStatement(
                        ...
                        "    AND jns_perawatan.nm_perawatan NOT LIKE '%uroflowmetri%' " +        
                        "    AND jns_perawatan.nm_perawatan NOT LIKE '%bahan%' " +                
