...
public class DlgRL52_10BesarPenyakitRawatJalan extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgRL52_10BesarPenyakitRawatJalan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        TabRawat.setTitleAt(0, "RL 5.2 Rawat Jalan");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("RL 5.2 10 Besar Kasus Baru Penyakit Rawat Jalan ");
                            ...
                            "<table width='100%' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"+
                                "<tr class='isi2'>"+
                                    "<td valign='top' align='center'>"+
                                        ...
                                        "<font size='2' face='Tahoma'>RL 5.2 10 BESAR KASUS BARU PENYAKIT RAWAT JALAN<br>PERIODE "+Tgl1.getSelectedItem()+" s.d. "+Tgl2.getSelectedItem()+"<br><br></font>"+        
                                    "</td>"+
                               "</tr>"+
                            "</table>")
                );
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRL52_10BesarPenyakitRawatJalan dialog = new DlgRL52_10BesarPenyakitRawatJalan(new javax.swing.JFrame(), true);
...
private void prosesCari() {
    ...
    try {
        ...
        kodeList.sort((a, b) -> {
            int totalB = kasusBaruL.getOrDefault(b, 0) + kasusBaruP.getOrDefault(b, 0);
            int totalA = kasusBaruL.getOrDefault(a, 0) + kasusBaruP.getOrDefault(a, 0);
        ...
        System.out.println("Notifikasi prosesCariRL52 SIRS 6.3: " + e);
    } finally {
