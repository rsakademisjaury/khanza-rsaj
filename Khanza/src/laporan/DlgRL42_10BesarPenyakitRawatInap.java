                            ...
                            "<table width='100%' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"+
                                "<tr class='isi2'>"+
                                    "<td valign='top' align='center'>"+
                                        ...
                                        "<font size='2' face='Tahoma'>RL 4.2 10 BESAR PENYAKIT RAWAT INAP<br>PERIODE "+Tgl1.getSelectedItem()+" s.d. "+Tgl2.getSelectedItem()+"<br><br></font>"+        
                                    "</td>"+
                               "</tr>"+
                            "</table>")
                );
...
private void prosesCari() {
    ...
    try {
        ...
        kodeList.sort((a, b) -> {
            int totalB = lakiMap.getOrDefault(b, 0) + perempuanMap.getOrDefault(b, 0);
            int totalA = lakiMap.getOrDefault(a, 0) + perempuanMap.getOrDefault(a, 0);
        ...
        System.out.println("Notifikasi prosesCari RL4.2 SIRS 6.3 : " + e);
    } finally {
