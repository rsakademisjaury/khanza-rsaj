...
public class DlgWaktuTungguLab extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgWaktuTungguLab(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Waktu Tunggu Layanan Laboratorium ");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgWaktuTungguLab dialog = new DlgWaktuTungguLab(new javax.swing.JFrame(), true);
...
private void prosesCari() {
    ...
    try {
        ...
        htmlContent.append(
            "<tr class='isi'>"
            + "<th style='background-color:#E8F9FF; font-family: Arial; font-size: 9px; width: 25px;' align='center'>No.</th>"
            + "<th style='background-color:#E8F9FF; font-family: Arial; font-size: 9px; width: 75px;' align='center'>No. Permintaan</th>"
            + "<th style='background-color:#E8F9FF; font-family: Arial; font-size: 9px; width: 90px;' align='center'>Waktu Order</th>"
            + "<th style='background-color:#E8F9FF; font-family: Arial; font-size: 9px; width: 40px;' align='center'>No. RM</th>"
            + "<th style='background-color:#E8F9FF; font-family: Arial; font-size: 9px; width: 150px;' align='center'>Nama</th>"
            + "<th style='background-color:#E8F9FF; font-family: Arial; font-size: 9px; width: 70px;' align='center'>Cara Bayar</th>"
            + "<th style='background-color:#E8F9FF; font-family: Arial; font-size: 9px; width: 70px;' align='center'>Ruangan / Unit</th>"
            + "<th style='background-color:#E8F9FF; font-family: Arial; font-size: 9px; width: 90px;' align='center'>Waktu Sampel</th>"
            + "<th style='background-color:#E8F9FF; font-family: Arial; font-size: 9px; width: 90px;' align='center'>Waktu Selesai</th>"
            + "<th style='background-color:#E8F9FF; font-family: Arial; font-size: 9px; width: 60px;' align='center'>Lama Pelayanan<br>120 Menit</th>"
            + "<th style='background-color:#E8F9FF; font-family: Arial; font-size: 9px;' align='center'>Isi Pemeriksaan</th>"
            + "</tr>"
        );
        ...
        String sql = "SELECT permintaan_lab.noorder, permintaan_lab.tgl_permintaan, permintaan_lab.jam_permintaan, " +
                "pasien.no_rkm_medis, pasien.nm_pasien, penjab.png_jawab, IFNULL(bangsal.nm_bangsal, poliklinik.nm_poli) AS ruangan, " +
                "permintaan_lab.tgl_sampel, permintaan_lab.jam_sampel, permintaan_lab.tgl_hasil, permintaan_lab.jam_hasil, " +
                "GROUP_CONCAT(template_laboratorium.Pemeriksaan SEPARATOR ', ') AS pemeriksaan " +
                "FROM permintaan_lab " +
                ...
                "LEFT JOIN permintaan_pemeriksaan_lab ON permintaan_lab.noorder = permintaan_pemeriksaan_lab.noorder " +
                "LEFT JOIN template_laboratorium ON permintaan_pemeriksaan_lab.kd_jenis_prw = template_laboratorium.kd_jenis_prw " +
                "WHERE permintaan_lab.tgl_permintaan BETWEEN ? AND ? " +
                "GROUP BY permintaan_lab.noorder ORDER BY permintaan_lab.tgl_permintaan, permintaan_lab.jam_permintaan";
        ...
        int no = 1;
        while (rs.next()) {
            String waktuOrder = rs.getString("tgl_permintaan") + " " + rs.getString("jam_permintaan");
            String waktuSampel = rs.getString("tgl_sampel") + " " + rs.getString("jam_sampel");
            String waktuHasil = rs.getString("tgl_hasil") + " " + rs.getString("jam_hasil");
            long selisihDetik = Sequel.selisihtime(waktuSampel, waktuHasil); // fungsi harus mengembalikan selisih dalam detik
            String lamaPelayanan = String.format("%02d:%02d:%02d", 
                selisihDetik / 3600, 
                (selisihDetik % 3600) / 60, 
                selisihDetik % 60);

            boolean lewat2Jam = selisihDetik > 7200;

            htmlContent.append("<tr class='isi'>")
                .append("<td style='width:25px;' align='center'>").append(no++).append("</td>")
                .append("<td style='width:75px;' align='center'>").append(rs.getString("noorder")).append("</td>")
                .append("<td style='width:90px;' align='center'>").append(waktuOrder).append("</td>")
                .append("<td style='width:40px;' align='center'>").append(rs.getString("no_rkm_medis")).append("</td>")
                .append("<td style='width:150px;' align='left'>").append(rs.getString("nm_pasien")).append("</td>")
                .append("<td style='width:70px;' align='left'>").append(rs.getString("png_jawab")).append("</td>")
                .append("<td style='width:70px;' align='left'>").append(rs.getString("ruangan")).append("</td>")
                .append("<td style='width:90px;' align='center'>").append(waktuSampel).append("</td>")
                .append("<td style='width:90px;' align='center'>").append(waktuHasil).append("</td>")
                .append("<td style='width:60px;' align='center'><span style='color:")
                .append(lewat2Jam ? "red" : "black").append(";'>").append(lamaPelayanan).append("</span></td>")
                .append("<td>").append(rs.getString("pemeriksaan")).append("</td>")
                .append("</tr>");
        }
        rs.close();
        ps.close();
