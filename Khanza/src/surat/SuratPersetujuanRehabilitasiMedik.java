 ...
 * @author salimmulyana
 */
public final class SuratPersetujuanRehabilitasiMedik extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public SuratPersetujuanRehabilitasiMedik(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        masa_berlaku.setDocument(new batasInput((byte)255).getKata(masa_berlaku));     
    ...
    private void initComponents() {
        ...
        MnCetakSJPDTTD.setText("Cetak Persetujuan Rehablitasi  Medik TTD");
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Surat Persetujuan Rehabilitasi Medik ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        TanggalPeriksa.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-03-2025" }));
        ...
        jLabel17.setText("Indikasi Fisioterapi lebih dari 4 kali :");
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(NoSurat.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("surat_persetujuan_rehabilitasimedik","?,?,?,?,?,?,?,?","No.Surat",8,new String[]{
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(Valid.hapusTabletf(tabMode,NoSurat,"surat_persetujuan_rehabilitasimedik","no_surat")==true){
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(NoSurat.getText().trim().equals("")){
            ...
            if(tbObat.getSelectedRow()!= -1){
                if(Sequel.mengedittf("surat_persetujuan_rehabilitasimedik","no_surat=?","no_surat=?,no_rawat=?,tanggalperiksa=?,diagnosa_utama=?,diagnosa_sekunder=?,indikasi=?,masa_berlaku=?",8,new String[]{
...
//            tgl=" surat_persetujuan_rehabilitasimedik.tanggalperiksa between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' ";
//            if(TCari.getText().trim().equals("")){
//                Valid.MyReportqry("rptDataSuratKewaspadaanKesehatan.jasper","report","::[ Data Surat Keterangan Kewaspadaan Kesehatan ]::",
//                     "select surat_persetujuan_rehabilitasimedik.no_surat,surat_persetujuan_rehabilitasimedik.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
//                     "surat_persetujuan_rehabilitasimedik.tanggalperiksa,surat_persetujuan_rehabilitasimedik.diagnosa_utama,reg_periksa.kd_dokter,dokter.nm_dokter,surat_persetujuan_rehabilitasimedik.jadwal "+                  
//                     "from surat_persetujuan_rehabilitasimedik inner join reg_periksa on surat_persetujuan_rehabilitasimedik.no_rawat=reg_periksa.no_rawat "+
...
//                     "where "+tgl+"order by surat_persetujuan_rehabilitasimedik.no_surat",param);
//            }else{
//                Valid.MyReportqry("rptDataSuratKewaspadaanKesehatan.jasper","report","::[ Data Surat Keterangan Kewaspadaan Kesehatan ]::",
//                     "select surat_persetujuan_rehabilitasimedik.no_surat,surat_persetujuan_rehabilitasimedik.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
//                     "surat_persetujuan_rehabilitasimedik.tanggalperiksa,surat_persetujuan_rehabilitasimedik.diagnosa_utama,reg_periksa.kd_dokter,dokter.nm_dokter,surat_persetujuan_rehabilitasimedik.jadwal "+                  
//                     "from surat_persetujuan_rehabilitasimedik inner join reg_periksa on surat_persetujuan_rehabilitasimedik.no_rawat=reg_periksa.no_rawat "+
//                     "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join dokter on dokter.kd_dokter=reg_periksa.kd_dokter "+
//                     "where "+tgl+"and (no_surat like '%"+TCari.getText().trim()+"%' or surat_persetujuan_rehabilitasimedik.no_rawat like '%"+TCari.getText().trim()+"%' or "+
//                     "reg_periksa.no_rkm_medis like '%"+TCari.getText().trim()+"%' or  pasien.nm_pasien like '%"+TCari.getText().trim()+"%' or "+
//                     "surat_persetujuan_rehabilitasimedik.tanggalperiksa like '%"+TCari.getText().trim()+"%' or surat_persetujuan_rehabilitasimedik.jadwal like '%"+TCari.getText().trim()+"%') "+                    
//                     "order by surat_persetujuan_rehabilitasimedik.no_surat",param);
//            }
//            
//        }
...
if(TPasien.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                ...
                "SELECT surat_persetujuan_rehabilitasimedik.no_surat,DATE_FORMAT( reg_periksa.tgl_registrasi, '%d-%m-%Y' ) AS tglregistrasi,"+
                "surat_persetujuan_rehabilitasimedik.diagnosa_utama,dokter.nm_dokter,pasien.jk,pasien.nm_pasien,DATE_FORMAT( pasien.tgl_lahir, '%d-%m-%Y' ) AS tgl_lahir,"+
                ...
                "surat_persetujuan_rehabilitasimedik.sekunder,surat_persetujuan_rehabilitasimedik.indikasi,surat_persetujuan_rehabilitasimedik.masa_berlaku,pasien.no_peserta AS nobpjs "+
                "FROM surat_persetujuan_rehabilitasimedik INNER JOIN reg_periksa INNER JOIN pasien INNER JOIN dokter INNER JOIN kelurahan INNER JOIN kecamatan "+
    ...
    private void MnCetakSJPDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSJPDActionPerformed
       if(TPasien.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                ...
                "surat_persetujuan_rehabilitasimedik.diagnosa_utama,dokter.nm_dokter,pasien.jk,pasien.nm_pasien,DATE_FORMAT( pasien.tgl_lahir, '%d-%m-%Y' ) AS tgl_lahir,"+
                "pasien.tmp_lahir,pasien.no_rkm_medis,pasien.pekerjaan,dokter.kd_dokter,concat( pasien.alamat, ', ', kelurahan.nm_kel, ', ', kecamatan.nm_kec, ', ', kabupaten.nm_kab ) AS alamat,"+
                "surat_persetujuan_rehabilitasimedik.diagnosa_sekunder,surat_persetujuan_rehabilitasimedik.indikasi,surat_persetujuan_rehabilitasimedik.masa_berlaku,pasien.no_peserta AS nobpjs "+
                "FROM surat_persetujuan_rehabilitasimedik INNER JOIN reg_periksa INNER JOIN pasien INNER JOIN dokter INNER JOIN kelurahan INNER JOIN kecamatan "+
                "INNER JOIN kabupaten ON reg_periksa.no_rkm_medis = pasien.no_rkm_medis "+
                "AND reg_periksa.kd_dokter = dokter.kd_dokter "+
                "AND pasien.kd_kel = kelurahan.kd_kel "+
    ...
    private void MnCetakSJPDTTDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSJPDTTDActionPerformed
           if(TPasien.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                ...
                finger=Sequel.cariIsi("select sha1(sidikjari.sidikjari) from sidikjari inner join pegawai on pegawai.id=sidikjari.id where pegawai.nik=?",tbObat.getValueAt(tbObat.getSelectedRow(),6).toString());
                param.put("finger","Dikeluarkan di "+akses.getnamars()+", Kabupaten/Kota "+akses.getkabupatenrs()+"\nDitandatangani secara elektronik oleh "+tbObat.getValueAt(tbObat.getSelectedRow(),7).toString()+"\nID "+(finger.equals("")?tbObat.getValueAt(tbObat.getSelectedRow(),6).toString():finger)+"\n"+Valid.SetTgl3(tbObat.getValueAt(tbObat.getSelectedRow(),4).toString()));
                Valid.MyReportqry("rptSuratPersetujuanRehabilitasiMedik.jasper","report","::[ Surat Keterangan Kewaspadaan Kesehatan ]::",
                "SELECT surat_persetujuan_rehabilitasimedik.no_surat,DATE_FORMAT( reg_periksa.tgl_registrasi, '%d-%m-%Y' ) AS tglregistrasi,"+
                "surat_persetujuan_rehabilitasimedik.diagnosa_utama,dokter.nm_dokter,pasien.jk,pasien.nm_pasien,DATE_FORMAT( pasien.tgl_lahir, '%d-%m-%Y' ) AS tgl_lahir,"+
                "pasien.tmp_lahir,pasien.no_rkm_medis,pasien.pekerjaan,dokter.kd_dokter,concat( pasien.alamat, ', ', kelurahan.nm_kel, ', ', kecamatan.nm_kec, ', ', kabupaten.nm_kab ) AS alamat,"+
                "surat_persetujuan_rehabilitasimedik.diagnosa_sekunder,surat_persetujuan_rehabilitasimedik.indikasi,surat_persetujuan_rehabilitasimedik.masa_berlaku,pasien.no_peserta AS nobpjs "+
    ...
    private void BtnUploadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnUploadActionPerformed
        ...
        FileName = timestamp + "_" + tbObat.getValueAt(tbObat.getSelectedRow(), 1).toString().replace("/", "") + "_FormulirPersetujuanRehabilitasiMedik";
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SuratPersetujuanRehabilitasiMedik dialog = new SuratPersetujuanRehabilitasiMedik(new javax.swing.JFrame(), true);
        ...
        try{
            ...
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                     "select surat_persetujuan_rehabilitasimedik.no_surat,surat_persetujuan_rehabilitasimedik.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                     "surat_persetujuan_rehabilitasimedik.tanggalperiksa,surat_persetujuan_rehabilitasimedik.diagnosa_utama,surat_persetujuan_rehabilitasimedik.diagnosa_sekunder,surat_persetujuan_rehabilitasimedik.indikasi,surat_persetujuan_rehabilitasimedik.masa_berlaku,reg_periksa.kd_dokter,dokter.nm_dokter "+                  
                     "from surat_persetujuan_rehabilitasimedik inner join reg_periksa on surat_persetujuan_rehabilitasimedik.no_rawat=reg_periksa.no_rawat "+
                     "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join dokter on dokter.kd_dokter=reg_periksa.kd_dokter "+
                     "where "+tgl+"order by surat_persetujuan_rehabilitasimedik.no_surat");
            }else{
                ps=koneksi.prepareStatement(
                    "select surat_persetujuan_rehabilitasimedik.no_surat,surat_persetujuan_rehabilitasimedik.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                     "surat_persetujuan_rehabilitasimedik.tanggalperiksa,surat_persetujuan_rehabilitasimedik.diagnosa_utama,surat_persetujuan_rehabilitasimedik.diagnosa_sekunder,surat_persetujuan_rehabilitasimedik.indikasi,surat_persetujuan_rehabilitasimedik.masa_berlaku,reg_periksa.kd_dokter,dokter.nm_dokter "+                  
                     ...
                     "where "+tgl+"and (no_surat like '%"+TCari.getText().trim()+"%' or surat_persetujuan_rehabilitasimedik.no_rawat like '%"+TCari.getText().trim()+"%' or "+
                     "reg_periksa.no_rkm_medis like '%"+TCari.getText().trim()+"%' or  pasien.nm_pasien like '%"+TCari.getText().trim()+"%' or "+
                     "surat_persetujuan_rehabilitasimedik.tanggalperiksa like '%"+TCari.getText().trim()+"%' or surat_persetujuan_rehabilitasimedik.indikasi like '%"+TCari.getText().trim()+"%') "+                    
                     "order by surat_persetujuan_rehabilitasimedik.no_surat");
            }
    ...
    public void emptTeks() {
        ...
        Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(surat_persetujuan_rehabilitasimedik.no_surat,3),signed)),0) from surat_persetujuan_rehabilitasimedik where surat_persetujuan_rehabilitasimedik.tanggalperiksa='"+Valid.SetTgl(TanggalPeriksa.getSelectedItem()+"")+"' ",
