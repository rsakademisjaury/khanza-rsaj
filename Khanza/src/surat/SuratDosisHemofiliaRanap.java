 ...
 * @author salimmulyana
 */
public final class SuratDosisHemofiliaRanap extends javax.swing.JDialog {
    ...
    private DlgCariDokter dokter=new DlgCariDokter(null,false);
     private String nomorSuratGenerated = "", FileName="",kodeberkas="";
    
    /** Creates new form DlgRujuk
     * @param parent
     * @param modal */
    public SuratDosisHemofiliaRanap(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        masa_berlaku.setDocument(new batasInput((byte)255).getKata(masa_berlaku));     
    ...
    private void initComponents() {
        ...
        MnCetakDosisHemofilia = new javax.swing.JMenuItem();
        ...
        dosis_perhitungan = new widget.TextArea();
        scrollPane3 = new widget.ScrollPane();
        on_demand = new widget.TextArea();
        scrollPane4 = new widget.ScrollPane();
        evaluasi = new widget.TextArea();
        kadar_faktor = new widget.TextBox();
        jLabel8 = new widget.Label();
        berat_badan = new widget.TextBox();
        ...
        MnCetakDosisHemofilia.setBackground(new java.awt.Color(255, 255, 254));
        MnCetakDosisHemofilia.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnCetakDosisHemofilia.setForeground(new java.awt.Color(50, 50, 50));
        MnCetakDosisHemofilia.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnCetakDosisHemofilia.setText("Cetak Dosis Hemofilia");
        MnCetakDosisHemofilia.setName("MnCetakDosisHemofilia"); // NOI18N
        MnCetakDosisHemofilia.setPreferredSize(new java.awt.Dimension(316, 30));
        MnCetakDosisHemofilia.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnCetakDosisHemofiliaActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnCetakDosisHemofilia);

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setUndecorated(true);
        setResizable(false);

        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Surat  Dosis Hemofilia Rawat Jalan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        jLabel3.setBounds(300, 420, 60, 23);
        ...
        NoSurat.setBounds(370, 420, 260, 23);
        ...
        TPasien.setBounds(265, 10, 300, 23);
        ...
        jLabel13.setBounds(460, 40, 100, 23);

        jLabel14.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel14.setText("Dosis perhitungan pemberian Faktor VIII / F IX : /12jam atau /24jam/Hari  :");
        jLabel14.setName("jLabel14"); // NOI18N
        FormInput.add(jLabel14);
        jLabel14.setBounds(11, 100, 440, 23);

        TanggalPeriksa.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "22-01-2025" }));
        TanggalPeriksa.setDisplayFormat("dd-MM-yyyy");
        TanggalPeriksa.setName("TanggalPeriksa"); // NOI18N
        FormInput.add(TanggalPeriksa);
        TanggalPeriksa.setBounds(560, 40, 85, 23);
        ...
        BtnDokter.setBounds(900, 70, 28, 23);

        label14.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        label14.setText("Dokter DPJP ");
        label14.setName("label14"); // NOI18N
        label14.setPreferredSize(new java.awt.Dimension(70, 23));
        FormInput.add(label14);
        label14.setBounds(460, 70, 70, 23);

        jLabel15.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel15.setText("On Demand / profilaksis  :");
        jLabel15.setName("jLabel15"); // NOI18N
        FormInput.add(jLabel15);
        jLabel15.setBounds(460, 100, 140, 20);

        jLabel16.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel16.setText("Kadar faktor VIII");
        jLabel16.setName("jLabel16"); // NOI18N
        FormInput.add(jLabel16);
        jLabel16.setBounds(11, 70, 100, 26);

        jLabel17.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel17.setText("Evaluasi  :");
        jLabel17.setName("jLabel17"); // NOI18N
        FormInput.add(jLabel17);
        jLabel17.setBounds(370, 450, 260, 20);

        scrollPane2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(153, 153, 153)));
        scrollPane2.setName("scrollPane2"); // NOI18N

        dosis_perhitungan.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        dosis_perhitungan.setColumns(20);
        dosis_perhitungan.setForeground(new java.awt.Color(0, 0, 0));
        dosis_perhitungan.setRows(5);
        dosis_perhitungan.setName("dosis_perhitungan"); // NOI18N
        dosis_perhitungan.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                dosis_perhitunganKeyPressed(evt);
            }
        });
        scrollPane2.setViewportView(dosis_perhitungan);

        FormInput.add(scrollPane2);
        scrollPane2.setBounds(10, 125, 440, 90);

        scrollPane3.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(153, 153, 153)));
        scrollPane3.setName("scrollPane3"); // NOI18N

        on_demand.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        on_demand.setColumns(20);
        on_demand.setForeground(new java.awt.Color(0, 0, 0));
        on_demand.setRows(5);
        on_demand.setName("on_demand"); // NOI18N
        on_demand.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                on_demandKeyPressed(evt);
            }
        });
        scrollPane3.setViewportView(on_demand);

        FormInput.add(scrollPane3);
        scrollPane3.setBounds(460, 125, 440, 90);
        ...
        scrollPane4.setBounds(370, 480, 440, 60);

        kadar_faktor.setForeground(new java.awt.Color(0, 0, 0));
        kadar_faktor.setHighlighter(null);
        kadar_faktor.setName("kadar_faktor"); // NOI18N
        kadar_faktor.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                kadar_faktorKeyPressed(evt);
            }
        });
        FormInput.add(kadar_faktor);
        kadar_faktor.setBounds(110, 70, 340, 23);

        jLabel8.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel8.setText("Berat Badan");
        jLabel8.setName("jLabel8"); // NOI18N
        FormInput.add(jLabel8);
        jLabel8.setBounds(11, 40, 100, 23);

        berat_badan.setForeground(new java.awt.Color(0, 0, 0));
        berat_badan.setHighlighter(null);
        berat_badan.setName("berat_badan"); // NOI18N
        berat_badan.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                berat_badanKeyPressed(evt);
            }
        });
        FormInput.add(berat_badan);
        berat_badan.setBounds(110, 40, 84, 23);
        ...
        jLabel10.setBounds(201, 40, 60, 23);
    ...
    private void NoSuratKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NoSuratKeyPressed
       Valid.pindah(evt,TCari,dosis_perhitungan);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(NoSurat.getText().trim().equals("")){
        ...
        }else if(dosis_perhitungan.getText().trim().equals("")){
            Valid.textKosong(TNoRw,"Dosis Perhitungan");
        }else if(on_demand.getText().trim().equals("")){
            Valid.textKosong(TNoRw,"On Demand");        
        }else if(kadar_faktor.getText().trim().equals("")){
            ...
            while (Integer.parseInt(Sequel.cariIsi("SELECT COUNT(*) FROM surat_dosis_hemofilia WHERE no_surat = ?", nomorSuratGenerated)) > 0) {
            ...
            if(Sequel.menyimpantf("surat_dosis_hemofilia","?,?,?,?,?,?,?,?,?","No.Surat",9,new String[]{
                    nomorSuratGenerated,
                    TNoRw.getText(),
                    Valid.SetTgl(TanggalPeriksa.getSelectedItem()+""),
                    dosis_perhitungan.getText(),
                    on_demand.getText(),
                    evaluasi.getText(),
                    kadar_faktor.getText(),
                    KdDokter.getText(),
                    berat_badan.getText(),                    
            })==true){
                tampil();
    ...
    private void BtnSimpanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnSimpanKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_SPACE){
            ...
            Valid.pindah(evt,kadar_faktor,BtnBatal);
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(Valid.hapusTabletf(tabMode,NoSurat,"surat_dosis_hemofilia","no_surat")==true){
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(NoSurat.getText().trim().equals("")){
            ...
            Valid.textKosong(TNoRw,"Evaluasi");   
        }else if(kadar_faktor.getText().trim().equals("")){
            Valid.textKosong(TNoRw,"Kadar Faktor");  
        }else{
            if(tbObat.getSelectedRow()!= -1){
                if(Sequel.mengedittf("surat_dosis_hemofilia","no_surat=?","no_surat=?,no_rawat=?,tanggalperiksa=?,dosis_perhitungan=?,on_demand=?,evaluasi=?,kadar_faktor=?",8,new String[]{
                        NoSurat.getText(),TNoRw.getText(),Valid.SetTgl(TanggalPeriksa.getSelectedItem()+""),dosis_perhitungan.getText(),on_demand.getText(),evaluasi.getText(),kadar_faktor.getText(),tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
                    })==true){
                    ...
                    tbObat.setValueAt(dosis_perhitungan.getText(),tbObat.getSelectedRow(),5);
                    tbObat.setValueAt(on_demand.getText(),tbObat.getSelectedRow(),6);
                    tbObat.setValueAt(evaluasi.getText(),tbObat.getSelectedRow(),7);
                    tbObat.setValueAt(kadar_faktor.getText(),tbObat.getSelectedRow(),8);                    
                    emptTeks();
                }
            }
        }
...
//            tgl=" surat_dosis_hemofilia.tanggalperiksa between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' ";
//            if(TCari.getText().trim().equals("")){
//                Valid.MyReportqry("rptDataSuratKewaspadaanKesehatan.jasper","report","::[ Data Surat Keterangan Kewaspadaan Kesehatan ]::",
//                     "select surat_dosis_hemofilia.no_surat,surat_dosis_hemofilia.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
//                     "surat_dosis_hemofilia.tanggalperiksa,surat_dosis_hemofilia.dosis_perhitungan,reg_periksa.kd_dokter,dokter.nm_dokter,surat_dosis_hemofilia.jadwal "+                  
//                     "from surat_dosis_hemofilia inner join reg_periksa on surat_dosis_hemofilia.no_rawat=reg_periksa.no_rawat "+
...
//                     "where "+tgl+"order by surat_dosis_hemofilia.no_surat",param);
//            }else{
//                Valid.MyReportqry("rptDataSuratKewaspadaanKesehatan.jasper","report","::[ Data Surat Keterangan Kewaspadaan Kesehatan ]::",
//                     "select surat_dosis_hemofilia.no_surat,surat_dosis_hemofilia.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
//                     "surat_dosis_hemofilia.tanggalperiksa,surat_dosis_hemofilia.dosis_perhitungan,reg_periksa.kd_dokter,dokter.nm_dokter,surat_dosis_hemofilia.jadwal "+                  
//                     "from surat_dosis_hemofilia inner join reg_periksa on surat_dosis_hemofilia.no_rawat=reg_periksa.no_rawat "+
//                     "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join dokter on dokter.kd_dokter=reg_periksa.kd_dokter "+
//                     "where "+tgl+"and (no_surat like '%"+TCari.getText().trim()+"%' or surat_dosis_hemofilia.no_rawat like '%"+TCari.getText().trim()+"%' or "+
//                     "reg_periksa.no_rkm_medis like '%"+TCari.getText().trim()+"%' or  pasien.nm_pasien like '%"+TCari.getText().trim()+"%' or "+
//                     "surat_dosis_hemofilia.tanggalperiksa like '%"+TCari.getText().trim()+"%' or surat_dosis_hemofilia.jadwal like '%"+TCari.getText().trim()+"%') "+                    
//                     "order by surat_dosis_hemofilia.no_surat",param);
//            }
//            
//        }
...
if(TPasien.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                ...
                "surat_dosis_hemofilia.dosis_perhitungan,dokter.nm_dokter,pasien.jk,pasien.nm_pasien,DATE_FORMAT( pasien.tgl_lahir, '%d-%m-%Y' ) AS tgl_lahir,"+
                ...
                "surat_dosis_hemofilia.sekunder,surat_dosis_hemofilia.evaluasi,surat_dosis_hemofilia.kadar_faktor,pasien.no_peserta AS nobpjs "+
                "FROM surat_dosis_hemofilia INNER JOIN reg_periksa INNER JOIN pasien INNER JOIN dokter INNER JOIN kelurahan INNER JOIN kecamatan "+
    ...
    private void MnCetakDosisHemofiliaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakDosisHemofiliaActionPerformed
           if(TPasien.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu pasien...!!!");
        }else{
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                ...
                finger=Sequel.cariIsi("select sha1(sidikjari.sidikjari) from sidikjari inner join pegawai on pegawai.id=sidikjari.id where pegawai.nik=?",tbObat.getValueAt(tbObat.getSelectedRow(),6).toString());
                param.put("finger","Dikeluarkan di "+akses.getnamars()+", Kabupaten/Kota "+akses.getkabupatenrs()+"\nDitandatangani secara elektronik oleh "+tbObat.getValueAt(tbObat.getSelectedRow(),7).toString()+"\nID "+(finger.equals("")?tbObat.getValueAt(tbObat.getSelectedRow(),6).toString():finger)+"\n"+Valid.SetTgl3(tbObat.getValueAt(tbObat.getSelectedRow(),4).toString()));
                Valid.MyReportqry("rptSuratDosisHemofilia.jasper","report","::[ Surat Keterangan Kewaspadaan Kesehatan ]::",
                "SELECT surat_dosis_hemofilia.no_surat,DATE_FORMAT( reg_periksa.tgl_registrasi, '%d %M %Y' ) AS tglregistrasi,"+
    ...
    }//GEN-LAST:event_MnCetakDosisHemofiliaActionPerformed
    ...
    private void dosis_perhitunganKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_dosis_perhitunganKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_ENTER){
            if(evt.isShiftDown()){
                dosis_perhitungan.requestFocus();
            }
        }else if(evt.getKeyCode()==KeyEvent.VK_PAGE_UP){
            dosis_perhitungan.requestFocus();
        }
    }//GEN-LAST:event_dosis_perhitunganKeyPressed

    private void on_demandKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_on_demandKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_on_demandKeyPressed
    ...
    private void kadar_faktorKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_kadar_faktorKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_kadar_faktorKeyPressed

    private void berat_badanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_berat_badanKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_berat_badanKeyPressed
    ...
    private void BtnUploadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnUploadActionPerformed
        ...
        FileName = timestamp + "_" + tbObat.getValueAt(tbObat.getSelectedRow(), 1).toString().replace("/", "") + "_DosisHemofiliaRanap";
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SuratDosisHemofiliaRanap dialog = new SuratDosisHemofiliaRanap(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JMenuItem MnCetakDosisHemofilia;
    ...
    private widget.TextBox berat_badan;
    private widget.TextArea dosis_perhitungan;
    ...
    private widget.TextBox kadar_faktor;
    private widget.Label label14;
    private widget.TextArea on_demand;
        ...
        try{
            ...
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                     "select surat_dosis_hemofilia.no_surat,surat_dosis_hemofilia.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                     "surat_dosis_hemofilia.tanggalperiksa,surat_dosis_hemofilia.dosis_perhitungan,surat_dosis_hemofilia.on_demand,surat_dosis_hemofilia.evaluasi,surat_dosis_hemofilia.kadar_faktor,surat_dosis_hemofilia.berat_badan,reg_periksa.kd_dokter,dokter.nm_dokter "+                  
                     "from surat_dosis_hemofilia inner join reg_periksa on surat_dosis_hemofilia.no_rawat=reg_periksa.no_rawat "+
                     "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join dokter on dokter.kd_dokter=reg_periksa.kd_dokter "+
                     "where "+tgl+"order by surat_dosis_hemofilia.no_surat");
            }else{
                ps=koneksi.prepareStatement(
                    "select surat_dosis_hemofilia.no_surat,surat_dosis_hemofilia.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                     "surat_dosis_hemofilia.tanggalperiksa,surat_dosis_hemofilia.dosis_perhitungan,surat_dosis_hemofilia.on_demand,surat_dosis_hemofilia.evaluasi,surat_dosis_hemofilia.kadar_faktor,surat_dosis_hemofilia.berat_badan,reg_periksa.kd_dokter,dokter.nm_dokter "+                  
                     ...
                     "where "+tgl+"and (no_surat like '%"+TCari.getText().trim()+"%' or surat_dosis_hemofilia.no_rawat like '%"+TCari.getText().trim()+"%' or "+
                     "reg_periksa.no_rkm_medis like '%"+TCari.getText().trim()+"%' or  pasien.nm_pasien like '%"+TCari.getText().trim()+"%' or "+
                     "surat_dosis_hemofilia.tanggalperiksa like '%"+TCari.getText().trim()+"%' or surat_dosis_hemofilia.evaluasi like '%"+TCari.getText().trim()+"%') "+                    
                     "order by surat_dosis_hemofilia.no_surat");
            }
    ...
    public void emptTeks() {
        ...
        NoSurat.setText("");        
        berat_badan.setText("");
        dosis_perhitungan.setText("");
        on_demand.setText("");
        evaluasi.setText("");
        kadar_faktor.setText("");        
        TanggalPeriksa.setDate(new Date());
        Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(surat_dosis_hemofilia.no_surat,3),signed)),0) from surat_dosis_hemofilia where surat_dosis_hemofilia.tanggalperiksa='"+Valid.SetTgl(TanggalPeriksa.getSelectedItem()+"")+"' ",
                "SDH"+TanggalPeriksa.getSelectedItem().toString().substring(6,10)+TanggalPeriksa.getSelectedItem().toString().substring(3,5)+TanggalPeriksa.getSelectedItem().toString().substring(0,2),3,NoSurat); 
        kadar_faktor.requestFocus();
    }
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            dosis_perhitungan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString());  
            on_demand.setText(tbObat.getValueAt(tbObat.getSelectedRow(),6).toString());  
            evaluasi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),7).toString());  
            kadar_faktor.setText(tbObat.getValueAt(tbObat.getSelectedRow(),8).toString());              
            berat_badan.setText(Sequel.cariIsi(
                "SELECT berat FROM pemeriksaan_ranap WHERE no_rawat=? AND tgl_perawatan = CURDATE()", 
                TNoRw.getText()
            ));
            KdDokter.setText(tbObat.getValueAt(tbObat.getSelectedRow(),10).toString());         
            NamaDokter.setText(tbObat.getValueAt(tbObat.getSelectedRow(),11).toString()); 
        }
    }
    ...
    public void setNoRm(String norwt,String norm,String pasien, Date tgl1, Date tgl2) {
        ...
        KdDokter.setText("D0201");
        NamaDokter.setText("Tutik H Dr Sp.PD");
        ChkInput.setSelected(true);
...
private void nomorSurat() {
    ...
    String lastNumber = Sequel.cariIsi(
        "SELECT MAX(CONVERT(LEFT(no_surat, 3), SIGNED)) FROM surat_dosis_hemofilia WHERE " +
        "no_surat LIKE '%/DOSIS/RSAJ/" + bln_romawi + "/" + TanggalPeriksa.getSelectedItem().toString().substring(6, 10) + "'"
    );
    ...
    nomorSuratGenerated = String.format("%03d", nextNumber) + "/DOSIS/RSAJ/" + bln_romawi + "/" + 
