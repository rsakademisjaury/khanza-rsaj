 ...
 * @author salimmulyana
 */
public final class LaporanTindakanOperasi extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public LaporanTindakanOperasi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        masa_berlaku.setDocument(new batasInput((byte)255).getKata(masa_berlaku));     
    ...
    private void initComponents() {
        ...
        JamSelesai.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "14:43:37" }));
...
private String convertToDateFormat(String dateStr) {
    ...
    private void BtnUploadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnUploadActionPerformed
        ...
        FileName = timestamp + "_" + tbOperasi.getValueAt(tbOperasi.getSelectedRow(), 0).toString().replace("/", "") + "_LaporanTindakanOperasiRalan";
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            LaporanTindakanOperasi dialog = new LaporanTindakanOperasi(new javax.swing.JFrame(), true);
...
//    }
    ...
    private void CreatePDF(String FileName) {
        if (TPasien.getText().trim().equals("")) {
            ...
            Valid.MyReportPDFqryUpload("rptLaporanTindakanOperasi.jasper", "report", "::[ Laporan Tindakan Operasi ]::",
                "SELECT tindakan_operasi.no_rawat, "
                + "DATE_FORMAT(tindakan_operasi.selesai_operasi, '%d %M %Y') AS tglcetak, "
                + "DATE_FORMAT(pasien.tgl_lahir, '%d %M %Y') AS tgl_lahir, "  
                + "poliklinik.nm_poli, "     
