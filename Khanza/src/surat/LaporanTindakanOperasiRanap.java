 ...
 * @author salimmulyana
 */
public final class LaporanTindakanOperasiRanap extends javax.swing.JDialog {
    ...
    private int i=0;
    private String tgl,finger,bln_angka = "", bln_romawi = "",kodedokter="",namadokter="",FileName = "", kodeberkas = "";
     ...
     * @param parent
     * @param modal */
    public LaporanTindakanOperasiRanap(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        masa_berlaku.setDocument(new batasInput((byte)255).getKata(masa_berlaku));     
        ...
        dokter.addWindowListener(new WindowListener() {
             ...
             public void windowClosed(WindowEvent e) {
                 if(akses.getform().equals("LaporanTindakanOperasi")){
    ...
    private void initComponents() {
        ...
        JamMulai = new widget.Tanggal();
        JamSelesai = new widget.Tanggal();
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Laporan Tindakan Operasi Rawat Jalan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        MulaiOperasi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "27-12-2025" }));
        MulaiOperasi.setDisplayFormat("dd-MM-yyyy");
        MulaiOperasi.setDoubleBuffered(true);
        MulaiOperasi.setName("MulaiOperasi"); // NOI18N
        FormInput.add(MulaiOperasi);
        MulaiOperasi.setBounds(720, 190, 85, 23);
        ...
        BtnDokter.setBounds(530, 40, 28, 23);
        ...
        GolonganOperasi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "-", "Khusus", "Besar", "Sedang", "Kecil", "Elektive", "Emergency", "Tidak Ada" }));
        ...
        label15.setBounds(900, 190, 90, 23);

        SelesaiOperasi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "27-12-2025" }));
        SelesaiOperasi.setDisplayFormat("dd-MM-yyyy"); // NOI18N
        SelesaiOperasi.setName("SelesaiOperasi"); // NOI18N
        FormInput.add(SelesaiOperasi);
        SelesaiOperasi.setBounds(1000, 190, 85, 23);

        JenisAnestesi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "-", "Anestesi Umum (General Anesthesia)", "Anestesi Regional", "Anestesi Lokal", "Anestesi Sedasi", "Anestesi Kombinasi", "Tidak Ada" }));
        ...
        JamMulai.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "13:11:25" }));
        JamMulai.setDate(new java.util.Date(1739250685000L));
        JamMulai.setDisplayFormat("HH:mm:ss");
        JamMulai.setDoubleBuffered(true);
        JamMulai.setName("JamMulai"); // NOI18N
        FormInput.add(JamMulai);
        JamMulai.setBounds(810, 190, 75, 23);

        JamSelesai.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "14:47:43" }));
        JamSelesai.setDisplayFormat("HH:mm:ss"); // NOI18N
        JamSelesai.setName("JamSelesai"); // NOI18N
        FormInput.add(JamSelesai);
        JamSelesai.setBounds(1090, 190, 75, 23);
    ...
    if (TNoRw.getText().trim().equals("") || TPasien.getText().trim().equals("")) {
        ...
        Valid.textKosong(NamaDokter, "Nama Operator");
        ...
        String sql = "INSERT INTO tindakan_operasi (no_rawat, operator, anastesi, jenis_anastesi, golongan_operasi, diagnosa_preop, asisten, perawat, diagnosa_postop, indikasi_operasi, nama_tindakan, jaringan_dieksisi, mulai_operasi, selesai_operasi, komplikasi, jumlah_perdarahan, perawatan_pasca_operasi, laporan_tindakan_operasi, kd_dokter, jam_mulai, jam_selesai, id) "
                + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, CURRENT_TIMESTAMP)";
        try {
            PreparedStatement ps = koneksi.prepareStatement(sql);
            ps.setString(1, TNoRw.getText());
            ps.setString(2, NamaDokter.getText());
            ps.setString(3, NamaAnestesi.getText());
            ps.setString(4, JenisAnestesi.getSelectedItem().toString());
            ps.setString(5, GolonganOperasi.getSelectedItem().toString());
            ps.setString(6, DiagnosisPra.getText());
            ps.setString(7, NamaAsisten.getText());
            ps.setString(8, NamaPerawat.getText());
            ps.setString(9, DiagnosisPasca.getText());
            ps.setString(10, IndikasiOperasi.getText());
            ps.setString(11, NamaTindakan.getText());
            ps.setString(12, JaringanDieksisi.getText());
            ps.setString(13, convertToDateFormat(MulaiOperasi.getSelectedItem().toString()));
            ps.setString(14, convertToDateFormat(SelesaiOperasi.getSelectedItem().toString()));
            ps.setString(15, KomplikasiOperasi.getText());
            ps.setString(16, JumlahPerdarahan.getText());
            ps.setString(17, PerawatanPasca.getText());
            ps.setString(18, LaporanTindakan.getText());
            ps.setString(19, KdDokter.getText());
            ps.setString(20, JamMulai.getSelectedItem().toString());
            ps.setString(21, JamSelesai.getSelectedItem().toString());
...
private String convertToDateFormat(String dateStr) {
    try {
        // Asumsikan input '14-02-2025', ubah ke '2025-02-14'
        ...
        return null; // Atau bisa melempar error jika perlu
    }
}    
    ...
    if (TNoRw.getText().trim().equals("") || TPasien.getText().trim().equals("")) {
        ...
        if (tbOperasi.getSelectedRow() > -1) {
            String id = tbOperasi.getValueAt(tbOperasi.getSelectedRow(), 21).toString(); // ID ada di kolom ke-21

            if (Sequel.mengedittf(
                "tindakan_operasi", "no_rawat=? AND id=?", 
                        "operator=?, "
                        + "anastesi=?, "
                        + "jenis_anastesi=?, "
                        + "golongan_operasi=?, "
                ...
                new String[]{
                    ...
                    Valid.SetTgl(MulaiOperasi.getSelectedItem().toString()),                    
                    Valid.SetTgl(SelesaiOperasi.getSelectedItem().toString()),                    
                    ...
                    JamSelesai.getSelectedItem().toString(),
                    TNoRw.getText(),
                    id
                }
            )) {
                ...
                JOptionPane.showMessageDialog(null, "Gagal memperbarui data. Pastikan data yang dipilih benar.", "Error", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    if(TPasien.getText().trim().equals("")){
        ...
        String kdDokter = Sequel.cariIsi("SELECT rawat_jl_drpr.kd_dokter FROM rawat_jl_drpr WHERE rawat_jl_drpr.no_rawat = ?", TNoRw.getText());
    ...
    private void MnCetakLaporanTindakanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakLaporanTindakanActionPerformed
        if (TPasien.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu pasien...!!!");
        } else if (tbOperasi.getSelectedRow() == -1) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan pilih salah satu tindakan operasi...!!!");
        } else {
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            Map<String, Object> param = new HashMap<>();         
            param.put("kd_dokter", tbOperasi.getValueAt(tbOperasi.getSelectedRow(), 18).toString());
            ...
            String id = tbOperasi.getValueAt(tbOperasi.getSelectedRow(), 21).toString(); // Ambil `mulai_operasi` dari tabel
            ...
            finger = Sequel.cariIsi("SELECT SHA1(sidikjari.sidikjari) FROM sidikjari INNER JOIN pegawai ON pegawai.id = sidikjari.id WHERE pegawai.nik=?", 
                                     tbOperasi.getValueAt(tbOperasi.getSelectedRow(), 6).toString());
            param.put("finger", "Dikeluarkan di " + akses.getnamars() + ", Kabupaten/Kota " + akses.getkabupatenrs() + 
                "\nDitandatangani secara elektronik oleh " + tbOperasi.getValueAt(tbOperasi.getSelectedRow(), 7).toString() + 
                "\nID " + (finger.equals("") ? tbOperasi.getValueAt(tbOperasi.getSelectedRow(), 6).toString() : finger) + 
                "\n" + Valid.SetTgl3(tbOperasi.getValueAt(tbOperasi.getSelectedRow(), 4).toString()));
            ...
            Valid.MyReportqry("rptLaporanTindakanOperasiInap.jasper", "report", "::[ Laporan Tindakan Operasi ]::",
                ...
                + "WHERE tindakan_operasi.no_rawat = '" + TNoRw.getText() + "' "
                + "AND tindakan_operasi.id = '" + id + "' ", param);
    ...
    akses.setform("LaporanTindakanOperasi");
        i=1;
        //        dokter.load();
        dokter.isCek();
        dokter.emptTeks();
    ...
    private void BtnUploadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnUploadActionPerformed
        ...
        FileName = timestamp + "_" + tbOperasi.getValueAt(tbOperasi.getSelectedRow(), 0).toString().replace("/", "") + "_LaporanTindakanOperasiRanap";
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            LaporanTindakanOperasiRanap dialog = new LaporanTindakanOperasiRanap(new javax.swing.JFrame(), true);
    ...
    private widget.Tanggal JamMulai;
    private widget.Tanggal JamSelesai;
...
//        TPasien.setText("");
    ...
    private void getData() {
        ...
        NamaDokter.setText(tbOperasi.getValueAt(row, 1).toString());
        ...
        KdDokter.setText(tbOperasi.getValueAt(row, 18).toString());
        JamMulai.setSelectedItem(tbOperasi.getValueAt(row, 19).toString());
        JamSelesai.setSelectedItem(tbOperasi.getValueAt(row, 20).toString());        
        ID.setText(tbOperasi.getValueAt(row, 21).toString());        
    } else {
...
//    }
    ...
    private void CreatePDF(String FileName) {
        if (TPasien.getText().trim().equals("")) {
            ...
            Valid.MyReportPDFqryUpload("rptLaporanTindakanOperasiInap.jasper", "report", "::[ Laporan Tindakan Operasi ]::",
                "SELECT tindakan_operasi.no_rawat, "
                + "DATE_FORMAT(tindakan_operasi.selesai_operasi, '%d %M %Y') AS tglcetak, "
                + "DATE_FORMAT(pasien.tgl_lahir, '%d %M %Y') AS tgl_lahir, "  
                ...
                + "INNER JOIN kamar ON kamar.kd_kamar = kamar_inap.kd_kamar "
                + "INNER JOIN bangsal ON bangsal.kd_bangsal = kamar.kd_bangsal "
                + "WHERE kamar_inap.no_rawat = tindakan_operasi.no_rawat "
                + "ORDER BY kamar_inap.tgl_masuk DESC, kamar_inap.jam_masuk DESC LIMIT 1) AS nm_bangsal, "
                + "reg_periksa.umurdaftar, "        
                + "reg_periksa.sttsumur, "
                + "pasien.jk, "        
                + "tindakan_operasi.operator, "
                ...
                + "INNER JOIN dokter ON reg_periksa.kd_dokter = dokter.kd_dokter "
                + "WHERE tindakan_operasi.no_rawat = '" + TNoRw.getText() + "' "
                + "AND tindakan_operasi.id = '" + id + "' ", FileName,param);
...
//    }
    ...
    private void ppBerkasDigitalBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            if (tbOperasi.getSelectedRow() > -1) {
                if (!tbOperasi.getValueAt(tbOperasi.getSelectedRow(), 0).toString().equals("")) {
                    this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                    DlgBerkasRawat berkas = new DlgBerkasRawat(null, true);
                    berkas.setJudul("::[ Berkas Digital Perawatan ]::", "berkasrawat/pages");
                    try {
                        if (akses.gethapus_berkas_digital_perawatan() == true) {
                            berkas.loadURL("http://" + koneksiDB.HOSTHYBRIDWEB() + ":" + koneksiDB.PORTWEB() + "/" + koneksiDB.HYBRIDWEB() + "/" + "berkasrawat/login2.php?act=login&usere=" + koneksiDB.USERHYBRIDWEB() + "&passwordte=" + koneksiDB.PASHYBRIDWEB() + "&no_rawat=" + tbOperasi.getValueAt(tbOperasi.getSelectedRow(), 0).toString());
                        } else {
                            berkas.loadURL("http://" + koneksiDB.HOSTHYBRIDWEB() + ":" + koneksiDB.PORTWEB() + "/" + koneksiDB.HYBRIDWEB() + "/" + "berkasrawat/login2nonhapus.php?act=login&usere=" + koneksiDB.USERHYBRIDWEB() + "&passwordte=" + koneksiDB.PASHYBRIDWEB() + "&no_rawat=" + tbOperasi.getValueAt(tbOperasi.getSelectedRow(), 0).toString());
                        }
                    } catch (Exception ex) {
...
private void UploadJPG(String FileName, String docpath) {
    try {
        ...
        File[] jpgFiles = jpgDir.listFiles((dir, name) -> name.startsWith(FileName + "_page_") && name.endsWith(".jpg"));
        ...
        for (File jpgFile : jpgFiles) {
            ...
            try {
                ...
                boolean uploadSuccess = false;
                kodeberkas = Sequel.cariIsi("SELECT kode FROM master_berkas_digital WHERE nama LIKE '%Laporan Tindakan%'");
                ...
                if (Sequel.cariInteger("SELECT COUNT(no_rawat) AS jumlah FROM berkas_digital_perawatan WHERE lokasi_file='" + filePath + "'") > 0) {
                    uploadSuccess = Sequel.mengedittf("berkas_digital_perawatan", "lokasi_file=?", "no_rawat=?,kode=?, lokasi_file=?", 4, new String[]{
                        tbOperasi.getValueAt(tbOperasi.getSelectedRow(), 0).toString().trim(), kodeberkas, filePath, filePath
                    });
                } else {
                    uploadSuccess = Sequel.menyimpantf("berkas_digital_perawatan", "?,?,?", "No.Rawat", 3, new String[]{
                        tbOperasi.getValueAt(tbOperasi.getSelectedRow(), 0).toString().trim(), kodeberkas, filePath
                    });
                }
                ...
                if (uploadSuccess) {
                    ...
                    MetadataBerkas.simpan(
                        koneksi,
                        tbOperasi.getValueAt(tbOperasi.getSelectedRow(), 0).toString().trim(),
                        kodeberkas,
                        filePath,
                        jpgFile.getName(),
                        akses.getkode()
