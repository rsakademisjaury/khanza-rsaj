 ...
 * @author salimmulyana
 */
public final class SuratDosisHemofilia extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public SuratDosisHemofilia(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        masa_berlaku.setDocument(new batasInput((byte)255).getKata(masa_berlaku));     
    ...
    private void initComponents() {
        ...
        jLabel3.setBounds(200, 360, 60, 23);
        ...
        NoSurat.setBounds(270, 360, 260, 23);
        ...
        TanggalPeriksa.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "10-02-2025" }));
        ...
        scrollPane4.setBounds(560, 490, 180, 50);
...
if(TPasien.getText().trim().equals("")){
    ...
    private void BtnUploadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnUploadActionPerformed
        ...
        FileName = timestamp + "_" + tbObat.getValueAt(tbObat.getSelectedRow(), 1).toString().replace("/", "") + "_DosisHemofiliaRalan";
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SuratDosisHemofilia dialog = new SuratDosisHemofilia(new javax.swing.JFrame(), true);
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            berat_badan.setText(Sequel.cariIsi("select berat from pemeriksaan_ralan where no_rawat=?",TNoRw.getText()));
            KdDokter.setText("D0201");         
            NamaDokter.setText("Dr. dr. Tutik Harjianti, SpPD, K-HOM"); 
        }
    }
    ...
    public void setNoRm(String norwt,String norm,String pasien, Date tgl1, Date tgl2) {
        ...
        try {
            String tanggalRegistrasi = Sequel.cariIsi("select tgl_registrasi from reg_periksa where no_rawat=?", TNoRw.getText());
            TanggalPeriksa.setDate(tanggalRegistrasi != null ? new SimpleDateFormat("yyyy-MM-dd").parse(tanggalRegistrasi) : null);
        } catch (Exception e) {
            e.printStackTrace();
        }
