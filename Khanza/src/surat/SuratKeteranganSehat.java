...
public final class SuratKeteranganSehat extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "09-07-2025" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "09-07-2025" }));
        ...
        PanelInput.setPreferredSize(new java.awt.Dimension(900, 280));
        ...
        jLabel3.setBounds(20, 210, 70, 23);
        ...
        jLabel13.setBounds(160, 80, 20, 23);
        ...
        jLabel15.setBounds(20, 110, 80, 23);
        ...
        Keperluan.setBounds(100, 210, 460, 23);

        jLabel17.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel17.setText("Cm");
        jLabel17.setName("jLabel17"); // NOI18N
        FormInput.add(jLabel17);
        jLabel17.setBounds(160, 110, 20, 23);

        jLabel18.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel18.setText("Tensi");
        jLabel18.setName("jLabel18"); // NOI18N
        FormInput.add(jLabel18);
        jLabel18.setBounds(230, 80, 40, 23);
        ...
        FormInput.add(Tensi);
        Tensi.setBounds(270, 80, 70, 23);

        jLabel20.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel20.setText("mmHg");
        jLabel20.setName("jLabel20"); // NOI18N
        FormInput.add(jLabel20);
        jLabel20.setBounds(350, 80, 40, 23);

        jLabel22.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel22.setText("°C");
        jLabel22.setName("jLabel22"); // NOI18N
        FormInput.add(jLabel22);
        jLabel22.setBounds(320, 110, 30, 23);
        ...
        FormInput.add(Suhu);
        Suhu.setBounds(270, 110, 40, 23);

        jLabel23.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel23.setText("Suhu");
        jLabel23.setName("jLabel23"); // NOI18N
        FormInput.add(jLabel23);
        jLabel23.setBounds(230, 110, 75, 23);
        ...
        CmbButaWarna.setBounds(100, 150, 130, 23);
        ...
        CmbKesimpulan.setBounds(100, 180, 130, 23);

        TanggalSurat.setForeground(new java.awt.Color(50, 70, 50));
        TanggalSurat.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "09-07-2025" }));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        try {    
            ...
            while (Integer.parseInt(Sequel.cariIsi("SELECT COUNT(*) FROM surat_keterangan_sehat WHERE no_surat = ?", nomorSuratGenerated)) > 0) {
            ...
            if(Sequel.menyimpantf("surat_keterangan_sehat","?,?,?,?,?,?,?,?,?,?","No.Surat",10,new String[]{
                    nomorSuratGenerated,TNoRw.getText(),Valid.SetTgl(TanggalSurat.getSelectedItem()+""),Bb.getText(),Tb.getText(),Tensi.getText(),Suhu.getText(),CmbButaWarna.getSelectedItem()+"",
                    Keperluan.getText(),CmbKesimpulan.getSelectedItem()+""
                })==true){
                tabMode.addRow(new String[]{
                    nomorSuratGenerated,TNoRw.getText(),TNoRM.getText(),TPasien.getText(),Valid.SetTgl(TanggalSurat.getSelectedItem()+""),Bb.getText(),Tb.getText(),Tensi.getText(),Suhu.getText(),CmbButaWarna.getSelectedItem().toString(),Keperluan.getText(),CmbKesimpulan.getSelectedItem().toString()
                });
...
//                "SKBS"+TanggalSurat.getSelectedItem().toString().substring(6,10)+TanggalSurat.getSelectedItem().toString().substring(3,5)+TanggalSurat.getSelectedItem().toString().substring(0,2),3,NoSurat);
    ...
    String lastNumber = Sequel.cariIsi(
        "SELECT MAX(CONVERT(LEFT(no_surat, 3), SIGNED)) FROM surat_keterangan_sehat WHERE " +
        "no_surat LIKE '%/SKBS/RSAJ/" + bln_romawi + "/" + TanggalSurat.getSelectedItem().toString().substring(6, 10) + "'"
    );
    ...
    nomorSuratGenerated = String.format("%03d", nextNumber) + "/SKBS/RSAJ/" + bln_romawi + "/" + 
