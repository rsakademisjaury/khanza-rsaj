...
public class DlgCariPembelian extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jCheckBox1.setText("Format Rekap");
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            if (!jCheckBox1.isSelected()){
                Valid.MyReportqry("rptPembelianLama.jasper","report","::[ Transaksi Pembelian Obat/BHP/Alkes ]::","select * from temporary where temporary.temp37='"+akses.getalamatip()+"' order by temporary.no",param);
            }
            else {
...
private void ppHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppHapusActionPerformed
    ...
    */
    ...
    private void tampil() {
        ...
        String orderby = "pembelian.tgl_beli,pembelian.no_faktur";
        if (jCheckBox1.isSelected()){
            orderby = "datasuplier.nama_suplier, pembelian.tgl_beli, pembelian.no_faktur";
         }
        try{     
            ps=koneksi.prepareStatement("select pembelian.tgl_beli,pembelian.no_faktur, "+
                    ...
                    " inner join detailbeli inner join databarang inner join kodesatuan inner join kategori_barang "+
                    ...
                    " and pembelian.nip=petugas.nip and databarang.kode_kategori=kategori_barang.kode"+
                    " where pembelian.tgl_beli between ? and ? and pembelian.no_faktur like ? and datasuplier.nama_suplier like ? and petugas.nama like ?  and kategori_barang.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and pembelian.no_faktur like ? or "+
                    " pembelian.tgl_beli between ? and ? and pembelian.no_faktur like ? and datasuplier.nama_suplier like ? and petugas.nama like ?  and kategori_barang.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and pembelian.kode_suplier like ? or "+
                    " pembelian.tgl_beli between ? and ? and pembelian.no_faktur like ? and datasuplier.nama_suplier like ? and petugas.nama like ?  and kategori_barang.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and datasuplier.nama_suplier like ? or "+
                    " pembelian.tgl_beli between ? and ? and pembelian.no_faktur like ? and datasuplier.nama_suplier like ? and petugas.nama like ?  and kategori_barang.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and pembelian.nip like ? or "+
                    " pembelian.tgl_beli between ? and ? and pembelian.no_faktur like ? and datasuplier.nama_suplier like ? and petugas.nama like ?  and kategori_barang.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and petugas.nama like ? or "+
                    " pembelian.tgl_beli between ? and ? and pembelian.no_faktur like ? and datasuplier.nama_suplier like ? and petugas.nama like ?  and kategori_barang.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and bangsal.nm_bangsal like ? or "+
                    " pembelian.tgl_beli between ? and ? and pembelian.no_faktur like ? and datasuplier.nama_suplier like ? and petugas.nama like ?  and kategori_barang.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and detailbeli.kode_brng like ? or "+
                    " pembelian.tgl_beli between ? and ? and pembelian.no_faktur like ? and datasuplier.nama_suplier like ? and petugas.nama like ?  and kategori_barang.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and databarang.nama_brng like ? or "+
                    " pembelian.tgl_beli between ? and ? and pembelian.no_faktur like ? and datasuplier.nama_suplier like ? and petugas.nama like ?  and kategori_barang.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and detailbeli.kode_sat like ? or "+
                    " pembelian.tgl_beli between ? and ? and pembelian.no_faktur like ? and datasuplier.nama_suplier like ? and petugas.nama like ?  and kategori_barang.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and detailbeli.no_batch like ? or "+
                    " pembelian.tgl_beli between ? and ? and pembelian.no_faktur like ? and datasuplier.nama_suplier like ? and petugas.nama like ?  and kategori_barang.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and industrifarmasi.nama_industri like ? or "+
                    " pembelian.tgl_beli between ? and ? and pembelian.no_faktur like ? and datasuplier.nama_suplier like ? and petugas.nama like ?  and kategori_barang.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and kategori_barang.nama like ? "+
                    " group by pembelian.no_faktur order by " + orderby);
            try {
                ...
                while(rs.next()){
                    ...
                    if (jCheckBox1.isSelected()){
                        if (!"".equals(currentSupplier) && !currentSupplier.equals(rs.getString(4))){
                            tabMode.addRow(new Object[]{"","","","","Total :",Valid.SetAngka4(tagihan),"","","","","",""});
                            tagihan = 0;
                        }
                        tabMode.addRow(new Object[]{(!currentSupplier.equals(rs.getString(4))?rs.getString(4):""),rs.getString(1),rs.getString(6),
                    ...
                    ps2=koneksi.prepareStatement("select detailbeli.kode_brng,databarang.nama_brng, "+
                        ...
                        "from detailbeli inner join databarang inner join kodesatuan inner join kategori_barang inner join industrifarmasi "+
                        " on detailbeli.kode_brng=databarang.kode_brng and databarang.kode_kategori=kategori_barang.kode "+
                        " and detailbeli.kode_sat=kodesatuan.kode_sat and databarang.kode_industri=industrifarmasi.kode_industri where "+
                        " detailbeli.no_faktur=? and kategori_barang.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and detailbeli.kode_brng like ? or "+
                        " detailbeli.no_faktur=? and kategori_barang.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and databarang.nama_brng like ? or "+
                        " detailbeli.no_faktur=? and kategori_barang.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and detailbeli.kode_sat like ? or "+
                        " detailbeli.no_faktur=? and kategori_barang.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and detailbeli.no_batch like ? or "+
                        " detailbeli.no_faktur=? and kategori_barang.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and industrifarmasi.nama_industri like ? or "+
                        " detailbeli.no_faktur=? and kategori_barang.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and kategori_barang.nama like ? order by detailbeli.kode_brng  ");
                    try {
                        ...
                        tabMode.addRow(new Object[]{"","","","","","Total",":","",Valid.SetAngka4(rs.getDouble("total1")),"",Valid.SetAngka4(rs.getDouble("potongan")),Valid.SetAngka4(rs.getDouble("total2"))});
                        tabMode.addRow(new Object[]{"","","","","","PPN",":","","","","",Valid.SetAngka4(rs.getDouble("ppn"))});
                        tabMode.addRow(new Object[]{"","","","","","Tagihan",":","","","","",Valid.SetAngka4(rs.getDouble("tagihan"))});
                    } catch (Exception e) {
                        System.out.println("Notifikasi : "+e);
                    } finally{
                        if(rs2!=null){
                    ...
                    total = total + Sequel.cariIsiAngka("select tagihan from pembelian where no_faktur=?",rs.getString(2));
                }               
                LTotal.setText(Valid.SetAngka4(total));
                if (jCheckBox1.isSelected()){
                    tabMode.addRow(new Object[]{"","","","","Total :",Valid.SetAngka4(tagihan),"","","","","",""});
                    tabMode.addRow(new Object[]{"Total Faktur:",Valid.SetAngka4(total),"","","","","","","","","",""});
