...
public class DlgCariPermintaan extends javax.swing.JDialog {
    ...
    public DlgCariPermintaan(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"Tanggal","No.Permintaan","Asal Permintaan","Pegawai","Ditujukan Ke", "Harga"};
    ...
    private void initComponents() {
        ...
        BtnCari.setPreferredSize(new java.awt.Dimension(75, 23));
        ...
        FormInput.add(pilihanFormat);
        pilihanFormat.setBounds(200, 70, 110, 23);
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(pilihanFormat.getSelectedItem().toString().equals("Rekap Per Unit")){
                for(int i=0;i<row;i++){  
                    Sequel.menyimpan("temporary","'"+i+"','"+
                                    ...
                                    tabMode.getValueAt(i,3).toString()+"','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','"+akses.getalamatip()+"'","Transaksi Pembelian"); 
                }
            }
            else {
                for(int i=0;i<row;i++){  
            ...
            if(pilihanFormat.getSelectedItem().toString().equals("Rekap Per Unit")){
                ...
                Valid.MyReportqry("rptPermintaan2.jasper","report","::[ Data Permintaan Obat/Alkes/BHP Medis ]::","select * from temporary where temporary.temp37='"+akses.getalamatip()+"' order by temporary.no",param);
            }
        }
...
private void ppHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppHapusActionPerformed
    ...
    private void nmbarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nmbarActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_nmbarActionPerformed
...
//        if (pilihanFormat.getSelectedItem().toString().equals("Rekap Per Unit")){
//            header_value = new String[] {"No.","Ruang/Unit/Instalasi","Jumlah Permintaan","Total Harga Permintaan","",""};
//        }
...
//                        "count(*) as jml_permintaan, \n" +
//                        "sum(detail_permintaan_medis.jumlah*databarang.ralan) as total \n" +
...
//                        "where permintaan_medis.tanggal between ? and ? group by bangsal.nm_bangsal order by bangsal.nm_bangsal ");
//            }
//            else if(NoPermintaan.getText().equals("")&&NmBangsal.getText().equals("")&&NmPeg.getText().equals("")&&nmjenis.getText().equals("")&&
...
//                
//            try {
//                if(pilihanFormat.getSelectedItem().toString().equals("Rekap Per Unit")||(NoPermintaan.getText().equals("")&&NmBangsal.getText().equals("")&&NmPeg.getText().equals("")&&nmjenis.getText().equals("")&&
//                    nmkategori.getText().equals("")&&nmgolongan.getText().equals("")&&nmbar.getText().equals("")&&TCari.getText().equals("")&&
//                        Status.getSelectedItem().toString().equals("Semua"))){
...
//                            nomor,rs.getString("asal"),rs.getString("jml_permintaan"),Valid.SetAngka4(Double.parseDouble(rs.getString("total"))),
//                        });
//                        total_query = total_query + Double.parseDouble(rs.getString("total"));
//                        nomor = nomor+1;
//                    }
//                    else{
//                    tabMode.addRow(new Object[]{
...
//                    String kode_keluar = Sequel.cariIsi("select no_keluar from pengeluaran_obat_bhp where keterangan like '%"+rs.getString("no_permintaan")+"%'");
//                    ps2=koneksi.prepareStatement(
//                            "select detail_permintaan_medis.kode_brng,databarang.nama_brng, "+
//                            "detail_permintaan_medis.kode_sat,kodesatuan.satuan,"+
//                            "detail_permintaan_medis.jumlah,detail_permintaan_medis.keterangan,  IFNULL(detail_pengeluaran_obat_bhp.jumlah, 0) as keluar,databarang.ralan as harga "+
...
//                            "inner join golongan_barang on golongan_barang.kode=databarang.kode_golongan "+
//                            "inner join jenis on databarang.kdjns=jenis.kdjns "+
//                            "left join detail_pengeluaran_obat_bhp on (detail_pengeluaran_obat_bhp.no_keluar = ? and detail_pengeluaran_obat_bhp.kode_brng=detail_permintaan_medis.kode_brng) "+        
//                            "where detail_permintaan_medis.no_permintaan=? and databarang.nama_brng like ? and concat(databarang.kdjns,jenis.nama) like ? and concat(databarang.kode_kategori,kategori_barang.nama) like ? and concat(databarang.kode_golongan,golongan_barang.nama) like ? and detail_permintaan_medis.kode_brng like ? or "+
...
//                        ps2.setString(4,"%"+kdjenis.getText()+nmjenis.getText()+"%");
//                        ps2.setString(5,"%"+kdkategori.getText()+nmkategori.getText()+"%");
//                        ps2.setString(6,"%"+kdgolongan.getText()+nmgolongan.getText()+"%");
//                        ps2.setString(7,"%"+TCari.getText()+"%");
//                        ps2.setString(8,rs.getString(2));
//                        ps2.setString(9,"%"+nmbar.getText()+"%");
//                        ps2.setString(10,"%"+kdjenis.getText()+nmjenis.getText()+"%");
//                        ps2.setString(11,"%"+kdkategori.getText()+nmkategori.getText()+"%");
//                        ps2.setString(12,"%"+kdgolongan.getText()+nmgolongan.getText()+"%");
//                        ps2.setString(13,"%"+TCari.getText()+"%");
//                        ps2.setString(14,rs.getString(2));
//                        ps2.setString(15,"%"+nmbar.getText()+"%");
//                        ps2.setString(16,"%"+kdjenis.getText()+nmjenis.getText()+"%");
//                        ps2.setString(17,"%"+kdkategori.getText()+nmkategori.getText()+"%");
//                        ps2.setString(18,"%"+kdgolongan.getText()+nmgolongan.getText()+"%");
//                        ps2.setString(19,"%"+TCari.getText()+"%");
//                        ps2.setString(20,rs.getString(2));
//                        ps2.setString(21,"%"+nmbar.getText()+"%");
//                        ps2.setString(22,"%"+kdjenis.getText()+nmjenis.getText()+"%");
//                        ps2.setString(23,"%"+kdkategori.getText()+nmkategori.getText()+"%");
//                        ps2.setString(24,"%"+kdgolongan.getText()+nmgolongan.getText()+"%");
        ...
        try {
            ...
            while(rs.next()){
                if(pilihanFormat.getSelectedItem().toString().equals("Rekap Per Unit")){
                    ...
                    // diberikan diambil dari tabel map_permintaan_mutasi_barang dan map_permintaan_pengeluaran_obat_bhp
                    ps2=koneksi.prepareStatement(
                        "select detail_permintaan_medis.kode_brng,databarang.nama_brng, "+
                        "detail_permintaan_medis.kode_sat,kodesatuan.satuan, "+
                        "detail_permintaan_medis.jumlah,detail_permintaan_medis.keterangan, "+
                        "(ifnull(map_mutasi.keluar,0)+ifnull(map_keluar.keluar,0)) as keluar,databarang.ralan as harga "+
                        "from detail_permintaan_medis "+
                        "inner join databarang on detail_permintaan_medis.kode_brng=databarang.kode_brng "+
                        "inner join kodesatuan on detail_permintaan_medis.kode_sat=kodesatuan.kode_sat "+
                        "inner join kategori_barang on kategori_barang.kode=databarang.kode_kategori "+
                        "inner join golongan_barang on golongan_barang.kode=databarang.kode_golongan "+
                        "inner join jenis on databarang.kdjns=jenis.kdjns "+
                        "left join ( "+
                        "   select no_permintaan,kode_brng,sum(jumlah_diberikan) as keluar "+
                        "   from map_permintaan_mutasi_barang "+
                        "   group by no_permintaan,kode_brng "+
                        ") as map_mutasi on map_mutasi.no_permintaan=detail_permintaan_medis.no_permintaan "+
                        "   and map_mutasi.kode_brng=detail_permintaan_medis.kode_brng "+
                        "left join ( "+
                        "   select mp.no_permintaan, dp.kode_brng, sum(dp.jumlah) as keluar "+
                        "   from map_permintaan_pengeluaran_obat_bhp mp "+
                        "   inner join detail_pengeluaran_obat_bhp dp on dp.no_keluar=mp.no_keluar "+
                        "   group by mp.no_permintaan, dp.kode_brng "+
                        ") as map_keluar on map_keluar.no_permintaan=detail_permintaan_medis.no_permintaan "+
                        "   and map_keluar.kode_brng=detail_permintaan_medis.kode_brng "+
                        "where detail_permintaan_medis.no_permintaan=? "+
                        "and databarang.nama_brng like ? "+
                        "and concat(databarang.kdjns,jenis.nama) like ? "+
                        ...
                        "and (detail_permintaan_medis.kode_brng like ? or databarang.nama_brng like ? or detail_permintaan_medis.kode_sat like ? or jenis.nama like ?) "+
                        "order by detail_permintaan_medis.kode_brng "
                    );
                    ...
                    try {
                        ...
                        while(rs2.next()){
                            ...
                            tabMode.addRow(new Object[]{
                                "",no+". "+rs2.getString("kode_brng")+" "+rs2.getString("nama_brng"),
                                "Permintaan :  "+rs2.getString("jumlah")+"   "+rs2.getString("satuan"),
                                "Diberikan :  " + rs2.getString("keluar")+"  "+rs2.getString("satuan"),
                                rs2.getString("keterangan"),
                                Valid.SetAngka4(harga_barang)
                            });
                            total_per_permintaan = total_per_permintaan + harga_barang;
                            no++;
                        }
