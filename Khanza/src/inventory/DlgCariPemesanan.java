...
public class DlgCariPemesanan extends javax.swing.JDialog {
    ...
    public double harga_barang, total_per_permintaan, total_query;
...
//                    "Disk(%)","Bsr.Disk(Rp)","Total(Rp)"};
        tabMode3=new DefaultTableModel(null,new Object[]{
            "Supplier","Tanggal","Petugas","No. Faktur","Jumlah. Faktur","Total Faktur"
                }){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
        ...
        tabMode4=new DefaultTableModel(null,new Object[]{
            "Supplier","Tanggal","Jatuh Tempo","Petugas","No. Faktur","Jumlah. Faktur","Total Faktur"
                }){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
        tbDokter2.setModel(tabMode4);
...
//        });   
            ...
            public void windowClosed(WindowEvent e) {
                if(akses.getform().equals("DlgCariPemesanan")){
                    if(barang.kategori.getTable().getSelectedRow()!= -1){                       
                        kdsat.setText(barang.kategori.getTable().getValueAt(barang.kategori.getTable().getSelectedRow(),0).toString());                    
                        nmsat.setText(barang.kategori.getTable().getValueAt(barang.kategori.getTable().getSelectedRow(),1).toString());
                    }                           
                    kdsat.requestFocus();
                }   
            }
    ...
    private void initComponents() {
        ...
        BtnPrintLaporan3 = new widget.Button();
        BtnPrintLaporan4 = new widget.Button();
        ...
        pilihanFormat = new widget.ComboBox();
        ...
        BtnPrint.setText("Cetak Rincian ");
        ...
        BtnPrintRekap.setText("Cetak Rekap ");
        BtnPrintRekap.setToolTipText("Alt+T");
        BtnPrintRekap.setName("BtnPrintRekap"); // NOI18N
        BtnPrintRekap.setPreferredSize(new java.awt.Dimension(125, 30));
        ...
        panelisi1.add(BtnPrintRekap);

        BtnPrintLaporan3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/b_print.png"))); // NOI18N
        BtnPrintLaporan3.setMnemonic('T');
        BtnPrintLaporan3.setText("Laporan 3");
        BtnPrintLaporan3.setToolTipText("Alt+T");
        BtnPrintLaporan3.setName("BtnPrintLaporan3"); // NOI18N
        BtnPrintLaporan3.setPreferredSize(new java.awt.Dimension(100, 30));
        BtnPrintLaporan3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnPrintLaporan3ActionPerformed(evt);
            }
        });
        BtnPrintLaporan3.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnPrintLaporan3KeyPressed(evt);
            }
        });
        panelisi1.add(BtnPrintLaporan3);

        BtnPrintLaporan4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/b_print.png"))); // NOI18N
        BtnPrintLaporan4.setMnemonic('T');
        BtnPrintLaporan4.setText("Laporan 4");
        BtnPrintLaporan4.setToolTipText("Alt+T");
        BtnPrintLaporan4.setName("BtnPrintLaporan4"); // NOI18N
        BtnPrintLaporan4.setPreferredSize(new java.awt.Dimension(100, 30));
        BtnPrintLaporan4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnPrintLaporan4ActionPerformed(evt);
            }
        });
        BtnPrintLaporan4.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnPrintLaporan4KeyPressed(evt);
            }
        });
        panelisi1.add(BtnPrintLaporan4);
        ...
        label17.setBounds(570, 10, 50, 23);
        ...
        panelisi4.add(kdbar);
        kdbar.setBounds(625, 10, 100, 23);

        nmbar.setEditable(false);
        nmbar.setName("nmbar"); // NOI18N
        nmbar.setPreferredSize(new java.awt.Dimension(207, 23));
        panelisi4.add(nmbar);
        nmbar.setBounds(730, 10, 170, 23);
        ...
        btnSatuan.setBounds(540, 10, 28, 23);
        ...
        pilihanFormat.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Format Khanza", "Rekap Per Unit" }));
        pilihanFormat.setName("pilihanFormat"); // NOI18N
        pilihanFormat.setPreferredSize(new java.awt.Dimension(40, 23));
        pilihanFormat.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                pilihanFormatActionPerformed(evt);
            }
        });
        panelisi4.add(pilihanFormat);
        pilihanFormat.setBounds(190, 10, 110, 23);
        ...
        tbDokter1.setComponentPopupMenu(jPopupMenu1);
        ...
        TabRawat.addTab("Laporan 3", scrollPane2);
        ...
        scrollPane3.setViewportView(tbDokter2);

        TabRawat.addTab("Laporan 4", scrollPane3);
    ...
    private void BtnKeluarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnKeluarKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_SPACE){            
            dispose();              
        }else{Valid.pindah(evt,BtnPrintRekap,kdbar);}
...
*/
    ...
    private void BtnAllKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnAllKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_SPACE){
            ...
            Valid.pindah(evt, BtnPrintRekap, BtnKeluar);
        }
        ...
        switch (TabRawat.getSelectedIndex()) {
            case 0:
                ...
                if(tabMode.getRowCount()==0){
                    ...
                    if(pilihanFormat.getSelectedItem().toString().equals("Rekap Per Unit")){
                    for(int i=0;i<row;i++){  
                    Sequel.menyimpan("temporary","'"+i+"','"+
                                    tabMode.getValueAt(i,0).toString()+"','"+
                                    tabMode.getValueAt(i,1).toString()+"','"+
                                    tabMode.getValueAt(i,2).toString()+"','"+
                                    tabMode.getValueAt(i,3).toString()+"','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','"+akses.getalamatip()+"'","Transaksi Pemesanan"); 
                }
            }
            else {
                for(int i=0;i<row;i++){  
                    ...
                    if(pilihanFormat.getSelectedItem().toString().equals("Rekap Per Unit")){
                    Valid.MyReportqry("rptPemesananrekap.jasper","report","::[ Transaksi Penerimaan Barang ]::","select * from temporary where temporary.temp37='"+akses.getalamatip()+"' order by temporary.no",param);
                    }else {
                    Valid.MyReportqry("rptPemesananformatrekap.jasper","report","::[ Transaksi Penerimaan Barang ]::","select * from temporary where temporary.temp37='"+akses.getalamatip()+"' order by temporary.no",param);
            }
        } 
    }
...
private void ppHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppHapusActionPerformed
    ...
    private void pilihanFormatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pilihanFormatActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_pilihanFormatActionPerformed
...
//                                    tabMode.getValueAt(i, 10).toString() + "','','','','','','','','','','','','','','','','','','','','','','','','','','','','"+ akses.getalamatip() + "'", 
...
//                Sequel.menyimpan("temporary", "'" + i + "','Jml.Total :','','','','','','','"+ LTotal.getText() + "','','','','','','','','','','','','','','','','','','','','','','','','','','','','"+ akses.getalamatip() + "'", "Transaksi Penerimaan");
//
//                // Ambil nilai dari temporary.tempt4 baris pertama
//                String tempt4Value = Sequel.cariIsi("SELECT temp4 FROM temporary WHERE temp37='" + akses.getalamatip() + "' ORDER BY no LIMIT 1");
//
//                Map<String, Object> param = new HashMap<>();    
//                param.put("namars", akses.getnamars());
//                param.put("alamatrs", akses.getalamatrs());
...
//                param.put("logo", Sequel.cariGambar("SELECT setting.logo FROM setting")); 
//
//                // Cek apakah temp4 mengandung "Laboratorium" atau "GUDANG FARMASI"
//                if (tempt4Value != null) {
//                    if (tempt4Value.contains("Laboratorium")) {
//                        Valid.MyReportqry("rptPemesananLab.jasper", "report", "::[ Transaksi Penerimaan Barang ]::", 
//                            "SELECT * FROM temporary WHERE temporary.temp37='" + akses.getalamatip() + "' ORDER BY temporary.no", param);
//                    } else if (tempt4Value.contains("GUDANG FARMASI")) {
...
switch (TabRawat.getSelectedIndex()) {
    case 0:
        ...
        if(tabMode.getRowCount() == 0){
            ...
            // Cek temp4 untuk menentukan arah cetakan
            String nilaiTemp4 = "";
            for (i = 0; i < row; i++) {
                if (tabMode.getValueAt(i, 3) != null && !tabMode.getValueAt(i, 3).toString().trim().isEmpty()) {
                    nilaiTemp4 = tabMode.getValueAt(i, 3).toString();
                    break;
                }
            }

            boolean isLaboratorium = nilaiTemp4.toLowerCase().contains("laboratorium");

            for (i = 0; i < row; i++) {
            String kolom0 = tabMode.getValueAt(i, 0).toString();  // biasanya "1. Batch"
            String kolom1 = tabMode.getValueAt(i, 1).toString();  // biasanya "Exp : ...."
            String kolom2 = tabMode.getValueAt(i, 2).toString();  // biasanya "Exp : ...."

            // Kosongkan kolom jika batch/exp dan jenis laporan LAB
            if (isLaboratorium && (kolom0.toLowerCase().contains("batch") || kolom0.toLowerCase().contains("exp") || kolom0.toLowerCase().contains("I.F. : Lab."))) {
                kolom0 = "";
                kolom1 = "";
                kolom2 = "";
            }
            ...
            if (tempt4Value != null && tempt4Value.toLowerCase().contains("laboratorium")) {
                Valid.MyReportqry("rptPemesananLab.jasper", "report", "::[ Transaksi Penerimaan Barang ]::",
                        "SELECT * FROM temporary WHERE temporary.temp37='" + akses.getalamatip() + "' ORDER BY temporary.no", param);
            } else {
                Valid.MyReportqry("rptPemesanan.jasper", "report", "::[ Transaksi Penerimaan Barang ]::",
    ...
    private void BtnPrintLaporan3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintLaporan3ActionPerformed
        // TODO add your handling code here:
    this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        BtnCariActionPerformed(evt);
        if(tabMode3.getRowCount()==0){
            ...
            for(i=0;i<row;i++){  
                Sequel.menyimpan("temporary","'"+i+"','"+
                                ...
                                tabMode3.getValueAt(i,5).toString()+"','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','"+akses.getalamatip()+"'","Transaksi Penerimaan"); 
            }
            i++;
            Sequel.menyimpan("temporary","'"+i+"','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','"+akses.getalamatip()+"'","Transaksi Penerimaan"); 
            i++;
        ...
        // ---------------- LOGIKA PILIH JASPER ----------------
        // Asumsi: akses.getkode() mengembalikan kode user/karyawan
        if ("19951241".equals(akses.getkode())) {
            // User khusus → cetak format LAB
            Valid.MyReportqry("rptPenerimaanLab.jasper","report","::[ Transaksi Penerimaan Obat/BHP/Alkes ]::","select * from temporary where temporary.temp37='"+akses.getalamatip()+"' order by temporary.no",param);
        } else {
            // Default seperti sebelumnya
            if (!jCheckBox1.isSelected()) {
                Valid.MyReportqry("rptPembelianLama.jasper","report","::[ Transaksi Penerimaan Obat/BHP/Alkes ]::","select * from temporary where temporary.temp37='"+akses.getalamatip()+"' order by temporary.no",param);
            } else {
                Valid.MyReportqry("rptPenerimaan.jasper","report","::[ Transaksi Penerimaan Obat/BHP/Alkes ]::","select * from temporary where temporary.temp37='"+akses.getalamatip()+"' order by temporary.no",param);
            }
        }
    }
    ...
    }//GEN-LAST:event_BtnPrintLaporan3ActionPerformed

    private void BtnPrintLaporan3KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnPrintLaporan3KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnPrintLaporan3KeyPressed
    ...
    private void BtnPrintLaporan4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintLaporan4ActionPerformed
    this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        BtnCariActionPerformed(evt);
        if(tabMode4.getRowCount()==0){
            ...
            for(i=0;i<row;i++){  
                Sequel.menyimpan("temporary","'"+i+"','"+
                                ...
                                tabMode4.getValueAt(i,6).toString()+"','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','"+akses.getalamatip()+"'","Transaksi Penerimaan"); 
            }
            i++;
            Sequel.menyimpan("temporary","'"+i+"','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','"+akses.getalamatip()+"'","Transaksi Penerimaan"); 
            i++;
            ...
            if (!jCheckBox1.isSelected()){
                ...
                Valid.MyReportqry("rptPenerimaan4.jasper","report","::[ Transaksi Penerimaan Obat/BHP/Alkes ]::","select * from temporary where temporary.temp37='"+akses.getalamatip()+"' order by temporary.no",param);
            }
        }        
        this.setCursor(Cursor.getDefaultCursor());    
    }//GEN-LAST:event_BtnPrintLaporan4ActionPerformed

    private void BtnPrintLaporan4KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnPrintLaporan4KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnPrintLaporan4KeyPressed
    ...
    */
    ...
    private widget.Button BtnPrintLaporan3;
    private widget.Button BtnPrintLaporan4;
    ...
    private widget.ComboBox pilihanFormat;
    ...
    private void tampil() {
        ...
        //ubah header
        String header_value[] = new String[] {"Tanggal","No.Permintaan","Asal Permintaan","Pegawai","Ditujukan Ke", "Harga"};
        if (pilihanFormat.getSelectedItem().toString().equals("Format Khanza")){
            header_value = new String[] {"Tanggal","No.Permintaan","Asal Permintaan","Pegawai","Ditujukan Ke","Harga"};
        }
//        TableColumnModel colModel = tbDokter.getColumnModel();
        for (i = 0; i < 11; i++) {
            TableColumn column = tbDokter.getColumnModel().getColumn(i);
            if(i==0){
                column.setPreferredWidth(120);
        ...
        if (pilihanFormat.getSelectedItem().toString().equals("Rekap Per Unit")){
            header_value = new String[] {"No.","Nama Suplier","Jumlah","Total Harga","","","",""};
        }        
        TableColumnModel colModel = tbDokter.getColumnModel();
        for (int j = 0; j < 9; j++){
//            colModel.getColumn(j).setHeaderValue(header_value[j]);
            TableColumn column = tbDokter.getColumnModel().getColumn (j);
            if(j==0){
                column.setPreferredWidth(120);
            }else if(j==1){
                column.setPreferredWidth(300);
        ...
        tbDokter.getTableHeader().repaint();              
       ...
       total_query = 0;
        try{   
            ...
            if(!nmsat.getText().equals("")){
                datajenis=" and jenis.nama like '%"+nmsat.getText()+"%' ";
            }
            ...
            if (pilihanFormat.getSelectedItem().toString().equals("Rekap Per Unit")){
                ps = koneksi.prepareStatement("select datasuplier.nama_suplier, count(*) as jumlah_penerimaan, round(sum(pemesanan.tagihan),2) as total_penerimaan from `datasuplier` "+
                        "left join pemesanan on datasuplier.kode_suplier=pemesanan.kode_suplier " +
                "where " + tanggal + " GROUP BY datasuplier.nama_suplier");
            }
            else {
                ...
                if (pilihanFormat.getSelectedItem().toString().equals("Rekap Per Unit")){
                    ...
                    while (rs.next()){
                        tabMode.addRow(new Object[]{
                            no,rs.getString("nama_suplier"),rs.getString("jumlah_penerimaan"),Valid.SetAngka4(Double.parseDouble(rs.getString("total_penerimaan"))),
                        });
                        total_query = total_query + Double.parseDouble(rs.getString("total_penerimaan"));
                        no = no+1;
                    }
                    tabMode.addRow(new Object[]{"","Total", "",Valid.SetAngka4(total_query)});
                }
                else {
                    while(rs.next()){
    ...
    private void tampil3() {
        ...
        //ubah header
        String header_value[] = new String[] {"Tgl.Beli","No.Faktur","Suplier","Petugas","Barang",
                    "Satuan","Jml","Harga Beli(Rp)","SubTotal(Rp)",
                    "Disk(%)","Bsr.Disk(Rp)","Total(Rp)"};
        if (jCheckBox1.isSelected()){
            header_value = new String[] {"Suplier","Tanggal","Petugas","No. Faktur","Jumlah Faktur","Total Faktur","","","","","",""};
        }
        TableColumnModel colModel = tbDokter1.getColumnModel();
        for (int i = 0; i < 6; i++){
            colModel.getColumn(i).setHeaderValue(header_value[i]);
        }
        tbDokter1.getTableHeader().repaint();
        
        //start baru
        Valid.tabelKosong(tabMode3);
        String orderby = "pemesanan.tgl_pesan,pemesanan.no_faktur";
        if (jCheckBox1.isSelected()){
            orderby = "datasuplier.nama_suplier, pemesanan.tgl_pesan, pemesanan.no_faktur";
         }
        try{     
            ps=koneksi.prepareStatement("select pemesanan.tgl_pesan,pemesanan.no_faktur, "+
                    "pemesanan.kode_suplier,datasuplier.nama_suplier, "+
                    "pemesanan.nip,petugas.nama,bangsal.nm_bangsal,pemesanan.total1,"+
                    "pemesanan.potongan,pemesanan.total2,pemesanan.ppn,pemesanan.tagihan "+
                    " from pemesanan inner join datasuplier inner join petugas inner join bangsal  "+
                    " inner join detailpesan inner join databarang inner join kodesatuan inner join kategori_barang "+
                    " inner join industrifarmasi on detailpesan.kode_brng=databarang.kode_brng "+
                    " and detailpesan.kode_sat=kodesatuan.kode_sat "+
                    " and pemesanan.kd_bangsal=bangsal.kd_bangsal "+
                    " and pemesanan.no_faktur=detailpesan.no_faktur "+
                    " and pemesanan.kode_suplier=datasuplier.kode_suplier "+
                    " and databarang.kode_industri=industrifarmasi.kode_industri "+
                    " and pemesanan.nip=petugas.nip and databarang.kode_kategori=kategori_barang.kode"+
                    " where pemesanan.tgl_pesan between ? and ? and pemesanan.no_faktur like ? and datasuplier.nama_suplier like ? and petugas.nama like ?  and kategori_barang.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and pemesanan.no_faktur like ? or "+
                    " pemesanan.tgl_pesan between ? and ? and pemesanan.no_faktur like ? and datasuplier.nama_suplier like ? and petugas.nama like ?  and kategori_barang.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and pemesanan.kode_suplier like ? or "+
                    " pemesanan.tgl_pesan between ? and ? and pemesanan.no_faktur like ? and datasuplier.nama_suplier like ? and petugas.nama like ?  and kategori_barang.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and datasuplier.nama_suplier like ? or "+
                    " pemesanan.tgl_pesan between ? and ? and pemesanan.no_faktur like ? and datasuplier.nama_suplier like ? and petugas.nama like ?  and kategori_barang.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and pemesanan.nip like ? or "+
                    " pemesanan.tgl_pesan between ? and ? and pemesanan.no_faktur like ? and datasuplier.nama_suplier like ? and petugas.nama like ?  and kategori_barang.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and petugas.nama like ? or "+
                    " pemesanan.tgl_pesan between ? and ? and pemesanan.no_faktur like ? and datasuplier.nama_suplier like ? and petugas.nama like ?  and kategori_barang.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and bangsal.nm_bangsal like ? or "+
                    " pemesanan.tgl_pesan between ? and ? and pemesanan.no_faktur like ? and datasuplier.nama_suplier like ? and petugas.nama like ?  and kategori_barang.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and detailpesan.kode_brng like ? or "+
                    " pemesanan.tgl_pesan between ? and ? and pemesanan.no_faktur like ? and datasuplier.nama_suplier like ? and petugas.nama like ?  and kategori_barang.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and databarang.nama_brng like ? or "+
                    " pemesanan.tgl_pesan between ? and ? and pemesanan.no_faktur like ? and datasuplier.nama_suplier like ? and petugas.nama like ?  and kategori_barang.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and detailpesan.kode_sat like ? or "+
                    " pemesanan.tgl_pesan between ? and ? and pemesanan.no_faktur like ? and datasuplier.nama_suplier like ? and petugas.nama like ?  and kategori_barang.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and detailpesan.no_batch like ? or "+
                    " pemesanan.tgl_pesan between ? and ? and pemesanan.no_faktur like ? and datasuplier.nama_suplier like ? and petugas.nama like ?  and kategori_barang.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and industrifarmasi.nama_industri like ? or "+
                    " pemesanan.tgl_pesan between ? and ? and pemesanan.no_faktur like ? and datasuplier.nama_suplier like ? and petugas.nama like ?  and kategori_barang.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and kategori_barang.nama like ? "+
                    " group by pemesanan.no_faktur order by " + orderby);
            try {
                ...
                while(rs.next()){
                    ...
                    if (jCheckBox1.isSelected()){
                        if (!"".equals(currentSupplier) && !currentSupplier.equals(rs.getString(4))){
                            tabMode3.addRow(new Object[]{"","","","","Total :",Valid.SetAngka4(tagihan),"","","","","",""});
                            tabMode3.addRow(new Object[]{"","","","","","","","","","",""});
                            tagihan = 0;
                        }
                        tabMode3.addRow(new Object[]{(!currentSupplier.equals(rs.getString(4))?rs.getString(4):""),rs.getString(1),rs.getString(6),
                          rs.getString(2),Valid.SetAngka4(rs.getDouble("tagihan")),"","","","","","",""
                        });    
                    }
                    else{
                        tabMode3.addRow(new Object[]{rs.getString(1),rs.getString(2),rs.getString(3)+", "+rs.getString(4),
                              rs.getString(5)+", "+rs.getString(6),"Pemesanan di "+rs.getString(7) +" :","","","","","","",""
                        });
                    }
                    if (!jCheckBox1.isSelected()){
                    ps2=koneksi.prepareStatement("select detailpesan.kode_brng,databarang.nama_brng, "+
                        ...
                        "detailpesan.subtotal,detailpesan.dis,detailpesan.besardis,detailpesan.total,"+
                        "detailpesan.no_batch,industrifarmasi.nama_industri,detailpesan.kadaluarsa "+
                        "from detailpesan inner join databarang inner join kodesatuan inner join kategori_barang inner join industrifarmasi "+
                        " on detailpesan.kode_brng=databarang.kode_brng and databarang.kode_kategori=kategori_barang.kode "+
                        " and detailpesan.kode_sat=kodesatuan.kode_sat and databarang.kode_industri=industrifarmasi.kode_industri where "+
                        " detailpesan.no_faktur=? and kategori_barang.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and detailpesan.kode_brng like ? or "+
                        " detailpesan.no_faktur=? and kategori_barang.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and databarang.nama_brng like ? or "+
                        " detailpesan.no_faktur=? and kategori_barang.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and detailpesan.kode_sat like ? or "+
                        " detailpesan.no_faktur=? and kategori_barang.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and detailpesan.no_batch like ? or "+
                        " detailpesan.no_faktur=? and kategori_barang.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and industrifarmasi.nama_industri like ? or "+
                        " detailpesan.no_faktur=? and kategori_barang.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and kategori_barang.nama like ? order by detailpesan.kode_brng  ");
                    try {
                        ps2.setString(1,rs.getString(2));
                        ps2.setString(2,"%"+nmsat.getText()+"%");
                        ps2.setString(3,"%"+nmbar.getText()+"%");
                        ...
                        int no=1;
                        while(rs2.next()){
                            tabMode3.addRow(new Object[]{"",no+". Batch "+rs2.getString("no_batch"),"Exp : "+rs2.getString("kadaluarsa"),"I.F. : "+rs2.getString("nama_industri"),rs2.getString(1)+", "+rs2.getString(2),
                                            rs2.getString(3)+", "+rs2.getString(4),
                                            rs2.getString(5),Valid.SetAngka4(rs2.getDouble(6)),Valid.SetAngka4(rs2.getDouble(7)),
                                            Valid.SetAngka4(rs2.getDouble(8)),Valid.SetAngka4(rs2.getDouble(9)),Valid.SetAngka4(rs2.getDouble(10))});
                            no++;
                            
                        }
                        tabMode3.addRow(new Object[]{"","","","","","Total",":","",Valid.SetAngka4(rs.getDouble("total1")),"",Valid.SetAngka4(rs.getDouble("potongan")),Valid.SetAngka4(rs.getDouble("total2"))});
                        tabMode3.addRow(new Object[]{"","","","","","PPN",":","","","","",Valid.SetAngka4(rs.getDouble("ppn"))});
                        tabMode3.addRow(new Object[]{"","","","","","Tagihan",":","","","","",Valid.SetAngka4(rs.getDouble("tagihan"))});
                    } catch (Exception e) {
                        System.out.println("Notifikasi : "+e);
                    } finally{
                        if(rs2!=null){
                    ...
                    currentSupplier = rs.getString(4);
                    
                    tagihan=tagihan+Sequel.cariIsiAngka("select tagihan from pemesanan where no_faktur=?",rs.getString(2));
                    total = total + Sequel.cariIsiAngka("select tagihan from pemesanan where no_faktur=?",rs.getString(2));
                }               
                LTotal.setText(Valid.SetAngka4(total));
                if (jCheckBox1.isSelected()){
                    tabMode3.addRow(new Object[]{"","","","","Total :",Valid.SetAngka4(tagihan),"","","","","",""});                    
                    tabMode3.addRow(new Object[]{"","","","","Total Faktur:",Valid.SetAngka4(total),"","","","","",""});
...
private void tampil4() {
        ...
        String header_value[] = new String[] {"Tgl.Beli","No.Faktur","Suplier","Petugas","Barang",
                    ...
                    "Disk(%)","Bsr.Disk(Rp)","Total(Rp)"};
        if (jCheckBox1.isSelected()){
            header_value = new String[] {"Suplier","Tanggal","Tgl. Jth Tempo","Petugas","No. Faktur","Jumlah Faktur","Total Faktur","","","","","",""};
        }
        TableColumnModel colModel = tbDokter2.getColumnModel();
        for (int i = 0; i < 7; i++){
            colModel.getColumn(i).setHeaderValue(header_value[i]);
        }
        tbDokter2.getTableHeader().repaint();
        ...
        try{     
            ps=koneksi.prepareStatement("select pemesanan.tgl_pesan,pemesanan.tgl_tempo,pemesanan.no_faktur, "+
                    " pemesanan.kode_suplier,datasuplier.nama_suplier, "+
                    " pemesanan.nip,petugas.nama,bangsal.nm_bangsal,pemesanan.total1,"+
                    " pemesanan.potongan,pemesanan.total2,pemesanan.ppn,pemesanan.tagihan "+
                    " from pemesanan inner join datasuplier inner join petugas inner join bangsal  "+
                    ...
                    " and pemesanan.nip=petugas.nip and databarang.kode_kategori=kategori_barang.kode"+
                    " where "+
                    " pemesanan.tgl_pesan between ? and ? and pemesanan.no_faktur like ? and datasuplier.nama_suplier like ? and petugas.nama like ?  and kategori_barang.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and pemesanan.no_faktur like ? or "+
                    " pemesanan.tgl_pesan between ? and ? and pemesanan.no_faktur like ? and datasuplier.nama_suplier like ? and petugas.nama like ?  and kategori_barang.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and pemesanan.kode_suplier like ? or "+
                    " pemesanan.tgl_pesan between ? and ? and pemesanan.no_faktur like ? and datasuplier.nama_suplier like ? and petugas.nama like ?  and kategori_barang.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and datasuplier.nama_suplier like ? or "+
                    " pemesanan.tgl_pesan between ? and ? and pemesanan.no_faktur like ? and datasuplier.nama_suplier like ? and petugas.nama like ?  and kategori_barang.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and pemesanan.nip like ? or "+
                    " pemesanan.tgl_pesan between ? and ? and pemesanan.no_faktur like ? and datasuplier.nama_suplier like ? and petugas.nama like ?  and kategori_barang.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and petugas.nama like ? or "+
                    ...
                    " pemesanan.tgl_pesan between ? and ? and pemesanan.no_faktur like ? and datasuplier.nama_suplier like ? and petugas.nama like ?  and kategori_barang.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and kategori_barang.nama like ? "+
                    " group by pemesanan.no_faktur order by " + orderby);
//                    " group by datasuplier.nama_suplier order by " + orderby);
            try {
                ps.setString(1,Valid.SetTgl(TglBeli1.getSelectedItem()+""));
                ps.setString(2,Valid.SetTgl(TglBeli2.getSelectedItem()+""));
                ps.setString(3,"%"+NoFaktur.getText()+"%");
                ...
                while(rs.next()){
                    ...
                    if (jCheckBox1.isSelected()){
                        if (!"".equals(currentSupplier) && !currentSupplier.equals(rs.getString("nama_suplier"))){
                            tabMode4.addRow(new Object[]{"","","","","","Total :",Valid.SetAngka4(tagihan),"","","","","",""});
                            tabMode4.addRow(new Object[]{"","","","","","","","","","","",""});
                            tagihan = 0;
                        }
                        tabMode4.addRow(new Object[]{(!currentSupplier.equals(rs.getString("nama_suplier"))?
                            rs.getString("nama_suplier"):""),
                            rs.getString("tgl_pesan"),
                            rs.getString("tgl_tempo"),
                            rs.getString("nama"),
                            rs.getString("no_faktur"),
                            Valid.SetAngka4(rs.getDouble("tagihan")),"","","","","","","",""
                        });    
                    }
                    else{
                    ...
                    try {
                        ...
                        int no=1;
                        while(rs2.next()){
                            tabMode4.addRow(new Object[]{"",no+". Batch "+rs2.getString("no_batch"),"Exp : "+rs2.getString("kadaluarsa"),"I.F. : "+rs2.getString("nama_industri"),rs2.getString(1)+", "+rs2.getString(2),
                                            rs2.getString(3)+", "+rs2.getString(4),
                                            rs2.getString(5),Valid.SetAngka4(rs2.getDouble(6)),Valid.SetAngka4(rs2.getDouble(7)),
                                            Valid.SetAngka4(rs2.getDouble(8)),Valid.SetAngka4(rs2.getDouble(9)),Valid.SetAngka4(rs2.getDouble(10))});
                            no++;
                        ...
                        tabMode4.addRow(new Object[]{"","","","","","Total",":","",Valid.SetAngka4(rs.getDouble("total1")),"",Valid.SetAngka4(rs.getDouble("potongan")),Valid.SetAngka4(rs.getDouble("total2"))});
                        tabMode4.addRow(new Object[]{"","","","","","PPN",":","","","","",Valid.SetAngka4(rs.getDouble("ppn"))});
                        tabMode4.addRow(new Object[]{"","","","","","Tagihan",":","","","","",Valid.SetAngka4(rs.getDouble("tagihan"))});
                    } catch (Exception e) {
                        System.out.println("Notifikasi : "+e);
                    } finally{
                        if(rs2!=null){
                    ...
                    currentSupplier = rs.getString("nama_suplier");
                    
                    tagihan=tagihan+Sequel.cariIsiAngka("select tagihan from pemesanan where no_faktur=?",rs.getString("no_faktur"));
                    total = total + Sequel.cariIsiAngka("select tagihan from pemesanan where no_faktur=?",rs.getString("no_faktur"));
                }               
                LTotal.setText(Valid.SetAngka4(total));
                if (jCheckBox1.isSelected()){
                    tabMode4.addRow(new Object[]{"","","","","","Total :",Valid.SetAngka4(tagihan),"","","","",""});                    
                    tabMode4.addRow(new Object[]{"","","","","","Total Faktur:",Valid.SetAngka4(total),"","","","",""});
...
//                    tabMode3.addRow(new Object[]{"","","","","Total Faktur:",Valid.SetAngka4(total),"","","","","",""});
    ...
    public void isCek(){
        BtnPrintRekap.setEnabled(akses.getpemesanan_obat());
...
private void getData() {
        if(tbDokter.getSelectedRow()!= -1){
            NoFaktur.setText(tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString());             
        }
    }  
