...
public class DlgBarang extends javax.swing.JDialog {
    ...
    public DlgCariJenis jenis = new DlgCariJenis(null, true);
    public DlgCariKategori kategori = new DlgCariKategori(null, true);
    public DlgCariGolongan golongan = new DlgCariGolongan(null, true);
    public DlgCariSatuan satuan = new DlgCariSatuan(null, true);
    public DlgCariIndustriFarmasi industri=new DlgCariIndustriFarmasi(null,true);
