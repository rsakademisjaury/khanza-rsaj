...
public final class DlgPeresepanDokter extends javax.swing.JDialog {
    ...
    public DlgCariAturanPakai aturanpakai=new DlgCariAturanPakai(null,true);
    ...
    private void initComponents() {
        ...
        BtnTambah.setPreferredSize(new java.awt.Dimension(115, 23));
        ...
        BtnSeek5.setText("Kalkulator Conversi");
        BtnSeek5.setToolTipText("Alt+4");
        BtnSeek5.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnSeek5.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        BtnSeek5.setName("BtnSeek5"); // NOI18N
        BtnSeek5.setPreferredSize(new java.awt.Dimension(150, 23));
        ...
        BtnTambah1.setText("Buat Racikan");
        ...
        BtnTambah1.setPreferredSize(new java.awt.Dimension(115, 23));
        ...
        BtnHapus.setText("Hapus Racikan");
        ...
        DTPBeri.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "01-07-2026" }));
        ...
        ChkRM.setOpaque(false);
        ChkRM.setRequestFocusEnabled(false);
        ChkRM.setRolloverEnabled(false);
        ...
        Ruangan.setBounds(756, 12, 250, 23);

        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel4.setText("Ruangan :");
        jLabel4.setName("jLabel4"); // NOI18N
        FormInput.add(jLabel4);
        jLabel4.setBounds(695, 12, 70, 23);
        ...
        TabRawat.addTab(" Umum   ", new javax.swing.ImageIcon(getClass().getResource("/picture/medicine.png")), Scroll); // NOI18N
        ...
        TabRawat.addTab("  Racikan    ", new javax.swing.ImageIcon(getClass().getResource("/picture/mortar.png")), jPanel3); // NOI18N
    ...
    private void BtnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnTambahActionPerformed
        ...
        DlgBarang barang=new DlgBarang(null,true);
        barang.emptTeks();
        barang.isCek();
                        ...
                        cmbJam.getSelectedItem()+":"+cmbMnt.getSelectedItem()+":"+cmbDtk.getSelectedItem(),status,"0000-00-00","00:00:00"
                            ...
                            //MODIF MUSTAFA
                             ...
                             try {
                                    ...
                                    String insertQuery = "INSERT INTO rsaj_ruang_resep (no_resep, no_rawat, ruangan, waktu, petugas, ip_komputer) VALUES (?,?,?,?,?,?)";
                                    String[] params = {NoResep.getText(), TNoRw.getText(), Ruangan.getText(),waktu, petugas, ipKomputer};
...
private void ppBersihkanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBersihkanActionPerformed
    ...
    private void ppStok1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppStok1ActionPerformed
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        DlgCekStok ceksetok=new DlgCekStok(null,true);
...
//MODIF MUSTAFA
        if (ChkRM.isSelected()) {
        String baseNomorResep = DTPBeri.getSelectedItem().toString().substring(6, 10) +
                                DTPBeri.getSelectedItem().toString().substring(3, 5) +
                                DTPBeri.getSelectedItem().toString().substring(0, 2);
        
        String query = "SELECT IFNULL(MAX(CONVERT(RIGHT(no_resep, LENGTH(no_resep)-8), SIGNED)), 0) FROM resep_obat " +
                       "WHERE tgl_peresepan = ? OR tgl_perawatan = ?";
        
        // Persiapkan statement dan parameter
        try (PreparedStatement ps = koneksi.prepareStatement(query)) {
            ps.setString(1, Valid.SetTgl(DTPBeri.getSelectedItem().toString()));
            ps.setString(2, Valid.SetTgl(DTPBeri.getSelectedItem().toString()));
            ResultSet rs = ps.executeQuery();
            
            if (rs.next()) {
                int lastNumber = rs.getInt(1);  // Ambil nomor resep terakhir
                String newNomorResep = baseNomorResep + String.format("%06d", lastNumber + 1); // Tambahkan 1 ke nomor terakhir
                NoResep.setText(newNomorResep);  // Set nomor resep baru
            }
        } catch (SQLException e) {
            System.out.println("Error generate nomor resep: " + e);
        }
    }
    //END MODIF MUSTAFA    
...
//        } 
    ...
    public void setNoRm(String norwt,Date tanggal, String jam,String menit,String detik,String KodeDokter,String NamaDokter,String status) {        
        ...
        if (status.equals("ranap")) {
            Ruangan.setText(Sequel.cariIsi(
                "SELECT kamar_inap.kd_kamar FROM kamar_inap WHERE kamar_inap.stts_pulang='-' AND kamar_inap.no_rawat = ?",
                TNoRw.getText()
                ));
        } else if (status.equals("ralan")) {
            Ruangan.setText(Sequel.cariIsi(
                "SELECT poliklinik.nm_poli FROM reg_periksa " +
