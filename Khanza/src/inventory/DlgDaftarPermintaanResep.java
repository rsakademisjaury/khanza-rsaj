...
public class DlgDaftarPermintaanResep extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnPanggilPasien.setPreferredSize(new java.awt.Dimension(120, 23));
    ...
    private void BtnPanggilPasienActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPanggilPasienActionPerformed
        // Display farmasi hanya untuk pasien rawat jalan yang mengambil resep di loket penyerahan.
        if(TabPilihRawat.getSelectedIndex()!=0 || TabRawatJalan.getSelectedIndex()!=0){
            JOptionPane.showMessageDialog(null,"Maaf, panggilan pasien hanya dapat dilakukan pada daftar Resep Rawat Jalan...!!!!");
            tbResepRalan.requestFocus();
            return;
        }
        ...
        String noResepPanggil=tbResepRalan.getValueAt(baris,0).toString().trim();
        String noRawatPanggil=tbResepRalan.getValueAt(baris,3).toString().trim();
        String namaPasienPanggil=tbResepRalan.getValueAt(baris,5).toString().trim();

        if(noResepPanggil.equals("") || noRawatPanggil.equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, data resep/pasien yang dipilih tidak lengkap sehingga tidak dapat dipanggil...!!!!");
            tbResepRalan.requestFocus();
            return;
        }
    ...
    private void BtnAllKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnAllKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_SPACE){
            ...
            Valid.pindah(evt, BtnCari, BtnPanggilPasien);
        }
    ...
    private void BtnKeluarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnKeluarKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_SPACE){            
            dispose();              
        }else{Valid.pindah(evt,BtnPanggilPasien,TCari);}
        ...
        try{  
            ...
            if(DEPOAKTIFOBAT.equals("")){
                ps=koneksi.prepareStatement("select resep_obat.no_resep,resep_obat.tgl_peresepan,resep_obat.jam_peresepan,resep_obat.no_rawat,pasien.no_rkm_medis,"+
                        ...
                        " rsaj_ruang_resep.ruangan,resep_obat.status as status_asal,penjab.png_jawab from resep_obat "+
                        " inner join reg_periksa on resep_obat.no_rawat=reg_periksa.no_rawat "+
                        " inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        " inner join dokter on resep_obat.kd_dokter=dokter.kd_dokter "+
                        " left join rsaj_ruang_resep on rsaj_ruang_resep.no_resep = resep_obat.no_resep "+                                        
                ...
                if(cmbStatus.getSelectedItem().toString().equals("Semua")){
                    while(rs.next()){
                        tabMode2.addRow(new String[]{
                            ...
                            rs.getString("ruangan"),rs.getString("status"),
...
////                        " rsaj_ruang_resep.ruangan,penjab.png_jawab,"+
...
////                        (semua?"":"and dokter.nm_dokter like ? and (rsaj_ruang_resep.ruangan like ? OR rsaj_ruang_resep.ruangan IS NULL) and "+
////                        "(resep_obat.no_resep like ? or resep_obat.no_rawat like ? or "+
...
////                        " resep_obat.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,resep_obat.kd_dokter,dokter.nm_dokter, "+
////                        " if(resep_obat.tgl_perawatan='0000-00-00','Belum Terlayani','Sudah Terlayani') as status,"+
////                        " bangsal.nm_bangsal,kamar.kd_bangsal,rsaj_ruang_resep.ruangan,penjab.png_jawab,"+
////                        " if(resep_obat.tgl_perawatan='0000-00-00','',resep_obat.tgl_perawatan) as tgl_perawatan,"+
////                        " if(resep_obat.jam='00:00:00','',resep_obat.jam) as jam from resep_obat  "+
...
//        semua = CrDokter2.getText().trim().equals("") && Kamar.getText().trim().equals("") && TCari.getText().trim().equals("");
//
////        String baseQuery = "select resep_obat.no_resep,resep_obat.tgl_peresepan,resep_obat.jam_peresepan," +
////                " resep_obat.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,resep_obat.kd_dokter,dokter.nm_dokter, " +
////                " if(resep_obat.tgl_perawatan='0000-00-00','Belum Terlayani','Sudah Terlayani') as status," +
////                " bangsal.nm_bangsal as ruangan,penjab.png_jawab," +
////                " if(resep_obat.tgl_perawatan='0000-00-00','',resep_obat.tgl_perawatan) as tgl_perawatan," +
////                " if(resep_obat.jam='00:00:00','',resep_obat.jam) as jam " +
////                "from resep_obat " +
////                "inner join reg_periksa on resep_obat.no_rawat=reg_periksa.no_rawat " +
...
////                "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj " +
////                "left join rsaj_ruang_resep on rsaj_ruang_resep.no_resep = resep_obat.no_resep " +
////                "left join kamar_inap on rsaj_ruang_resep.ruangan = kamar_inap.kd_kamar " +
...
//
//                            // LOGIKA RUANGAN
//                            "IF(rsaj_ruang_resep.ruangan IS NOT NULL AND rsaj_ruang_resep.ruangan <> '', " +
//                            "   bangsal_manual.nm_bangsal, " +
//                            "   CASE " +
//                            "       WHEN reg_periksa.status_lanjut = 'Ranap' THEN bangsal_auto.nm_bangsal " +                            
//                            "       ELSE '-' " +
//                            "   END" +
//                            ") AS ruangan, " +
//
...
//                            "INNER JOIN penjab ON reg_periksa.kd_pj = penjab.kd_pj " +
//
//                            // AMBIL RUANGAN DARI INPUTAN MANUAL (rsaj_ruang_resep.ruangan = kd_kamar)
//                            "LEFT JOIN rsaj_ruang_resep ON rsaj_ruang_resep.no_resep = resep_obat.no_resep " +
//                            "LEFT JOIN kamar kamar_manual ON rsaj_ruang_resep.ruangan = kamar_manual.kd_kamar " +
//                            "LEFT JOIN bangsal bangsal_manual ON kamar_manual.kd_bangsal = bangsal_manual.kd_bangsal " +
//
//                            // AMBIL RUANGAN OTOMATIS (kamar_inap → bangsal)
//                            "LEFT JOIN kamar_inap ON resep_obat.no_rawat = kamar_inap.no_rawat " +
//                            "LEFT JOIN kamar kamar_auto ON kamar_inap.kd_kamar = kamar_auto.kd_kamar " +
//                            "LEFT JOIN bangsal bangsal_auto ON kamar_auto.kd_bangsal = bangsal_auto.kd_bangsal ";
//
//
//
//        if (!DEPOAKTIFOBAT.equals("")) {
//            baseQuery += " inner join set_depo_ranap on set_depo_ranap.kd_bangsal=bangsal.kd_bangsal ";
//        }
//
//        baseQuery += " where resep_obat.tgl_peresepan<>'0000-00-00' and resep_obat.status='ranap' and resep_obat.tgl_peresepan between ? and ? ";
//
//        if (!semua) {
//            baseQuery += " and dokter.nm_dokter like ? and bangsal.nm_bangsal like ? and (resep_obat.no_resep like ? or resep_obat.no_rawat like ? or " +
//                    "pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or dokter.nm_dokter like ? or penjab.png_jawab like ?)";
//        }
//
//        baseQuery += " group by resep_obat.no_resep order by resep_obat.tgl_peresepan desc,resep_obat.jam_peresepan desc";
//
...
//    }
    ...
    try {
        ...
        String baseQuery = "SELECT resep_obat.no_resep, resep_obat.tgl_peresepan, resep_obat.jam_peresepan, " +
                ...
                "IF(rsaj_ruang_resep.ruangan IS NOT NULL AND rsaj_ruang_resep.ruangan <> '', " +
                "   bangsal_manual.nm_bangsal, " +
                "   CASE WHEN reg_periksa.status_lanjut = 'Ranap' THEN bangsal_auto.nm_bangsal ELSE '-' END " +
                ") AS ruangan, " +
                "penjab.png_jawab, " +
                "IF(resep_obat.tgl_perawatan='0000-00-00','',resep_obat.tgl_perawatan) AS tgl_perawatan, " +
                "IF(resep_obat.jam='00:00:00','',resep_obat.jam) AS jam " +
        ...
        if (!DEPOAKTIFOBAT.equals("")) {
            baseQuery += " INNER JOIN set_depo_ranap ON set_depo_ranap.kd_bangsal = bangsal_auto.kd_bangsal ";
        }

        baseQuery += " WHERE resep_obat.tgl_peresepan <> '0000-00-00' AND resep_obat.status = 'ranap' " +
                     "AND resep_obat.tgl_peresepan BETWEEN ? AND ? ";

        if (!semua) {
            baseQuery += "AND dokter.nm_dokter LIKE ? " +
                    "AND ( " +
                    "  (rsaj_ruang_resep.ruangan IS NOT NULL AND rsaj_ruang_resep.ruangan <> '' AND bangsal_manual.nm_bangsal LIKE ?) " +
                    "  OR ( (rsaj_ruang_resep.ruangan IS NULL OR rsaj_ruang_resep.ruangan = '') AND bangsal_auto.nm_bangsal LIKE ?) " +
                    ") " +
        ...
        if (!semua) {
            ps.setString(paramIndex++, "%" + CrDokter2.getText().trim() + "%");
            ps.setString(paramIndex++, "%" + Kamar.getText().trim() + "%"); // bangsal_manual
            ps.setString(paramIndex++, "%" + Kamar.getText().trim() + "%"); // bangsal_auto
        ...
        System.out.println("Notifikasi tampil3: " + ex);
    } finally {
        try {
            if (rs != null) rs.close();
            if (ps != null) ps.close();
        } catch (Exception e) {
            System.out.println("Notifikasi close tampil3: " + e);
        }
    }
    ...
    public void tampil4() {
        ...
        try{  
            ...
            if(DEPOAKTIFOBAT.equals("")){
                ps=koneksi.prepareStatement("select resep_obat.no_resep,resep_obat.tgl_peresepan,resep_obat.jam_peresepan,resep_obat.no_rawat,pasien.no_rkm_medis,"+
                        " pasien.nm_pasien,resep_obat.kd_dokter,dokter.nm_dokter,if(resep_obat.tgl_perawatan='0000-00-00','Belum Terlayani','Sudah Terlayani') as status,"+
                        " bangsal.nm_bangsal,rsaj_ruang_resep.ruangan,resep_obat.status as status_asal,penjab.png_jawab from resep_obat "+
                        " inner join reg_periksa on resep_obat.no_rawat=reg_periksa.no_rawat "+
                        " inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        " inner join dokter on resep_obat.kd_dokter=dokter.kd_dokter "+
                        " inner join penjab on reg_periksa.kd_pj=penjab.kd_pj "+
