...
public final class DlgResepObat extends javax.swing.JDialog {
    ...
    private DlgCariAturanPakai aturanpakai=new DlgCariAturanPakai(null,true);
...
//        Object[] row={"No.Resep","Tgl.Resep","Pasien","Dokter Peresep", "Ruangan", "Jenis Bayar", "No. SEP"};
...
//        tbResep.setDefaultRenderer(Object.class, new WarnaTable());
        ...
        String[] kolom = {
            "No.Resep", "Tgl.Resep", "Pasien", "Dokter Peresep",
            "Ruangan", "Jenis Bayar", "No. SEP"
        };
        ...
        // Set lebar kolom
        int[] lebarKolom = {100, 200, 300, 250, 100, 150, 150};
        TableColumnModel columnModel = tbResep.getColumnModel();

        for (int i = 0; i < kolom.length; i++) {
            columnModel.getColumn(i).setPreferredWidth(lebarKolom[i]);
        }

        // Warna baris (highlight)
        tbResep.setDefaultRenderer(Object.class, new WarnaTable());
    ...
    private void initComponents() {
        ...
        ppLembarObatBilling = new javax.swing.JMenuItem();
        ppLembarObatBillingSEP = new javax.swing.JMenuItem();
        ...
        Popup2.setPreferredSize(new java.awt.Dimension(250, 281));
        ...
        ppLembarObatBilling.setBackground(new java.awt.Color(255, 255, 254));
        ppLembarObatBilling.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppLembarObatBilling.setForeground(new java.awt.Color(50, 50, 50));
        ppLembarObatBilling.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppLembarObatBilling.setText("Lembar Pemberian Obat & Billing");
        ppLembarObatBilling.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppLembarObatBilling.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppLembarObatBilling.setName("ppLembarObatBilling"); // NOI18N
        ppLembarObatBilling.setPreferredSize(new java.awt.Dimension(225, 25));
        ppLembarObatBilling.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppLembarObatBillingActionPerformed(evt);
            }
        });
        Popup2.add(ppLembarObatBilling);

        ppLembarObatBillingSEP.setBackground(new java.awt.Color(255, 255, 254));
        ppLembarObatBillingSEP.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppLembarObatBillingSEP.setForeground(new java.awt.Color(50, 50, 50));
        ppLembarObatBillingSEP.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppLembarObatBillingSEP.setText("Lembar Pemberian Obat + Billing + SEP");
        ppLembarObatBillingSEP.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppLembarObatBillingSEP.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppLembarObatBillingSEP.setName("ppLembarObatBillingSEP"); // NOI18N
        ppLembarObatBillingSEP.setPreferredSize(new java.awt.Dimension(225, 25));
        ppLembarObatBillingSEP.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppLembarObatBillingSEPActionPerformed(evt);
            }
        });
        Popup2.add(ppLembarObatBillingSEP);
        ...
        MnBridgingApotekBPJS.setText("Bridging Apotek BPJS");
        ...
        MnBridgingApotekBPJS.setPreferredSize(new java.awt.Dimension(320, 26));
        MnBridgingApotekBPJS.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                MnBridgingApotekBPJSMouseClicked(evt);
            }
        });
        ...
        Popup2.add(MnBridgingApotekBPJS);
        ...
        BtnPanggilPasien.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/marketing.png"))); // NOI18N
        ...
        BtnPanggilPasien.setPreferredSize(new java.awt.Dimension(120, 30));
        ...
        panelGlass8.add(BtnPanggilPasien);
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "24-06-2026 10:53:00" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "24-06-2026 10:53:01" }));
        ...
        DTPBeri.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "24-06-2026" }));
        ...
        if(tabMode.getRowCount()==0){
            ...
            for(i=0;i<tabMode.getRowCount();i++){  
                Sequel.menyimpan("temporary_resep","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",38,new String[]{
                    ""+i,
                    getValue(tabMode, i, 0),
                    getValue(tabMode, i, 1),
                    getValue(tabMode, i, 2),
                    getValue(tabMode, i, 3),
                    getValue(tabMode, i, 4),
                    getValue(tabMode, i, 5),
                    getValue(tabMode, i, 6),
                    "","","","","","","","","","","","","","","","","","","","","","","","","","","","","",akses.getalamatip()
                });
            }
...
//                   "aturan_pakai.aturan, detail_pemberian_obat.jml, kodesatuan.satuan, pasien.jk, " +
//                   "reg_periksa.umurdaftar, reg_periksa.sttsumur, " +
//                   "CASE " +
//                   "    WHEN kamar.kd_kamar IS NOT NULL THEN kamar.kd_kamar " +
//                   "    ELSE poliklinik.nm_poli " +
//                   "END as unit_sekarang " +
//                   "from resep_obat " +
...
//                   "    and aturan_pakai.aturan <>''", param);
//
//  
////                    "select resep_obat.no_resep,resep_obat.tgl_perawatan,resep_obat.jam,pasien.tgl_lahir, "+
////                    "resep_obat.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,databarang.nama_brng,"+
////                    "aturan_pakai.aturan,detail_pemberian_obat.jml,kodesatuan.satuan,pasien.jk,reg_periksa.umurdaftar,reg_periksa.sttsumur,"+
////                    "CASE WHEN kamar.kd_kamar IS NOT NULL THEN CONCAT(kamar.kd_kamar) ELSE poliklinik.nm_poli END as unit_sekarang "+        
////                    "from resep_obat inner join reg_periksa "+
////                    "inner join pasien inner join "+
////                    "inner join poliklinik on reg_periksa.kd_poli=poliklinik.kd_poli "+        
////                    "left join kamar_inap on reg_periksa.no_rawat = kamar_inap.no_rawat "+
////                    "left join kamar on kamar_inap.kd_kamar = kamar.kd_kamar "+
////                    "left join bangsal on kamar.kd_bangsal = bangsal.kd_bangsal "+        
...
//            param.put("unit_sekarang",tabMode.getValueAt(0,4));
            param.put("propinsirs",akses.getpropinsirs());
            ...
            Valid.MyReportqry("rptLembarObat.jasper","report","::[ Lembar Pemberian Obat ]::",
    ...
    private void ppLembarObat1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppLembarObat1ActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            param.put("peresep",NmDokter.getText());
            param.put("noresep",NoResep.getText());
            param.put("jeniskelamin",Sequel.cariIsi(
                    "select pasien.jk from pasien inner join reg_periksa " +
                    "on pasien.no_rkm_medis=reg_periksa.no_rkm_medis where reg_periksa.no_rawat=?",
                    TNoRw.getText()));
            param.put("umur",Sequel.cariIsi(
                    "select concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur) " +
                    "from reg_periksa where reg_periksa.no_rawat=?",TNoRw.getText()));
            param.put("alamatpasien",Sequel.cariIsi(
                    "select pasien.alamat from pasien inner join reg_periksa " +
                    "on pasien.no_rkm_medis=reg_periksa.no_rkm_medis where reg_periksa.no_rawat=?",
                    TNoRw.getText()));
            param.put("notelppasien",Sequel.cariIsi(
                    "select pasien.no_tlp from pasien inner join reg_periksa " +
                    "on pasien.no_rkm_medis=reg_periksa.no_rkm_medis where reg_periksa.no_rawat=?",
                    TNoRw.getText()));
            param.put("sipdokter",Sequel.cariIsi(
                    "select ifnull(dokter.no_ijn_praktek,'') from dokter where dokter.kd_dokter=?",
                    KdDokter.getText()));
    ...
    private void ppLembarObatBillingActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppLembarObatBillingActionPerformed
    if(tabMode.getRowCount()==0){
         JOptionPane.showMessageDialog(null,"Maaf, data sudah habis...!!!!");
         TNoRw.requestFocus();
    }else if(TPasien.getText().trim().equals("")){
        ...
        param.put("emailrs",akses.getemailrs());
        param.put("kontakrs",akses.getkontakrs());
        param.put("unit_sekarang",Sequel.cariIsi("select rsaj_ruang_resep.ruangan from rsaj_ruang_resep where rsaj_ruang_resep.no_rawat=? AND rsaj_ruang_resep.no_resep='"+NoResep.getText()+"'", TNoRw.getText()));
        param.put("SEP", Sequel.cariIsi(
                        "select bridging_sep.no_sep from bridging_sep " +
                        "inner join reg_periksa on bridging_sep.no_rawat = reg_periksa.no_rawat " +
                        "where bridging_sep.no_rawat = ? and " +
                        "((reg_periksa.status_lanjut='Ralan' and bridging_sep.jnspelayanan='2') or " +
                        " (reg_periksa.status_lanjut='Ranap' and bridging_sep.jnspelayanan='1'))",
                        TNoRw.getText()
                    ));
        param.put("penanggung",Sequel.cariIsi(
            "select penjab.png_jawab from penjab where penjab.kd_pj=?", 
            Sequel.cariIsi("select reg_periksa.kd_pj from reg_periksa where reg_periksa.no_rawat=?", TNoRw.getText()))
        );                           
        param.put("tanggal",Valid.SetTgl(DTPBeri.getSelectedItem()+""));
        param.put("norawat",TNoRw.getText());
        param.put("pasien",TPasien.getText());
        ...
        Valid.MyReportqry2("rptLembarObatBilling.jasper","report","::[ Lembar Pemberian Obat dan Billing ]::",
            "select databarang.kode_brng, databarang.nama_brng, detail_pemberian_obat.jml, " +
            "detail_pemberian_obat.biaya_obat, detail_pemberian_obat.embalase, databarang.kode_sat, " +
            "detail_pemberian_obat.tuslah, detail_pemberian_obat.total, " +
            "ifnull(aturan_pakai.aturan,'') as aturan " +
            "from detail_pemberian_obat " +
            "inner join databarang on detail_pemberian_obat.kode_brng = databarang.kode_brng " +
            "inner join resep_obat on detail_pemberian_obat.no_rawat = resep_obat.no_rawat " +
            "and detail_pemberian_obat.tgl_perawatan = resep_obat.tgl_perawatan " +
            "and detail_pemberian_obat.jam = resep_obat.jam " +
            "left join aturan_pakai on detail_pemberian_obat.no_rawat = aturan_pakai.no_rawat " +
            ...
            "where detail_pemberian_obat.no_rawat = '"+TNoRw.getText()+"' " +
            "and resep_obat.no_resep = '"+NoResep.getText()+"'", 
        param);

        
        this.setCursor(Cursor.getDefaultCursor());
    }
    }//GEN-LAST:event_ppLembarObatBillingActionPerformed

    private void ppLembarObatBillingSEPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppLembarObatBillingSEPActionPerformed
    if (tabMode.getRowCount() == 0) {
        JOptionPane.showMessageDialog(null, "Maaf, data sudah habis...!!!!");
        TNoRw.requestFocus();
    } else if (TPasien.getText().trim().equals("")) {
        ...
        try {
            ...
            // ==== (1) Ambil unit_sekarang dengan parameter yang benar ====
            param.put("unit_sekarang", Sequel.cariIsi(
                "select rsaj_ruang_resep.ruangan from rsaj_ruang_resep where rsaj_ruang_resep.no_rawat=? and rsaj_ruang_resep.no_resep=?",
                TNoRw.getText(), NoResep.getText()
            ));

            // ==== (2) Tentukan status layanan dari NO_RESEP (bukan dari reg_periksa yang bisa berubah) ====
            String statusResep = Sequel.cariIsi(
                "select resep_obat.status from resep_obat where resep_obat.no_resep=? and resep_obat.no_rawat=? limit 1",
                NoResep.getText(), TNoRw.getText()
            );

            // fallback kalau entah kenapa kosong (jaga-jaga)
            if (statusResep == null || statusResep.trim().isEmpty()) {
                String statusLanjut = Sequel.cariIsi("select status_lanjut from reg_periksa where no_rawat=?", TNoRw.getText());
                statusResep = (statusLanjut != null && statusLanjut.equalsIgnoreCase("Ralan")) ? "ralan" : "ranap";
            }

            // mapping BPJS: 2 = Rawat Jalan, 1 = Rawat Inap
            String jnsPelayanan = statusResep.equalsIgnoreCase("ralan") ? "2" : "1";

            // ==== (3) Ambil NO SEP berdasarkan jnspelayanan hasil status resep ====
            String noSEP = Sequel.cariIsi(
                "select bridging_sep.no_sep from bridging_sep where bridging_sep.no_rawat=? and bridging_sep.jnspelayanan=? " +
                "order by bridging_sep.tglsep desc limit 1",
                TNoRw.getText(), jnsPelayanan
            );

            // fallback terakhir: kalau tidak ketemu SEP sesuai jns, ambil SEP terakhir di no_rawat tsb
            if (noSEP == null || noSEP.trim().isEmpty()) {
                noSEP = Sequel.cariIsi(
                    "select bridging_sep.no_sep from bridging_sep where bridging_sep.no_rawat=? " +
                    "order by bridging_sep.tglsep desc limit 1",
                    TNoRw.getText()
                );
            }

            // DEBUG biar gampang lacak kalau ada kasus aneh
            System.out.println("DEBUG CETAK LEMBAR OBAT+SEP => no_rawat=" + TNoRw.getText()
                + " | no_resep=" + NoResep.getText()
            ...
            param.put("SEP", noSEP);
            param.put("parameter", noSEP); // untuk rptBridgingSEP2
            ...
            // ==== (4) Datasource rptLembarObatBilling (prepared statement biar aman) ====
            String sql1 =
                "select databarang.kode_brng, databarang.nama_brng, detail_pemberian_obat.jml, " +
                "detail_pemberian_obat.biaya_obat, detail_pemberian_obat.embalase, databarang.kode_sat, " +
                "detail_pemberian_obat.tuslah, detail_pemberian_obat.total, " +
                ...
                "and resep_obat.no_resep = ?";

            java.sql.PreparedStatement ps1 = koneksi.prepareStatement(sql1);
            ps1.setString(1, TNoRw.getText());
            ps1.setString(2, NoResep.getText());
            JRResultSetDataSource dataSource1 = new JRResultSetDataSource(ps1.executeQuery());

            // ==== (5) Fill report 1 ====
            JasperReport report1 = (JasperReport) JRLoader.loadObjectFromFile("report/rptLembarObatBilling47.jasper");
            JasperPrint print1 = JasperFillManager.fillReport(report1, param, dataSource1);

            // ==== (6) Fill report 2 (SEP) ====
            JasperReport report2 = (JasperReport) JRLoader.loadObjectFromFile("report/rptBridgingSEP47.jasper");
            JasperPrint print2 = JasperFillManager.fillReport(report2, param, koneksi);
            ...
            // ==== (8) Tampilkan ====
            JasperViewer viewer = new JasperViewer(print1, false);
            viewer.setTitle("Lembar Obat + SEP");
            viewer.setVisible(true);

            try { ps1.close(); } catch (Exception ex) { /* ignore */ }

        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Gagal menampilkan laporan gabungan : " + e.getMessage());
            e.printStackTrace();
        } finally {
            this.setCursor(Cursor.getDefaultCursor());
        }
    }
    }//GEN-LAST:event_ppLembarObatBillingSEPActionPerformed

    private void MnBridgingApotekBPJSMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_MnBridgingApotekBPJSMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_MnBridgingApotekBPJSMouseClicked

    private void MnBridgingApotekBPJSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnBridgingApotekBPJSActionPerformed
        // TODO add your handling code here:
        if(tabMode.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, data sudah habis...!!!!");
            TNoRw.requestFocus();
            ...
            dlgobtApotekBPJS.setNoRm(TNoRw.getText(),TNoRm.getText(),TPasien.getText(),Valid.SetTgl(DTPBeri.getSelectedItem()+""),cmbJam.getSelectedItem()+":"+cmbMnt.getSelectedItem()+":"+cmbDtk.getSelectedItem(),NoResep.getText());
    ...
    }//GEN-LAST:event_MnBridgingApotekBPJSActionPerformed
    ...
    private void BtnPanggilPasienActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPanggilPasienActionPerformed
        ...
        int baris = tbResep.getSelectedRow();
        if(baris == -1){
            JOptionPane.showMessageDialog(null,"Maaf, silahkan pilih dulu pasien/resep yang akan dipanggil...!!!!");
            tbResep.requestFocus();
            return;
        }

        String noResepPanggil = tbResep.getValueAt(baris,0).toString().trim();
        if(noResepPanggil.equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, pilih baris utama resep/pasien (baris yang memiliki No.Resep), bukan baris rincian obat...!!!!");
            tbResep.requestFocus();
            return;
        }

        String noRawatPanggil = Sequel.cariIsi("select no_rawat from resep_obat where no_resep=?",noResepPanggil);
        if(noRawatPanggil.equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, No.Rawat untuk resep yang dipilih tidak ditemukan...!!!!");
            tbResep.requestFocus();
            return;
        }

        String namaPasienPanggil = Sequel.cariIsi(
                "select pasien.nm_pasien from resep_obat inner join reg_periksa on resep_obat.no_rawat=reg_periksa.no_rawat " +
                "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis where resep_obat.no_resep=?",
                noResepPanggil);

        PreparedStatement psPanggil = null;
        try {
            psPanggil = koneksi.prepareStatement(
                    "insert into rsaj_panggilan_farmasi " +
                    "(no_resep,no_rawat,status,dibuat_oleh,dibuat_pada) values (?,?, 'MENUNGGU', ?, now())");
            psPanggil.setString(1,noResepPanggil);
            psPanggil.setString(2,noRawatPanggil);
            psPanggil.setString(3,akses.getkode());
            psPanggil.executeUpdate();
    ...
    */
    ...
    private javax.swing.JMenuItem ppLembarObatBilling;
    private javax.swing.JMenuItem ppLembarObatBillingSEP;
    ...
    public void tampil() {
        ...
        try{  
            ps=koneksi.prepareStatement("select DISTINCT resep_obat.no_resep,resep_obat.tgl_perawatan,resep_obat.jam,"+
                    " resep_obat.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,resep_obat.kd_dokter,dokter.nm_dokter,"+
                    " rsaj_ruang_resep.ruangan,"+
                    " penjab.png_jawab,"+
                    " IF(resep_obat.status = 'ranap', (select bridging_sep.no_sep from bridging_sep where bridging_sep.no_rawat = resep_obat.no_rawat and bridging_sep.jnspelayanan = '1' limit 1), "+
                    " (select bridging_sep.no_sep from bridging_sep where bridging_sep.no_rawat = resep_obat.no_rawat and bridging_sep.jnspelayanan = '2' limit 1)) as 'No.SEP' "+        
...
//                    " where (kamar_inap.stts_pulang <> '' or resep_obat.status = 'ralan')"+
                    " where concat(resep_obat.tgl_perawatan,' ',resep_obat.jam) between ? and ? "+
                    (TCari.getText().trim().equals("")?"":"and (resep_obat.no_resep like ? or resep_obat.no_rawat like ? or (poliklinik.nm_poli like ?  and resep_obat.status = 'ralan') "+
					" or penjab.png_jawab like ? or "+
            ...
            try{
                ...
                while(rs.next()){
                    ...
                    psracikan=koneksi.prepareStatement(
                            "select DISTINCT obat_racikan.no_racik,obat_racikan.nama_racik,"+
                    ...
                    try {
                        ...
                        while(rsracikan.next()){
                            ...
                            ps2=koneksi.prepareStatement(
                                "select DISTINCT databarang.kode_brng,databarang.nama_brng,detail_pemberian_obat.jml,"+
                                "detail_pemberian_obat.biaya_obat,detail_pemberian_obat.embalase,detail_pemberian_obat.tuslah,detail_pemberian_obat.total from "+
                                "detail_pemberian_obat inner join databarang inner join detail_obat_racikan "+
                                "on detail_pemberian_obat.kode_brng=databarang.kode_brng and "+
                                "detail_pemberian_obat.kode_brng=detail_obat_racikan.kode_brng and "+
    ...
    public void isCek(){
        ...
        BtnPanggilPasien.setEnabled(akses.gettelaah_resep());
        BtnTelaah.setEnabled(akses.gettelaah_resep());
        NoResep.setEnabled(akses.getadmin());
    }
