            ...
            if (i == JOptionPane.YES_OPTION) {
                ...
                try {
                    if(!nomorpermintaan.equals("")){
                        Sequel.queryu("delete from map_permintaan_mutasi_barang where no_permintaan=?",nomorpermintaan);
                    }
                    ...
                    for(i=0;i<tbDokter.getRowCount();i++){  
                        if(Valid.SetAngka(tbDokter.getValueAt(i,0).toString())>0){
                            if(Sequel.menyimpantf2("mutasibarang","'"+tbDokter.getValueAt(i,3).toString()+"','"+Valid.SetAngka(tbDokter.getValueAt(i,0).toString())+"',"+
                                ...
                                if(!nomorpermintaan.equals("")){
                                    if(Sequel.menyimpantf2("map_permintaan_mutasi_barang","?,?,?,?,?,?,?,?","Map Permintaan Mutasi",8,new String[]{
                                        nomorpermintaan,
                ...
                if(sukses==true){
                    ...
                    JOptionPane.showMessageDialog(null,"Terjadi kesalahan saat pemrosesan data, transaksi dibatalkan.\nPeriksa kembali data map mutasi / data stok sebelum melanjutkan menyimpan..!!");
                    Sequel.RollBack();
                } 
