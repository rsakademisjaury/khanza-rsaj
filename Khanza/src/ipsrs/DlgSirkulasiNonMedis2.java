...
public class DlgSirkulasiNonMedis2 extends javax.swing.JDialog {
    ...
    public DlgSirkulasiNonMedis2(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
                "Kode Barang","Nama Barang","Satuan","Jenis","Tgl.Opname","Stok Awal","Stok Awal(Rp)","Pengadaan","Pengadaan(Rp)",
    ...
    private void initComponents() {
        ...
        panelisi4Layout.setHorizontalGroup(
            ...
            .addGroup(panelisi4Layout.createSequentialGroup()
                ...
                .addComponent(Tgl1, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(label18, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(Tgl2, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(label17, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(kdbar, javax.swing.GroupLayout.PREFERRED_SIZE, 95, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(4, 4, 4)
                .addComponent(nmbar, javax.swing.GroupLayout.PREFERRED_SIZE, 238, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(kdjenis, javax.swing.GroupLayout.PREFERRED_SIZE, 95, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(3, 3, 3)
                .addComponent(nmjenis, javax.swing.GroupLayout.PREFERRED_SIZE, 239, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
...
//                        "kodesatuan.satuan,ipsrsjenisbarang.nm_jenis AS jenis,ipsrsbarang.stok,(ipsrsbarang.stok*ipsrsbarang.harga) as aset "+
...
//                           Valid.SetAngka(totalutd),
//                           Valid.SetAngka(jumlahhibah),
...
//                   Valid.SetAngka(ttltotalstokawal),"",
//                   Valid.SetAngka(ttltotalbeli),"",
//                   Valid.SetAngka(ttltotalpesan),"",
//                   Valid.SetAngka(ttltotalkeluar),"",
//                   Valid.SetAngka(ttltotalutd),"",
...
//        }
    ...
    try {
        String sql = "SELECT ipsrsbarang.kode_brng, ipsrsbarang.nama_brng, " +
                     ...
                     "INNER JOIN ipsrsjenisbarang ON ipsrsbarang.jenis = ipsrsjenisbarang.kd_jenis " +
                     "WHERE (ipsrsbarang.nama_brng LIKE ? OR ipsrsbarang.kode_brng LIKE ? OR kodesatuan.satuan LIKE ?) ";
        ...
        ps.setString(1, "%" + nmbar.getText().trim() + "%");
        ps.setString(2, "%" + nmbar.getText().trim() + "%");
        ps.setString(3, "%" + nmbar.getText().trim() + "%");
