...
public class IPSRSCariPermintaan extends javax.swing.JDialog {
    ...
    public IPSRSCariPermintaan(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"Tanggal","No.Permintaan","Ruangan","Pegawai","Status","Harga"};
    ...
    private void initComponents() {
        ...
        EditPermintaan = new javax.swing.JMenuItem();
        ...
        BtnLihatStokKeluar = new widget.Button();
        ...
        ppUpdate.setText("Ubah Pemberian");
        ...
        ppUpdate.setPreferredSize(new java.awt.Dimension(200, 25));
        ppUpdate.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppUpdateActionPerformed(evt);
            }
        });
        jPopupMenu1.add(ppUpdate);

        EditPermintaan.setBackground(new java.awt.Color(255, 255, 254));
        EditPermintaan.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        EditPermintaan.setForeground(new java.awt.Color(50, 50, 50));
        EditPermintaan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        EditPermintaan.setText("Edit Permintaan");
        EditPermintaan.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        EditPermintaan.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        EditPermintaan.setName("EditPermintaan"); // NOI18N
        EditPermintaan.setPreferredSize(new java.awt.Dimension(200, 25));
        EditPermintaan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                EditPermintaanActionPerformed(evt);
            }
        });
        jPopupMenu1.add(EditPermintaan);
        ...
        BtnLihatStokKeluar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/inventaris.png"))); // NOI18N
        BtnLihatStokKeluar.setMnemonic('T');
        BtnLihatStokKeluar.setText("Lihat Stok Keluar");
        BtnLihatStokKeluar.setToolTipText("Alt+T");
        BtnLihatStokKeluar.setName("BtnLihatStokKeluar"); // NOI18N
        BtnLihatStokKeluar.setPreferredSize(new java.awt.Dimension(150, 30));
        BtnLihatStokKeluar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnLihatStokKeluarActionPerformed(evt);
            }
        });
        BtnLihatStokKeluar.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnLihatStokKeluarKeyPressed(evt);
            }
        });
        panelisi1.add(BtnLihatStokKeluar);
        ...
        NoPermintaan.setBounds(95, 10, 235, 23);
...
//
//        Valid.MyReportqry(
//            "rptPermintaanNonMedis.jasper",
//            "report",
//            "::[ Data Permintaan Barang Non Medis ]::",
//            "SELECT permintaan_non_medis.ruang," +
//            "permintaan_non_medis.no_permintaan," +
//            "permintaan_non_medis.tanggal," +
//            "ipsrsbarang.nama_brng," +
//            "detail_permintaan_non_medis.jumlah," +
//            "kodesatuan.satuan," +
//            "ipsrsbarang.harga," +
//            "(ipsrsbarang.harga * detail_permintaan_non_medis.jumlah) as total " +
//            "FROM permintaan_non_medis," +
//            "detail_permintaan_non_medis," +
//            "ipsrsbarang," +
//            "kodesatuan " +
//            "WHERE permintaan_non_medis.no_permintaan = detail_permintaan_non_medis.no_permintaan " +
//            "AND ipsrsbarang.kode_brng = detail_permintaan_non_medis.kode_brng " +
//            "AND kodesatuan.kode_sat = detail_permintaan_non_medis.kode_sat " +
//            "AND ?"+akses.getalamatip()+"' order by permintaan_non_medis.tanggal",param);
//        }
...
//            param.put("parameter","%"+Ruangan.getText().trim()+"%");
//            Valid.MyReportqry("rptPermintaanNonMedis.jasper","report","::[ Data Permintaan Barang Non Medis ]::",
//                    "SELECT permintaan_non_medis.ruang,"+
//                    "permintaan_non_medis.no_permintaan,"+
//                    "permintaan_non_medis.tanggal," +
//                    "ipsrsbarang.nama_brng," +
...
//                    "and ipsrsbarang.kode_brng=detail_permintaan_non_medis.kode_brng " +
//                    "and kodesatuan.kode_sat=detail_permintaan_non_medis.kode_sat " +
////                    "and permintaan_non_medis.ruang=? " +
////                    "AND permintaan_non_medis.tanggal BETWEEN ? " +
//                    "AND ?"+akses.getalamatip()+"' order by permintaan_non_medis.tanggal",param);
//        }
//        this.setCursor(Cursor.getDefaultCursor());
    ...
    String statusPermintaan = Sequel.cariIsi(
        "SELECT status FROM permintaan_non_medis WHERE no_permintaan = ?",
        NoPermintaan.getText()
    );
    if (!"Disetujui".equalsIgnoreCase(statusPermintaan)) {
        JOptionPane.showMessageDialog(null,
            "Maaf, hanya permintaan dengan status 'Disetujui' yang dapat dicetak.",
            "Peringatan",
    ...
    if (tabMode.getRowCount() == 0) {
        ...
        param.put("emailrs", akses.getemailrs());
        param.put("logo", Sequel.cariGambar("SELECT setting.logo FROM setting"));
        param.put("noper", NoPermintaan.getText());
        param.put("parameter", Ruangan.getText());
        param.put("tanggal1", Valid.SetTgl(Tanggal1.getSelectedItem() + ""));
        param.put("tanggal2", Valid.SetTgl(Tanggal2.getSelectedItem() + ""));
...
private void ppHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppHapusActionPerformed
    ...
    private void ppDisetujuiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppDisetujuiActionPerformed
        if(tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString().trim().equals("")){
            ...
            String noPermintaan = tbDokter.getValueAt(tbDokter.getSelectedRow(), 1).toString().trim();
            String ruangan = tbDokter.getValueAt(tbDokter.getSelectedRow(), 2).toString().trim();
            String petugas = tbDokter.getValueAt(tbDokter.getSelectedRow(), 3).toString().trim();
            String keterangan = noPermintaan + ", Ruangan " + ruangan + ", oleh " + petugas;
            ...
            aplikasi.tampil(noPermintaan, keterangan);
            aplikasi.setNoRm(noPermintaan, ruangan, petugas);                                                                               
            aplikasi.isCek();
    ...
    if (tbDokter.getValueAt(tbDokter.getSelectedRow(), 0).toString().trim().equals("")) {
        ...
        Sequel.queryu("UPDATE permintaan_non_medis SET status='Disetujui' WHERE no_permintaan=?", noPermintaan);

        // Panggil form pengeluaran
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        IPSRSPengeluaranUpdate aplikasi = new IPSRSPengeluaranUpdate(null, false);
        aplikasi.tampilkanpermintaan = false;
        aplikasi.tampil(noPermintaan, keterangan);
        aplikasi.setNoRm(noPermintaan, ruangan, petugas);                                                                               
        aplikasi.isCek();
    ...
    private void BtnLihatStokKeluarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnLihatStokKeluarActionPerformed
    this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        IPSRSCariPengeluaran aplikasi = new IPSRSCariPengeluaran(null, false);
        aplikasi.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
        aplikasi.setLocationRelativeTo(internalFrame1);
        aplikasi.setVisible(true);
    this.setCursor(Cursor.getDefaultCursor());
    }//GEN-LAST:event_BtnLihatStokKeluarActionPerformed

    private void BtnLihatStokKeluarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnLihatStokKeluarKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnLihatStokKeluarKeyPressed

    private void EditPermintaanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditPermintaanActionPerformed

        String no = "";
    try {
        int row = tbDokter.getSelectedRow();
        if (row >= 0) {
            int modelRow = (tbDokter.getRowSorter() != null) ? tbDokter.convertRowIndexToModel(row) : row;
            Object v = tbDokter.getModel().getValueAt(modelRow, 1); // kolom 1 = "No.Permintaan"
            if (v != null) no = v.toString().trim();
        }
    } catch (Exception ignore) {}
    if (no.isEmpty()) {
        no = (NoPermintaan.getText() == null) ? "" : NoPermintaan.getText().trim();
    }
    if (no.isEmpty()) {
        try { Valid.textKosong(NoPermintaan, "No.Permintaan"); } 
        catch (Exception ignore) { javax.swing.JOptionPane.showMessageDialog(this, "Pilih baris atau isi No.Permintaan dulu."); }
        NoPermintaan.requestFocus();
        return;
    }

    // === pola sederhana seperti contoh kamu ===
    this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
    try {
        IPSRSEditPermintaan aplikasi = new IPSRSEditPermintaan(null, false);
        aplikasi.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
        aplikasi.setLocationRelativeTo(internalFrame1);

        // set nomor & langsung load detail
        aplikasi.tampil2();
        aplikasi.setNoRM(NoPermintaan.getText());
    ...
    }//GEN-LAST:event_EditPermintaanActionPerformed
    ...
    */
    ...
    private widget.Button BtnLihatStokKeluar;
    private widget.Button BtnPrint;
    private javax.swing.JMenuItem EditPermintaan;
        ...
        try{  
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    //cari kode pengeluaran
                    String kode_keluar = Sequel.cariIsi("select no_keluar from ipsrspengeluaran where keterangan like '"+rs.getString("no_permintaan")+"%'");
                    ps2=koneksi.prepareStatement(
                                "select detail_permintaan_non_medis.kode_brng,ipsrsbarang.nama_brng, "+
                                "detail_permintaan_non_medis.kode_sat,kodesatuan.satuan,ipsrsbarang.harga,"+
                                "detail_permintaan_non_medis.jumlah,detail_permintaan_non_medis.keterangan, IFNULL(ipsrsdetailpengeluaran.jumlah, 0) as keluar,(detail_permintaan_non_medis.jumlah*ipsrsbarang.harga) as total "+        
                                ...
                                "inner join ipsrsjenisbarang on ipsrsbarang.jenis=ipsrsjenisbarang.kd_jenis "+
                                "left join ipsrsdetailpengeluaran on (ipsrsdetailpengeluaran.no_keluar = ? and ipsrsdetailpengeluaran.kode_brng=detail_permintaan_non_medis.kode_brng) "+
                                "where detail_permintaan_non_medis.no_permintaan=? and ipsrsbarang.nama_brng like ? and ipsrsjenisbarang.nm_jenis like ? and "+
                    ...
                    try {
                        ...
                        int no=1;
                        total_per_permintaan = 0.0;
                        while(rs2.next()){
                            harga_barang = Double.parseDouble(rs2.getString("jumlah")) * Double.parseDouble(rs2.getString("harga"));
                            tabMode.addRow(new Object[]{
                                "",no+". "+rs2.getString("kode_brng")+" "+rs2.getString("nama_brng"),
                                "Permintaan :  "+rs2.getString("jumlah")+"   "+rs2.getString("satuan"),"Diberikan :  " + rs2.getString("keluar")+"  "+rs2.getString("satuan"),rs2.getString("keterangan"), Valid.SetAngka4(harga_barang)                        
                            });
                            total_per_permintaan = total_per_permintaan + harga_barang;
                            no++;
                        }                         
                        total_query = total_query + total_per_permintaan;                        
                        tabMode.addRow(new Object[]{"","", "", "", " Total Harga Permintaan >>",Valid.SetAngka4(total_per_permintaan)});                                                                       
//                        //rigth allignment
//                        DefaultTableCellRenderer rightRenderer = new DefaultTableCellRenderer();
//                        rightRenderer.setHorizontalAlignment(SwingConstants.RIGHT);                        
//                        tbDokter.getColumnModel().getColumn(5).setCellRenderer(rightRenderer);
                    } catch (Exception e) {
    ...
    private void getData() {
        if(tbDokter.getSelectedRow()!= -1){
            NoPermintaan.setText(tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString()); 
            Ruangan.setText(tbDokter.getValueAt(tbDokter.getSelectedRow(),2).toString());             
            Valid.SetTgl(Tanggal1,tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString());          
        }
    }    
