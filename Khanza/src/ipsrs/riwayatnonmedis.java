...
//        }  
    ...
    try {
        ...
        System.out.println("Notif stok awal/akhir: " + e);
    } finally {
        try { if (rs != null) rs.close(); } catch (Exception e) { }
        try { if (psawal != null) psawal.close(); } catch (Exception e) { }
    }

    try {
        ps = koneksi.prepareStatement(
            "INSERT INTO ipsrs_riwayat_barang " +
            "(kode_brng, stok_awal, masuk, keluar, stok_akhir, posisi, petugas, tgl, jam, status) " +
        ...
        ps.setDouble(3, masuk);
        ps.setDouble(4, keluar);
        ps.setDouble(5, posisi.equals("Opname") ? masuk : stokakhir); // kalau Opname, stok akhir = jumlah masuk (fix nilai)
        ps.setString(6, posisi);
        ps.setString(7, petugas);
        ps.setString(8, status);
        ...
        System.out.println("Notifikasi insert riwayat: " + e);
    } finally {
