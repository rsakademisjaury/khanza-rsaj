...
public class IPSRSPermintaan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        panelisi3.setPreferredSize(new java.awt.Dimension(100, 200));
        ...
        label11.setBounds(240, 20, 70, 30);
        ...
        Tanggal.setBounds(320, 20, 100, 30);

        label13.setText("Pegawai  :");
        label13.setName("label13"); // NOI18N
        label13.setPreferredSize(new java.awt.Dimension(70, 23));
        panelisi3.add(label13);
        label13.setBounds(0, 60, 110, 30);

        label16.setText("Ruangan  :");
        label16.setName("label16"); // NOI18N
        label16.setPreferredSize(new java.awt.Dimension(60, 23));
        panelisi3.add(label16);
        label16.setBounds(20, 140, 90, 30);
        ...
        panelisi3.add(kdptg);
        kdptg.setBounds(120, 60, 76, 30);

        nmptg.setEditable(false);
        nmptg.setName("nmptg"); // NOI18N
        nmptg.setPreferredSize(new java.awt.Dimension(207, 23));
        panelisi3.add(nmptg);
        nmptg.setBounds(200, 60, 390, 30);
        ...
        btnPetugas.setBounds(600, 60, 30, 30);

        label14.setText(" Departemen  :");
        label14.setName("label14"); // NOI18N
        label14.setPreferredSize(new java.awt.Dimension(70, 23));
        panelisi3.add(label14);
        label14.setBounds(0, 100, 110, 30);
        ...
        Departemen.setBounds(120, 100, 300, 30);
        ...
        NmDepartemen.setBounds(120, 140, 300, 30);
        ...
        BtnDepartemen.setBounds(430, 140, 130, 30);
...
//        }        
    ...
    if (NoPermintaan.getText().trim().equals("")) {
        Valid.textKosong(NoPermintaan, "No.Permintaan");
    } else if (NmDepartemen.getText().trim().equals("")) {
        Valid.textKosong(NmDepartemen, "Ruangan");
    } else if (nmptg.getText().trim().equals("")) {
        Valid.textKosong(kdptg, "Petugas");
    } else if (tbDokter.getRowCount() == 0) {
        JOptionPane.showMessageDialog(null, "Maaf, data sudah habis...!!!!");
        ...
        JOptionPane.showMessageDialog(null, "Maaf, Silahkan masukkan permintaan...!!!!");
        tbDokter.requestFocus();
    } else if (Sequel.cariInteger("SELECT COUNT(*) FROM permintaan_non_medis WHERE no_permintaan=?", NoPermintaan.getText()) > 0) {
        JOptionPane.showMessageDialog(null, "No. Permintaan sudah digunakan. Silakan gunakan nomor lain.");
        ...
        if (reply == JOptionPane.YES_OPTION) {
            ...
            // Simpan ke permintaan_non_medis
            if (Sequel.menyimpantf2("permintaan_non_medis", "?,?,?,?,?", "No.Permintaan", 5, new String[]{
                NoPermintaan.getText(),
                NmDepartemen.getText(),
                kdptg.getText(),
                ...
                for (i = 0; i < jml; i++) {
                    try {
                        if (Valid.SetAngka(tbDokter.getValueAt(i, 0).toString()) > 0) {
                            // Cek duplikat barang di database (opsional)
                            if (Sequel.cariInteger(
                                "SELECT COUNT(*) FROM detail_permintaan_non_medis WHERE no_permintaan='" + NoPermintaan.getText() + 
                                "' AND kode_brng='" + tbDokter.getValueAt(i, 1).toString() + "'"
                            ) > 0) {
                                JOptionPane.showMessageDialog(null, "Barang " + tbDokter.getValueAt(i, 2).toString() + " sudah dimasukkan.");
                                sukses = false;
                                break;
                            }
                            ...
                            if (!Sequel.menyimpantf2("detail_permintaan_non_medis", "?,?,?,?,?", "Detail Permintaan", 5, new String[]{
                                ...
                                tbDokter.getValueAt(i, 3).toString(), // kode_sat
                                tbDokter.getValueAt(i, 0).toString(), // jumlah
                                tbDokter.getValueAt(i, 5).toString().replaceAll("'", "").replaceAll("\"", "") // keterangan
                            })) {
                                sukses = false;
                                break;
                            }
            ...
            Sequel.AutoComitTrue();
            autoNomor(); // regenerate no_permintaan baru
            BtnCariActionPerformed(null);
        }
    }
