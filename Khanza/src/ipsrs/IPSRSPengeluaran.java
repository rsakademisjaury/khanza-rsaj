...
public class IPSRSPengeluaran extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        NoPermintaan.setBounds(774, 10, 110, 23);
        ...
        Ruangan.setBounds(894, 10, 180, 23);
        ...
        Pegawai.setBounds(1084, 10, 250, 23);
...
*/
    ...
    if(NoKeluar.getText().trim().equals("")){
        ...
        if (reply == JOptionPane.YES_OPTION) {
            ...
            // Simpan ke tabel utama pengeluaran
            if(Sequel.menyimpantf2("ipsrspengeluaran","?,?,?,?","No.Keluar",4,new String[]{
                NoKeluar.getText(),
                ...
                // Simpan juga ke tabel tambahan RS-AJ
                if(Sequel.menyimpantf2("ipsrspengeluaran_rsaj","?,?,?,?,?,?,?","No.Keluar",7,new String[]{
                    NoKeluar.getText(),
                    Valid.SetTgl(TglKeluar.getSelectedItem()+""),
                    kdptg.getText(),
                    Keterangan.getText(),
...
//            //Modif MUSTAFA
//            
//            // Ambil no_keluar berdasarkan no_permintaan yang ada dalam keterangan
//            NoKeluar.setText(Sequel.cariIsi(
//                "SELECT no_keluar FROM ipsrspengeluaran WHERE keterangan LIKE ?", 
//                "%" + nopermintaan + "%"
//            ));
//            
//            //end Modif MUSTAFA
...
//        Keterangan.setText(keterangan);
//
//        // Cek apakah data pengeluaran sudah pernah dibuat
//        String noKeluarDB = Sequel.cariIsi(
//            "SELECT no_keluar FROM ipsrspengeluaran WHERE keterangan LIKE ?",
//            nopermintaan + ",%"
//        );
//
//        if (!noKeluarDB.equals("")) {
//            // Data sudah ada, tampilkan nomor keluar lama
//            NoKeluar.setText(noKeluarDB);
//        } else {
//            // Data belum ada, berarti pengeluaran baru → panggil autoNomor
//            autoNomor();
//        }
//
//        // Tetap tampilkan detail permintaan
//        ps = koneksi.prepareStatement(
//            "SELECT ipsrsbarang.kode_brng, CONCAT(ipsrsbarang.nama_brng,' (',ipsrsbarang.jenis,')'), " +
//            "ipsrsbarang.kode_sat, ipsrsbarang.stok, ipsrsbarang.harga, detail_permintaan_non_medis.jumlah " +
//            "FROM ipsrsbarang INNER JOIN detail_permintaan_non_medis " +
//            "ON ipsrsbarang.kode_brng = detail_permintaan_non_medis.kode_brng " +
//            "WHERE detail_permintaan_non_medis.no_permintaan = ? " +
//            "ORDER BY ipsrsbarang.nama_brng"
//        );
//
//        try {
