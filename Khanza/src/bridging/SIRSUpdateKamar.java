...
public final class SIRSUpdateKamar extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnKirim.setPreferredSize(new java.awt.Dimension(0, 30));
...
/**/
    ...
    private void BtnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnUpdateActionPerformed
        final int MAX_BATCH = 203;       // Maksimal jumlah data yang dikirim dalam satu batch (maksimal 10 data)
        ...
        if (tbObat.getValueAt(i, 0).toString().equals("true") &&
            ...
            try {
               ...
               jsonPayload.put("jumlah_dbd", "0");
                ...
                String idTTKirim = tbObat.getValueAt(i, 4).toString(); // Ambil id_t_tt dari tabel
                    ...
                    try {
                        ...
                        if (retryCount >= maxRetry) {
                            ...
                            Sequel.menyimpan("sirs_update_kamar", "?,?,?", "Kode Kamar", 3, new String[]{
                                idTTKirim, "Gagal: " + ex.getMessage(), waktuUpdate
                            });
                        } else {
                    ...
                    if (responseJson != null && !responseJson.trim().isEmpty()) {
                        ...
                        if (root.has("fasyankes")) {
                            ...
                            if (fasyankesArray.size() >= 1) {
                                ...
                                // Jika array kosong
                                Sequel.menyimpan("sirs_update_kamar", "?,?,?", "Kode Kamar", 3, new String[]{
                                    idTTKirim, "Response kosong dari API", waktuUpdate
                                });
                            }
                        } else {
                            // Format response tidak sesuai harapan
                            Sequel.menyimpan("sirs_update_kamar", "?,?,?", "Kode Kamar", 3, new String[]{
                                idTTKirim, "Format response tidak valid", waktuUpdate
                            });
                        }
                    } else {
                        // Jika response kosong, tapi dianggap sukses
                        Sequel.menyimpan("sirs_update_kamar", "?,?,?", "Kode Kamar", 3, new String[]{
                            idTTKirim, "Data berhasil dikirim (204 No Content)", waktuUpdate
                        });
                    }
                }
...
//                     "where ( " +
//                     "    sirs_mapping_kamar.id_t_tt like ? or " +
//                     "    sirs_mapping_kamar.tt_kelas like ? or " +
//                     "    sirs_mapping_kamar.nm_ruang like ? " +
//                     ") " +
...
//                rs=ps.executeQuery();
//                while(rs.next()){
//                    String idTT = rs.getString("id_t_tt");
    ...
    try{
        ...
        try {
            ...
            while(rs.next()){
                ...
                int terpakai = rs.getInt("terpakai");

                totalJumBed += jumlah;
                totalBedTerpakai += terpakai;
                jumlahData++;
