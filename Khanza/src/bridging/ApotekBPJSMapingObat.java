...
//        }
    ...
    if(kdobat.getText().trim().equals("") || TObat.getText().trim().equals("")){
        ...
        if(Sequel.menyimpantf("maping_obat_apotek_bpjs","?,?,?,?,?","Mapping Obat",5,new String[]{
            kdobat.getText().trim(),
            KdObatBPJS.getText().trim(),
            NmObatBPJS.getText().trim(),
            "",
            ""
        })==true){
            tabMode.addRow(new Object[]{
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
               "select DISTINCT maping_obat_apotek_bpjs.kode_brng,databarang.nama_brng,maping_obat_apotek_bpjs.kode_brng_apotek_bpjs,maping_obat_apotek_bpjs.nama_brng_apotek_bpjs from maping_obat_apotek_bpjs inner join databarang on maping_obat_apotek_bpjs.kode_brng=databarang.kode_brng "+
