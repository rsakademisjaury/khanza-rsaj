...
public final class SiranapKetersediaanKamar extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnMappingKamar = new widget.Button();
        BtnUpdateKamar = new widget.Button();
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "2025-12-30 15:36:47" }));
        ...
        BtnMappingKamar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/ranap.png"))); // NOI18N
        BtnMappingKamar.setMnemonic('2');
        BtnMappingKamar.setText("Mapping Kamar");
        BtnMappingKamar.setToolTipText("Alt+2");
        BtnMappingKamar.setName("BtnMappingKamar"); // NOI18N
        BtnMappingKamar.setPreferredSize(new java.awt.Dimension(140, 26));
        BtnMappingKamar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnMappingKamarActionPerformed(evt);
            }
        });
        BtnMappingKamar.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnMappingKamarKeyPressed(evt);
            }
        });
        panelGlass9.add(BtnMappingKamar);

        BtnUpdateKamar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/ranap.png"))); // NOI18N
        BtnUpdateKamar.setMnemonic('2');
        BtnUpdateKamar.setText("Update Kamar");
        BtnUpdateKamar.setToolTipText("Alt+2");
        BtnUpdateKamar.setName("BtnUpdateKamar"); // NOI18N
        BtnUpdateKamar.setPreferredSize(new java.awt.Dimension(140, 26));
        BtnUpdateKamar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnUpdateKamarActionPerformed(evt);
            }
        });
        BtnUpdateKamar.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnUpdateKamarKeyPressed(evt);
            }
        });
        panelGlass9.add(BtnUpdateKamar);
...
private void btnKamarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnKamarActionPerformed
    ...
    private void BtnMappingKamarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnMappingKamarActionPerformed
        SIRSMapingKamar sirs = new SIRSMapingKamar(null, false);
        sirs.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
        sirs.setLocationRelativeTo(internalFrame1);
        sirs.setVisible(true);
    }//GEN-LAST:event_BtnMappingKamarActionPerformed

    private void BtnMappingKamarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnMappingKamarKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnMappingKamarKeyPressed

    private void BtnUpdateKamarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnUpdateKamarActionPerformed
        SIRSUpdateKamar sirsu = new SIRSUpdateKamar(null, false);
        sirsu.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
        sirsu.setLocationRelativeTo(internalFrame1);        
        sirsu.setVisible(true);
    }//GEN-LAST:event_BtnUpdateKamarActionPerformed

    private void BtnUpdateKamarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnUpdateKamarKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnUpdateKamarKeyPressed
    ...
    */
    ...
    private widget.Button BtnMappingKamar;
    private widget.Button BtnPrint;
    private widget.Button BtnSimpan;
    private widget.Button BtnUpdateKamar;
