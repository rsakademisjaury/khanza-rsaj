 ...
 * <p>
 * Toast.useEffect                      boolean     false   (default)
...
public class Notifications {
    ...
    public class NotificationAnimation {
        ...
        private void installDefault() {
            frameInsets = UIUtils.getInsets("Toast.frameInsets", new Insets(70, 10, 10, 10));
//            frameInsets = new Insets(70, 10, 10, 10); // top, left, bottom, right
