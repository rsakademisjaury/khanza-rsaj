...
public final class RMPenilaianAwalMedisRalanGigi extends javax.swing.JDialog {
    ...
    public RMPenilaianAwalMedisRalanGigi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "No.Rawat","No.RM","Nama Pasien","Kode Dokter","Dokter Gigi","Bagian Gigi","Diagnosa Gigi",
            "Hasil Pemeriksaan","Catatan Pemeriksaan","Tanggal Permintaan","No Permintaan","Rahang","Amnesa","Status Umum","Extra Oral","Intra Oral","Rencana Pengobatan"
        }){
        ...
        Amnesa.setDocument(new batasInput((int)1000).getKata(Amnesa));
        StatusUmum.setDocument(new batasInput((int)1000).getKata(StatusUmum));
    ...
    private void initComponents() {
        ...
        MnLaporanPengkajian = new javax.swing.JMenuItem();
        ...
        StatusUmum = new widget.TextArea();
        jLabel33 = new widget.Label();
        ExtraOral = new widget.ComboBox();
        jLabel34 = new widget.Label();
        IntraOral = new widget.ComboBox();
        ...
        MnLaporanPengkajian.setBackground(new java.awt.Color(255, 255, 254));
        MnLaporanPengkajian.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnLaporanPengkajian.setForeground(new java.awt.Color(50, 50, 50));
        MnLaporanPengkajian.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnLaporanPengkajian.setText("Laporan Pengkajian");
        MnLaporanPengkajian.setName("MnLaporanPengkajian"); // NOI18N
        MnLaporanPengkajian.setPreferredSize(new java.awt.Dimension(220, 26));
        MnLaporanPengkajian.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnLaporanPengkajianActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnLaporanPengkajian);
        ...
        DiagnosaUtama.setBounds(680, 230, 520, 23);

        jLabel27.setText("Diagnosa Gigi :");
        jLabel27.setName("jLabel27"); // NOI18N
        FormInput.add(jLabel27);
        jLabel27.setBounds(550, 230, 120, 23);
        ...
        jLabel11.setBounds(550, 310, 120, 23);
        ...
        scrollPane6.setBounds(680, 310, 541, 50);

        jLabel30.setText("Extra Oral :");
        jLabel30.setName("jLabel30"); // NOI18N
        FormInput.add(jLabel30);
        jLabel30.setBounds(670, 170, 120, 23);

        jLabel31.setText("Kode ICD :");
        jLabel31.setName("jLabel31"); // NOI18N
        FormInput.add(jLabel31);
        jLabel31.setBounds(1050, 210, 210, 23);
        ...
        KodeDiagnosaUtama.setBounds(1200, 230, 75, 23);
        ...
        BtnDokter6.setBounds(1280, 230, 28, 23);
        ...
        PanelWall.setBounds(300, 180, 40, 30);
        ...
        PanelWall1.setBounds(20, 180, 40, 30);
        ...
        PanelWall2.setBounds(60, 180, 40, 30);
        ...
        PanelWall3.setBounds(100, 180, 40, 30);
        ...
        PanelWall4.setBounds(140, 180, 40, 30);
        ...
        PanelWall5.setBounds(180, 180, 40, 30);
        ...
        PanelWall6.setBounds(220, 180, 40, 30);
        ...
        PanelWall7.setBounds(260, 180, 40, 30);
        ...
        PanelWall10.setBounds(420, 180, 40, 30);
        ...
        PanelWall9.setBounds(380, 180, 40, 30);
        ...
        PanelWall8.setBounds(340, 180, 40, 30);
        ...
        PanelWall11.setBounds(460, 180, 40, 30);
        ...
        PanelWall12.setBounds(500, 180, 40, 30);
        ...
        PanelWall13.setBounds(540, 180, 40, 30);
        ...
        PanelWall14.setBounds(580, 180, 40, 30);
        ...
        PanelWall15.setBounds(620, 180, 40, 30);
        ...
        PanelWall16.setBounds(220, 220, 40, 30);
        ...
        PanelWall17.setBounds(260, 220, 40, 30);
        ...
        PanelWall18.setBounds(300, 220, 40, 30);
        ...
        PanelWall19.setBounds(340, 220, 40, 30);
        ...
        PanelWall20.setBounds(380, 220, 40, 30);
        ...
        PanelWall21.setBounds(420, 220, 40, 30);
        ...
        PanelWall22.setBounds(460, 220, 40, 30);
        ...
        PanelWall23.setBounds(500, 220, 40, 30);
        ...
        PanelWall24.setBounds(140, 220, 40, 30);
        ...
        PanelWall25.setBounds(180, 220, 40, 30);
        ...
        PanelWall26.setBounds(140, 310, 40, 30);
        ...
        PanelWall27.setBounds(180, 310, 40, 30);
        ...
        PanelWall28.setBounds(220, 310, 40, 30);
        ...
        PanelWall29.setBounds(260, 310, 40, 30);
        ...
        PanelWall30.setBounds(300, 310, 40, 30);
        ...
        PanelWall31.setBounds(340, 310, 40, 30);
        ...
        PanelWall32.setBounds(380, 310, 40, 30);
        ...
        PanelWall33.setBounds(420, 310, 40, 30);
        ...
        PanelWall34.setBounds(460, 310, 40, 30);
        ...
        PanelWall35.setBounds(500, 310, 40, 30);
        ...
        PanelWall36.setBounds(20, 350, 40, 30);
        ...
        PanelWall37.setBounds(60, 350, 40, 30);
        ...
        PanelWall38.setBounds(100, 350, 40, 30);
        ...
        PanelWall39.setBounds(140, 350, 40, 30);
        ...
        PanelWall40.setBounds(180, 350, 40, 30);
        ...
        PanelWall41.setBounds(220, 350, 40, 30);
        ...
        PanelWall42.setBounds(260, 350, 40, 30);
        ...
        PanelWall43.setBounds(300, 350, 40, 30);
        ...
        PanelWall44.setBounds(340, 350, 40, 30);
        ...
        PanelWall45.setBounds(380, 350, 40, 30);
        ...
        PanelWall46.setBounds(420, 350, 40, 30);
        ...
        PanelWall47.setBounds(460, 350, 40, 30);
        ...
        PanelWall48.setBounds(500, 350, 40, 30);
        ...
        PanelWall49.setBounds(540, 350, 40, 30);
        ...
        PanelWall50.setBounds(580, 350, 40, 30);
        ...
        PanelWall51.setBounds(620, 350, 40, 30);

        label15.setText("Amnesa :");
        label15.setName("label15"); // NOI18N
        label15.setPreferredSize(new java.awt.Dimension(70, 23));
        FormInput.add(label15);
        label15.setBounds(0, 80, 100, 23);
        ...
        scrollPane7.setViewportView(Amnesa);

        FormInput.add(scrollPane7);
        scrollPane7.setBounds(110, 80, 541, 50);
        ...
        gigi28.setBounds(620, 160, 40, 23);
        ...
        gigi16.setBounds(100, 160, 40, 23);
        ...
        gigi15.setBounds(140, 160, 40, 23);
        ...
        gigi14.setBounds(180, 160, 40, 23);
        ...
        gigi13.setBounds(220, 160, 40, 23);
        ...
        gigi12.setBounds(260, 160, 40, 23);
        ...
        gigi11.setBounds(300, 160, 40, 23);
        ...
        gigi21.setBounds(340, 160, 40, 23);
        ...
        gigi22.setBounds(380, 160, 40, 23);
        ...
        gigi23.setBounds(420, 160, 40, 23);
        ...
        gigi24.setBounds(460, 160, 40, 23);
        ...
        gigi25.setBounds(500, 160, 40, 23);
        ...
        gigi26.setBounds(540, 160, 40, 23);
        ...
        gigi27.setBounds(580, 160, 40, 23);
        ...
        gigi31.setBounds(340, 380, 40, 23);
        ...
        gigi32.setBounds(380, 380, 40, 23);
        ...
        gigi33.setBounds(420, 380, 40, 23);
        ...
        gigi34.setBounds(460, 380, 40, 23);
        ...
        gigi35.setBounds(500, 380, 40, 23);
        ...
        gigi36.setBounds(540, 380, 40, 23);
        ...
        gigi37.setBounds(580, 380, 40, 23);
        ...
        gigi38.setBounds(620, 380, 40, 23);
        ...
        gigi41.setBounds(300, 380, 40, 23);
        ...
        gigi42.setBounds(260, 380, 40, 23);
        ...
        gigi43.setBounds(220, 380, 40, 23);
        ...
        gigi44.setBounds(180, 380, 40, 23);
        ...
        gigi45.setBounds(140, 380, 40, 23);
        ...
        gigi46.setBounds(100, 380, 40, 23);
        ...
        gigi51.setBounds(300, 250, 40, 23);
        ...
        gigi52.setBounds(260, 250, 40, 23);
        ...
        gigi53.setBounds(220, 250, 40, 23);
        ...
        gigi54.setBounds(180, 250, 40, 23);
        ...
        gigi55.setBounds(140, 250, 40, 23);
        ...
        gigi61.setBounds(340, 250, 40, 23);
        ...
        gigi62.setBounds(380, 250, 40, 23);
        ...
        gigi63.setBounds(420, 250, 40, 23);
        ...
        gigi64.setBounds(460, 250, 40, 23);
        ...
        gigi65.setBounds(500, 250, 40, 23);
        ...
        gigi71.setBounds(340, 290, 40, 23);
        ...
        gigi72.setBounds(380, 290, 40, 23);
        ...
        gigi73.setBounds(420, 290, 40, 23);
        ...
        gigi74.setBounds(460, 290, 40, 23);
        ...
        gigi75.setBounds(500, 290, 40, 23);
        ...
        gigi81.setBounds(300, 290, 40, 23);
        ...
        gigi82.setBounds(260, 290, 40, 23);
        ...
        gigi83.setBounds(220, 290, 40, 23);
        ...
        gigi84.setBounds(180, 290, 40, 23);
        ...
        gigi85.setBounds(140, 290, 40, 23);
        ...
        FormInput.add(Hasil);
        Hasil.setBounds(680, 270, 130, 23);
        ...
        jLabel32.setBounds(810, 270, 60, 23);
        ...
        Rahang.setBounds(880, 270, 130, 23);

        label16.setText("Dokter Gigi :");
        label16.setName("label16"); // NOI18N
        label16.setPreferredSize(new java.awt.Dimension(70, 23));
        FormInput.add(label16);
        label16.setBounds(0, 40, 100, 23);

        label17.setText("Staus Umum :");
        label17.setName("label17"); // NOI18N
        label17.setPreferredSize(new java.awt.Dimension(70, 23));
        FormInput.add(label17);
        label17.setBounds(670, 80, 70, 23);

        scrollPane8.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane8.setName("scrollPane8"); // NOI18N

        StatusUmum.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        StatusUmum.setColumns(20);
        StatusUmum.setRows(5);
        StatusUmum.setName("StatusUmum"); // NOI18N
        StatusUmum.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                StatusUmumKeyPressed(evt);
            }
        });
        scrollPane8.setViewportView(StatusUmum);

        FormInput.add(scrollPane8);
        scrollPane8.setBounds(750, 80, 541, 50);

        jLabel33.setText("Hasil Pemeriksaan :");
        jLabel33.setName("jLabel33"); // NOI18N
        FormInput.add(jLabel33);
        jLabel33.setBounds(550, 270, 120, 23);

        ExtraOral.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Bentuk Kepala", "Bentuk Muka", "Profil", "Symetris Muka", "Mata", "Hidung", "Pernafasan", "Telinga", "Sendahan", "Bibir/ Mulut", "Kelenjar", "Lain-Lain" }));
        ExtraOral.setName("ExtraOral"); // NOI18N
        ExtraOral.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ExtraOralActionPerformed(evt);
            }
        });
        ExtraOral.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                ExtraOralKeyPressed(evt);
            }
        });
        FormInput.add(ExtraOral);
        ExtraOral.setBounds(800, 170, 170, 23);

        jLabel34.setText("Intra Oral :");
        jLabel34.setName("jLabel34"); // NOI18N
        FormInput.add(jLabel34);
        jLabel34.setBounds(940, 170, 120, 23);

        IntraOral.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Kebersihan Mulut", "Selaput Lendir", "Karang Gigi", "Caries Frequensi", "Gigi Goyang", "Penyakit Periodontal", "Lidah", "Recessi ginggiva", "Gingivitis", "Stomatilis", "Oklusi", "Artikulasi", "Eugnathie", "Status x foto", "Kebersihan Mulut" }));
        ...
        FormInput.add(IntraOral);
        IntraOral.setBounds(1070, 170, 200, 23);

        jLabel35.setText("STATUS LOKAL");
        jLabel35.setName("jLabel35"); // NOI18N
        FormInput.add(jLabel35);
        jLabel35.setBounds(670, 140, 130, 20);

        jLabel36.setText("Rencana Pengobatan :");
        jLabel36.setName("jLabel36"); // NOI18N
        FormInput.add(jLabel36);
        jLabel36.setBounds(680, 370, 120, 23);

        Rencana.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Untuk Pencabutan", "Untuk Pembersihan Karang Gigi", "Untuk Perawatan Jaringan Penunjang Akar Gigi", "Untuk Perawatan Pengawetan Gigi", "Perawatan Gigi Anak", "Untuk Meratakan Gigi", "Untuk Gigi Tiruan", "Untuk Bedah Mulut" }));
        ...
        Rencana.setBounds(810, 370, 300, 23);
...
private void autoNomor() {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        }else if(Amnesa.getText().equals("")){
            Valid.textKosong(Amnesa,"amnesa");
        }else if(StatusUmum.getText().equals("")){
            Valid.textKosong(StatusUmum,"Status Umum");
        }else{
...
//            Valid.textKosong(Catatan,"Catatan Pemeriksaan");
//        }else{
            if(Sequel.menyimpantf("pemeriksaan_gigi","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",15,new String[]{
                    ...
                    TNoPermintaan.getText(),Rahang.getSelectedItem().toString(),Amnesa.getText(),StatusUmum.getText(),ExtraOral.getSelectedItem().toString(),
                    IntraOral.getSelectedItem().toString(),Rencana.getSelectedItem().toString()
                })==true){
                    tampil();
                    emptTeks();
            }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(tbObat.getSelectedRow()>-1){
            if(Sequel.queryu2tf("delete from pemeriksaan_gigi where no_rawat=?",1,new String[]{
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
       ...
       // }else if(StatusUmum.getText().equals("")){
            ...
            if(tbObat.getSelectedRow()>-1){
                if(Sequel.mengedittf("pemeriksaan_gigi","no_rawat=?","no_rawat=?,kd_dokter=?,bagian=?,diagnosa=?,kd_diagnosa=?,hasil=?,catatan=?,tanggal=?,noorder=?,rahang=?,amnesa=?,status_umum=?,extra_oral=?,intra_oral=?,rencana_pengobatan=?",16,new String[]{
                    TNoRw.getText(),KodeDokter.getText(),bagian,DiagnosaUtama.getText(),KodeDiagnosaUtama.getText(),
                    Hasil.getSelectedItem().toString(),Catatan.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+""),
                    TNoPermintaan.getText(),Rahang.getSelectedItem().toString(),Amnesa.getText(),StatusUmum.getText(),ExtraOral.getSelectedItem().toString(),
                    IntraOral.getSelectedItem().toString(),Rencana.getSelectedItem().toString(),
        ...
        if(tabMode.getRowCount()==0){
            ...
            Map<String, Object> param = new HashMap<>(); 
                ...
                if(TCari.getText().equals("")){
                    Valid.MyReportqry("rptPenilaianAwalMedisGigi.jasper","report","::[ Laporan Penilaian Medis GIGI]::",
                         "select reg_periksa.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien, "+
                         "pemeriksaan_gigi.kd_dokter,dokter.nm_dokter,pemeriksaan_gigi.bagian,pemeriksaan_gigi.kd_diagnosa,pemeriksaan_gigi.diagnosa,pasien.jk,pasien.tgl_lahir, "+
                         "pemeriksaan_gigi.hasil,pemeriksaan_gigi.catatan,pemeriksaan_gigi.tanggal,pemeriksaan_gigi.noorder,pemeriksaan_gigi.rahang,pemeriksaan_gigi.amnesa,pemeriksaan_gigi.status_umum,pemeriksaan_gigi.extra_oral,pemeriksaan_gigi.intra_oral,pemeriksaan_gigi.rencana_pengobatan from pemeriksaan_gigi inner join reg_periksa on pemeriksaan_gigi.no_rawat=reg_periksa.no_rawat  "+
                         ...
                         "where pemeriksaan_gigi.tanggal between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' order by pemeriksaan_gigi.tanggal ",param);
                }else{
                    Valid.MyReportqry("rptPenilaianAwalMedisGigi.jasper","report","::[ Laporan Penilaian Medis GIGI ]::",
                        "select reg_periksa.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien, "+
                        "pemeriksaan_gigi.kd_dokter,dokter.nm_dokter,pemeriksaan_gigi.bagian,pemeriksaan_gigi.kd_diagnosa,pemeriksaan_gigi.diagnosa,pasien.jk,pasien.tgl_lahir, "+
                        "pemeriksaan_gigi.hasil,pemeriksaan_gigi.catatan,pemeriksaan_gigi.tanggal,pemeriksaan_gigi.noorder,pemeriksaan_gigi.rahang,pemeriksaan_gigi.amnesa,pemeriksaan_gigi.status_umum,pemeriksaan_gigi.extra_oral,pemeriksaan_gigi.intra_oral,pemeriksaan_gigi.rencana_pengobatan from pemeriksaan_gigi inner join reg_periksa on pemeriksaan_gigi.no_rawat=reg_periksa.no_rawat  "+
                        "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join dokter on pemeriksaan_gigi.kd_dokter=dokter.kd_dokter "+
                        "where pemeriksaan_gigi.tanggal between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' and "+
                        ...
                        "pemeriksaan_gigi.kd_dokter like '%"+TCari.getText().trim()+"%' or dokter.nm_dokter like '%"+TCari.getText().trim()+"%') order by pemeriksaan_gigi.tanggal ",param);
                }
    ...
    private void MnLaporanPengkajianActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanPengkajianActionPerformed
        if(tbObat.getSelectedRow()>-1){
            Map<String, Object> param = new HashMap<>();
            param.put("namars",akses.getnamars());
            param.put("alamatrs",akses.getalamatrs());
            ...
            Valid.MyReportqry("rptCetakPenilaianAwalMedisGigi.jasper","report","::[ Laporan Penilaian Medis GIGI]::",
                         "select reg_periksa.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien, "+
                         "pemeriksaan_gigi.kd_dokter,dokter.nm_dokter,pemeriksaan_gigi.bagian,pemeriksaan_gigi.kd_diagnosa,pemeriksaan_gigi.diagnosa,pasien.jk,pasien.tgl_lahir, "+
                         "pemeriksaan_gigi.hasil,pemeriksaan_gigi.catatan,pemeriksaan_gigi.tanggal,pemeriksaan_gigi.noorder,pemeriksaan_gigi.rahang,pemeriksaan_gigi.amnesa,pemeriksaan_gigi.status_umum,pemeriksaan_gigi.extra_oral,pemeriksaan_gigi.intra_oral,pemeriksaan_gigi.rencana_pengobatan from pemeriksaan_gigi inner join reg_periksa on pemeriksaan_gigi.no_rawat=reg_periksa.no_rawat  "+
                         "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join dokter on pemeriksaan_gigi.kd_dokter=dokter.kd_dokter "+
                         "where pemeriksaan_gigi.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'",param);
        }
    }//GEN-LAST:event_MnLaporanPengkajianActionPerformed
    ...
    private void StatusUmumKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_StatusUmumKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_StatusUmumKeyPressed

    private void HasilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_HasilActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_HasilActionPerformed

    private void ExtraOralActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ExtraOralActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_ExtraOralActionPerformed

    private void ExtraOralKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_ExtraOralKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_ExtraOralKeyPressed
    ...
    */
    ...
    private widget.TextArea StatusUmum;
        ...
        try{
            if(TCari.getText().equals("")){
                ps=koneksi.prepareStatement(
                    "select reg_periksa.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien, "+
                    "pemeriksaan_gigi.kd_dokter,dokter.nm_dokter,pemeriksaan_gigi.bagian,pemeriksaan_gigi.diagnosa, "+
                    "pemeriksaan_gigi.hasil,pemeriksaan_gigi.catatan,pemeriksaan_gigi.tanggal,pemeriksaan_gigi.noorder,pemeriksaan_gigi.rahang,pemeriksaan_gigi.amnesa,pemeriksaan_gigi.status_umum,pemeriksaan_gigi.extra_oral,pemeriksaan_gigi.intra_oral,pemeriksaan_gigi.rencana_pengobatan from pemeriksaan_gigi inner join reg_periksa on pemeriksaan_gigi.no_rawat=reg_periksa.no_rawat  "+
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join dokter on pemeriksaan_gigi.kd_dokter=dokter.kd_dokter "+
                    "where pemeriksaan_gigi.tanggal between ? and ? order by pemeriksaan_gigi.tanggal");
            }else{
                ps=koneksi.prepareStatement(
                    "select reg_periksa.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien, "+
                    "pemeriksaan_gigi.kd_dokter,dokter.nm_dokter,pemeriksaan_gigi.bagian,pemeriksaan_gigi.diagnosa, "+
                    "pemeriksaan_gigi.hasil,pemeriksaan_gigi.catatan,pemeriksaan_gigi.tanggal,pemeriksaan_gigi.noorder,pemeriksaan_gigi.rahang,pemeriksaan_gigi.amnesa,pemeriksaan_gigi.status_umum,pemeriksaan_gigi.extra_oral,pemeriksaan_gigi.intra_oral,pemeriksaan_gigi.rencana_pengobatan from pemeriksaan_gigi inner join reg_periksa on pemeriksaan_gigi.no_rawat=reg_periksa.no_rawat  "+
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join dokter on pemeriksaan_gigi.kd_dokter=dokter.kd_dokter "+
                    "where pemeriksaan_gigi.tanggal between ? and ? and pemeriksaan_gigi.tanggal like ? or "+
...
//                    ps.setString(36,"%"+TCari.getText()+"%");
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("hasil"),rs.getString("catatan"),rs.getString("tanggal"),rs.getString("noorder"),rs.getString("rahang"),
                        rs.getString("amnesa"),rs.getString("status_umum"),rs.getString("extra_oral"),rs.getString("intra_oral"),rs.getString("rencana_pengobatan")
                    });
                }
            } catch (Exception e) {
    ...
    public void emptTeks() {
        ...
        Amnesa.setText("");
        StatusUmum.setText("");
        ExtraOral.requestFocus();
        IntraOral.requestFocus();
...
//        gigi85.setSelected(true);
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("1.1")){
                gigi11.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("1.2")){
                gigi12.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("1.3")){
                gigi13.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("1.4")){
                gigi14.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("1.5")){
                gigi15.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("1.6")){
                gigi16.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("1.7")){
                gigi17.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("1.8")){
                gigi18.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("2.1")){
                gigi21.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("2.2")){
                gigi22.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("2.3")){
                gigi23.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("2.4")){
                gigi24.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("2.5")){
                gigi25.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("2.6")){
                gigi26.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("2.7")){
                gigi27.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("2.8")){
                gigi28.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("3.1")){
                gigi31.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("3.2")){
                gigi32.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("3.3")){
                gigi33.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("3.4")){
                gigi34.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("3.5")){
                gigi35.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("3.6")){
                gigi36.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("3.7")){
                gigi37.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("3.8")){
                gigi38.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("4.1")){
                gigi41.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("4.2")){
                gigi42.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("4.3")){
                gigi43.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("4.4")){
                gigi44.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("4.5")){
                gigi45.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("4.6")){
                gigi46.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("4.7")){
                gigi47.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("4.8")){
                gigi48.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("5.1")){
                gigi51.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("5.2")){
                gigi52.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("5.3")){
                gigi53.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("5.4")){
                gigi54.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("5.5")){
                gigi55.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("6.1")){
                gigi61.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("6.2")){
                gigi62.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("6.3")){
                gigi63.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("6.4")){
                gigi64.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("6.5")){
                gigi65.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("7.1")){
                gigi71.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("7.2")){
                gigi72.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("7.3")){
                gigi73.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("7.4")){
                gigi74.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("7.5")){
                gigi75.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("8.1")){
                gigi81.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("8.2")){
                gigi82.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("8.3")){
                gigi83.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("8.4")){
                gigi84.setSelected(true);
            }
            if(tbObat.getValueAt(tbObat.getSelectedRow(),5).toString().equals("8.5")){
                gigi85.setSelected(true);
            }
            ...
            Valid.SetTgl2(Tanggal,tbObat.getValueAt(tbObat.getSelectedRow(),9).toString());
            TNoPermintaan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),10).toString());
            Rahang.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),11).toString());
            Amnesa.setText(tbObat.getValueAt(tbObat.getSelectedRow(),12).toString());
            StatusUmum.setText(tbObat.getValueAt(tbObat.getSelectedRow(),13).toString());
            ExtraOral.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),14).toString());
            IntraOral.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),15).toString());
            Rencana.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),16).toString());
        }
    }
...
//            PanelInput.setPreferredSize(new Dimension(WIDTH,this.getHeight()-122));
    ...
    public void isCek(){
        //BtnSimpan.setEnabled(akses.getdata_pemeriksaan_gigi());
        //BtnHapus.setEnabled(akses.getdata_pemeriksaan_gigi());
        //BtnEdit.setEnabled(akses.getdata_pemeriksaan_gigi());
        //BtnPrint.setEnabled(akses.getdata_pemeriksaan_gigi()); 
