 ...
 * @author perpustakaan
 */
public final class ValidasiSOAPRalan extends javax.swing.JDialog {
...
//    private SimpleDateFormat tanggalNow = new SimpleDateFormat("dd-MM-yyyy");
     ...
     * @param parent
     * @param modal */
    public ValidasiSOAPRalan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().equals("")||TNoRM.getText().equals("")||TPasien.getText().equals("")){
            ...
            if(Sequel.menyimpantf("validasi_pemeriksaan_ralan","?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",12,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            ValidasiSOAPRalan dialog = new ValidasiSOAPRalan(new javax.swing.JFrame(), true);
        ...
        try{
            if(TCari.getText().equals("")){
                ps=koneksi.prepareStatement(
                    ...
                    "on pemeriksaan_ralan.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join pegawai on pemeriksaan_ralan.nip=pegawai.nik LEFT JOIN validasi_pemeriksaan_ralan ON validasi_pemeriksaan_ralan.no_rawat = pemeriksaan_ralan.no_rawat AND validasi_pemeriksaan_ralan.tgl_perawatan = pemeriksaan_ralan.tgl_perawatan AND validasi_pemeriksaan_ralan.jam_rawat = pemeriksaan_ralan.jam_rawat where "+
                    "pemeriksaan_ralan.no_rawat like ? and ISNULL(validasi_pemeriksaan_ralan.status_validasi) order by pemeriksaan_ralan.no_rawat desc");
            }else{
                ps=koneksi.prepareStatement(
                    "select reg_periksa.tgl_registrasi,reg_periksa.status_lanjut,pemeriksaan_ralan.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien, "+
                    "pemeriksaan_ralan.tgl_perawatan,pemeriksaan_ralan.jam_rawat,pemeriksaan_ralan.keluhan, " +
