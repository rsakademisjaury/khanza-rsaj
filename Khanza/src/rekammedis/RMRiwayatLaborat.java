...
public final class RMRiwayatLaborat extends javax.swing.JDialog {    
     ...
     * @param parent
     * @param modal */
    public RMRiwayatLaborat(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        TabRawat.addTab("Riwayat Laborat dan Berkas Laborat", internalFrame2);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMRiwayatLaborat dialog = new RMRiwayatLaborat(new javax.swing.JFrame(), true);
            ...
            if(chkBerkasDigital.isSelected()==true){
                try{
                    rs2=koneksi.prepareStatement(
                        ...
                        "where berkas_digital_perawatan.kode='005' and berkas_digital_perawatan.no_rawat='"+norawat+"'").executeQuery();
                    if(rs2.next()){                                    
                        htmlContent.append(
                          "<tr class='isi'>"+ 
                            "<td valign='top' width='2%'></td>"+        
