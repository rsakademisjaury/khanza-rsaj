...
public final class RMDataAsuhanGizi extends javax.swing.JDialog {
    ...
    public RMDataAsuhanGizi(java.awt.Frame parent, boolean modal) {
        ...
        TB.getDocument().addDocumentListener(new DocumentListener() {
            ...
            public void hitungBBIdeal() {
                try {
                    double tb = Double.parseDouble(TB.getText());
                    double bbIdeal = (tb - 100) * 0.9;
                    BBIdeal.setText(String.format("%.2f", bbIdeal));
    ...
    */
    ...
    public void setNoRm(String norwt, Date tgl2) {
        ...
        try (PreparedStatement ps = koneksi.prepareStatement("SELECT COUNT(*) FROM asuhan_gizi WHERE no_rawat = ?")) {
