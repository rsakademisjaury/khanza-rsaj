...
public class DlgEOWS extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgEOWS(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
         setSize(1285,674);
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Modified Early Obstetric Warning Score ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgEOWS dialog = new DlgEOWS(new javax.swing.JFrame(), true);
        ...
        try {
            ...
            htmlContent.append(                             
                "<tr class='isi'>"+
                    ...
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='66%'>Modified Early Obstetric Warning Score</td>"+
                "</tr>"
            );     
                ...
                while(rs.next()){
                    ...
                    try {
                        rs2=koneksi.prepareStatement(
                                "select eows_rajal.no_rawat,eows_rajal.tanggal,eows_rajal.jam,eows_rajal.nik,eows_rajal.pernafasan,eows_rajal.score_pernafasan,eows_rajal.saturasi,eows_rajal.score_saturasi,eows_rajal.cairan,eows_rajal.score_cairan,eows_rajal.suhu,"+
                                "eows_rajal.score_suhu,eows_rajal.denyut,eows_rajal.score_denyut,eows_rajal.tekanan,eows_rajal.score_tekanan,eows_rajal.tekanan1,eows_rajal.score_tekanan1,eows_rajal.kesadaran,eows_rajal.score_kesadaran,eows_rajal.discharge,eows_rajal.score_discharge, "+
                               "eows_rajal.proteinuria,eows_rajal.score_proteinuria,eows_rajal.total_score,eows_rajal.klasifikasi,eows_rajal.respon,eows_rajal.tindakan,eows_rajal.frekuensi,pegawai.nama,departemen.nama "+
                                "from eows_rajal inner join pegawai on eows_rajal.nik=pegawai.nik inner join departemen on pegawai.departemen=departemen.dep_id where eows_rajal.no_rawat='"+rs.getString("no_rawat")+"' "+
                                "order by eows_rajal.tanggal,eows_rajal.jam").executeQuery();
                        if(rs2.next()){
                            htmlContent.append(
                                    "<tr class='isi'>"+
                                        ...
                                        "<td valign='middle' bgcolor='#FFFFF8' align='center' width='23%'>Cairan</td>"+
                                        ...
                                        "<td valign='middle' bgcolor='#FFFFF8' align='center' width='23%'>Tekanan Darah Distolik</td>"+
                                        "<td valign='middle' bgcolor='#FFFFF8' align='center' width='23%'>Kesadaran</td>"+
                                        "<td valign='middle' bgcolor='#FFFFF8' align='center' width='23%'>Discharge</td>"+
                                        "<td valign='middle' bgcolor='#FFFFF8' align='center' width='23%'>Proteinuria</td>"+
                            ...
                            while(rs2.next()){
                                ...
                                klasifikasi=Sequel.cariIsi("SELECT klasifikasi FROM eows_rajal WHERE tanggal='"+rs2.getString("tanggal")+"' and jam='"+rs2.getString("jam")+"'");
...
//                                 System.out.println("Notif Rekening : "+rs2.getString("no_rawat"));
                                //2021/04/18/000056
                                 htmlContent.append(                             
                                    "<tr class='isi'>"+
                                        ...
                                        "<td align='left' "+stylee+">"+rs2.getString("cairan")+"("+rs2.getString("score_cairan")+")</td>"+
                                        ...
                                        "<td align='left' "+stylee+">"+rs2.getString("tekanan1")+"("+rs2.getString("score_tekanan1")+")</td>"+
                                        "<td align='left' "+stylee+">"+rs2.getString("kesadaran")+"("+rs2.getString("score_kesadaran")+")</td>"+
                                        "<td align='left' "+stylee+">"+rs2.getString("discharge")+"("+rs2.getString("score_discharge")+")</td>"+
                                        "<td align='left' "+stylee+">"+rs2.getString("proteinuria")+"("+rs2.getString("score_proteinuria")+")</td>"+
                    ...
                    try {
                        rs2=koneksi.prepareStatement(
                                "select eows_ranap.no_rawat,eows_ranap.tanggal,eows_ranap.jam,eows_ranap.nik,eows_ranap.pernafasan,eows_ranap.score_pernafasan,eows_ranap.saturasi,eows_ranap.score_saturasi,eows_ranap.cairan,eows_ranap.score_cairan,eows_ranap.suhu,"+
                                "eows_ranap.score_suhu,eows_ranap.denyut,eows_ranap.score_denyut,eows_ranap.tekanan,eows_ranap.score_tekanan,eows_ranap.tekanan1,eows_ranap.score_tekanan1,eows_ranap.kesadaran,eows_ranap.score_kesadaran,eows_ranap.discharge,eows_ranap.score_discharge, "+
                               "eows_ranap.proteinuria,eows_ranap.score_proteinuria,eows_ranap.total_score,eows_ranap.klasifikasi,eows_ranap.respon,eows_ranap.tindakan,eows_ranap.frekuensi,pegawai.nama,departemen.nama "+
                                "from eows_ranap inner join pegawai on eows_ranap.nik=pegawai.nik inner join departemen on pegawai.departemen=departemen.dep_id where eows_ranap.no_rawat='"+rs.getString("no_rawat")+"' "+
                                "order by eows_ranap.tanggal,eows_ranap.jam").executeQuery();
                        if(rs2.next()){
                            htmlContent.append(
                                    "<tr class='isi'>"+
                                        "<td valign='middle' bgcolor='#FFFFF8' align='center' width='7%'>Tanggal</td>"+
                            ...
                            while(rs2.next()){
                                ...
                                klasifikasi=Sequel.cariIsi("SELECT klasifikasi FROM eows_ranap WHERE tanggal='"+rs2.getString("tanggal")+"' and jam='"+rs2.getString("jam")+"'");
