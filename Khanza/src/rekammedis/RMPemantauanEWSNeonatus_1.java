 ...
 * @author perpustakaan
 */
public final class RMPemantauanEWSNeonatus_1 extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMPemantauanEWSNeonatus_1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPemantauanEWSNeonatus_1 dialog = new RMPemantauanEWSNeonatus_1(new javax.swing.JFrame(), true);
