...
public class DlgDataAlergiPasien extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Alergi Pasien ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        TCari.setPreferredSize(new java.awt.Dimension(370, 26));
        ...
        jPanel3.add(panelGlass8);

        internalFrame1.add(jPanel3, java.awt.BorderLayout.PAGE_END);

        PanelInput.setName("PanelInput"); // NOI18N
        PanelInput.setOpaque(false);
        PanelInput.setPreferredSize(new java.awt.Dimension(150, 250));
        ...
        jLabel13.setBounds(10, 140, 110, 23);

        scrollPane1.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        scrollPane1.setName("scrollPane1"); // NOI18N

        TKeterangan.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(153, 153, 153)));
        ...
        scrollPane1.setBounds(120, 140, 580, 90);
        ...
        cmbKategory.setBounds(70, 110, 130, 23);
        ...
        jLabel15.setBounds(210, 110, 70, 23);
        ...
        cmbSeverity.setBounds(280, 110, 130, 23);
...
//        LCount.setText("" + tabMode.getRowCount());
    Valid.tabelKosong(tabMode); // Kosongkan tabel sebelum diisi ulang
    try {
        String sql = "SELECT "
                + " alergi_pasien.no_rawat, "
                + " reg_periksa.no_rkm_medis, "
                ...
                + " alergi_pasien.tgl_perawatan, "
                + " alergi_pasien.allergy_code, "
                + " satu_sehat_ref_allergy.display AS alergi, "
                + " alergi_pasien.category, "
                + " alergi_pasien.reactioncode, "
                + " alergi_pasien.severity, "
                + " alergi_pasien.note, "
                ...
                + "INNER JOIN pegawai ON alergi_pasien.nippetugas = pegawai.nik "
        ...
        // Set parameter pencarian jika TCari tidak kosong
        ...
        // Debug query untuk memastikan kebenaran
        ...
        while (rs.next()) {
            tabMode.addRow(new String[]{
                rs.getString("no_rawat") != null ? rs.getString("no_rawat") : "-",
                rs.getString("no_rkm_medis") != null ? rs.getString("no_rkm_medis") : "-",
                rs.getString("nm_pasien") != null ? rs.getString("nm_pasien") : "-",
                rs.getString("jk") != null ? rs.getString("jk") : "-",
                rs.getString("umur") != null ? rs.getString("umur") : "-",
                rs.getString("no_tlp") != null ? rs.getString("no_tlp") : "-",
                rs.getString("png_jawab") != null ? rs.getString("png_jawab") : "-",
                rs.getString("tgl_perawatan") != null ? rs.getString("tgl_perawatan") : "-",
                rs.getString("allergy_code") != null ? rs.getString("allergy_code") : "-",
                rs.getString("alergi") != null ? rs.getString("alergi") : "-",
                rs.getString("category") != null ? rs.getString("category") : "-",
                rs.getString("reactioncode") != null ? rs.getString("reactioncode") : "-",
                rs.getString("severity") != null ? rs.getString("severity") : "-",
                rs.getString("note") != null ? rs.getString("note") : "-",
                rs.getString("nippetugas") != null ? rs.getString("nippetugas") : "-",
