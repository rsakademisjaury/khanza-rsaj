 ...
 * @author perpustakaan
 */
public final class ValidasiSBARRanap extends javax.swing.JDialog {
...
//    private SimpleDateFormat tanggalNow = new SimpleDateFormat("dd-MM-yyyy");
     ...
     * @param parent
     * @param modal */
    public ValidasiSBARRanap(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "Validasi SBAR Rawat Inap", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 14), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        BtnSimpan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/verify.png"))); // NOI18N
        ...
        NamaDokter.setBounds(247, 40, 510, 23);
        ...
        BtnDokter.setBounds(759, 40, 30, 23);
        ...
        label15.setBounds(810, 10, 120, 23);
        ...
        KodeDokter1.setBounds(910, 10, 141, 23);
        ...
        NamaDokter1.setBounds(1060, 10, 260, 23);
        ...
        TanggalPemeriksaan.setBounds(910, 40, 141, 23);
        ...
        label16.setBounds(810, 40, 90, 23);

        label17.setText("Jam SBAR:");
        label17.setName("label17"); // NOI18N
        label17.setPreferredSize(new java.awt.Dimension(70, 23));
        FormInput.add(label17);
        label17.setBounds(1050, 40, 70, 23);
        ...
        JamPemeriksaan.setBounds(1131, 40, 130, 23);
        ...
        scrollPane6.setBounds(10, 90, 200, 160);
        ...
        scrollPane13.setBounds(220, 90, 200, 160);
        ...
        scrollPane14.setBounds(430, 90, 200, 160);
        ...
        scrollPane15.setViewportView(TRecomendation);

        FormInput.add(scrollPane15);
        scrollPane15.setBounds(640, 90, 200, 160);
        ...
        scrollPane16.setBounds(850, 90, 200, 160);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().equals("")||TNoRM.getText().equals("")||TPasien.getText().equals("")){
            ...
            if(Sequel.menyimpantf("validasi_pemeriksaan_sbar_ranap","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",15,new String[]{
...
//        }
    ...
    private void TSituationKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TSituationKeyPressed
        Valid.pindah2(evt,BtnDokter,TBackground);
    ...
    private void TAssesmentKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TAssesmentKeyPressed
        Valid.pindah2(evt,TBackground,TRecomendation);
    ...
    private void TRecomendationKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TRecomendationKeyPressed
        Valid.pindah2(evt,TAssesment,Tulis);
    ...
    private void TulisKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TulisKeyPressed
        Valid.pindah2(evt,TRecomendation,BtnSimpan);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            ValidasiSBARRanap dialog = new ValidasiSBARRanap(new javax.swing.JFrame(), true);
        ...
        try{
            if(TCari.getText().equals("")){
                ps=koneksi.prepareStatement(
                    ...
                    "pemeriksaan_ranap_sbar.background,pemeriksaan_ranap_sbar.assesment,pemeriksaan_ranap_sbar.recommendation,pemeriksaan_ranap_sbar.nip,pegawai.nama, "+ 
                    "pemeriksaan_ranap_sbar.tulis,pemeriksaan_ranap_sbar.baca,pemeriksaan_ranap_sbar.konfirmasi from pasien inner join reg_periksa inner join pemeriksaan_ranap_sbar "+
                    "on pemeriksaan_ranap_sbar.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join pegawai on pemeriksaan_ranap_sbar.nip=pegawai.nik LEFT JOIN validasi_pemeriksaan_sbar_ranap ON validasi_pemeriksaan_sbar_ranap.no_rawat = pemeriksaan_ranap_sbar.no_rawat AND validasi_pemeriksaan_sbar_ranap.tgl_perawatan = pemeriksaan_ranap_sbar.tgl_perawatan AND validasi_pemeriksaan_sbar_ranap.jam_rawat = pemeriksaan_ranap_sbar.jam_rawat where "+
                    "pemeriksaan_ranap_sbar.no_rawat like ? and ISNULL(validasi_pemeriksaan_sbar_ranap.status_validasi) order by pemeriksaan_ranap_sbar.no_rawat desc");
            }else{
                ps=koneksi.prepareStatement(
                    "select reg_periksa.tgl_registrasi,reg_periksa.status_lanjut,pemeriksaan_ranap_sbar.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien, "+
                    "pemeriksaan_ranap_sbar.tgl_perawatan,pemeriksaan_ranap_sbar.jam_rawat,pemeriksaan_ranap_sbar.situation, " +
