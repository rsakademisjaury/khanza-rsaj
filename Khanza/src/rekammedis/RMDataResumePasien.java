...
public final class RMDataResumePasien extends javax.swing.JDialog {
    ...
    private String tanggal="",finger="",variabel="", noRMoriginal="",FileName = "", kodeberkas = "";
    ...
    public RMDataResumePasien(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Prosedur Sekunder 1","ICD9 Sek1","Prosedur Sekunder 2","ICD9 Sek2","Prosedur Sekunder 3","ICD9 Sek3","Obat-obatan waktu pulang/nasihat","No. SEP"
        }){
    ...
    private void initComponents() {
        ...
        MnLaporanResumeUpload = new javax.swing.JMenuItem();
        ...
        MnLaporanResumeUpload.setBackground(new java.awt.Color(255, 255, 254));
        MnLaporanResumeUpload.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnLaporanResumeUpload.setForeground(new java.awt.Color(50, 50, 50));
        MnLaporanResumeUpload.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnLaporanResumeUpload.setText("Laporan Resume Pasien");
        MnLaporanResumeUpload.setName("MnLaporanResumeUpload"); // NOI18N
        MnLaporanResumeUpload.setPreferredSize(new java.awt.Dimension(250, 26));
        MnLaporanResumeUpload.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnLaporanResumeUploadActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnLaporanResumeUpload);

        MnTTD.setBackground(new java.awt.Color(255, 255, 254));
        MnTTD.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnTTD.setForeground(new java.awt.Color(70, 70, 70));
        MnTTD.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnTTD.setText("Tanda Tangan Digital");
        MnTTD.setName("MnTTD"); // NOI18N
        MnTTD.setPreferredSize(new java.awt.Dimension(200, 26));
        MnTTD.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnTTDActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnTTD);
        ...
        BtnCari3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/accept_page.png"))); // NOI18N
        BtnCari3.setMnemonic('6');
        BtnCari3.setText("Salin Resume");
        BtnCari3.setToolTipText("Alt+6");
        BtnCari3.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnCari3.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        BtnCari3.setIconTextGap(5);
        BtnCari3.setName("BtnCari3"); // NOI18N
        BtnCari3.setPreferredSize(new java.awt.Dimension(150, 22));
        BtnCari3.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/accept.png"))); // NOI18N
        BtnCari3.setSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/accept_page.png"))); // NOI18N
        ...
        TNoSEP.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        TNoSEP.setText("0342R0490123V000001");
        TNoSEP.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        TNoSEP.setName("TNoSEP"); // NOI18N
        TNoSEP.setPreferredSize(new java.awt.Dimension(140, 26));
        ...
        panelGlass9Layout.setHorizontalGroup(
            ...
            .addGroup(panelGlass9Layout.createSequentialGroup()
                ...
                .addGap(5, 5, 5)
                .addComponent(BtnCari3, javax.swing.GroupLayout.PREFERRED_SIZE, 127, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(TNoSEP, javax.swing.GroupLayout.PREFERRED_SIZE, 155, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        scrollInput.setPreferredSize(new java.awt.Dimension(80, 653));

        FormInput.setBackground(new java.awt.Color(250, 255, 245));
        FormInput.setBorder(null);
        FormInput.setName("FormInput"); // NOI18N
        FormInput.setPreferredSize(new java.awt.Dimension(70, 651));
        ...
        jLabel4.setBounds(20, 50, 240, 23);
        ...
        TPasien.setBounds(285, 10, 260, 23);
        ...
        FormInput.add(TNoRM);
        TNoRM.setBounds(209, 10, 70, 23);

        jLabel25.setText("Diagnosa Sekunder 2 :");
        jLabel25.setName("jLabel25"); // NOI18N
        FormInput.add(jLabel25);
        jLabel25.setBounds(0, 410, 140, 23);
        ...
        DiagnosaSekunder2.setBounds(155, 410, 400, 23);

        jLabel26.setText("Diagnosa Sekunder 3 :");
        jLabel26.setName("jLabel26"); // NOI18N
        FormInput.add(jLabel26);
        jLabel26.setBounds(0, 440, 140, 23);
        ...
        DiagnosaUtama.setBounds(155, 350, 400, 23);

        jLabel27.setText("Diagnosa Utama :");
        jLabel27.setName("jLabel27"); // NOI18N
        FormInput.add(jLabel27);
        jLabel27.setBounds(20, 350, 110, 23);
        ...
        DiagnosaSekunder3.setBounds(155, 440, 400, 23);

        jLabel28.setText("Diagnosa Sekunder 4 :");
        jLabel28.setName("jLabel28"); // NOI18N
        FormInput.add(jLabel28);
        jLabel28.setBounds(0, 470, 140, 23);
        ...
        DiagnosaSekunder4.setBounds(155, 470, 400, 23);
        ...
        scrollPane3.setBounds(20, 170, 600, 60);

        jLabel9.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel9.setText("Hasil Radiologi Yang Positif :");
        jLabel9.setName("jLabel9"); // NOI18N
        FormInput.add(jLabel9);
        jLabel9.setBounds(650, 50, 190, 30);
        ...
        scrollPane5.setBounds(960, 80, 300, 240);

        jLabel11.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel11.setText("Obat-obatan Waktu Pulang/Nasihat :");
        jLabel11.setName("jLabel11"); // NOI18N
        FormInput.add(jLabel11);
        jLabel11.setBounds(20, 230, 240, 30);

        scrollPane6.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(102, 102, 102)));
        ...
        scrollPane6.setBounds(20, 260, 600, 60);
        ...
        jLabel29.setBounds(20, 320, 100, 40);

        jLabel30.setText("Diagnosa Sekunder 1 :");
        jLabel30.setName("jLabel30"); // NOI18N
        FormInput.add(jLabel30);
        jLabel30.setBounds(0, 380, 140, 23);
        ...
        DiagnosaSekunder1.setBounds(155, 380, 400, 23);

        jLabel31.setText("Kode ICD :");
        jLabel31.setName("jLabel31"); // NOI18N
        FormInput.add(jLabel31);
        jLabel31.setBounds(420, 320, 200, 30);
        ...
        KodeDiagnosaUtama.setBounds(560, 350, 60, 23);
        ...
        KodeDiagnosaSekunder1.setBounds(560, 380, 60, 23);
        ...
        KodeDiagnosaSekunder2.setBounds(560, 410, 60, 23);
        ...
        KodeDiagnosaSekunder3.setBounds(560, 440, 60, 23);
        ...
        KodeDiagnosaSekunder4.setBounds(560, 470, 60, 23);

        jLabel32.setText("Prosedur Utama :");
        jLabel32.setName("jLabel32"); // NOI18N
        FormInput.add(jLabel32);
        jLabel32.setBounds(650, 350, 110, 23);
        ...
        ProsedurUtama.setBounds(785, 350, 400, 23);
        ...
        KodeProsedurUtama.setBounds(1190, 350, 60, 23);
        ...
        ProsedurSekunder1.setBounds(785, 380, 400, 23);

        jLabel33.setText("Prosedur Sekunder 1 :");
        jLabel33.setName("jLabel33"); // NOI18N
        FormInput.add(jLabel33);
        jLabel33.setBounds(650, 380, 120, 23);
        ...
        KodeProsedurSekunder1.setBounds(1190, 380, 60, 23);

        jLabel34.setText("Prosedur Sekunder 2 :");
        jLabel34.setName("jLabel34"); // NOI18N
        FormInput.add(jLabel34);
        jLabel34.setBounds(650, 410, 120, 23);
        ...
        ProsedurSekunder2.setBounds(785, 410, 400, 23);
        ...
        KodeProsedurSekunder2.setBounds(1190, 410, 60, 23);
        ...
        KodeProsedurSekunder3.setBounds(1190, 440, 60, 23);
        ...
        ProsedurSekunder3.setBounds(785, 440, 400, 23);

        jLabel35.setText("Prosedur Sekunder 3 :");
        jLabel35.setName("jLabel35"); // NOI18N
        FormInput.add(jLabel35);
        jLabel35.setBounds(650, 440, 120, 23);
        ...
        label14.setBounds(560, 10, 70, 23);
        ...
        BtnDokter.setBounds(1010, 10, 28, 23);
        ...
        BtnDokter1.setBounds(250, 50, 140, 23);
        ...
        BtnDokter2.setBounds(840, 50, 110, 23);
        ...
        BtnDokter3.setBounds(1170, 50, 90, 30);

        BtnDokter4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        BtnDokter4.setMnemonic('2');
        BtnDokter4.setText("Riwayat Pemberian Obat");
        BtnDokter4.setToolTipText("Alt+2");
        BtnDokter4.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        BtnDokter4.setHorizontalTextPosition(javax.swing.SwingConstants.LEFT);
        BtnDokter4.setIconTextGap(8);
        ...
        BtnDokter4.setBounds(430, 230, 190, 30);
        ...
        BtnDokter5.setBounds(450, 50, 170, 23);
...
//        FileName = randomNumber + "_" + tbObat.getValueAt(tbObat.getSelectedRow(), 2).toString()+"_RESUME_RALAN";
//        CreatePDF(FileName);
...
//        ppBerkasDigitalBtnPrintActionPerformed(evt);
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TNoRw.getText().equals("")||TNoRM.getText().equals("")||TPasien.getText().equals("")){
            ...
            if(tbObat.getSelectedRow()>-1){
                if(aksesInstance.isAdminUtama()|| akses.getkode().equals("20061624")||(akses.getkode().equals("20101731"))||(akses.getkode().equals("20031546"))||(akses.getkode().equals("20031546B"))){
                    ganti();
                }else{
                    if(KodeDokter.getText().equals(tbObat.getValueAt(tbObat.getSelectedRow(),4).toString())){
                        ganti();
...
if(tbObat.getSelectedRow()>-1){
    ...
    private void MnLaporanResume2ActionPerformed(java.awt.event.ActionEvent evt) {                                                
        if(tbObat.getSelectedRow()>-1){
            Map<String, Object> param = new HashMap<>();    
            param.put("kd_dokter",Sequel.cariIsi("select nm_dokter from dokter where kd_dokter=?",KodeDokter.getText()));            
            param.put("ttd","http://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/tandatangandokter/pages/upload/"+KodeDokter.getText()+".png");
            ...
            Valid.MyReport("rptLaporanResumeCetak.jasper","report","::[ Laporan Resume Pasien ]::",param);
        }
    }                                               
    ...
    private void BtnCari2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCari2ActionPerformed
        ...
        try{
            ...
            DTPCari1.setDate(calendar.getTime());
        }catch(Exception e){
    ...
    private void BtnCari3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCari3ActionPerformed
        ...
        try {
            ...
            TNoRw.setText(text); //jTextField1 ganti jadi textfield tujuan
    ...
    private void MnLaporanResumeUploadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanResumeUploadActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_MnLaporanResumeUploadActionPerformed
    ...
    FileName = timestamp + "_" + tbObat.getValueAt(tbObat.getSelectedRow(), 2).toString() + "_ResumeRalan";
    ...
    */
    ...
    private javax.swing.JMenuItem MnLaporanResumeUpload;
    ...
    public void tampil() {
        ...
        try{
            if(TCari.getText().equals("")){
                ps=koneksi.prepareStatement(
                    "select DATE_FORMAT(reg_periksa.tgl_registrasi,'%d-%m-%Y')as tgl_registrasi,reg_periksa.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,bridging_sep.no_sep, "+
                    "resume_pasien.kd_dokter,dokter.nm_dokter,resume_pasien.kondisi_pulang,resume_pasien.keluhan_utama,resume_pasien.jalannya_penyakit, "+
                    "resume_pasien.pemeriksaan_penunjang,resume_pasien.hasil_laborat,resume_pasien.diagnosa_utama,resume_pasien.kd_diagnosa_utama, "+
                    "resume_pasien.diagnosa_sekunder,resume_pasien.kd_diagnosa_sekunder,resume_pasien.diagnosa_sekunder2,resume_pasien.kd_diagnosa_sekunder2, "+
                    "resume_pasien.diagnosa_sekunder3,resume_pasien.kd_diagnosa_sekunder3,resume_pasien.diagnosa_sekunder4,resume_pasien.kd_diagnosa_sekunder4, "+
            ...
            try {
                if(TCari.getText().equals("")){
                    ps.setString(1,Valid.SetTgl(DTPCari1.getSelectedItem()+"01-01-2020"));
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("kd_prosedur_sekunder3"),rs.getString("obat_pulang"),rs.getString("no_sep") 
                    });
                }
            } catch (Exception e) {
                System.out.println("Notif : "+e);
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            TNoSEP.setText(tbObat.getValueAt(tbObat.getSelectedRow(),30).toString());    
        }
    }
    ...
    public void setNoRm(String norwt, Date tgl2) {
        ...
        try (PreparedStatement ps = koneksi.prepareStatement("SELECT COUNT(*) FROM resume_pasien WHERE no_rawat = ?")) {
        ps.setString(1, norwt);
...
private void CreatePDF(String FileName) {
    if (tabMode.getRowCount() == 0) {
        ...
        if (tbObat.getSelectedRow() != -1) {
            ...
            Valid.MyReportPDFqryUpload("rptLaporanResume.jasper", "report", "::[ Resume Rawat Jalan ]::",
                    "SELECT "
            ...
            + "WHERE "
                    + "resume_pasien.no_rawat ='" + TNoRw.getText() + "' ",FileName, param);   
            this.setCursor(Cursor.getDefaultCursor());
        }else{
