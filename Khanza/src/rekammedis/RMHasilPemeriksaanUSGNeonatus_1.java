 ...
 * @author perpustakaan
 */
public final class RMHasilPemeriksaanUSGNeonatus_1 extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMHasilPemeriksaanUSGNeonatus_1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMHasilPemeriksaanUSGNeonatus_1 dialog = new RMHasilPemeriksaanUSGNeonatus_1(new javax.swing.JFrame(), true);
