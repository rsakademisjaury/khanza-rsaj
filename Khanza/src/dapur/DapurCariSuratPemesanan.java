...
public class DapurCariSuratPemesanan extends javax.swing.JDialog {
                ...
                if(akses.getform().equals("DlgCariPemesanan")){
                    if(pegawai.getTable().getSelectedRow()!= -1){                   
                        if(pilihan==1){
                            ...
                            PemesanBarang.setText(pegawai.tbKamar.getValueAt(pegawai.tbKamar.getSelectedRow(),1).toString());                        
                        } 
                    }            
                }
            }
    ...
    private void initComponents() {
        ...
        PemesanBarang = new widget.TextBox();
        ...
        DlgCetak.setModalExclusionType(java.awt.Dialog.ModalExclusionType.APPLICATION_EXCLUDE);
        DlgCetak.setName("DlgCetak"); // NOI18N
        DlgCetak.setPreferredSize(new java.awt.Dimension(600, 150));
        ...
        panelBiasa4.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        ...
        BtnPrint5.setBounds(130, 60, 100, 30);
        ...
        BtnKeluar4.setBounds(390, 60, 100, 30);
        ...
        BtnSeek5.setBounds(490, 20, 28, 23);

        PemesanBarang.setEditable(false);
        PemesanBarang.setText("RAHMATIA AMG");
        PemesanBarang.setName("PemesanBarang"); // NOI18N
        PemesanBarang.setPreferredSize(new java.awt.Dimension(300, 23));
        panelBiasa4.add(PemesanBarang);
        PemesanBarang.setBounds(130, 20, 360, 23);

        jLabel24.setText("Pemesan Barang   : ");
        jLabel24.setName("jLabel24"); // NOI18N
        jLabel24.setPreferredSize(new java.awt.Dimension(60, 23));
        panelBiasa4.add(jLabel24);
        jLabel24.setBounds(10, 20, 120, 23);
        ...
        jLabel25.setBounds(50, 240, 140, 23);
        ...
        Apoteker.setBounds(190, 240, 340, 23);
        ...
        BtnSeek6.setBounds(530, 240, 28, 23);
...
private void ppHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppHapusActionPerformed
  if(tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString().trim().equals("")){
    ...
    private void BtnPrint5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint5ActionPerformed
        if(PemesanBarang.getText().trim().equals("")){
            Valid.textKosong(PemesanBarang,"Pemesan Barang");        
            ...
            try {
                ...
                try {
                    ...
                    if(rs.next()){
                        ...
                        param.put("kabidkeu",PemesanBarang.getText());
                        param.put("logo",Sequel.cariGambar("select setting.logo from setting"));
    ...
    */
    ...
    private widget.TextBox PemesanBarang;
