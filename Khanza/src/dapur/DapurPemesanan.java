...
//        }  
    ...
    if(NoFaktur.getText().trim().equals("")){
        ...
        // Cek kd_rek valid
        if(Sequel.cariInteger("select count(*) from rekening where kd_rek=?", Penerimaan_Dapur) == 0){
            JOptionPane.showMessageDialog(null,"Kode rekening Penerimaan_Dapur tidak ditemukan di master rekening.");
            return;
        }
        if(ppn>0 && Sequel.cariInteger("select count(*) from rekening where kd_rek=?", PPN_Masukan) == 0){
            JOptionPane.showMessageDialog(null,"Kode rekening PPN_Masukan tidak ditemukan di master rekening.");
            return;
        }
        if(Sequel.cariInteger("select count(*) from rekening where kd_rek=?", Kontra_Penerimaan_Dapur) == 0){
            JOptionPane.showMessageDialog(null,"Kode rekening Kontra_Penerimaan_Dapur tidak ditemukan di master rekening.");
            return;
        }
        ...
        if (reply == JOptionPane.YES_OPTION) {
            ...
            // Proses jurnal jika sukses
            if(sukses==true){
                Sequel.queryu("delete from tampjurnal");

                System.out.println("Debug: Penerimaan_Dapur = " + Penerimaan_Dapur);
                System.out.println("Debug: PPN_Masukan = " + PPN_Masukan);
                System.out.println("Debug: Kontra_Penerimaan_Dapur = " + Kontra_Penerimaan_Dapur);
