...
public class DlgCariPermintaanRadiologi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TanggalPulang.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "25-02-2025 19:04:32" }));
    ...
    private void tampil() {
        ...
        try {
            ...
            ps=koneksi.prepareStatement(
                    ...
                    "permintaan_radiologi.dokter_perujuk,dokter.nm_dokter,poliklinik.nm_poli,permintaan_radiologi.informasi_tambahan,permintaan_radiologi.diagnosa_klinis, reg_periksa.umurdaftar,reg_periksa.sttsumur "+
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("nm_pasien")+"  ( "+rs.getString("umurdaftar")+" "+rs.getString("sttsumur")+" )",rs.getString("tgl_permintaan"),rs.getString("jam_permintaan"),
            ...
            try {
                ...
                while(rs.next()){
                    tabMode2.addRow(new String[]{
                        rs.getString("noorder"),rs.getString("no_rawat"),rs.getString("no_rkm_medis")+" "+rs.getString("nm_pasien")+"  ( "+rs.getString("umurdaftar")+" "+rs.getString("sttsumur")+" )",
        ...
        try {
            ...
            if(cmbStatus.getSelectedIndex()==0){
                ps=koneksi.prepareStatement(
                        ...
                        "if(permintaan_radiologi.tgl_sampel='0000-00-00','',permintaan_radiologi.tgl_sampel) as tgl_sampel,if(permintaan_radiologi.jam_sampel='00:00:00','',permintaan_radiologi.jam_sampel) as jam_sampel,"+
                        "permintaan_radiologi.tgl_hasil,if(permintaan_radiologi.jam_hasil='00:00:00','',permintaan_radiologi.jam_hasil) as jam_hasil,"+
                        "permintaan_radiologi.dokter_perujuk,dokter.nm_dokter,ifnull(bangsal.nm_bangsal,'Ranap Gabung') as nm_bangsal,permintaan_radiologi.informasi_tambahan,permintaan_radiologi.diagnosa_klinis,reg_periksa.umurdaftar,reg_periksa.sttsumur "+
                        "from permintaan_radiologi inner join reg_periksa on permintaan_radiologi.no_rawat=reg_periksa.no_rawat "+
                        "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        "inner join dokter on permintaan_radiologi.dokter_perujuk=dokter.kd_dokter "+
        ...
        try {
            ...
            if(cmbStatus.getSelectedIndex()==0){
                ps=koneksi.prepareStatement(
                        ...
                        "if(permintaan_radiologi.jam_sampel='00:00:00','',permintaan_radiologi.jam_sampel) as jam_sampel, permintaan_radiologi.tgl_hasil,"+
                        "if(permintaan_radiologi.jam_hasil='00:00:00','',permintaan_radiologi.jam_hasil) as jam_hasil,"+
                        "permintaan_radiologi.dokter_perujuk,dokter.nm_dokter,ifnull(bangsal.nm_bangsal,'Ranap Gabung') as nm_bangsal,permintaan_radiologi.informasi_tambahan,permintaan_radiologi.diagnosa_klinis,reg_periksa.umurdaftar,reg_periksa.sttsumur from permintaan_radiologi "+
                ...
                if(detik.equals("05")){
                    ...
                    if(formalarm.contains("ralan")){
                        ...
                        for(i=0;i<tbRadiologiRalan.getRowCount();i++){
                            if((!tbRadiologiRalan.getValueAt(i,0).toString().equals(""))&&tbRadiologiRalan.getValueAt(i,5).toString().equals("")&&tbRadiologiRalan.getValueAt(i,12).toString().toLowerCase().contains("cito")){
                                permintaanbaru++;
                            }
                        }
                    }
                    ...
                    if(formalarm.contains("ranap")){
                        ...
                        for(i=0;i<tbRadiologiRanap.getRowCount();i++){
                            if((!tbRadiologiRanap.getValueAt(i,0).toString().equals(""))&&tbRadiologiRanap.getValueAt(i,5).toString().equals("")&&tbRadiologiRanap.getValueAt(i,12).toString().toLowerCase().contains("cito")){
                                permintaanbaru++;
                            }
                        }
                    }
