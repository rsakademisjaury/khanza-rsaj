 ...
 * @author dosen
 */
public class DlgPermintaanEchoDoopler extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgPermintaanEchoDoopler(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "  Permintaan Echo dan USG Doopler", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 14), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        TglSO.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "22-05-2025" }));
...
//            Valid.textKosong(btnKamar,"Kamar/Bangsal");
            ...
            if(tbObat.getSelectedRow()> -1){
                if(Sequel.mengedittf("permintaan_echo","no_rawat=?","no_rawat=?,tanggal=?,kd_kamar=?,diagnosa=?,catatan=?",6,new String[]{
...
//                param.put("finger","Dikeluarkan di "+akses.getnamars()+", Kabupaten/Kota "+akses.getkabupatenrs()+"\nDitandatangani secara elektronik oleh "+Dokter.getText()+"\nID "+(finger.equals("")?KdDokter.getText():finger)+"\n"+DTPTgl.getSelectedItem()); 
                ...
                Valid.MyReportqry("rptSuratPermintaanRawatInap.jasper","report","::[ Surat Permintaan Rawat Inap ]::",
                        ...
                        "where reg_periksa.no_rawat='"+NoRw.getText()+"' Group by permintaan_echo.no_rawat",param);
                this.setCursor(Cursor.getDefaultCursor());
            }else{
                JOptionPane.showMessageDialog(null,"Maaf, silahkan pilih data...!!!!");
            }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPermintaanEchoDoopler dialog = new DlgPermintaanEchoDoopler(new javax.swing.JFrame(), true);
            ...
            if(R1.isSelected()==true){
                ps=koneksi.prepareStatement("select "
                    ...
                    (TCari.getText().equals("")?"":"and "
                            ...
                            + "or permintaan_echo.diagnosa like ?)")+" "
                ...
                ps=koneksi.prepareStatement("select "
                    ...
                    "inner join dokter on reg_periksa.kd_dokter=dokter.kd_dokter "+
                    "inner join poliklinik on reg_periksa.kd_poli=poliklinik.kd_poli "+                    
                    "where permintaan_echo.no_rawat in (select DISTINCT no_rawat from kamar_inap) "
                        + "and permintaan_echo.tanggal between ? and ? "+
                    (TCari.getText().equals("")?"":"and "
                            + "(permintaan_echo.no_rawat like ? "
    ...
    private void jam(){
        ActionListener taskPerformer = (ActionEvent e) -> {
            if(aktif==true){
                ...
                if(detik.equals("05")){
                    bookingbaru=Sequel.cariInteger("select count(*) from permintaan_echo where no_rawat not in (select DISTINCT no_rawat from kamar_inap) ");
                    if(bookingbaru>0){
                        try {
