...
//            jam();
    ...
    private void initComponents() {
        ...
        TglSO.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "29-06-2026" }));
        ...
        BtnPernyataanMemilihDPJP.setForeground(new java.awt.Color(0, 0, 0));
        BtnPernyataanMemilihDPJP.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/resumeri.png"))); // NOI18N
        BtnPernyataanMemilihDPJP.setText("Formulir Memilih DPJP");
        ...
        BtnPernyataanMemilihDPJP.setPreferredSize(new java.awt.Dimension(160, 30));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(NoRw.getText().trim().equals("")||NoRM.getText().trim().equals("")||NmPasien.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("permintaan_rawat_inap","?,?,?,?,?,?,NOW(),'Baru'","Pasien",6,new String[]{
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(Valid.hapusTabletf(tabMode,NoRw,"permintaan_rawat_inap","no_rawat")==true){
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            if(R1.isSelected()==true){
                sql="select permintaan_rawat_inap.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,pasien.jk,reg_periksa.umurdaftar,reg_periksa.sttsumur,"+
                    "pasien.no_tlp,penjab.png_jawab,poliklinik.nm_poli,dokter.nm_dokter,permintaan_rawat_inap.tanggal,permintaan_rawat_inap.kd_kamar,kamar.kd_bangsal,"+
                    "bangsal.nm_bangsal,kamar.trf_kamar,permintaan_rawat_inap.diagnosa,permintaan_rawat_inap.catatan from permintaan_rawat_inap "+
                    "inner join reg_periksa on permintaan_rawat_inap.no_rawat=reg_periksa.no_rawat "+
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj "+
                    "inner join dokter on reg_periksa.kd_dokter=dokter.kd_dokter "+
                    "inner join poliklinik on reg_periksa.kd_poli=poliklinik.kd_poli "+
                    "inner join kamar on permintaan_rawat_inap.kd_kamar=kamar.kd_kamar "+
                    "inner join bangsal on kamar.kd_bangsal=bangsal.kd_bangsal "+
                    "where permintaan_rawat_inap.no_rawat not in (select DISTINCT no_rawat from kamar_inap) "+
                    (TCari.getText().equals("")?"":"and (permintaan_rawat_inap.no_rawat like '%"+TCari.getText().trim()+"%' or reg_periksa.no_rkm_medis like '%"+TCari.getText().trim()+"%' or pasien.nm_pasien like '%"+TCari.getText().trim()+"%' "+
                    ...
                    "or permintaan_rawat_inap.diagnosa like '%"+TCari.getText().trim()+"%')")+" order by permintaan_rawat_inap.tanggal";
                ...
                sql="select permintaan_rawat_inap.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,pasien.jk,reg_periksa.umurdaftar,reg_periksa.sttsumur,"+
                    ...
                    "inner join kamar on permintaan_rawat_inap.kd_kamar=kamar.kd_kamar "+
                    "inner join bangsal on kamar.kd_bangsal=bangsal.kd_bangsal "+
                    "where permintaan_rawat_inap.no_rawat in (select DISTINCT no_rawat from kamar_inap) and permintaan_rawat_inap.tanggal between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' "+
                    (TCari.getText().equals("")?"":"and (permintaan_rawat_inap.no_rawat like '%"+TCari.getText().trim()+"%' or reg_periksa.no_rkm_medis like '%"+TCari.getText().trim()+"%' or pasien.nm_pasien like '%"+TCari.getText().trim()+"%' "+
                    "or penjab.png_jawab like '%"+TCari.getText().trim()+"%' or poliklinik.nm_poli like '%"+TCari.getText().trim()+"%' or dokter.nm_dokter like '%"+TCari.getText().trim()+"%' or bangsal.nm_bangsal like '%"+TCari.getText().trim()+"%' "+
                    "or permintaan_rawat_inap.diagnosa like '%"+TCari.getText().trim()+"%')")+" order by permintaan_rawat_inap.tanggal";
            }
...
//            Valid.textKosong(btnKamar,"Kamar/Bangsal");
            ...
            if(tbObat.getSelectedRow()> -1){
                if(Sequel.mengedittf("permintaan_rawat_inap","no_rawat=?","no_rawat=?,tanggal=?,kd_kamar=?,diagnosa=?,catatan=?",6,new String[]{
...
//                param.put("finger","Dikeluarkan di "+akses.getnamars()+", Kabupaten/Kota "+akses.getkabupatenrs()+"\nDitandatangani secara elektronik oleh "+Dokter.getText()+"\nID "+(finger.equals("")?KdDokter.getText():finger)+"\n"+DTPTgl.getSelectedItem()); 
                ...
                Valid.MyReportqry("rptSuratPermintaanRawatInap.jasper","report","::[ Surat Permintaan Rawat Inap ]::",
                        "select permintaan_rawat_inap.no_rawat,"
                                ...
                                + "poliklinik.nm_poli,"
                                + "dokter.nm_dokter,"
                                + "permintaan_rawat_inap.tanggal,"
                                + "permintaan_rawat_inap.diagnosa,"
                                + "permintaan_rawat_inap.catatan,"
                                + "Group_concat(dr.nm_dokter) as nm_dokter_dpjp,"
                                + "reg_periksa.kd_dokter "
                                + "from "
                                + "permintaan_rawat_inap "+
                        "inner join reg_periksa on permintaan_rawat_inap.no_rawat=reg_periksa.no_rawat "+
                        "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj "+
                        "inner join dokter on reg_periksa.kd_dokter=dokter.kd_dokter "+
                        "inner join poliklinik on reg_periksa.kd_poli=poliklinik.kd_poli "+
                        "Join dpjp_ranap on permintaan_rawat_inap.no_rawat = dpjp_ranap.no_rawat " +
                        "Join dokter as dr on dpjp_ranap.kd_dokter = dr.kd_dokter "+        
                        "where reg_periksa.no_rawat='"+NoRw.getText()+"' Group by permintaan_rawat_inap.no_rawat",param);
                this.setCursor(Cursor.getDefaultCursor());
            }else{
                JOptionPane.showMessageDialog(null,"Maaf, silahkan pilih data...!!!!");
            }
        ...
        try{ 
            if(R1.isSelected()==true){
                ps=koneksi.prepareStatement("select "
                        + "permintaan_rawat_inap.no_rawat,"
                        + "reg_periksa.no_rkm_medis,"
                        + "pasien.nm_pasien,"
                        + "pasien.jk,"
                        + "reg_periksa.umurdaftar,"
                        ...
                        + "permintaan_rawat_inap.diagnosa,"                        
                        + "permintaan_rawat_inap.catatan,"
                        + "permintaan_rawat_inap.kd_dokter "
                        + "from permintaan_rawat_inap "+
                    "inner join reg_periksa on permintaan_rawat_inap.no_rawat=reg_periksa.no_rawat "+
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj "+
                    "inner join dokter on reg_periksa.kd_dokter=dokter.kd_dokter "+
                    ...
                    (TCari.getText().equals("")?"":"and "
                            + "(permintaan_rawat_inap.no_rawat like ? or "
                            ...
                            + "or permintaan_rawat_inap.diagnosa like ?)")+" "
                            + "order by permintaan_rawat_inap.tanggal");
                try {
                ...
                ps=koneksi.prepareStatement("select "
                    ...
                    "inner join dokter on reg_periksa.kd_dokter=dokter.kd_dokter "+
                    "inner join poliklinik on reg_periksa.kd_poli=poliklinik.kd_poli "+                    
                    "where permintaan_rawat_inap.no_rawat in (select DISTINCT no_rawat from kamar_inap) "
                        + "and permintaan_rawat_inap.tanggal between ? and ? "+
                    (TCari.getText().equals("")?"":"and "
                            + "(permintaan_rawat_inap.no_rawat like ? "
...
//                if(detik.equals("05")){
//                    bookingbaru=Sequel.cariInteger("select count(*) from permintaan_rawat_inap where no_rawat not in (select DISTINCT no_rawat from kamar_inap) ");
//                    if(bookingbaru>0){
//                        try {
...
//    }
    ...
    try {
        ...
        String cekUpload = Sequel.cariIsi("SELECT ifnull(no_rawat_upload,'') FROM permintaan_rawat_inap WHERE no_rawat=?", norawat);
    ...
    Valid.MyReportPDFqryUpload(
        ...
        "SELECT permintaan_rawat_inap.no_rawat, reg_periksa.no_rkm_medis, pasien.nm_pasien, pasien.jk, reg_periksa.umurdaftar, reg_periksa.sttsumur, " +
        "pasien.no_tlp, penjab.png_jawab, poliklinik.nm_poli, dokter.nm_dokter, permintaan_rawat_inap.tanggal, permintaan_rawat_inap.diagnosa, " +
        "permintaan_rawat_inap.catatan, group_concat(dr.nm_dokter) AS nm_dokter_dpjp, reg_periksa.kd_dokter " +
        "FROM permintaan_rawat_inap " +
        "INNER JOIN reg_periksa ON permintaan_rawat_inap.no_rawat=reg_periksa.no_rawat " +
        "INNER JOIN pasien ON reg_periksa.no_rkm_medis=pasien.no_rkm_medis " +
        "INNER JOIN penjab ON reg_periksa.kd_pj=penjab.kd_pj " +
