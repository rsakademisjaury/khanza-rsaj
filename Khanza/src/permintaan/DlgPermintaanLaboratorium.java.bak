...
public final class DlgPermintaanLaboratorium extends javax.swing.JDialog {
    ...
    private HashSet<String> pilihan;    
    ...
    private void initComponents() {
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "29-11-2025" }));
        ...
        jLabel25.setText("< Untuk Pemeriksaan CITO, cukup ketik CITO");
        jLabel25.setName("jLabel25"); // NOI18N
        PanelInput.add(jLabel25);
        jLabel25.setBounds(780, 70, 260, 23);
        ...
        panelGlass11.setPreferredSize(new java.awt.Dimension(700, 157));
        ...
        Pemeriksaan.setBounds(85, 10, 320, 23);
        ...
        Scroll1.setBounds(10, 40, 670, 350);
        ...
        BtnCari1.setBounds(410, 10, 28, 23);

        jLabel4.setText("No.Permintaan :");
        jLabel4.setName("jLabel4"); // NOI18N
        panelGlass11.add(jLabel4);
        jLabel4.setBounds(440, 10, 98, 23);
        ...
        TNoPermintaanPK.setBounds(550, 10, 130, 23);

        PanelCariUtama.add(panelGlass11, java.awt.BorderLayout.WEST);
        ...
        TanggalPA.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "29-11-2025" }));
        ...
        TanggalBahan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "29-11-2025" }));
    ...
    private void tbTarifPKMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbTarifPKMouseClicked
        if(tabMode2.getRowCount()!=0){
            try {
                //ambil pilihan
                pilihan.clear();
                for (int x = 0; x < tbDetailPK.getRowCount(); x++) {  // Loop through the rows
                    if ((Boolean) tbDetailPK.getValueAt(x, 0)){
                        pilihan.add(tbDetailPK.getValueAt(x,4).toString());
                    }  
                }
                ...
                if(tbTarifPK.getValueAt(i2,0).toString().equals("true")){
                    ...
                    try {
                        ...
                        while(rstampil.next()){
                            ...
                            if (pilihan.contains(rstampil.getString("id_template"))){
                                tabMode.addRow(new Object[]{
