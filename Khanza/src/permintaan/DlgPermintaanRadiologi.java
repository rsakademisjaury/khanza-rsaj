...
public final class DlgPermintaanRadiologi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel25.setBounds(640, 100, 290, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        if(TNoRw.getText().equals("")||TNoRM.getText().equals("")||TPasien.getText().equals("")){
            ...
            JOptionPane.showMessageDialog(rootPane,
                    "Maaf, untuk keperluan satu sehat 1 permintaan hanya dibolehkan 1 pemeriksaan,\n"+
                    "silahkan membuat permintaan baru untuk pemeriksaan berikutnya.");
            TCariPeriksa.requestFocus();
        }else{
            jmlparsial=0;
