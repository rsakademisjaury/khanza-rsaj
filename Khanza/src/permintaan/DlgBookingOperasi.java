...
public class DlgBookingOperasi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        DTPCari3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "01-07-2025" }));
        ...
        DTPCari4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "01-07-2025" }));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            if(Sequel.cariRegistrasi(TNoRw.getText())>0){
                ...
                if(Sequel.menyimpantf("booking_operasi","?,?,?,?,?,?,?,?,?,?,now()","data", 10,new String[]{
  ...
  //      Valid.pindah(evt,jenis,BtnOperator1);
    ...
    */
    ...
    public void isCek(){
        ...
        Perawat.setText(Sequel.cariIsi("Select nama from petugas where nip = ?", akses.getkode()));
    }
