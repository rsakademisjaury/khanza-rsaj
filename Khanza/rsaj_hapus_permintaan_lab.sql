...
-- ----------------------------
-- Table structure for rsaj_hapus_permintaan_lab
-- ----------------------------
DROP TABLE IF EXISTS `rsaj_hapus_permintaan_lab`;
CREATE TABLE `rsaj_hapus_permintaan_lab`  (
  `no_rawat` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `noorder` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
