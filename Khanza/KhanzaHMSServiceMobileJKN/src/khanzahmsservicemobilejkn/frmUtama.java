...
public class frmUtama extends javax.swing.JFrame {
    ...
    private  String requestJson,URL="",utc="",link="",datajam="",nol_jam = "",nol_menit = "",nol_detik = "",jam="",menit="",
                detik="",hari="",noresep="",no_urut="",kodepoli="",kodedokter="",kodebpjs=Sequel.cariIsi("select password_asuransi.kd_pj from password_asuransi");
    ...
    private void jam(){
        ActionListener taskPerformer = new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(detik.equals("01")&&((nilai_menit%2)==0)){
                    ...
                    try {
                        ...
                        try {
                            ...
                            while(rs.next()){
                                ...
                                datajam=Sequel.cariIsi("SELECT rmb.validasi FROM referensi_mobilejkn_bpjs rmb WHERE rmb.no_rawat =? AND rmb.`status` = 'Checkin' AND rmb.validasi != '0000-00-00 00:00:00'",rs.getString("no_rawat"));
                                if(!datajam.equals("")){
                                ...
                                datajam=Sequel.cariIsi("select if(pemeriksaan_ralan.no_rawat is null, concat(DATE(NOW()),' ',TIME(NOW())), concat(DATE(NOW()),' ',TIME(NOW()))) from reg_periksa left join pemeriksaan_ralan on reg_periksa.no_rawat = pemeriksaan_ralan.no_rawat left join rawat_jl_drpr on reg_periksa.no_rawat = rawat_jl_drpr.no_rawat where reg_periksa.no_rawat=? and (rawat_jl_drpr.no_rawat is not null or pemeriksaan_ralan.no_rawat is not null) order by pemeriksaan_ralan.tgl_perawatan desc, pemeriksaan_ralan.jam_rawat desc, rawat_jl_drpr.tgl_perawatan desc, rawat_jl_drpr.jam_rawat desc limit 2",rs.getString("no_rawat"));
                                if(!datajam.equals("")){
                                ...
                                // datajam=Sequel.cariIsi("select if(pemeriksaan_ralan.no_rawat is null, concat(DATE(NOW()),' ',rawat_jl_drpr.jam_rawat), concat(DATE(NOW()),' ',pemeriksaan_ralan.jam_rawat)) from reg_periksa left join pemeriksaan_ralan on reg_periksa.no_rawat = pemeriksaan_ralan.no_rawat left join rawat_jl_drpr on reg_periksa.no_rawat = rawat_jl_drpr.no_rawat where reg_periksa.no_rawat=? and (rawat_jl_drpr.no_rawat is not null or pemeriksaan_ralan.no_rawat is not null) order by pemeriksaan_ralan.tgl_perawatan desc, pemeriksaan_ralan.jam_rawat desc, rawat_jl_drpr.tgl_perawatan desc, rawat_jl_drpr.jam_rawat desc limit 2",rs.getString("no_rawat"));
                                datajam=Sequel.cariIsi("select now() from reg_periksa where reg_periksa.stts IN ('Sudah','Dirawat','Sudah Bayar','Transit') and reg_periksa.no_rawat=?",rs.getString("no_rawat"));
                                if(!datajam.equals("")){
...
//                                no_urut = Sequel.cariIsi("SELECT rsuh_antrian_farmasi.no_urut FROM rsuh_antrian_farmasi WHERE rsuh_antrian_farmasi.no_rawat=?",rs.getString("no_rawat"));
                                if(!noresep.equals("")){
                                    try {     
...
//                                                        "\"nomorantrean\": "+Integer.parseInt(no_urut)+"," +
                                 ...
                                 datajam=Sequel.cariIsi("select concat(DATE(NOW()),' ',resep_obat.jam_peresepan) from resep_obat where resep_obat.tgl_peresepan<>'0000-00-00' and tgl_perawatan != '0000-00-00' and resep_obat.status='ralan' and resep_obat.no_rawat=?",rs.getString("no_rawat"));
                                // datajam=Sequel.cariIsi("SELECT far.tanggal FROM rsuh_antrian_farmasi far WHERE far.no_rawat = ?",rs.getString("no_rawat"));
...
//                                datajam=Sequel.cariIsi("select concat(DATE(NOW()),' ',resep_obat.jam) from resep_obat where resep_obat.status='ralan' and resep_obat.no_rawat=? and concat(resep_obat.tgl_perawatan,' ',resep_obat.jam)<>'0000-00-00 00:00:00'",rs.getString("no_rawat"));
                        ...
                        try {
                            ...
                            while(rs.next()){
                                ...
                                // datajam=Sequel.cariIsi("SELECT CONCAT(rp.tgl_registrasi,' ',rp.jam_reg - INTERVAL '5' MINUTE) FROM reg_periksa rp WHERE rp.no_rawat =?",rs.getString("no_rawat"));
//                                datajam=Sequel.cariIsi("select if(concat(reg_periksa.tgl_registrasi,' ',reg_periksa.jam_reg)>concat('"+rs.getString("tgl_registrasi")+"',' ','"+rs2.getString("jam_mulai")+"'),concat(reg_periksa.tgl_registrasi,' ',reg_periksa.jam_reg - INTERVAL '3' MINUTE),concat('"+rs.getString("tgl_registrasi")+"',' ','"+rs2.getString("jam_mulai")+"')) as tanggal from reg_periksa where reg_periksa.no_rawat=?",rs.getString("no_rawat"));
//                                datajam=Sequel.cariIsi("select if(concat(reg_periksa.tgl_registrasi,' ',reg_periksa.jam_reg)>concat('"+rs.getString("tgl_registrasi")+"',' ','"+rs2.getString("jam_mulai")+"'),CONCAT(reg_periksa.tgl_registrasi,' ',(reg_periksa.jam_reg - INTERVAL ROUND((RAND()*(2-1+1)+2),0) MINUTE) - INTERVAL ROUND((RAND()*(2-1+1)+2),0) SECOND),concat('"+rs.getString("tgl_registrasi")+"',' ','"+rs2.getString("jam_mulai")+"')) as tanggal from reg_periksa where reg_periksa.no_rawat=?",rs.getString("no_rawat"));
                                datajam=Sequel.cariIsi("select CONCAT(reg_periksa.tgl_registrasi,' ',(reg_periksa.jam_reg - INTERVAL ROUND((RAND()*(2-1+1)+5),0) MINUTE) - INTERVAL ROUND((RAND()*(2-1+1)+2),0) SECOND) as tanggal  from reg_periksa where reg_periksa.no_rawat=?",rs.getString("no_rawat"));
                                if(!datajam.equals("")){
                                ...
                                datajam=Sequel.cariIsi("select concat(reg_periksa.tgl_registrasi,' ',reg_periksa.jam_reg) as tanggal from reg_periksa where reg_periksa.no_rawat=?",rs.getString("no_rawat"));
                                if(!datajam.equals("")){
...
//                                            datajam=Sequel.cariIsi("select if(concat(reg_periksa.tgl_registrasi,' ',reg_periksa.jam_reg)>concat('"+rs.getString("tgl_registrasi")+"',' ','"+rs2.getString("jam_mulai")+"'),concat(reg_periksa.tgl_registrasi,' ',reg_periksa.jam_reg),concat('"+rs.getString("tgl_registrasi")+"',' ','"+rs2.getString("jam_mulai")+"')) as tanggal from reg_periksa where reg_periksa.no_rawat=?",rs.getString("no_rawat"));
                                            datajam=Sequel.cariIsi("select CONCAT(reg_periksa.tgl_registrasi,' ',(reg_periksa.jam_reg + INTERVAL ROUND((RAND()*(2-1+1)+2),0) MINUTE) + INTERVAL ROUND((RAND()*(2-1+1)+2),0) SECOND) as tanggal  from reg_periksa where reg_periksa.no_rawat=?",rs.getString("no_rawat"));
                                            if(!datajam.equals("")){
                                                if(Sequel.menyimpantf2("referensi_mobilejkn_bpjs_taskid","?,?,?","task id",3,new String[]{rs.getString("no_rawat"),"3",datajam})==true){
                                                    parsedDate = dateFormat.parse(datajam);
                                                    try {     
                                                        TeksArea.append("Menjalankan WS taskid mulai tunggu poli Mobile JKN Pasien Non BPJS/BPJS Onsite\n");
                                                        headers = new HttpHeaders();
                                                        headers.setContentType(MediaType.APPLICATION_JSON);
                                                        headers.add("x-cons-id",koneksiDB.CONSIDAPIMOBILEJKN());
                                                        utc=String.valueOf(api.GetUTCdatetimeAsString());
