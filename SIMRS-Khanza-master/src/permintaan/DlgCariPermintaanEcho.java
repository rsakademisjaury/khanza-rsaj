...
public class DlgCariPermintaanEcho extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgCariPermintaanEcho(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariPermintaanEcho dialog = new DlgCariPermintaanEcho(new javax.swing.JFrame(), true);
        ...
        try {
            ...
            while (rs.next()) {
                ...
                ps2 = koneksi.prepareStatement(
                    ...
                    "where permintaan_pemeriksaan_radiologi.noorder = ? " +
                    "and (jns_perawatan_radiologi.nm_perawatan like '%echo%' or jns_perawatan_radiologi.nm_perawatan like '%usg doppler%')"
                );
                try {
    ...
    try {
        ...
        ps = koneksi.prepareStatement(
            ...
            "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj " +
            "where permintaan_radiologi.status='ralan' and permintaan_radiologi.tgl_permintaan between ? and ? " +
            "and jns_perawatan_radiologi.nm_perawatan like '%echo%' " +  // Tidak tampilkan '%echo%'
            "and jns_perawatan_radiologi.nm_perawatan like '%usg doppler%' " +  // Tidak tampilkan '%usg doppler%'
            (semua ? "" : "and dokter.nm_dokter like ? and poliklinik.nm_poli like ? and " +
