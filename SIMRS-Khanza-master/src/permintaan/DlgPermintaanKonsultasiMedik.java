...
public class DlgPermintaanKonsultasiMedik extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TanggalJawab.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "22-02-2025 15:55:48" }));
        ...
        NoPermintaan.setBounds(388, 40, 230, 23);

        jLabel9.setText("No. Permintaan :");
        jLabel9.setName("jLabel9"); // NOI18N
        FormInput.add(jLabel9);
        jLabel9.setBounds(290, 40, 90, 23);

        TanggalPermintaan.setForeground(new java.awt.Color(50, 70, 50));
        TanggalPermintaan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "22-02-2025 15:55:48" }));
    ...
    if(NoRw.getText().trim().equals("") || NoRM.getText().trim().equals("") || NmPasien.getText().trim().equals("")){
        ...
        if(Sequel.menyimpantf("konsultasi_medik","?,?,?,?,?,?,?,?","No.Permintaan",8,new String[]{
            ...
            Permintaan.getSelectedItem().toString(),KdDokter.getText(),KdDokterDikonsuli.getText(),DiagnosaKerja.getText(),Valid.KarakterHaram(UraianKonsultasi.getText())
        }) == true){
            // Tambahkan pengecekan status_lanjut 'Ranap' di reg_periksa sebelum menyimpan ke dpjp_ranap
