...
public class DlgDokter extends javax.swing.JDialog {
    ...
    private DlgCariSpesialis spesial=new DlgCariSpesialis(null,true);
    ...
    private void initComponents() {
        ...
        CmbStts.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "MENIKAH", "BELUM MENIKAH", "JANDA", "DUDHA", "JOMBLO", "CERAI HIDUP", "CERAI MATI" }));
        ...
        if(TKd.getText().trim().equals("")){
            ...
            try { 
                ...
                Sequel.menyimpanignore("pegawai","'0','"+TKd.getText()+"','"+TNm.getText()+"','"+CmbJk.getSelectedItem().toString().replaceAll("PEREMPUAN","Wanita").replaceAll("LAKI-LAKI","Pria")+"',"+
                        "'-','-','-','-','-','-','-','-','-','-','-','0','"+TTmp.getText()+"','"+Valid.SetTgl(DTPLahir.getSelectedItem()+"")+"','"+TAlmt.getText()+"','-','1900-01-01','<1','-','T','-','AKTIF','0','0','0','1900-01-01','0','0','pages/pegawai/photo/','-','1900-01-01','1900-01-01','-','-'");        
