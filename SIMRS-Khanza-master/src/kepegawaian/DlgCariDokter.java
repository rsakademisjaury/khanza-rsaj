...
public final class DlgCariDokter extends javax.swing.JDialog {
    ...
    public DlgCariDokter(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"Kode Dokter","Nama Dokter","J.K.","Tmp.Lahir","Tgl.Lahir","G.D.","Agama","Alamat Tinggal","No.HP/Telp","Stts.Nikah","Spesialis","Alumni","No.Ijin Praktek","NIK/No.KTP"};
    ...
    private void tampil() {
        ...
        try {
            ...
            ps=koneksi.prepareStatement(
                ...
                "dokter.stts_nikah,spesialis.nm_sps,dokter.alumni,dokter.no_ijn_praktek,pegawai.no_ktp  "+
                "from pegawai, dokter inner join spesialis on dokter.kd_sps=spesialis.kd_sps "+
                "where dokter.status='1' and pegawai.nik=dokter.kd_dokter  order by dokter.nm_dokter");
            try{
                rs=ps.executeQuery();
                while(rs.next()){
