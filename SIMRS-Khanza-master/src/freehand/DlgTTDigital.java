 ...
 * @author perpustakaan
 */
public class DlgTTDigital extends javax.swing.JDialog {

    private Connection koneksi = koneksiDB.condb();
    private sekuel Sequel = new sekuel();
    private String username = "",kodeberkas="",FileName="";
     ...
     * @param modal
     */
    public DlgTTDigital(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), ".:[ Tanda Tangan Digital ]:.", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(70, 70, 70))); // NOI18N
        internalFrame1.setName("internalFrame1"); // NOI18N
        internalFrame1.setPreferredSize(new java.awt.Dimension(824, 379));
        ...
        jLabel5.setBounds(50, 170, 27, 16);
        ...
        FormInput.add(TPath);
        TPath.setBounds(400, 170, 235, 24);

        jLabel4.setText("Nama File:");
        jLabel4.setName("jLabel4"); // NOI18N
        FormInput.add(jLabel4);
        jLabel4.setBounds(50, 170, 56, 16);
        ...
        FormInput.add(TFile);
        TFile.setBounds(160, 170, 235, 24);
        ...
        panelGlass8.setLayout(flowLayout1);
        ...
        panelGlass9.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(204, 204, 204), 1, true));
        panelGlass9.setName("panelGlass9"); // NOI18N
        panelGlass9.setPreferredSize(new java.awt.Dimension(300, 200));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        try {
            ...
            String fileName = "ttdigital" + TNoRW.getText().replaceAll("/", "") + ".jpg";
            String filePath = "tmpImageFreehand/" + fileName;
            ...
            Logger.getLogger(DlgTTDigital.class.getName()).log(Level.SEVERE, null, ex);
...
//
//        // Upload gambar
//        uploadImage(FileName, "imagefreehand/rehabmedik/pertama/");
//
//        // Tutup dialog
//        dispose();
//    } catch (AWTException | IOException ex) {
...
//    }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgTTDigital dialog = new DlgTTDigital(new javax.swing.JFrame(), true);
...
private void uploadImage(String FileName) {
    String docpath = "imagefreehand/resume/";
    ...
    try {
        ...
        reqEntity.addPart("file", new ByteArrayBody(data, FileName));
        ...
        if (statusCode == 200) {
            ...
            String tanggal = Sequel.cariIsi("SELECT CURRENT_DATE");
            String jam = Sequel.cariIsi("SELECT CURRENT_TIME");

            boolean berhasil = Sequel.menyimpantf("rehab_kunjunganpertama_image", "?,?,?,?", "Upload Image", 4, new String[]{
                noRawat, tanggal, jam, filePath
            });

            if (berhasil) {
                System.out.println("Upload berhasil dan disimpan di database: " + filePath);
            } else {
                System.err.println("Upload berhasil tetapi gagal disimpan di database: " + filePath);
            }
        } else {
            System.err.println("Gagal mengunggah file. Kode status: " + statusCode);
        }
        ...
        System.err.println("Kesalahan saat mengunggah gambar: " + e.getMessage());
    }
}

private void deleteFile(File file) {
    if (file.delete()) {
        System.out.println("File sementara berhasil dihapus: " + file.getAbsolutePath());
    } else {
        System.err.println("Gagal menghapus file sementara: " + file.getAbsolutePath());
    }
}    
    
//    private void uploadImage(String FileName, String docpath) {
//       try {
//            docpath = "imagefreehand/rehabmedik/pertama/";
//            File file = new File("tmpImageFreehand/" + FileName);
...
//                kodeberkas = Sequel.cariIsi("SELECT no_rawat FROM rehab_kunjunganpertama_image WHERE no_rawat=?",TNoRW.getText());
//                String filePath = "imagefreehand/rehabmedik/pertama/" + FileName;
//
...
//                } else {
//                    System.err.println("Upload gagal disimpan ke database: " + FileName);
//                }
//            } finally {
