...
public final class DlgLhtPiutang extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnAll.setPreferredSize(new java.awt.Dimension(85, 23));
        ...
        panelisi4.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        label11.setText("Tgl.Piutang :");
        label11.setName("label11"); // NOI18N
        label11.setPreferredSize(new java.awt.Dimension(80, 23));
        panelisi4.add(label11, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, -1, -1));

        Tgl1.setDisplayFormat("dd-MM-yyyy");
        Tgl1.setName("Tgl1"); // NOI18N
        Tgl1.setPreferredSize(new java.awt.Dimension(100, 23));
        panelisi4.add(Tgl1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 10, -1, -1));

        label18.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        label18.setText("s.d.");
        label18.setName("label18"); // NOI18N
        label18.setPreferredSize(new java.awt.Dimension(30, 23));
        panelisi4.add(label18, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 10, -1, -1));

        Tgl2.setDisplayFormat("dd-MM-yyyy");
        Tgl2.setName("Tgl2"); // NOI18N
        Tgl2.setPreferredSize(new java.awt.Dimension(100, 23));
        panelisi4.add(Tgl2, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 10, -1, -1));

        label19.setText("Cara Bayar :");
        label19.setName("label19"); // NOI18N
        label19.setPreferredSize(new java.awt.Dimension(85, 23));
        panelisi4.add(label19, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 10, -1, -1));

        kdpenjab.setName("kdpenjab"); // NOI18N
        kdpenjab.setPreferredSize(new java.awt.Dimension(83, 23));
        kdpenjab.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                kdpenjabKeyPressed(evt);
            }
        });
        panelisi4.add(kdpenjab, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 10, -1, -1));

        nmpenjab.setEditable(false);
        nmpenjab.setName("nmpenjab"); // NOI18N
        nmpenjab.setPreferredSize(new java.awt.Dimension(295, 23));
        panelisi4.add(nmpenjab, new org.netbeans.lib.awtextra.AbsoluteConstraints(505, 10, 300, -1));
        ...
        panelisi4.add(BtnSeek2, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 10, -1, -1));
