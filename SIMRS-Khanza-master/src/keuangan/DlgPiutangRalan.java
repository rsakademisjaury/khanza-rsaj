...
public final class DlgPiutangRalan extends javax.swing.JDialog {
    ...
    public DlgPiutangRalan(java.awt.Frame parent, boolean modal) {
        ...
        Object[] rowRwJlDr={"Tanggal","No.Nota","No.SEP","No.RM","Nama Pasien",
                            "Registrasi","Obat+Emb+Tsl","Konsul","Tindakan","Operasi",
            ...
            try {            
                ...
                switch (pilihan) {
                                            ...
                                            "<table width='1900px' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"+
                                                "<tr class='isi2'>"+
                                                    "<td valign='top' align='center'>"+
                                                        ...
                                                        akses.getalamatrs()+", "+akses.getkabupatenrs()+", "+akses.getpropinsirs()+"<br>"+
                                                        akses.getkontakrs()+", E-mail : "+akses.getemailrs()+"<br><br>"+
                                                        "<font size='2' face='Tahoma'>DETAIL JM DOKTER PERIODE "+NmPoli.getText()+"   "+Tgl1.getSelectedItem()+" s.d. "+Tgl2.getSelectedItem()+"<br><br></font>"+        
                                                    "</td>"+
                                               "</tr>"+
                                            "</table>"+
                                            "<table width='1900px' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"+
                    ...
                    case "Laporan 3 (CSV)":
                            htmlContent = new StringBuilder();
                            htmlContent.append(                             
                                "\"Tanggal\";\"No.Nota\";\"No.SEP\";\"No.RM\";\"Nama Pasien\";\"Jenis Bayar\";\"Registrasi\";\"Obat+Emb+Tsl\";\"Paket Tindakan\";\"Operasi\";\"Laborat\";\"Radiologi\";\"Tambahan\";\"Potongan\";\"Total\";\"Ekses\";\"Sudah Dibayar\";\"Sisa\";\"Dokter\";\"\n"
                            ); 
                            for(i=0;i<tabMode.getRowCount();i++){  
                                htmlContent.append(                             
    ...
    public void tampil(){
        ...
        try{    
            ...
            ps= koneksi.prepareStatement("select reg_periksa.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,reg_periksa.tgl_registrasi,dokter.nm_dokter,penjab.png_jawab, "+
                        "piutang_pasien.uangmuka,piutang_pasien.totalpiutang,bridging_sep.no_sep "+
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    tabMode.addRow(new Object[] {
                        ...
                        rs.getString("no_sep"),rs.getString("no_rkm_medis"),rs.getString("nm_pasien"),
//                        rs.getString("png_jawab"),
//                        Sequel.cariIsi("select perujuk from rujuk_masuk where no_rawat=?",
//                        rs.getString("no_rawat"),
                        Valid.SetAngka(Registrasi),Valid.SetAngka(Obat),Valid.SetAngka(Ralan_Dokter),Valid.SetAngka(Ralan_Paramedis+Ralan_Dokter_paramedis),
                ...
                if(tabMode.getRowCount()>0){
                    tabMode.addRow(new Object[] {
                            ">> Total",":","","","",Valid.SetAngka(ttlRegistrasi),Valid.SetAngka(ttlObat),Valid.SetAngka(ttlRalan_Dokter),Valid.SetAngka(ttlRalan_Paramedis),
