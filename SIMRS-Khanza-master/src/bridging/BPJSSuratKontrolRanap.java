 ...
 * @author dosen
 */
public class BPJSSuratKontrolRanap extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public BPJSSuratKontrolRanap(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        try {
            ...
            JADIKANBOOKINGSURATKONTROLAPIBPJS="no";
                ...
                // Contoh jika Anda ingin memeriksa saat pengguna memilih item di tabel
        tbObat.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                if (tbObat.getSelectedRow() != -1) { // Cek apakah ada baris yang dipilih
                    if (Sequel.cariIsi(
                        "SELECT keterangan_kontrol FROM keterangan_kontrol_bpjs WHERE keterangan_kontrol = '' AND no_rawat = ?", 
                        tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString()
                    ) != null) {         
                        BtnSimpanAlasan.setVisible(true); // Menampilkan button
                    } else {
                        BtnSimpanAlasan.setVisible(false); // Menyembunyikan button
                    }
                }
            }
        });
    ...
    private void initComponents() {
        ...
        DTPTanggalSurat1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "12-11-2024" }));
        ...
        DTPTanggalSurat2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "12-11-2024" }));
        ...
        DTPTanggalKontrol1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "12-11-2024" }));
        ...
        DTPTanggalKontrol2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "12-11-2024" }));
        ...
        TanggalSurat.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "12-11-2024" }));
        ...
        jLabel14.setBounds(491, 70, 140, 23);

        TanggalKontrol.setForeground(new java.awt.Color(50, 70, 50));
        TanggalKontrol.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "12-11-2024 13:48:10" }));
        ...
        TanggalKontrol.setBounds(637, 70, 90, 23);
        ...
        BtnCari1.setBounds(740, 90, 100, 40);

        jLabel18.setText("Alasan Kontrol :");
        jLabel18.setName("jLabel18"); // NOI18N
        FormInput.add(jLabel18);
        jLabel18.setBounds(0, 130, 91, 23);

        KeteranganKontrol.setHighlighter(null);
        KeteranganKontrol.setName("KeteranganKontrol"); // NOI18N
        FormInput.add(KeteranganKontrol);
        KeteranganKontrol.setBounds(94, 130, 602, 26);
        ...
        BtnSimpanAlasan.setBounds(700, 130, 120, 26);
            ...
            try {
                ...
                if (nameNode.path("code").asText().equals("200")) {
                    if (Sequel.mengedittf("bridging_surat_kontrol_bpjs", "no_surat=?", 
                        ...
                        // Perbarui keterangan kontrol di tabel "keterangan_kontrol_bpjs"
                        Sequel.mengedittf("keterangan_kontrol_bpjs", "?,?,?,NOW()", "Keterangan Kontrol", 4, new String[]{
                        NoRawat.getText(), KeteranganKontrol.getText(), akses.getkode()
                    });
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            BPJSSuratKontrolRanap dialog = new BPJSSuratKontrolRanap(new javax.swing.JFrame(), true);
    ...
    // Menambahkan pengecekan status_lanjut
    String statusLanjut = Sequel.cariIsi("select status_lanjut from reg_periksa where no_rawat=?", NoRawat.getText());
    if (statusLanjut.equals("Ranap")) {
        NoSEP.setText(Sequel.cariIsi("select no_sep from bridging_sep where jnspelayanan='2' and no_rawat=?", NoRawat.getText()));
    } else if (statusLanjut.equals("Ralan")) {
        NoSEP.setText(Sequel.cariIsi("select no_sep from bridging_sep where jnspelayanan='1' and no_rawat=?", NoRawat.getText()));
    }
    ...
    // Menggunakan query yang sesuai untuk TCari
    if (statusLanjut.equals("Ranap")) {
        TCari.setText(Sequel.cariIsi("select no_sep from bridging_sep where jnspelayanan='2' and no_rawat=?", NoRawat.getText()));
    } else if (statusLanjut.equals("Ralan")) {
        TCari.setText(Sequel.cariIsi("select no_sep from bridging_sep where jnspelayanan='1' and no_rawat=?", NoRawat.getText()));
    }
