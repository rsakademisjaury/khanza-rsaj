 ...
 * @author perpustakaan
 */
public class DlgDiagnosaPenyakitSoap extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgDiagnosaPenyakitSoap(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "07-12-2022" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "07-12-2022" }));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgDiagnosaPenyakitSoap dialog = new DlgDiagnosaPenyakitSoap(new javax.swing.JFrame(), true);
    ...
    public void setNoRw(String norw,String norm, String Nama){
        TNoRw.setText(norw);
        Valid.SetTgl(DTPCari1,Sequel.cariIsi("select tgl_registrasi from reg_periksa where reg_periksa.no_rawat='"+norw+"' "));
//     
        TNoRM.setText(norm);
