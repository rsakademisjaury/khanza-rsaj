...
public class DlgBulananHAIs extends javax.swing.JDialog {
    ...
    private int i=0,deku=0,urine=0,sputum=0,darah=0,antibiotik=0,nm_ruangan=0,jmlnm_ruangan=0,ETT=0,CVL=0,IVL=0,UC=0,VAP=0,IAD=0,PLEB=0,
        ...
        try {
            ...
            htmlContent.append(                             
                "<tr class='isi'>"+
                    ...
                    "<td valign='middle' bgcolor='#FFFAFA' align='center' width='5%' rowspan='2'>Ruangan</td>"+
            ...
            ps=koneksi.prepareStatement(
                    "select data_HAIs.tanggal from data_HAIs where tanggal between ? and ? group by tanggal order by tanggal");
//            "select data_HAIs.tanggal from data_HAIs where tanggal between ? and ?  group by tanggal order by tanggal");
            try {
                i=1;
                jmlETT=0;jmlCVL=0;jmlIVL=0;jmlUC=0;jmlVAP=0;jmlIAD=0;jmlPLEB=0;
                jmlnm_ruangan=0;jmlISK=0;jmlILO=0;jmldeku=0;jmlsputum=0;jmldarah=0;
...
//                ps.setString(4);
                rs=ps.executeQuery();
                while(rs.next()){
                    nm_ruangan=Sequel.cariInteger("select count(data_HAIs.nm_ruangan) from data_HAIs where data_HAIs.tanggal=?",rs.getString("tanggal"),"%"+NmKamar.getText().trim()+"%");
                    jmlnm_ruangan=jmlnm_ruangan+nm_ruangan;
                    ETT=Sequel.cariInteger("select sum(data_HAIs.ETT) from data_HAIs where data_HAIs.tanggal=?",rs.getString("tanggal"),"%"+NmKamar.getText().trim()+"%");
                    jmlETT=jmlETT+ETT;
                    CVL=Sequel.cariInteger("select sum(data_HAIs.CVL) from data_HAIs where data_HAIs.tanggal=?",rs.getString("tanggal"),"%"+NmKamar.getText().trim()+"%");
                    jmlCVL=jmlCVL+CVL;
                    IVL=Sequel.cariInteger("select sum(data_HAIs.IVL) from data_HAIs where data_HAIs.tanggal=?",rs.getString("tanggal"),"%"+NmKamar.getText().trim()+"%");
                    jmlIVL=jmlIVL+IVL;
                    UC=Sequel.cariInteger("select sum(data_HAIs.UC) from data_HAIs where data_HAIs.tanggal=?",rs.getString("tanggal"),"%"+NmKamar.getText().trim()+"%");
                    jmlUC=jmlUC+UC;
                    VAP=Sequel.cariInteger("select sum(data_HAIs.VAP) from data_HAIs where data_HAIs.tanggal=?",rs.getString("tanggal"),"%"+NmKamar.getText().trim()+"%");
                    jmlVAP=jmlVAP+VAP;
                    IAD=Sequel.cariInteger("select sum(data_HAIs.IAD) from data_HAIs where data_HAIs.tanggal=?",rs.getString("tanggal"),"%"+NmKamar.getText().trim()+"%");
                    jmlIAD=jmlIAD+IAD;
                    PLEB=Sequel.cariInteger("select sum(data_HAIs.PLEB) from data_HAIs where data_HAIs.tanggal=?",rs.getString("tanggal"),"%"+NmKamar.getText().trim()+"%");
                    jmlPLEB=jmlPLEB+PLEB;
                    ISK=Sequel.cariInteger("select sum(data_HAIs.ISK) from data_HAIs where data_HAIs.tanggal=?",rs.getString("tanggal"),"%"+NmKamar.getText().trim()+"%");
                    jmlISK=jmlISK+ISK;
                    ILO=Sequel.cariInteger("select sum(data_HAIs.ILO) from data_HAIs where data_HAIs.tanggal=?",rs.getString("tanggal"),"%"+NmKamar.getText().trim()+"%");
                    jmlILO=jmlILO+ILO;
                    HAP=Sequel.cariInteger("select sum(data_HAIs.HAP) from data_HAIs where data_HAIs.tanggal=?",rs.getString("tanggal"),"%"+NmKamar.getText().trim()+"%");
                    jmlHAP=jmlHAP+HAP;
                    Tinea=Sequel.cariInteger("select sum(data_HAIs.Tinea) from data_HAIs where data_HAIs.tanggal=?",rs.getString("tanggal"),"%"+NmKamar.getText().trim()+"%");
                    jmlTinea=jmlTinea+Tinea;
                    Scabies=Sequel.cariInteger("select sum(data_HAIs.Scabies) from data_HAIs where data_HAIs.tanggal=?",rs.getString("tanggal"),"%"+NmKamar.getText().trim()+"%");
                    jmlScabies=jmlScabies+Scabies;
                    deku=Sequel.cariInteger("select count(data_HAIs.no_rawat) from data_HAIs where data_HAIs.DEKU='IYA' and tanggal=?",rs.getString("tanggal"),"%"+NmKamar.getText().trim()+"%");
                    jmldeku=jmldeku+deku;
                    sputum=Sequel.cariInteger("select count(data_HAIs.no_rawat) from data_HAIs where data_HAIs.SPUTUM<>'' and tanggal=?",rs.getString("tanggal"),"%"+NmKamar.getText().trim()+"%");
                    jmlsputum=jmlsputum+sputum;
                    darah=Sequel.cariInteger("select count(data_HAIs.no_rawat) from data_HAIs where data_HAIs.DARAH<>'' and tanggal=?",rs.getString("tanggal"),"%"+NmKamar.getText().trim()+"%");
                    jmldarah=jmldarah+darah;
                    urine=Sequel.cariInteger("select count(data_HAIs.no_rawat) from data_HAIs where data_HAIs.URINE<>'' and tanggal=?",rs.getString("tanggal"),"%"+NmKamar.getText().trim()+"%");
                    jmlurine=jmlurine+urine;
                    ANTIBIOTIK=Sequel.cariInteger("select count(data_HAIs.no_rawat) from data_HAIs where data_HAIs.ANTIBIOTIK<>'' and tanggal=?",rs.getString("tanggal"),"%"+NmKamar.getText().trim()+"%");
                    jmlANTIBIOTIK=jmlANTIBIOTIK+ANTIBIOTIK;
                    htmlContent.append(                             
                        "<tr class='isi'>"+
                            "<td valign='middle' align='center'>"+i+"</td>"+
                            "<td valign='middle' align='center'>"+rs.getString("tanggal")+"</td>"+
                            "<td valign='middle' align='center'>"+nm_ruangan+"</td>"+
                ...
                htmlContent.append(                             
                    "<tr class='isi'>"+
                        ...
                        "<td valign='middle' align='center'>"+jmlnm_ruangan+"</td>"+
