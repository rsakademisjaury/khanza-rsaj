...
private void prosesCari() {
    ...
    try {
        ...
        htmlContent.append("<tr class='head'>"
            ...
            + "<td rowspan='2' bgcolor='#F7F7F7' width='8%' align='center'>Kode ICD-10</td>"
            + "<td rowspan='2' bgcolor='#F7F7F7' align='center'>Diagnosis Penyakit</td>"
        ...
        String queryBaru = "SELECT dp.kd_penyakit, SUBSTRING(pyk.nm_penyakit,1,80) AS nm_penyakit, " +
                           "p.jk FROM diagnosa_pasien dp " +
        ...
        System.out.println("Notifikasi prosesCariRL52: " + e);
    }
    this.setCursor(Cursor.getDefaultCursor());
}
