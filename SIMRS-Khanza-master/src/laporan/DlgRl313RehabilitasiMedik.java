...
//                        "where reg_periksa.kd_poli=? and reg_periksa.tgl_registrasi between ? and ? and jns_perawatan.nm_perawatan like ? group by jns_perawatan.nm_perawatan ");
            ...
            pstindakan = koneksi.prepareStatement(
                        "SELECT nm_perawatan, COUNT(*) AS jumlah " +
                        "FROM ( " +
                        "    SELECT jns_perawatan.nm_perawatan, reg_periksa.no_rawat " +
                        "    FROM reg_periksa " +
                        ...
                        "    AND jns_perawatan.nm_perawatan NOT LIKE '%konsul%' " +
                        "    AND jns_perawatan.nm_perawatan NOT LIKE '%Konsultasi%' " +
                    ...
                    try{
                        ...
                        pstindakan.setString(5, rs.getString("kd_poli"));
                        pstindakan.setString(6, Valid.SetTgl(Tgl1.getSelectedItem() + ""));
                        pstindakan.setString(7, Valid.SetTgl(Tgl2.getSelectedItem() + ""));
                        pstindakan.setString(8, "%" + TCari.getText().trim() + "%");
...
//                        }
                        ...
                        while(rstindakan.next()){
//                            System.out.println("Jenis Perawatan: " + rstindakan.getString(1) + ", Jumlah: " + rstindakan.getInt(2));
                            String namaPerawatan = rstindakan.getString(1);
                            int jumlah = rstindakan.getInt(2);

                            // Hanya tambahkan jika nama perawatan tidak null atau kosong
                            if(namaPerawatan != null && !namaPerawatan.trim().isEmpty()) {
                                tabMode.addRow(new Object[]{
                                    i, namaPerawatan, jumlah
                                });
                                ttl += jumlah;
                                i++;
                            }
