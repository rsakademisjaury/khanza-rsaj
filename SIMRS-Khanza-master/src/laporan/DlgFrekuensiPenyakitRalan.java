...
public class DlgFrekuensiPenyakitRalan extends javax.swing.JDialog {
    ...
    public DlgFrekuensiPenyakitRalan(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"Kode", "Nama Penyakit", "Diagnosa Lain","Lama (L)","Lama (P)","Baru (L)","Baru (P)","Lk2(Hidup)","Pr(Hidup)","Lk2(Mati)","Pr(Mati)","Jumlah"};
        tabMode = new DefaultTableModel(null, row) {
            @Override
            public boolean isCellEditable(int rowIndex, int colIndex) {
                return false; // Mengatur agar sel tidak bisa di-edit
            }

            Class[] types = new Class[] {
                java.lang.Object.class,   // Kode
                java.lang.Object.class,   // Nama Penyakit
                java.lang.Object.class,   // Diagnosa Lain    
                java.lang.Integer.class,  // Lama
                java.lang.Integer.class,  // Baru
                java.lang.Integer.class,  // Lama
                java.lang.Integer.class,  // Baru
                java.lang.Integer.class,  // Lk2(Hidup)
                java.lang.Integer.class,  // Pr(Hidup)
                java.lang.Integer.class,  // Lk2(Mati)
                java.lang.Integer.class,  // Pr(Mati)
                java.lang.Integer.class   // Jumlah
               
            };

            @Override
            public Class getColumnClass(int columnIndex) {
                return types[columnIndex]; // Mengambil tipe kolom sesuai indeks
            }
        };
        ...
        for (int m = 0; m < 12; m++) {
            ...
            if (m == 0) {
                column.setPreferredWidth(60);  // Kode
            } else if (m == 1) {
                column.setPreferredWidth(350); // Nama Penyakit
            } else if (m == 2) {
                column.setPreferredWidth(400); // Diagnosa Lain
            } else {
                column.setPreferredWidth(60);  // Kolom lainnya
            }
        }
    ...
    private int i=0,a=0,b=0,c=0,d=0,e=0,f=0,g=0,h=0;
    ...
    private void tampil() {
        ...
        try{ 
            ps=koneksi.prepareStatement(
                ...
                "(penyakit.kd_penyakit like ? or penyakit.nm_penyakit like ?) group by penyakit.kd_penyakit");
            try {
                ...
                while(rs.next()){
                    ...
                    // Inisialisasi dan penggunaan ps8 untuk pasien Lama
                    e=0;  // Pasien Lama
                    f=0;  // Pasien Baru

                    ps8 = koneksi.prepareStatement("select diagnosa_pasien.no_rawat as jumlah " +
                        "from penyakit inner join diagnosa_pasien " +
                        "inner join reg_periksa inner join dokter inner join pasien inner join poliklinik inner join penjab " +
                        ...
                        "and reg_periksa.tgl_registrasi between ? and ? and poliklinik.nm_poli like ? and dokter.nm_dokter like ? " +
                        "and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? " +
                        "and diagnosa_pasien.kd_penyakit=? and reg_periksa.stts_daftar='Lama' group by diagnosa_pasien.no_rawat ");

                    try {
                        ps8.setString(1, Valid.SetTgl(Tgl1.getSelectedItem() + ""));
                        ps8.setString(2, Valid.SetTgl(Tgl2.getSelectedItem() + ""));
                        ps8.setString(3, "%" + nmpoli.getText().trim() + "%");
                        ps8.setString(4, "%" + nmdokter.getText().trim() + "%");
                        ps8.setString(5, "%" + nmpenjab.getText().trim() + "%");
                        ps8.setString(6, "%" + nmkabupaten.getText().trim() + "%");
                        ps8.setString(7, "%" + nmkecamatan.getText().trim() + "%");
                        ps8.setString(8, "%" + nmkelurahan.getText().trim() + "%");
                        ps8.setString(9, rs.getString("kd_penyakit"));
                        rs8=ps8.executeQuery();
                        rs8.last();
                        if(rs8.getRow()>0) e=rs8.getRow();
                    } catch (Exception e) {
                        System.out.println("Notif ps8 : "+e);
                    } finally{
                        if(rs8!=null){
                    ...
                    // Inisialisasi dan penggunaan ps9 untuk pasien Baru
                    ps9 = koneksi.prepareStatement("select diagnosa_pasien.no_rawat as jumlah " +
                        "from penyakit inner join diagnosa_pasien " +
                        "inner join reg_periksa inner join dokter inner join pasien inner join poliklinik inner join penjab " +
                        "inner join kabupaten inner join kecamatan inner join kelurahan " +
                        "on penyakit.kd_penyakit=diagnosa_pasien.kd_penyakit and reg_periksa.no_rawat=diagnosa_pasien.no_rawat and reg_periksa.kd_dokter=dokter.kd_dokter " +
                    ...
                    try {
                        ...
                        ps9.setString(3, "%" + nmpoli.getText().trim() + "%");
                        ps9.setString(4, "%" + nmdokter.getText().trim() + "%");
                        ps9.setString(5, "%" + nmpenjab.getText().trim() + "%");
                        ps9.setString(6, "%" + nmkabupaten.getText().trim() + "%");
                        ps9.setString(7, "%" + nmkecamatan.getText().trim() + "%");
                        ps9.setString(8, "%" + nmkelurahan.getText().trim() + "%");
                        ps9.setString(9, rs.getString("kd_penyakit"));
                        rs9=ps9.executeQuery();
                        rs9.last();
                        if(rs9.getRow()>0) f=rs9.getRow();
                    } catch (Exception e) {
                        System.out.println("Notif ps9 : "+e);
                    } finally{
                        if(rs9!=null){
                            rs9.close();
                        }
                    ...
                    ps10 = koneksi.prepareStatement("select diagnosa_pasien.no_rawat as jumlah " +
                        "from penyakit inner join diagnosa_pasien " +
                        "inner join reg_periksa inner join dokter inner join pasien inner join poliklinik inner join penjab " +
                        "inner join kabupaten inner join kecamatan inner join kelurahan " +
                        "on penyakit.kd_penyakit=diagnosa_pasien.kd_penyakit and reg_periksa.no_rawat=diagnosa_pasien.no_rawat and reg_periksa.kd_dokter=dokter.kd_dokter " +
                        ...
                        "and reg_periksa.tgl_registrasi between ? and ? and poliklinik.nm_poli like ? and dokter.nm_dokter like ? " +
                        "and penjab.png_jawab like ? and kabupaten.nm_kab like ? and kecamatan.nm_kec like ? and kelurahan.nm_kel like ? " +
                        "and diagnosa_pasien.kd_penyakit=? and reg_periksa.stts_daftar='Baru' group by diagnosa_pasien.no_rawat ");

                    try {
                        ps10.setString(1, Valid.SetTgl(Tgl1.getSelectedItem() + ""));
                        ps10.setString(2, Valid.SetTgl(Tgl2.getSelectedItem() + ""));
                        ps10.setString(3, "%" + nmpoli.getText().trim() + "%");
                        ps10.setString(4, "%" + nmdokter.getText().trim() + "%");
                        ps10.setString(5, "%" + nmpenjab.getText().trim() + "%");
                        ps10.setString(6, "%" + nmkabupaten.getText().trim() + "%");
                        ps10.setString(7, "%" + nmkecamatan.getText().trim() + "%");
                        ps10.setString(8, "%" + nmkelurahan.getText().trim() + "%");
                        ps10.setString(9, rs.getString("kd_penyakit"));
                        rs10=ps10.executeQuery();
                        rs10.last();
                        if(rs10.getRow()>0) g=rs10.getRow();
                    } catch (Exception e) {
                        System.out.println("Notif ps10 : "+e);
                    } finally{
                        if(rs10!=null){
                            rs10.close();
                        }
                    ...
                    // Inisialisasi dan penggunaan ps9 untuk pasien Baru
                    ps11 = koneksi.prepareStatement("select diagnosa_pasien.no_rawat as jumlah " +
                        "from penyakit inner join diagnosa_pasien " +
                        "inner join reg_periksa inner join dokter inner join pasien inner join poliklinik inner join penjab " +
                        "inner join kabupaten inner join kecamatan inner join kelurahan " +
                        "on penyakit.kd_penyakit=diagnosa_pasien.kd_penyakit and reg_periksa.no_rawat=diagnosa_pasien.no_rawat and reg_periksa.kd_dokter=dokter.kd_dokter " +
                    ...
                    try {
                        ps11.setString(1, Valid.SetTgl(Tgl1.getSelectedItem() + ""));
                        ps11.setString(2, Valid.SetTgl(Tgl2.getSelectedItem() + ""));
                        ps11.setString(3, "%" + nmpoli.getText().trim() + "%");
                        ps11.setString(4, "%" + nmdokter.getText().trim() + "%");
                        ps11.setString(5, "%" + nmpenjab.getText().trim() + "%");
                        ps11.setString(6, "%" + nmkabupaten.getText().trim() + "%");
                        ps11.setString(7, "%" + nmkecamatan.getText().trim() + "%");
                        ps11.setString(8, "%" + nmkelurahan.getText().trim() + "%");
                        ps11.setString(9, rs.getString("kd_penyakit"));
                        rs11=ps11.executeQuery();
                        rs11.last();
                        if(rs11.getRow()>0) h=rs11.getRow();
                    } catch (Exception e) {
                        System.out.println("Notif ps11 : "+e);
                    } finally{
                        if(rs11!=null){
                            rs11.close();
                        }
                    ...
                    // Menambahkan baris pada tabMode dengan hasil jumlah pasien Lama dan Baru
                    tabMode.addRow(new Object[]{rs.getString("kd_penyakit"), rs.getString("penyakit"), diagnosa, e,f,g,h,c,d,a,b,i});
