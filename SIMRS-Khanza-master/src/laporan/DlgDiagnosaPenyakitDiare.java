 ...
 * @author perpustakaan
 */
public class DlgDiagnosaPenyakitDiare extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgDiagnosaPenyakitDiare(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgDiagnosaPenyakitDiare dialog = new DlgDiagnosaPenyakitDiare(new javax.swing.JFrame(), true);
