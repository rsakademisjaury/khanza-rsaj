 ...
 * @author perpustakaan
 */
public final class EOWSRanap extends javax.swing.JDialog {
...
//    private SimpleDateFormat tanggalNow = new SimpleDateFormat("dd-MM-yyyy");
     ...
     * @param parent
     * @param modal */
    public EOWSRanap(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        isMenu();
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("eows_ranap","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",29,new String[]{
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(tbObat.getSelectedRow()>-1){
            if(Sequel.queryu2tf("delete from eows_ranap where jam=?",1,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            EOWSRanap dialog = new EOWSRanap(new javax.swing.JFrame(), true);
    ...
    public void tampil() {
        ...
        try{
            if(TCari.getText().equals("")){
                ps=koneksi.prepareStatement(
                         "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,eows_ranap.tanggal,eows_ranap.jam,eows_ranap.nik,pegawai.nama,"+
                        "eows_ranap.pernafasan,eows_ranap.score_pernafasan,eows_ranap.saturasi,eows_ranap.score_saturasi,eows_ranap.cairan,eows_ranap.score_cairan,eows_ranap.suhu,eows_ranap.score_suhu,"+
                        "eows_ranap.denyut,eows_ranap.score_denyut,eows_ranap.tekanan,eows_ranap.score_tekanan1,eows_ranap.tekanan1,eows_ranap.score_tekanan,eows_ranap.kesadaran,eows_ranap.score_kesadaran,eows_ranap.discharge,eows_ranap.score_discharge,eows_ranap.proteinuria,eows_ranap.score_proteinuria,"+
                        "eows_ranap.total_score,eows_ranap.klasifikasi,eows_ranap.respon,eows_ranap.tindakan,eows_ranap.frekuensi "+
                        "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        "inner join eows_ranap on reg_periksa.no_rawat=eows_ranap.no_rawat "+
                        "inner join pegawai on eows_ranap.nik=pegawai.nik "+
                        "inner join bahasa_pasien on bahasa_pasien.id=pasien.bahasa_pasien "+
                        "inner join cacat_fisik on cacat_fisik.id=pasien.cacat_fisik where "+
                        "eows_ranap.tanggal between ? and ? order by eows_ranap.tanggal");
            }else{
                ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,eows_ranap.tanggal,eows_ranap.jam,eows_ranap.nik,pegawai.nama,"+
                        "eows_ranap.pernafasan,eows_ranap.score_pernafasan,eows_ranap.saturasi,eows_ranap.score_saturasi,eows_ranap.cairan,eows_ranap.score_cairan,eows_ranap.suhu,eows_ranap.score_suhu,"+
                        ...
                        "inner join bahasa_pasien on bahasa_pasien.id=pasien.bahasa_pasien "+
                        "inner join cacat_fisik on cacat_fisik.id=pasien.cacat_fisik where "+
                        "eows_ranap.tanggal between ? and ? and reg_periksa.no_rawat like ? or "+
                        "eows_ranap.tanggal between ? and ? and pasien.no_rkm_medis like ? or "+
                        "eows_ranap.tanggal between ? and ? and pasien.nm_pasien like ? or "+
                        "eows_ranap.tanggal between ? and ? and eows_ranap.nik like ? or "+
                        "eows_ranap.tanggal between ? and ? and pegawai.nama like ? order by eows_ranap.tanggal");
            }
