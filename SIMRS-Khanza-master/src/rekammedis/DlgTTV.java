...
public class DlgTTV extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgTTV(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
         setSize(1285,674);
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Vital Sign (TTV) Pasien ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgTTV dialog = new DlgTTV(new javax.swing.JFrame(), true);
        ...
        try {
            ...
            htmlContent.append(                             
                "<tr class='isi'>"+
                    ...
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='66%'>Vital Sign (TTV)</td>"+
                "</tr>"
            );     
            ps=koneksi.prepareStatement(
                ...
                "reg_periksa.status_lanjut from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis where reg_periksa.no_rkm_medis='"+noRm+"' "+
                ...
                while(rs.next()){
                    ...
                    try {
                        rs2=koneksi.prepareStatement(
                                "select pemeriksaan_ralan.tgl_perawatan,pemeriksaan_ralan.jam_rawat,pemeriksaan_ralan.suhu_tubuh,"+
                                "pemeriksaan_ralan.tensi,pemeriksaan_ralan.nadi,pemeriksaan_ralan.respirasi,pemeriksaan_ralan.tinggi,pemeriksaan_ralan.berat,pemeriksaan_ralan.nip,pegawai.nama,departemen.nama "+
                        ...
                        if(rs2.next()){
                            htmlContent.append(
                                    "<tr class='isi'>"+
                                        ...
                                        "<td valign='middle' bgcolor='#FFFFF8' align='center' width='24%'>Tensi</td>"+
                                        "<td valign='middle' bgcolor='#FFFFF8' align='center' width='23%'>Nadi</td>"+
                                        "<td valign='middle' bgcolor='#FFFFF8' align='center' width='23%'>Respirasi</td>"+
                                        "<td valign='middle' bgcolor='#FFFFF8' align='center' width='23%'>Tinggi</td>"+
                                        "<td valign='middle' bgcolor='#FFFFF8' align='center' width='23%'>Berat</td>"+
                                    "</tr>");
                            rs2.beforeFirst();
                            while(rs2.next()){
...
//                                 System.out.println("Notif Rekening : "+rs2.getString("nik"));
                                //2021/04/18/000056
                                 htmlContent.append(                             
                                    "<tr class='isi'>"+
                                        ...
                                        "<td align='left' "+stylee+" >"+rs2.getString("suhu_tubuh")+" C</td>"+
                                        "<td align='left' "+stylee+">"+rs2.getString("tensi")+"</td>"+
                                        "<td align='left' "+stylee+">"+rs2.getString("nadi")+"</td>"+
                                        "<td align='left' "+stylee+">"+rs2.getString("respirasi")+"</td>"+
                                        "<td align='left' "+stylee+">"+rs2.getString("tinggi")+" Cm</td>"+
                                        "<td align='left' "+stylee+">"+rs2.getString("berat")+" Kg</td>"+
                                    "</tr>"
                                 ); 
                            } 
                        }       
                    ...
                    try {
                        rs2=koneksi.prepareStatement(
                                "select pemeriksaan_ranap.tgl_perawatan,pemeriksaan_ranap.jam_rawat,pemeriksaan_ranap.suhu_tubuh,"+
                                "pemeriksaan_ranap.tensi,pemeriksaan_ranap.nadi,pemeriksaan_ranap.respirasi,pemeriksaan_ranap.tinggi,pemeriksaan_ranap.berat,pemeriksaan_ranap.nip,pegawai.nama,departemen.nama "+
...
//                                 System.out.println("Notif Rekening : "+rs2.getString("nik"));
    ...
    public void setNoRawat(String x,String y, String NoRm)
    {
        this.noRawat=x;
        this.noRm=NoRm;
        TCari.setText(NoRm);
