...
public class DlgImplementasi extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgImplementasi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
         setSize(1285,674);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgImplementasi dialog = new DlgImplementasi(new javax.swing.JFrame(), true);
        ...
        try {
            ...
            htmlContent.append(                             
                "<tr class='isi'>"+
                    ...
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='66%'>Implementasi Keperawatan</td>"+
                "</tr>"
            );     
