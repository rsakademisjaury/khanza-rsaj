 ...
 * @author perpustakaan
 */
public final class EOWSRajal extends javax.swing.JDialog {
...
//    private SimpleDateFormat tanggalNow = new SimpleDateFormat("dd-MM-yyyy");
     ...
     * @param parent
     * @param modal */
    public EOWSRajal(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Score Saturasi Oksigen","Bau Cairan Ketuban","Score Bau Cairan Ketuban","Suhu","Score Suhu","Denyut Jantung","Score Denyut Jantung",
            "Tekanan Darah Sistolik","Score Tekanan Darah Sistolik","Tekanan Darah Distolik","Score Darah Distolik","Kesadaran","Score Kesadaran","Discharge","Score Discharge","Proteinuria","Score Proteinuria","Total Score",
            "Klasifikasi","Respon Klinis","Tindakan","Frekuensi Monitoring",
...
//        tbMasalahDetailMasalah.setDefaultRenderer(Object.class, new WarnaTable());
        ...
        Tekanan2.setDocument(new batasInput((byte)5).getKata(Tekanan2));
        ...
        pegawai.addWindowListener(new WindowListener() {
            ...
            @Override
            public void windowClosed(WindowEvent e) {
                if(akses.getform().equals("EOWSRajal")){
...
//        isMenu();
    ...
    private void initComponents() {
        ...
        ScoreCairan = new widget.TextBox();
        ...
        Discharge = new widget.ComboBox();
        ScoreDischarge = new widget.TextBox();
        ScoreProteinuria = new widget.TextBox();
        Proteinuria = new widget.ComboBox();
        ...
        ScoreTekanan1 = new widget.TextBox();
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[Modified  Early Obstetric Warning Score Rawat Inap ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        jLabel225.setText("3. Bau Cairan Ketuban");
        jLabel225.setName("jLabel225"); // NOI18N
        FormInput.add(jLabel225);
        jLabel225.setBounds(30, 170, 160, 23);

        Cairan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Khas", "Busuk (Keruh,Kental)" }));
        Cairan.setName("Cairan"); // NOI18N
        Cairan.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                CairanItemStateChanged(evt);
            }
        });
        ...
        Cairan.setBounds(190, 170, 120, 23);

        jLabel227.setText("Score MEOWS :");
        jLabel227.setName("jLabel227"); // NOI18N
        FormInput.add(jLabel227);
        jLabel227.setBounds(320, 170, 75, 23);

        ScoreCairan.setEditable(false);
        ScoreCairan.setText("2");
        ScoreCairan.setFocusTraversalPolicyProvider(true);
        ScoreCairan.setName("ScoreCairan"); // NOI18N
        ScoreCairan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ScoreCairanActionPerformed(evt);
            }
        });
        FormInput.add(ScoreCairan);
        ScoreCairan.setBounds(400, 170, 60, 23);
        ...
        jLabel237.setText("Total Score MEOWS:");
        jLabel237.setName("jLabel237"); // NOI18N
        FormInput.add(jLabel237);
        jLabel237.setBounds(280, 410, 110, 23);
        ...
        FormInput.add(Total);
        Total.setBounds(400, 410, 60, 23);

        jLabel238.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel238.setText("8. Kesadaran");
        jLabel238.setName("jLabel238"); // NOI18N
        FormInput.add(jLabel238);
        jLabel238.setBounds(30, 320, 150, 23);

        Kesadaran.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Sadar", "V", "P-U" }));
        ...
        Kesadaran.setBounds(190, 320, 120, 23);

        jLabel240.setText("Score MEOWS :");
        jLabel240.setName("jLabel240"); // NOI18N
        FormInput.add(jLabel240);
        jLabel240.setBounds(320, 380, 75, 23);
        ...
        ScoreKesadaran.setBounds(400, 320, 60, 23);

        jLabel106.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel106.setText("MODIFIED EARLY OBSTETRIC WARNING SCORE (MEOWS)");
        jLabel106.setName("jLabel106"); // NOI18N
        FormInput.add(jLabel106);
        jLabel106.setBounds(30, 80, 310, 23);
        ...
        jLabel239.setText("9. Discharge/Lochia");
        jLabel239.setName("jLabel239"); // NOI18N
        FormInput.add(jLabel239);
        jLabel239.setBounds(30, 350, 150, 23);

        Discharge.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Normal", "Banyak atau Berlebihan" }));
        Discharge.setName("Discharge"); // NOI18N
        Discharge.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                DischargeItemStateChanged(evt);
            }
        });
        ...
        Discharge.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                DischargeKeyPressed(evt);
            }
        });
        FormInput.add(Discharge);
        Discharge.setBounds(190, 350, 120, 23);

        ScoreDischarge.setEditable(false);
        ScoreDischarge.setText("0");
        ScoreDischarge.setFocusTraversalPolicyProvider(true);
        ScoreDischarge.setName("ScoreDischarge"); // NOI18N
        FormInput.add(ScoreDischarge);
        ScoreDischarge.setBounds(400, 350, 60, 23);

        ScoreProteinuria.setEditable(false);
        ScoreProteinuria.setText("0");
        ScoreProteinuria.setFocusTraversalPolicyProvider(true);
        ScoreProteinuria.setName("ScoreProteinuria"); // NOI18N
        FormInput.add(ScoreProteinuria);
        ScoreProteinuria.setBounds(400, 380, 60, 23);

        Proteinuria.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "- s/d ++", "+++" }));
        Proteinuria.setName("Proteinuria"); // NOI18N
        Proteinuria.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                ProteinuriaItemStateChanged(evt);
            }
        });
        Proteinuria.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                ProteinuriaKeyPressed(evt);
            }
        });
        FormInput.add(Proteinuria);
        Proteinuria.setBounds(190, 380, 120, 23);

        jLabel242.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel242.setText("10. Proteinuria (Perhari)");
        jLabel242.setName("jLabel242"); // NOI18N
        FormInput.add(jLabel242);
        jLabel242.setBounds(30, 380, 150, 23);

        jLabel245.setText("Score MEOWS :");
        jLabel245.setName("jLabel245"); // NOI18N
        FormInput.add(jLabel245);
        jLabel245.setBounds(320, 320, 75, 23);

        jLabel246.setText("Score MEOWS :");
        jLabel246.setName("jLabel246"); // NOI18N
        FormInput.add(jLabel246);
        jLabel246.setBounds(320, 350, 75, 23);

        jLabel235.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel235.setText("7. Tekanan Darah Distolik");
        jLabel235.setName("jLabel235"); // NOI18N
        FormInput.add(jLabel235);
        jLabel235.setBounds(30, 290, 140, 23);

        Tekanan2.setFocusTraversalPolicyProvider(true);
        Tekanan2.setName("Tekanan2"); // NOI18N
        Tekanan2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Tekanan2ActionPerformed(evt);
            }
        });
        Tekanan2.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                Tekanan2KeyReleased(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                Tekanan2KeyTyped(evt);
            }
        });
        FormInput.add(Tekanan2);
        Tekanan2.setBounds(190, 290, 120, 23);

        jLabel247.setText("Score MEOWS :");
        jLabel247.setName("jLabel247"); // NOI18N
        FormInput.add(jLabel247);
        jLabel247.setBounds(320, 290, 75, 23);

        ScoreTekanan1.setEditable(false);
        ScoreTekanan1.setFocusTraversalPolicyProvider(true);
        ScoreTekanan1.setName("ScoreTekanan1"); // NOI18N
        FormInput.add(ScoreTekanan1);
        ScoreTekanan1.setBounds(400, 290, 60, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
        ...
        }else if(Tekanan2.getText().trim().equals("")){
            Valid.textKosong(Tekanan2,"Tekanan Darah Distolik");
        }else if(ScoreTekanan1.getText().trim().equals("")){
            Valid.textKosong(ScoreTekanan1,"Score Tekanan Darah Distolik");
            ...
            if(Sequel.menyimpantf("eows_rajal","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",29,new String[]{
                    ...
                    ScoreSaturasi.getText(),Cairan.getSelectedItem().toString(),ScoreCairan.getText(),Suhu1.getText(),ScoreSuhu.getText(),Denyut1.getText(),
                    ScoreDenyut.getText(),Tekanan1.getText(),ScoreTekanan.getText(),Tekanan2.getText(),ScoreTekanan1.getText(),Kesadaran.getSelectedItem().toString(),ScoreKesadaran.getText(),Discharge.getSelectedItem().toString(),ScoreDischarge.getText(),Proteinuria.getSelectedItem().toString(),ScoreProteinuria.getText(),Total.getText(),Klasifikasi.getText(),Respon.getText(),Tindakan.getText(),
                    Frekuensi.getText()
                })==true){
                    emptTeks();
            }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(tbObat.getSelectedRow()>-1){
            if(Sequel.queryu2tf("delete from eows_rajal where jam=?",1,new String[]{
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(tbObat.getSelectedRow()>-1){
                if(Sequel.mengedittf("eows_rajal","jam=?","no_rawat=?,tanggal=?,jam=?,nik=?,pernafasan=?,score_pernafasan=?,saturasi=?,score_saturasi=?,cairan=?,score_cairan=?,suhu=?,score_suhu=?,denyut=?,score_denyut=?,tekanan=?,score_tekanan=?,tekanan1=?,score_tekanan1=?,kesadaran=?,score_kesadaran=?,discharge=?,score_discharge=?,protenuria=?,score_proteinuria=?,total_score=?,klasifikasi=?,respon=?,tindakan=?,frekuensi=?",30,new String[]{
                    TNoRw.getText(),tanggalNow.format(new Date()),jamNow.format(new Date()),KdPetugas.getText(),Pernafasan1.getText(),ScorePernafasan.getText(),Saturasi1.getText(),
                    ScoreSaturasi.getText(),Cairan.getSelectedItem().toString(),ScoreCairan.getText(),Suhu1.getText(),ScoreSuhu.getText(),Denyut1.getText(),
                    ScoreDenyut.getText(),Tekanan1.getText(),ScoreTekanan.getText(),Tekanan2.getText(),ScoreTekanan1.getText(),Kesadaran.getSelectedItem().toString(),ScoreKesadaran.getText(),Discharge.getSelectedItem().toString(),ScoreDischarge.getText(),Proteinuria.getSelectedItem().toString(),ScoreProteinuria  .getText(),Total.getText(),Klasifikasi.getText(),Respon.getText(),Tindakan.getText(),
                    Frekuensi.getText()
...
//        tampilMasalah();
    ...
    private void CairanItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_CairanItemStateChanged
        if(Cairan.getSelectedIndex()==0){
            ScoreCairan.setText("0");
        }else if(Cairan.getSelectedIndex()==1){
            ScoreCairan.setText("2");
        }
//        isjml();
        isTotalKlasifikasi();
        ...
        isTotalTindakan();
        isTotalFrekuensi();
    }//GEN-LAST:event_CairanItemStateChanged
    ...
    private void KesadaranItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_KesadaranItemStateChanged
        if(Kesadaran.getSelectedIndex()==0){
            ...
            ScoreKesadaran.setText("1");
        }else if(Kesadaran.getSelectedIndex()==2){
            ScoreKesadaran.setText("2");
        }
//        isjml();
        isTotalKlasifikasi();
        isTotalRespon();
    ...
    private void DischargeItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_DischargeItemStateChanged
        if(Discharge.getSelectedIndex()==0){
            ScoreDischarge.setText("0");
        }else if(Discharge.getSelectedIndex()==1){
            ScoreDischarge.setText("2");
        }
//        isjml();
        isTotalKlasifikasi();
        isTotalRespon();
        isTotalTindakan();
        isTotalFrekuensi();
    }//GEN-LAST:event_DischargeItemStateChanged

    private void DischargeKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_DischargeKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_DischargeKeyPressed

    private void ProteinuriaItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_ProteinuriaItemStateChanged
        if(Proteinuria.getSelectedIndex()==0){
            ScoreProteinuria.setText("0");
        }else if(Proteinuria.getSelectedIndex()==1){
            ScoreProteinuria.setText("1");
        }
//        isjml();
        isTotalKlasifikasi();
        isTotalRespon();
        isTotalTindakan();
        isTotalFrekuensi();
    }//GEN-LAST:event_ProteinuriaItemStateChanged

    private void ProteinuriaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_ProteinuriaKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_ProteinuriaKeyPressed

    private void ScoreCairanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ScoreCairanActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_ScoreCairanActionPerformed

    private void Tekanan2KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Tekanan2KeyReleased
        if(Tekanan2.getText().isEmpty()){
           ScoreTekanan1.setText("");
       }else{
          tekanan1();  
       }
    }//GEN-LAST:event_Tekanan2KeyReleased

    private void Tekanan2KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Tekanan2KeyTyped
        char kata= evt.getKeyChar();
        if(!((kata>='0') && (kata<='9') || (kata== KeyEvent.VK_BACK_SPACE))){
            JOptionPane.showMessageDialog(null,"Hanya diperbolehkan menginputkan Angka");
        }
    ...
    private void Tekanan2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Tekanan2ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_Tekanan2ActionPerformed
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            EOWSRajal dialog = new EOWSRajal(new javax.swing.JFrame(), true);
    ...
    private widget.ComboBox Discharge;
    ...
    private widget.TextBox Tekanan2;
    ...
    public void tampil() {
        ...
        try{
            if(TCari.getText().equals("")){
                ps=koneksi.prepareStatement(
                         "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,eows_rajal.tanggal,eows_rajal.jam,eows_rajal.nik,pegawai.nama,"+
                        "eows_rajal.pernafasan,eows_rajal.score_pernafasan,eows_rajal.saturasi,eows_rajal.score_saturasi,eows_rajal.cairan,eows_rajal.score_cairan,eows_rajal.suhu,eows_rajal.score_suhu,"+
                        "eows_rajal.denyut,eows_rajal.score_denyut,eows_rajal.tekanan,eows_rajal.score_tekanan1,eows_rajal.tekanan1,eows_rajal.score_tekanan,eows_rajal.kesadaran,eows_rajal.score_kesadaran,eows_rajal.discharge,eows_rajal.score_discharge,eows_rajal.proteinuria,eows_rajal.score_proteinuria,"+
                        "eows_rajal.total_score,eows_rajal.klasifikasi,eows_rajal.respon,eows_rajal.tindakan,eows_rajal.frekuensi "+
                        "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        "inner join eows_rajal on reg_periksa.no_rawat=eows_rajal.no_rawat "+
                        "inner join pegawai on eows_rajal.nik=pegawai.nik "+
                        "inner join bahasa_pasien on bahasa_pasien.id=pasien.bahasa_pasien "+
                        "inner join cacat_fisik on cacat_fisik.id=pasien.cacat_fisik where "+
                        "eows_rajal.tanggal between ? and ? order by eows_rajal.tanggal");
            }else{
                ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,eows_rajal.tanggal,eows_rajal.jam,eows_rajal.nik,pegawai.nama,"+
                        "eows_rajal.pernafasan,eows_rajal.score_pernafasan,eows_rajal.saturasi,eows_rajal.score_saturasi,eows_rajal.cairan,eows_rajal.score_cairan,eows_rajal.suhu,eows_rajal.score_suhu,"+
                        ...
                        "inner join bahasa_pasien on bahasa_pasien.id=pasien.bahasa_pasien "+
                        "inner join cacat_fisik on cacat_fisik.id=pasien.cacat_fisik where "+
                        "eows_rajal.tanggal between ? and ? and reg_periksa.no_rawat like ? or "+
                        "eows_rajal.tanggal between ? and ? and pasien.no_rkm_medis like ? or "+
                        "eows_rajal.tanggal between ? and ? and pasien.nm_pasien like ? or "+
                        "eows_rajal.tanggal between ? and ? and eows_rajal.nik like ? or "+
                        "eows_rajal.tanggal between ? and ? and pegawai.nama like ? order by eows_rajal.tanggal");
            }
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("pernafasan"),rs.getString("score_pernafasan"),rs.getString("saturasi"),rs.getString("score_saturasi"),rs.getString("cairan"),rs.getString("score_cairan"),
                        rs.getString("suhu"),rs.getString("score_suhu"),rs.getString("denyut"),rs.getString("score_denyut"),rs.getString("tekanan"),rs.getString("score_tekanan"),rs.getString("tekanan1"),rs.getString("score_tekanan1"),
                        rs.getString("kesadaran"),rs.getString("score_kesadaran"),rs.getString("discharge"),rs.getString("score_discharge"),rs.getString("proteinuria"),rs.getString("score_proteinuria"),rs.getString("total_score"),rs.getString("klasifikasi"),rs.getString("respon"),rs.getString("tindakan"),
...
//    }
    ...
    private void pernafasan(){
        if(Integer.parseInt(Pernafasan1.getText())>30){
            ScorePernafasan.setText("2");
        }else if(Integer.parseInt(Pernafasan1.getText())>=30){
    ...
    private void saturasi(){
        if(Integer.parseInt(Saturasi1.getText())>=100){
        ...
        }else if(Integer.parseInt(Saturasi1.getText())>=90){
            ScoreSaturasi.setText("1");
        }else if(Integer.parseInt(Saturasi1.getText())<90){
    ...
    private void suhu(){
        if(Double.parseDouble(Suhu1.getText())>38.0){
            ScoreSuhu.setText("2");
        }else if(Double.parseDouble(Suhu1.getText())>=37.9){
            ScoreSuhu.setText("0");
        }else if(Double.parseDouble(Suhu1.getText())>=36.0){
            ScoreSuhu.setText("0");
        }else if(Double.parseDouble(Suhu1.getText())>=35.9){
            ScoreSuhu.setText("1");
    ...
    private void denyut(){
        if(Integer.parseInt(Denyut1.getText())>=121){
            ScoreDenyut.setText("2");
        }else if(Integer.parseInt(Denyut1.getText())>=120){
            ScoreDenyut.setText("1");
        }else if(Integer.parseInt(Denyut1.getText())>=100){
            ScoreDenyut.setText("1");
        }else if(Integer.parseInt(Denyut1.getText())>=99){
    ...
    private void tekanan(){
        if(Integer.parseInt(Tekanan1.getText())>160){
            ScoreTekanan.setText("2");
        }else if(Integer.parseInt(Tekanan1.getText())>=159){
            ScoreTekanan.setText("1");
        }else if(Integer.parseInt(Tekanan1.getText())>=150){
            ScoreTekanan.setText("1");
        }else if(Integer.parseInt(Tekanan1.getText())>=149){
            ScoreTekanan.setText("0");
        }else if(Integer.parseInt(Tekanan1.getText())>=100){
            ScoreTekanan.setText("0");
        }else if(Integer.parseInt(Tekanan1.getText())>=99){
            ScoreTekanan.setText("1");
    ...
    private void tekanan1(){
        if(Integer.parseInt(Tekanan2.getText())>=110){
            ScoreTekanan1.setText("2");
        }else if(Integer.parseInt(Tekanan2.getText())>=109){
            ScoreTekanan1.setText("1");
        }else if(Integer.parseInt(Tekanan2.getText())>=90){
            ScoreTekanan1.setText("1");
        }else if(Integer.parseInt(Tekanan2.getText())<90){
            ScoreTekanan1.setText("0");
        }
        isTotalKlasifikasi();
        isTotalRespon();
        isTotalTindakan();
    ...
    private void isTotalKlasifikasi(){
        try {
            Total.setText((Integer.parseInt(ScorePernafasan.getText())+Integer.parseInt(ScoreSaturasi.getText())+Integer.parseInt(ScoreCairan.getText())+Integer.parseInt(ScoreSuhu.getText())+Integer.parseInt(ScoreDenyut.getText())+Integer.parseInt(ScoreTekanan.getText())+Integer.parseInt(ScoreTekanan1.getText())+Integer.parseInt(ScoreKesadaran.getText())+Integer.parseInt(ScoreDischarge.getText())+Integer.parseInt(ScoreProteinuria.getText()))+"");
    ...
    private void isTotalTindakan(){
        try {
            Total.setText((Integer.parseInt(ScorePernafasan.getText())+Integer.parseInt(ScoreSaturasi.getText())+Integer.parseInt(ScoreCairan.getText())+Integer.parseInt(ScoreSuhu.getText())+Integer.parseInt(ScoreDenyut.getText())+Integer.parseInt(ScoreTekanan.getText())+Integer.parseInt(ScoreKesadaran.getText()))+"");
            if(Total.getText().equals("0")){
                ...
                Tindakan.setText(
                 ...
                 Tindakan.setText(
                        "Perawat pelaksana menginformasikan kepada ketua tim \n"
                        + "penanggung jawab jaga ruangan \n"
                        + "ketua tim/penanggung jawab ruangan membuat keputusan \n"
                        + "1. meingkatkan frekuensi observasi/monitoring \n"
                        + "2. perbaikan asuhan yang dibutuhan pasien \n"
                        + "3. Lapor dr.jaga atau dpjp jika terdapat gejala \n"
                        + "   Impending Eclamsia(nyeri kepala,gangguan penglihatan \n"
                        + "   Nyeri ulu hati)");
            }else if(Total.getText().equals("3")){
                 Tindakan.setText(
                         "Perawat pelaksana menginformasikan kepada ketua tim \n"
                 ...
                 Tindakan.setText(
                        "1. Ketua Tim perawat segara memberikan informasi tentang \n"
                        + "kondisi pasien kepada dr.jaga atau dpjp \n"
                        + "2. Dokter jaga atau dpjp melakukan assesment sesuai \n"
            ...
            Tindakan.setText(
                        "1. DPJP/Dokter Jaga mengkosultasikan ke DPJP ICU \n"
                        + "2. DPJP ICU melakukan assesment segera dan bila sesuai \n"
                        + "indikasi pasien dirawat diruang HCU/ICU \n"
                        + "3. Untuk pasien di IGD(Prioritas3,4 dan 5) \n"
                        + "perawat penanggung jawab segera kirim pasienke ruang \n"
                        + "Resusitasi IGD untuk penanganan Bantuan Hidup Lanjut (BHL)");
        }
        } catch (Exception e) {
            Total.setText("0");
        }
    ...
    private void isTotalFrekuensi(){
        try {
            ...
            Frekuensi.setText("Lakukan Resusitasi Dan Monitoring TTV Secara Kontinyu");
        }
        } catch (Exception e) {
            Total.setText("0");
        }
...
//    }
    ...
    public void emptTeks() {
        ...
        ScoreKesadaran.setText("0");
        Discharge.setSelectedIndex(0);
        ScoreDischarge.setText("0");
        Proteinuria.setSelectedIndex(0);
        ScoreProteinuria.setText("0");
        Total.setText("0");
        Klasifikasi.setText("");
        Respon.setText("");
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            Cairan.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),13).toString());
            ScoreCairan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),14).toString());
            ...
            Tekanan2.setText(tbObat.getValueAt(tbObat.getSelectedRow(),21).toString());
            ScoreTekanan1.setText(tbObat.getValueAt(tbObat.getSelectedRow(),22).toString());
            Kesadaran.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),23).toString());
            ScoreKesadaran.setText(tbObat.getValueAt(tbObat.getSelectedRow(),24).toString());
            Discharge.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),25).toString());
            ScoreDischarge.setText(tbObat.getValueAt(tbObat.getSelectedRow(),26).toString());
            Proteinuria.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),27).toString());
            ScoreProteinuria.setText(tbObat.getValueAt(tbObat.getSelectedRow(),28).toString());
            Total.setText(tbObat.getValueAt(tbObat.getSelectedRow(),29).toString());
            Klasifikasi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),30).toString());
            Respon.setText(tbObat.getValueAt(tbObat.getSelectedRow(),31).toString());
            Tindakan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),32).toString());
