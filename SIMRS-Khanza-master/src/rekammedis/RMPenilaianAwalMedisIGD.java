...
public final class RMPenilaianAwalMedisIGD extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        scrollPane7.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(102, 102, 102)));
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "13-11-2023 12:05:48" }));
    ...
    */
    ...
    private void isRawat() {
        ...
        if(Sequel.cariInteger("select count(no_rawat) from data_triase_igd where no_rawat='"+TNoRw.getText()+"' ")>0){ 
           ...
           // BB.setText(Sequel.cariIsi("select bb from data_triase_igd where no_rawat=?",TNoRw.getText())); 
           // TB.setText(Sequel.cariIsi("select tb from data_triase_igd where no_rawat=?",TNoRw.getText())); 
        ...
        //    GCS.setText(Sequel.cariIsi("select gcs from data_triase_igd where no_rawat=?",TNoRw.getText())); 
            KeluhanUtama.setText(Sequel.cariIsi("select keluhan_utama from data_triase_igdprimer where no_rawat=?",TNoRw.getText())); 
//            RPK.setText(Sequel.cariIsi("select rpk from data_triase_igd where no_rawat=?",TNoRw.getText())); 
//            RPO.setText(Sequel.cariIsi("select rpo from data_triase_igd where no_rawat=?",TNoRw.getText())); 
//            RPD.setText(Sequel.cariIsi("select rpd from data_triase_igd where no_rawat=?",TNoRw.getText())); 
//            Alergi.setText(Sequel.cariIsi("select alergi from data_triase_igd where no_rawat=?",TNoRw.getText())); 
        }
    }
