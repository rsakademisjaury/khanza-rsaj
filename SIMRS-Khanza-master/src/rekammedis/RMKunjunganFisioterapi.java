...
public final class RMKunjunganFisioterapi extends javax.swing.JDialog {
    ...
    public RMKunjunganFisioterapi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "No.Rawat","No.R.M.","Nama Pasien","Umur","JK","Tgl.Lahir","Tanggal ","Kunjungan Ke","Diagnosa","Terapi","Program","NIP","Dokter/Paramedis","Profesi/Jabatan"
        }){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Kunjungan KFR ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "25-06-2022" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "25-06-2022" }));
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "25-06-2022" }));
        ...
        jLabel18.setText("Dlakukan Oleh :");
        ...
        jLabel12.setText("Diagnosal :");
        jLabel12.setName("jLabel12"); // NOI18N
        FormInput.add(jLabel12);
        jLabel12.setBounds(0, 110, 125, 23);
        ...
        Diagnosa.setBounds(130, 110, 660, 23);
        ...
        jLabel13.setBounds(0, 140, 125, 23);
        ...
        Terapi.setBounds(130, 140, 660, 23);

        jLabel15.setText("Program :");
        jLabel15.setName("jLabel15"); // NOI18N
        FormInput.add(jLabel15);
        jLabel15.setBounds(0, 170, 114, 23);
        ...
        Program.setBounds(120, 170, 671, 23);

        jLabel25.setText("Kunjungan Ke :");
        jLabel25.setName("jLabel25"); // NOI18N
        FormInput.add(jLabel25);
        jLabel25.setBounds(140, 80, 90, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            Valid.textKosong(Diagnosa,"Diagnosisa");
            ...
            if(Sequel.menyimpantf("kunjungan_fisioterapi","?,?,?,?,?,?,?","Data",7,new String[]{
                TNoRw.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+"")+" "+Jam.getSelectedItem()+":"+Menit.getSelectedItem()+":"+Detik.getSelectedItem(),
                cmbImun.getSelectedItem().toString(),Diagnosa.getText(),Terapi.getText(),Program.getText(),KdPeg.getText()
            })==true){
                tampil();
                emptTeks();
            }   
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            Sequel.mengedit("kunjungan_fisioterapi","no_rawat=?","no_rawat=?,tanggal=?,kunjungan_ke=?,diagnosa=?,terapi=?,program=?,nip=?",8,new String[]{
                TNoRw.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+"")+" "+Jam.getSelectedItem()+":"+Menit.getSelectedItem()+":"+Detik.getSelectedItem(),
                cmbImun.getSelectedItem().toString(),Diagnosa.getText(),Terapi.getText(),Program.getText(),KdPeg.getText(),
                tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
            });
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            finger=Sequel.cariIsi("select sha1(sidikjari.sidikjari) from sidikjari inner join pegawai on pegawai.id=sidikjari.id where pegawai.nik=?",KdPeg.getText());
            ...
            if(TCari.getText().trim().equals("")){
                Valid.MyReportqry("rptCetakKunjunganFisioterapi.jasper","report","::[ Kunjungan KFR ]::",
                    ...
                    "kunjungan_fisioterapi.program,kunjungan_fisioterapi.nip,pegawai.nama,pegawai.jbtn,date_format(pasien.tgl_lahir,'%d-%m-%Y') as lahir "+
    ...
    private void KdPegKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KdPegKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_PAGE_DOWN){
            Sequel.cariIsi("select nama from pegawai where nik=?",NmPegawai,KdPeg.getText());
        }else if(evt.getKeyCode()==KeyEvent.VK_PAGE_UP){
            Detik.requestFocus();
    ...
    */
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("nip"),rs.getString("nama"),rs.getString("jbtn")
                    });
                }
            } catch (Exception e) {
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            Jabatan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),13).toString());
    ...
    public void isCek(){
        ...
        if(akses.getjml2()>=1){
            ...
            Sequel.cariIsi("select pegawai.nama from pegawai where pegawai.nik=?",NmPegawai,KdPeg.getText());
