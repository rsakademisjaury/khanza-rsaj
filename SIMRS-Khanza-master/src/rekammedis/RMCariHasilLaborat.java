...
public final class RMCariHasilLaborat extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        ppPilihSemua.setPreferredSize(new java.awt.Dimension(200, 25));
        ppPilihSemua.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppPilihSemuaActionPerformed(evt);
            }
        });
        PopupMB.add(ppPilihSemua);
        ...
        internalFrame1.setComponentPopupMenu(PopupMB);
        internalFrame1.setName("internalFrame1"); // NOI18N
        internalFrame1.setLayout(new java.awt.BorderLayout(1, 1));

        Scroll.setComponentPopupMenu(PopupMB);
