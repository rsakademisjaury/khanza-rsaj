 ...
 * @author dosen
 */
public final class DlgCariPoli4 extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgCariPoli4(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariPoli4 dialog = new DlgCariPoli4(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try {
            ...
            iyem="";
            ps=koneksi.prepareStatement("select * from rsaj_poliklinik_vclaim where status='1'");
            try{           
                rs=ps.executeQuery();
                while(rs.next()){
