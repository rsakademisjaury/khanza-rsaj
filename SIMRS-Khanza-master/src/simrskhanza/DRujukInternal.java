...
public final class DRujukInternal extends javax.swing.JDialog {
    ...
    private DlgCariDokter dokter1=new DlgCariDokter(null,true);
...
//        ChkAccor.setSelected(false);
    ...
    private void initComponents() {
        ...
        diagnosa_jawaban = new widget.TextArea();
        ...
        kd_dokter.setBounds(640, 70, 108, 23);
        ...
        nm_dokter.setBounds(750, 70, 330, 23);
        ...
        BtnPetugas.setBounds(1080, 70, 28, 23);
        ...
        TglLahir.setBounds(640, 10, 100, 26);
        ...
        label11.setBounds(570, 40, 60, 20);
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "14-05-2024 11:52:24" }));
        ...
        TglAsuhan.setBounds(640, 40, 140, 20);
        ...
        kd_dokter2.setBounds(90, 40, 108, 23);
        ...
        nama_dokter2.setBounds(200, 40, 330, 23);
        ...
        BtnDPJP.setBounds(530, 40, 28, 23);
        ...
        Scroll10.setBounds(740, 440, 320, 120);
        ...
        TCariKomplikasi.setBounds(720, 630, 210, 20);
        ...
        kd_poli.setBounds(90, 70, 108, 23);
        ...
        BtnPoli.setBounds(530, 70, 28, 23);
        ...
        status.setBounds(720, 570, 80, 23);
        ...
        jawab_permintaan.setBounds(150, 440, 222, 82);
        ...
        saran_tindakan.setBounds(280, 440, 222, 82);
        ...
        label19.setBounds(570, 130, 150, 23);

        TglAsuhan1.setForeground(new java.awt.Color(50, 70, 50));
        TglAsuhan1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "14-05-2024 11:52:25" }));
        ...
        scrollPane7.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(153, 153, 153)));
        ...
        scrollPane7.setBounds(20, 530, 550, 30);

        scrollPane8.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(153, 153, 153)));
        scrollPane8.setName("scrollPane8"); // NOI18N

        diagnosa_jawaban.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        diagnosa_jawaban.setColumns(20);
        diagnosa_jawaban.setForeground(new java.awt.Color(0, 0, 0));
        diagnosa_jawaban.setRows(5);
        diagnosa_jawaban.setName("diagnosa_jawaban"); // NOI18N
        diagnosa_jawaban.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                diagnosa_jawabanKeyPressed(evt);
            }
        });
        scrollPane8.setViewportView(diagnosa_jawaban);

        tbKomplikasiKehamilanSebelumnya.add(scrollPane8);
        scrollPane8.setBounds(590, 530, 80, 30);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().trim().equals("")||TNoRM.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("rujukan_internal_poli","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Rujukan Sama",16,new String[]{
                TNoRw.getText(),
                kd_dokter.getText(),
                kd_poli.getText(),
                nm_poli.getText(),
...
//            Valid.pindah(evt,TCari,BtnPetugas);
    ...
    private void diagnosa_jawabanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_diagnosa_jawabanKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_diagnosa_jawabanKeyPressed
    ...
    */
    ...
    private widget.TextArea diagnosa_jawaban;
