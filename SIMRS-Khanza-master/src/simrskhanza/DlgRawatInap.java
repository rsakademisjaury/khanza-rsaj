...
import rekammedis.KonsultasiInternal;
import rekammedis.KonsultasiLembar;
...
//    public class PlaceholdersearchField;
    ...
    private void initComponents() {
        ...
        jLabel88.setBounds(20, 60, 70, 23);
        ...
        jLabel70.setBounds(50, 200, 80, 23);
        ...
        jLabel95.setBounds(450, 220, 30, 23);
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "26-02-2025" }));
        ...
        BtnVerifikasiSBAR.setPreferredSize(new java.awt.Dimension(190, 30));
            ...
            switch (TabRawat.getSelectedIndex()) {
                ...
                if((!TSituation.getText().trim().equals(""))||(!TBackground.getText().trim().equals(""))||(!TAssesment.getText().trim().equals(""))||
                    ...
                    if(KdPeg2.getText().trim().equals("")||TPegawai2.getText().trim().equals("")){
                        ...
                        if(akses.getkode().equals("Admin Utama")){
                            Sequel.menyimpan("pemeriksaan_ranap_sbar","?,?,?,?,?,?,?,?,?,?,?","Data",11,new String[]{
                                TNoRw.getText(),Valid.SetTgl(DTPTgl.getSelectedItem()+""),cmbJam.getSelectedItem()+":"+cmbMnt.getSelectedItem()+":"+cmbDtk.getSelectedItem(),
    ...
    private void BtnVerifikasiSBARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnVerifikasiSBARActionPerformed
        if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            ValidasiSBARRanap form=new ValidasiSBARRanap(null,false);
            form.isCek();
            form.emptTeks();
            form.setNoRm(TNoRw.getText(),DTPCari2.getDate());
            form.tampil();
...
/*        BtnPenilaianUlangNyeri.setVisible(akses.getpenilaian_ulang_nyeri()); 
        ...
        buttonList.add(BtnVerifikasiSBAR);
