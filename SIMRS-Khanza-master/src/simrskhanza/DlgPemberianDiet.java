...
public class DlgPemberianDiet extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "04-07-2024" }));
            ...
            if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
                ...
                if(Sequel.menyimpantf("detail_beri_diet1","'"+TNoRw.getText()+"','"+Kamar.getText()+"','"+
                    ...
                    tabMode.addRow(new String[]{
                        TNoRw.getText(),TPasien.getText(),Ruang.getText(),Valid.SetTgl(DTPTgl.getSelectedItem()+""),WaktuDiet.getText(),JamDiet.getText(),NmDiet.getText(),"-",Kamar.getText(),KdDiet.getText(),KamarReal.getSelectedItem()+"",Status_Titipan.getSelectedItem()+""
                    });
    ...
    */
    ...
    public void tampil() {   
        try{
            ...
            ps=koneksi.prepareStatement(
                "select detail_beri_diet1.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,concat(detail_beri_diet1.kd_kamar,', ',bangsal.nm_bangsal),"+
                "detail_beri_diet1.tanggal,detail_beri_diet1.waktu,jam_diet_pasien.jam,diet.nama_diet,detail_beri_diet1.kd_kamar,detail_beri_diet1.kd_diet,detail_beri_diet1.kd_kamar_real,detail_beri_diet1.status " +
                "from detail_beri_diet1 inner join reg_periksa on detail_beri_diet1.no_rawat=reg_periksa.no_rawat "+
                "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                "inner join diet on detail_beri_diet1.kd_diet=diet.kd_diet "+
                "inner join kamar on detail_beri_diet1.kd_kamar=kamar.kd_kamar "+
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("kd_kamar"),rs.getString("kd_diet"),rs.getString(9),rs.getString(10),rs.getString(11)
                    });
                }
            } catch (Exception e) {
    ...
    private void getData() {
        if(tbDataDiet.getSelectedRow()!= -1){
            ...
            KamarReal.setSelectedItem(tbDataDiet.getValueAt(tbDataDiet.getSelectedRow(),10).toString());
            Status_Titipan.setSelectedItem(tbDataDiet.getValueAt(tbDataDiet.getSelectedRow(),11).toString());
