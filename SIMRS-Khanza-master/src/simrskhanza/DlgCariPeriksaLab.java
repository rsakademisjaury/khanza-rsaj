...
//                                menampilkan judul nama pemeriksaan
    ...
    private void BtnUploadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnUploadActionPerformed
        ...
        FileName = timestamp + "_" + tbDokter.getValueAt(tbDokter.getSelectedRow(), 0).toString().replace("/", "") + "_HasilLaboratorium";
                    ...
                    while(rs.next()){
                        ...
                        try {
                            ...
                            if(rspermintaan.next()){
                                ...
                                param.put("tanggalpermintaan",rspermintaan.getString("tgl_permintaan"));  
                                param.put("jampermintaan",rspermintaan.getString("jam_permintaan"));                                
                                Valid.MyReportPDFqryUpload("rptPeriksaLabPermintaan.jasper","report","::[ Pemeriksaan Laboratorium ]::",
