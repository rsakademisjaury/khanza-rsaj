...
public class DlgAbout extends javax.swing.JDialog {
    ...
    public DlgAbout(java.awt.Frame parent, boolean modal) {
        ...
        tentang_update.setCaretPosition(0);
        
        try {
            // Membaca direktori dari user/klien
            String mainDir = System.getProperty("user.dir");

            // Menyusun jalur file dengan direktori utama
            String filePath = mainDir + "/settingupdate/update.txt";

            // Membaca file dari jalur absolut
            BufferedReader reader = new BufferedReader(new FileReader(filePath));
            StringBuilder contentBuilder = new StringBuilder();
            String line;

            // Baca semua baris dan gabungkan
            ...
            tentang_update.setText(contentBuilder.toString());
            tentang_update.setCaretPosition(0);
    ...
    private void initComponents() {
        ...
        tentang_update = new javax.swing.JTextArea();
        ...
        jLabel17.setText("Update 2024-06-19");
        ...
        jLabel36.setText("Kontributor & Donatur : RS Jeumpa Pontianak Kalimantan Barat, RS Sadewa Yogyakarta,");
        jLabel36.setName("jLabel36"); // NOI18N
        panelGlass4.add(jLabel36);
        jLabel36.setBounds(10, 100, 440, 14);
        ...
        tentang_update.setEditable(false);
        tentang_update.setColumns(20);
        tentang_update.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        tentang_update.setForeground(new java.awt.Color(51, 51, 51));
        tentang_update.setLineWrap(true);
        tentang_update.setRows(5);
        tentang_update.setBorder(null);
        tentang_update.setName("tentang_update"); // NOI18N
        jScrollPane1.setViewportView(tentang_update);

        internalFrame1.add(jScrollPane1);
        jScrollPane1.setBounds(470, 40, 880, 650);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgAbout dialog = new DlgAbout(new javax.swing.JFrame(), false);
    ...
    private javax.swing.JTextArea tentang_update;
