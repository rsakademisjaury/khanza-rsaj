 ...
 * @author dosen
 */
public final class DlgCariSmf extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgCariSmf(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        try {
            if(Valid.daysOld("./cache/smf.iyem")<8){
                tampil2();
            }else{
                tampil();
            }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariSmf dialog = new DlgCariSmf(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            file=new File("./cache/smf.iyem");
            file.createNewFile();
            fileWriter = new FileWriter(file);
            iyem="";
            ps=koneksi.prepareStatement("SELECT s.kd_sps, s.nm_sps FROM spesialis s JOIN dokter d ON s.kd_sps = d.kd_sps WHERE s.kd_sps != '-' and d.status = '1' GROUP BY s.kd_sps ORDER BY s.nm_sps ");
            try {
                rs=ps.executeQuery();
                while(rs.next()){
            ...
            fileWriter.write("{\"smf\":["+iyem.substring(0,iyem.length()-1)+"]}");
            fileWriter.flush();
            fileWriter.close();
            iyem=null;
        }catch(Exception e){
    ...
    private void tampil2() {
        try {
            myObj = new FileReader("./cache/smf.iyem");
            root = mapper.readTree(myObj);
            Valid.tabelKosong(tabMode);
            response = root.path("smf");
            if(response.isArray()){
