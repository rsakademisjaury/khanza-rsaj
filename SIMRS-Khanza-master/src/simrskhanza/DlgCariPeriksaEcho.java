...
public class DlgCariPeriksaEcho extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgCariPeriksaEcho(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(Kd2.getText().equals("")||Petugas.getText().equals("")){
                ...
                try {
                    ...
                    Logger.getLogger(DlgCariPeriksaEcho.class.getName()).log(Level.SEVERE, null, ex);
                }
                try {
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariPeriksaEcho dialog = new DlgCariPeriksaEcho(new javax.swing.JFrame(), true);
