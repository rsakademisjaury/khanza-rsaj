...
public class DlgTindakanOperasi extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal*/
    public DlgTindakanOperasi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        Laporan.setDocument(new batasInput((int)8000).getKata(Laporan));
    ...
    private void initComponents() {
        ...
        LTotal.setPreferredSize(new java.awt.Dimension(300, 30));
        ...
        kdoperator1.setBounds(100, 80, 100, 23);
        ...
        nmoperator1.setBounds(210, 80, 190, 23);
        ...
        BtnOperator1.setBounds(400, 80, 28, 23);
        ...
        label17.setBounds(480, 420, 101, 23);
        ...
        kdasistoperator1.setBounds(580, 420, 100, 23);
        ...
        nmasistoperator1.setBounds(680, 420, 190, 23);
        ...
        btnAsis1.setBounds(870, 420, 28, 23);

        label19.setText("Dokter Bedah 2 :");
        label19.setName("label19"); // NOI18N
        label19.setPreferredSize(new java.awt.Dimension(70, 23));
        FormInput.add(label19);
        label19.setBounds(20, 110, 81, 23);
        ...
        kdoperator2.setBounds(100, 110, 100, 23);
        ...
        nmoperator2.setBounds(210, 110, 190, 23);
        ...
        BtnOperator2.setBounds(400, 110, 28, 23);

        label20.setText("Dokter Bedah 3 :");
        label20.setName("label20"); // NOI18N
        label20.setPreferredSize(new java.awt.Dimension(70, 23));
        FormInput.add(label20);
        label20.setBounds(20, 140, 81, 23);
        ...
        kdoperator3.setBounds(100, 140, 100, 23);
        ...
        nmoperator3.setBounds(210, 140, 190, 23);
        ...
        btnOperator3.setBounds(400, 140, 28, 23);

        label21.setText("dr Anestesi :");
        label21.setName("label21"); // NOI18N
        label21.setPreferredSize(new java.awt.Dimension(70, 23));
        FormInput.add(label21);
        label21.setBounds(20, 190, 81, 23);
        ...
        kdanestesi.setBounds(100, 190, 100, 23);
        ...
        nmanestesi.setBounds(210, 190, 190, 23);
        ...
        BtnAnastesi.setBounds(400, 190, 28, 23);

        label22.setText("dr Anak :");
        label22.setName("label22"); // NOI18N
        label22.setPreferredSize(new java.awt.Dimension(70, 23));
        FormInput.add(label22);
        label22.setBounds(70, 540, 81, 23);
        ...
        kddranak.setBounds(150, 540, 100, 23);
        ...
        nmdranak.setBounds(260, 540, 190, 23);
        ...
        btnAnak.setBounds(450, 540, 28, 23);
        ...
        btnAsis2.setBounds(870, 450, 28, 23);
        ...
        nmasistoperator2.setBounds(680, 450, 190, 23);
        ...
        kdasistoperator2.setBounds(580, 450, 100, 23);

        label18.setText("Perawat Scrub 2 :");
        label18.setName("label18"); // NOI18N
        label18.setPreferredSize(new java.awt.Dimension(70, 23));
        FormInput.add(label18);
        label18.setBounds(480, 450, 101, 23);
        ...
        btnAsis3.setBounds(450, 690, 28, 23);
        ...
        nminstrumen.setBounds(260, 690, 190, 23);
        ...
        btnPrwRes.setBounds(850, 200, 28, 23);
        ...
        nmprwresust.setBounds(660, 200, 190, 23);
        ...
        kdasistanestesi.setBounds(100, 220, 100, 23);
        ...
        nmasistanestesi.setBounds(200, 220, 190, 23);
        ...
        kdbidan.setBounds(150, 570, 100, 23);
        ...
        nmbidan.setBounds(260, 570, 190, 23);
        ...
        kdprwluar.setBounds(150, 660, 100, 23);
        ...
        nmprwluar.setBounds(260, 660, 190, 23);
        ...
        btnPrwLuar.setBounds(450, 660, 28, 23);
        ...
        btnBidan2.setBounds(450, 600, 28, 23);
        ...
        nmbidan2.setBounds(260, 600, 190, 23);
        ...
        kdbidan3.setBounds(150, 630, 100, 23);
        ...
        nmbidan3.setBounds(260, 630, 190, 23);
        ...
        btnBidan3.setBounds(450, 630, 28, 23);

        label25.setText("Perawat Sirkuler 1 :");
        label25.setName("label25"); // NOI18N
        label25.setPreferredSize(new java.awt.Dimension(70, 23));
        FormInput.add(label25);
        label25.setBounds(480, 570, 101, 23);
        ...
        kdonloop1.setBounds(580, 570, 100, 23);
        ...
        nmonloop1.setBounds(680, 570, 190, 23);
        ...
        btnOnloop1.setBounds(870, 570, 28, 23);
        ...
        btnOnloop2.setBounds(870, 600, 28, 23);
        ...
        nmonloop2.setBounds(680, 600, 190, 23);
        ...
        kdonloop2.setBounds(580, 600, 100, 23);

        label31.setText("Perawat Sirkuler 2 :");
        label31.setName("label31"); // NOI18N
        label31.setPreferredSize(new java.awt.Dimension(70, 23));
        FormInput.add(label31);
        label31.setBounds(480, 600, 101, 23);

        label32.setText("Perawat Sirkuler 3 :");
        label32.setName("label32"); // NOI18N
        label32.setPreferredSize(new java.awt.Dimension(70, 23));
        FormInput.add(label32);
        label32.setBounds(480, 630, 101, 23);
        ...
        btnOnloop3.setBounds(870, 630, 28, 23);
        ...
        nmonloop3.setBounds(680, 630, 190, 23);
        ...
        kdpjanak.setBounds(150, 720, 100, 23);
        ...
        nmpjanak.setBounds(260, 720, 190, 23);
        ...
        kddrumum.setBounds(150, 750, 100, 23);
        ...
        nmdrumum.setBounds(260, 750, 190, 23);
        ...
        btndrumum.setBounds(450, 750, 28, 23);

        label35.setText("Perawat Scrub 3 :");
        label35.setName("label35"); // NOI18N
        label35.setPreferredSize(new java.awt.Dimension(70, 23));
        FormInput.add(label35);
        label35.setBounds(480, 480, 101, 23);
        ...
        kdasistoperator3.setBounds(580, 480, 100, 23);
        ...
        nmasistoperator3.setBounds(680, 480, 190, 23);
        ...
        kdasistanestesi2.setBounds(100, 250, 100, 23);
        ...
        nmasistanestesi2.setBounds(200, 250, 190, 23);
        ...
        BtnAsnes1.setBounds(390, 250, 28, 23);

        label37.setText("Perawat Sirkuler 4 :");
        label37.setName("label37"); // NOI18N
        label37.setPreferredSize(new java.awt.Dimension(70, 23));
        FormInput.add(label37);
        label37.setBounds(480, 660, 101, 23);
        ...
        kdonloop4.setBounds(580, 660, 100, 23);
        ...
        nmonloop4.setBounds(680, 660, 190, 23);
        ...
        btnOnloop4.setBounds(870, 660, 28, 23);
        ...
        btnOnloop5.setBounds(870, 690, 28, 23);
        ...
        nmonloop5.setBounds(680, 690, 190, 23);
        ...
        kdonloop5.setBounds(580, 690, 100, 23);

        label38.setText("Perawat Sirkuler 5 :");
        label38.setName("label38"); // NOI18N
        label38.setPreferredSize(new java.awt.Dimension(70, 23));
        FormInput.add(label38);
        label38.setBounds(480, 690, 101, 23);
   ...
   isForm();  
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            Valid.textKosong(jenis,"Jenis Anastesi");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgTindakanOperasi dialog = new DlgTindakanOperasi(new javax.swing.JFrame(), true);
    ...
    public void isCek(){
       // Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(nota_jual,6),signed)),0) from penjualan ","PJ",6,NoNota); 
        ...
        /*  BtnOperator2.setEnabled(akses.getadmin());
            btnOperator3.setEnabled(akses.getadmin());
            btnAnak.setEnabled(akses.getadmin());
            btnBidan.setEnabled(akses.getadmin());
            btnBidan2.setEnabled(akses.getadmin());
            btnBidan3.setEnabled(akses.getadmin());
            btnPrwLuar.setEnabled(akses.getadmin());
            btnAsis3.setEnabled(akses.getadmin());
            BtnOperator2.setEnabled(akses.getadmin());
            BtnOperator2.setEnabled(akses.getadmin());
            BtnOperator2.setEnabled(akses.getadmin());
            BtnOperator2.setEnabled(akses.getadmin());
