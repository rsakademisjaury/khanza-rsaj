...
public final class InventarisKoleksi extends javax.swing.JDialog {
    ...
    public InventarisKoleksi(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"No.Inventaris","Kode Barang","Nama Barang","Produsen",
                      ...
                      "Asal Barang","Tgl.Pengadaan","Harga","Kondisi","Ruang",
                      "No.Rak","No.Box","Sumber Listrik","Besar Daya","Tahun Kalibrasi"
        };
    ...
    private void initComponents() {
        ...
        label8.setBounds(750, 10, 100, 23);
        ...
        status_barang.setBounds(860, 70, 100, 23);
        ...
        sumber_daya_listrik.setBounds(860, 40, 100, 23);

        jLabel20.setText("Sumber Daya Listrik :");
        jLabel20.setName("jLabel20"); // NOI18N
        FormInput.add(jLabel20);
        jLabel20.setBounds(740, 40, 110, 23);

        jLabel21.setText("Kondisi :");
        jLabel21.setName("jLabel21"); // NOI18N
        FormInput.add(jLabel21);
        jLabel21.setBounds(790, 70, 60, 23);

        label2.setText("Besar Daya :");
        label2.setName("label2"); // NOI18N
        FormInput.add(label2);
        label2.setBounds(760, 100, 90, 23);
        ...
        besar_daya.setBounds(860, 100, 100, 23);

        label10.setText("Tahun Kalibrasi :");
        label10.setName("label10"); // NOI18N
        FormInput.add(label10);
        label10.setBounds(730, 130, 120, 23);

        label3.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        label3.setText("Watt");
        label3.setName("label3"); // NOI18N
        FormInput.add(label3);
        label3.setBounds(970, 100, 80, 23);
        ...
        tgl_pengadaan.setBounds(860, 10, 100, 23);
        ...
        tahun_kalibrasi.setBounds(860, 130, 100, 23);
        ...
        no_box.setBounds(1040, 130, 70, 23);
    ...
    */
    ...
    public void tampil() {
        try {
            ps=koneksi.prepareStatement("select inventaris.no_inventaris,inventaris_barang.kode_barang, inventaris_barang.nama_barang, "+
                        ...
                        "inventaris.harga,inventaris.status_barang,inventaris_ruang.nama_ruang,inventaris.no_rak,inventaris.no_box,inventaris.sumber_daya_listrik,inventaris.besar_daya,inventaris.tahun_kalibrasi "+
    ...
    private void getData() {
        if(tbJnsPerawatan.getSelectedRow()!= -1){
                ...
                tgl_pengadaan.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),10).toString());
                ...
                no_rak.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),14).toString());
                no_box.setSelectedItem(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),15).toString());        
                sumber_daya_listrik.setSelectedItem(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),16).toString());
                besar_daya.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),17).toString());
                tahun_kalibrasi.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),18).toString());                
          }
    }
