...
public class DlgRekapObatPasien extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TabRawat1.addTab("Pasien Umum Sudah Bayar", new javax.swing.ImageIcon(getClass().getResource("/picture/rkontrol.png")), scrollPane4); // NOI18N
        ...
        TabRawat1.addTab("Pasien Instansi Sudah Bayar", new javax.swing.ImageIcon(getClass().getResource("/picture/liatdpjp.png")), scrollPane6); // NOI18N
            ...
            if(nmpenjab.getText().equals("")&&TCari.getText().equals("")){
                if((status.getSelectedIndex()==0)||(status.getSelectedIndex()==1)){
                    psreg=koneksi.prepareStatement(
                       ...
                       "pasien.nm_pasien,"+
                       "tagihan_sadewa.tgl_bayar as tgl_bayar "+
                       "from "+
                       "reg_periksa "+                       
                       "inner join penjab on reg_periksa.kd_pj = penjab.kd_pj "+
                       "inner join nota_jalan on reg_periksa.no_rawat=nota_jalan.no_rawat "+        
                       "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                       "inner join tagihan_sadewa on reg_periksa.no_rawat=tagihan_sadewa.no_nota "+        
                       "where "+
                       "reg_periksa.stts<>'Batal' and "+
                       "reg_periksa.status_lanjut='Ralan' and "+
                       "reg_periksa.kd_pj='001' and "+        
                       "tagihan_sadewa.tgl_bayar between ? and ? "+
                       "order by "+
                       "tagihan_sadewa.tgl_bayar"
                    );
                }
                ...
                if((status.getSelectedIndex()==0)||(status.getSelectedIndex()==2)){
                    pskamar=koneksi.prepareStatement(
                       ...
                       "tagihan_sadewa.tgl_bayar between ? and ? "+
                       "group by "+
                       "reg_periksa.no_rawat order by tagihan_sadewa.tgl_bayar"
                    );
                }
                ...
                if((status.getSelectedIndex()==0)||(status.getSelectedIndex()==1)){
                    psreg=koneksi.prepareStatement(                          
                       ...
                       "reg_periksa.status_lanjut='Ralan' and "+
                       "reg_periksa.kd_pj='001' and "+        
                       "tagihan_sadewa.tgl_bayar between ? and ? and "+
                       "concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and "+
                       "(reg_periksa.no_rkm_medis like ? or pasien.nm_pasien like ?) "+
                       "order by "+
                       "tagihan_sadewa.tgl_bayar"
                    );
                }
                                 ...
                                 while(rsobat.next()){
                                     if(a==1){
                                        tabMode.addRow(new String[]{
                                            i+"",rsreg.getString("tgl_bayar"),rsreg.getString("tgl_registrasi"),rsreg.getString("no_rawat")+"  -  "+rsreg.getString("no_nota"),rsreg.getString("status_lanjut"),rsreg.getString("no_rkm_medis"),rsreg.getString("nm_pasien"),rsreg.getString("instansi"),
                        ...
                        try {
                            ...
                            if(rsobat.next()){
                                 ...
                                 while(rsobat.next()){
                                     if(a==1){
                                        tabMode.addRow(new String[]{
                                            i+"",rskamar.getString("tgl_bayar"),rskamar.getString("tgl_keluar"),rskamar.getString("no_rawat")+"  -  "+rskamar.getString("no_nota"),rskamar.getString("status_lanjut"),rskamar.getString("no_rkm_medis"),rskamar.getString("nm_pasien"),rskamar.getString("instansi"),
                                            rsobat.getString(3),rsobat.getString(1)+" "+rsobat.getString(2),Valid.SetAngka(rsobat.getDouble(4)),
                                            Valid.SetAngka(rsobat.getDouble(5)),Valid.SetAngka(rsobat.getDouble(6)),Valid.SetAngka(rsobat.getDouble(7))
                                        });
                                        i++; 
    ...
    private void prosesCari3() {
        try{   
            ...
            if(nmpenjab.getText().equals("")&&TCari.getText().equals("")){
                if((status.getSelectedIndex()==0)||(status.getSelectedIndex()==1)){
                    psreg=koneksi.prepareStatement(
                       ...
                       "penjab.png_jawab AS instansi,"+        
                       "pasien.nm_pasien,"+
                       "bayar_piutang.tgl_bayar as tgl_bayar "+
                       "from "+
                       "reg_periksa "+                       
                       "inner join penjab on reg_periksa.kd_pj = penjab.kd_pj "+
                       "inner join nota_jalan on reg_periksa.no_rawat=nota_jalan.no_rawat "+        
                       "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                       "inner join bayar_piutang on reg_periksa.no_rawat=bayar_piutang.no_rawat "+        
                       "where "+
                       "reg_periksa.stts<>'Batal' and "+
                       "reg_periksa.status_lanjut='Ralan' and "+
                       "bayar_piutang.tgl_bayar between ? and ? "+
                       "order by "+
                ...
                if((status.getSelectedIndex()==0)||(status.getSelectedIndex()==2)){
                    pskamar=koneksi.prepareStatement(
                       ...
                       "bayar_piutang.tgl_bayar between ? and ? "+
                       "group by "+
                       "reg_periksa.no_rawat order by bayar_piutang.tgl_bayar"
                    );
                }
                ...
                if((status.getSelectedIndex()==0)||(status.getSelectedIndex()==1)){
                    psreg=koneksi.prepareStatement(                          
                       ...
                       "reg_periksa.stts<>'Batal' and "+
                       "reg_periksa.status_lanjut='Ralan' and "+
                       "bayar_piutang.tgl_bayar between ? and ? and "+
                       "concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and "+
                       "(reg_periksa.no_rkm_medis like ? or pasien.nm_pasien like ?) "+
                       "order by "+
                       "bayar_piutang.tgl_bayar"
            ...
            try {
                    ...
                    while(rsreg.next()){
                        if((status.getSelectedIndex()==0)&&nmjns.getText().equals("")&&nmkategori.getText().equals("")&&nmgolongan.getText().equals("")&&nmasal.getText().equals("")){
                            psobat=koneksi.prepareStatement(
                                ...
                                "(SELECT CASE WHEN penjab.kd_pj='bpj' THEN sum(detail_pemberian_obat.tuslah)*0.3 ELSE sum(detail_pemberian_obat.tuslah) END ) AS tuslah,"+
                                "sum(detail_pemberian_obat.total) as total "+
                                "from detail_pemberian_obat inner join reg_periksa on detail_pemberian_obat.no_rawat=reg_periksa.no_rawat "+
                                "inner join databarang on detail_pemberian_obat.kode_brng=databarang.kode_brng "+
                                "inner join penjab on reg_periksa.kd_pj = penjab.kd_pj "+                
                ...
                if(ttltotal>0){
                    tabMode3.addRow(new Object[]{">>","Total ",":","","","","","","","",Valid.SetAngka(ttlbiaya),Valid.SetAngka(ttlembalase),Valid.SetAngka(ttltuslah),Valid.SetAngka(ttltotal)});
