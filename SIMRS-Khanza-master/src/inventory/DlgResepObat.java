...
public final class DlgResepObat extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "12-10-2024 10:02:57" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "12-10-2024 10:02:58" }));
        ...
        DTPBeri.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "12-10-2024" }));
            ...
            try{
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("nm_dokter")+"    |    "+rs.getString("ruangan")+"    |    "+rs.getString("png_jawab")+"    |    "+rs.getString("No.SEP")
                    });
