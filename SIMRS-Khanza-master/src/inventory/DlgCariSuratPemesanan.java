...
//                            KabidKeu.setText(pegawai.tbKamar.getValueAt(pegawai.tbKamar.getSelectedRow(),1).toString());                        
    ...
    private void initComponents() {
        ...
        BtnPrint5.setBounds(150, 40, 100, 30);
        ...
        BtnKeluar4.setBounds(270, 40, 100, 30);
        ...
        Apoteker.setBounds(150, 10, 220, 23);
        ...
        BtnSeek6.setBounds(370, 10, 28, 23);
...
//                        param.put("kabidkeu",KabidKeu.getText());
    ...
    private void BtnKeluar4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKeluar4ActionPerformed
        DlgCetak.dispose();
        DlgCetak.setSize(internalFrame5.getWidth()-20,internalFrame5.getHeight()-20);
        DlgCetak.setLocationRelativeTo(internalFrame5);
        DlgCetak.setAlwaysOnTop(true);
        DlgCetak.setVisible(true);
