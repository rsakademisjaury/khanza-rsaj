...
public class GrafikReportEMRDokter extends javax.swing.JDialog {
    ...
    public GrafikReportEMRDokter(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[]{"NIP", "Nama", "Jumlah Pasien", "AM Ralan", "AM IGD",
            "CPPT Ralan", "AM Ranap", "CPPT ranap", "Resep NonRacikan", "Resep Racikan"}) {
            @Override
    ...
    private void initComponents() {
        ...
        Tanggal1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-10-2023" }));
        ...
        Tanggal2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-10-2023" }));
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    ...
                    + "	(\n"
                    + "		( SELECT COUNT( penilaian_medis_ralan.no_rawat ) FROM penilaian_medis_ralan WHERE penilaian_medis_ralan.tanggal BETWEEN'" + Valid.SetTgl(Tanggal1.getSelectedItem() + "") + "' AND '" + Valid.SetTgl(Tanggal2.getSelectedItem() + "") + "' AND penilaian_medis_ralan.kd_dokter = reg_periksa.kd_dokter )"
                    + " + ( SELECT count( penilaian_medis_ralan_anak.no_rawat ) FROM penilaian_medis_ralan_anak WHERE penilaian_medis_ralan_anak.tanggal BETWEEN'" + Valid.SetTgl(Tanggal1.getSelectedItem() + "") + "' AND '" + Valid.SetTgl(Tanggal2.getSelectedItem() + "") + "' AND penilaian_medis_ralan_anak.kd_dokter = reg_periksa.kd_dokter ) "
                    + "+ ( SELECT count( penilaian_medis_ralan_bedah.no_rawat ) FROM penilaian_medis_ralan_bedah WHERE penilaian_medis_ralan_bedah.tanggal BETWEEN'" + Valid.SetTgl(Tanggal1.getSelectedItem() + "") + "' AND '" + Valid.SetTgl(Tanggal2.getSelectedItem() + "") + "' AND penilaian_medis_ralan_bedah.kd_dokter = reg_periksa.kd_dokter ) "
                    + "+ ( SELECT count( penilaian_medis_ralan_tht.no_rawat ) FROM penilaian_medis_ralan_tht WHERE penilaian_medis_ralan_tht.tanggal BETWEEN'" + Valid.SetTgl(Tanggal1.getSelectedItem() + "") + "' AND '" + Valid.SetTgl(Tanggal2.getSelectedItem() + "") + "' AND penilaian_medis_ralan_tht.kd_dokter = reg_periksa.kd_dokter ) "
                    + "+ ( SELECT count( penilaian_medis_ralan_mata.no_rawat ) FROM penilaian_medis_ralan_mata WHERE penilaian_medis_ralan_mata.tanggal BETWEEN'" + Valid.SetTgl(Tanggal1.getSelectedItem() + "") + "' AND '" + Valid.SetTgl(Tanggal2.getSelectedItem() + "") + "' AND penilaian_medis_ralan_mata.kd_dokter = reg_periksa.kd_dokter ) "
                    + "+ ( SELECT count( penilaian_medis_ralan_psikiatrik.no_rawat ) FROM penilaian_medis_ralan_psikiatrik WHERE penilaian_medis_ralan_psikiatrik.tanggal BETWEEN'" + Valid.SetTgl(Tanggal1.getSelectedItem() + "") + "' AND '" + Valid.SetTgl(Tanggal2.getSelectedItem() + "") + "' AND penilaian_medis_ralan_psikiatrik.kd_dokter = reg_periksa.kd_dokter ) \n"
                    + "+ ( SELECT count( penilaian_medis_ralan_geriatri.no_rawat ) FROM penilaian_medis_ralan_geriatri WHERE penilaian_medis_ralan_geriatri.tanggal BETWEEN'" + Valid.SetTgl(Tanggal1.getSelectedItem() + "") + "' AND '" + Valid.SetTgl(Tanggal2.getSelectedItem() + "") + "' AND penilaian_medis_ralan_geriatri.kd_dokter = reg_periksa.kd_dokter ) "
                    + "+ ( SELECT count( penilaian_medis_ralan_bedah_mulut.no_rawat ) FROM penilaian_medis_ralan_bedah_mulut WHERE penilaian_medis_ralan_bedah_mulut.tanggal BETWEEN'" + Valid.SetTgl(Tanggal1.getSelectedItem() + "") + "' AND '" + Valid.SetTgl(Tanggal2.getSelectedItem() + "") + "' AND penilaian_medis_ralan_bedah_mulut.kd_dokter = reg_periksa.kd_dokter ) "
                    + "+ ( SELECT count( penilaian_medis_ralan_kandungan.no_rawat ) FROM penilaian_medis_ralan_kandungan WHERE penilaian_medis_ralan_kandungan.tanggal BETWEEN'" + Valid.SetTgl(Tanggal1.getSelectedItem() + "") + "' AND '" + Valid.SetTgl(Tanggal2.getSelectedItem() + "") + "' AND penilaian_medis_ralan_kandungan.kd_dokter = reg_periksa.kd_dokter ) "
                    + "+ ( SELECT count( penilaian_medis_ralan_kulitdankelamin.no_rawat ) FROM penilaian_medis_ralan_kulitdankelamin WHERE penilaian_medis_ralan_kulitdankelamin.tanggal BETWEEN'" + Valid.SetTgl(Tanggal1.getSelectedItem() + "") + "' AND '" + Valid.SetTgl(Tanggal2.getSelectedItem() + "") + "' AND penilaian_medis_ralan_kulitdankelamin.kd_dokter = reg_periksa.kd_dokter ) "
                    + "+ ( SELECT count( penilaian_psikologi.no_rawat ) FROM penilaian_psikologi WHERE penilaian_psikologi.tanggal BETWEEN'" + Valid.SetTgl(Tanggal1.getSelectedItem() + "") + "' AND '" + Valid.SetTgl(Tanggal2.getSelectedItem() + "") + "' AND penilaian_psikologi.nip = reg_periksa.kd_dokter ) "
                    + "+ ( SELECT count( penilaian_medis_ralan_bedah.no_rawat ) FROM penilaian_medis_ralan_bedah WHERE penilaian_medis_ralan_bedah.tanggal BETWEEN'" + Valid.SetTgl(Tanggal1.getSelectedItem() + "") + "' AND '" + Valid.SetTgl(Tanggal2.getSelectedItem() + "") + "' AND penilaian_medis_ralan_bedah.kd_dokter = reg_periksa.kd_dokter ) "
                    + "	) AS AWRalan,\n"
                    + "	( SELECT count( penilaian_medis_igd.no_rawat ) FROM penilaian_medis_igd WHERE penilaian_medis_igd.tanggal BETWEEN'" + Valid.SetTgl(Tanggal1.getSelectedItem() + "") + "' AND'" + Valid.SetTgl(Tanggal2.getSelectedItem() + "") + "' AND penilaian_medis_igd.kd_dokter = reg_periksa.kd_dokter ) AS awalmedisigd,\n"
                    + "	((\n"
                    + "		SELECT count( penilaian_medis_ranap.no_rawat ) FROM penilaian_medis_ranap  WHERE penilaian_medis_ranap.tanggal BETWEEN'" + Valid.SetTgl(Tanggal1.getSelectedItem() + "") + "'  AND'" + Valid.SetTgl(Tanggal2.getSelectedItem() + "") + "'  AND penilaian_medis_ranap.kd_dokter = reg_periksa.kd_dokter  ) "
                    + "+ ( SELECT count( penilaian_medis_ranap_kandungan.no_rawat ) FROM penilaian_medis_ranap_kandungan WHERE penilaian_medis_ranap_kandungan.tanggal BETWEEN'" + Valid.SetTgl(Tanggal1.getSelectedItem() + "") + "' AND'" + Valid.SetTgl(Tanggal2.getSelectedItem() + "") + "' AND penilaian_medis_ranap_kandungan.kd_dokter = reg_periksa.kd_dokter )) AS AWRANAP,\n  "
                    + "	( SELECT count( pemeriksaan_ralan.no_rawat ) FROM pemeriksaan_ralan WHERE pemeriksaan_ralan.tgl_perawatan BETWEEN'" + Valid.SetTgl(Tanggal1.getSelectedItem() + "") + "' AND'" + Valid.SetTgl(Tanggal2.getSelectedItem() + "") + "' AND pemeriksaan_ralan.nip = reg_periksa.kd_dokter ) AS CPPTRALANDOKTER,\n"
                    + "	( SELECT count( pemeriksaan_ranap.no_rawat ) FROM pemeriksaan_ranap WHERE pemeriksaan_ranap.tgl_perawatan BETWEEN'" + Valid.SetTgl(Tanggal1.getSelectedItem() + "") + "' AND'" + Valid.SetTgl(Tanggal2.getSelectedItem() + "") + "' AND pemeriksaan_ranap.nip = reg_periksa.kd_dokter ) AS CPPTRANAP,\n"
                    + "	(\n"
                    + "	SELECT\n"
                    + "		count( resep_obat.no_resep ) \n"
                    + "	FROM\n"
                    + "		resep_obat \n"
                    + "	WHERE\n"
                    + "		resep_obat.tgl_peresepan BETWEEN'" + Valid.SetTgl(Tanggal1.getSelectedItem() + "") + "' \n"
                    ...
                    + "	AND'" + Valid.SetTgl(Tanggal2.getSelectedItem() + "") + "' \n"
                    + "		AND resep_obat.kd_dokter = reg_periksa.kd_dokter \n"
                    + "	AND resep_obat.no_resep IN ( SELECT resep_dokter_racikan.no_resep FROM resep_dokter_racikan )) AS RESEPRACIKAN \n"
                    + "FROM\n"
                    + "	reg_periksa\n"
                    + "	INNER JOIN dokter ON reg_periksa.kd_dokter = dokter.kd_dokter \n"
                    + "WHERE\n"
