...
public final class SuratCutiHamil extends javax.swing.JDialog {
    ...
    public SuratCutiHamil(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "No.Surat","No.Rawat","No.R.M.","Nama Pasien","Pekerjaan","Tgl.Periksa","Kota Tujuan","Tgl. Awal","Tgl. Akhir","Kode Dokter","Nama Dokter"
        }){
    ...
    private void initComponents() {
        ...
        MnCetakSuratHamil.setText("Cetak Surat Layak Terbang");
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Surat Layak Terbang ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        jLabel13.setText("Tgl. Awal :");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(445, 40, 60, 23);

        TanggalAwal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "22-09-2023" }));
        ...
        TanggalAwal.setBounds(514, 40, 80, 23);

        jLabel15.setText("Tgl. Akhir :");
        jLabel15.setName("jLabel15"); // NOI18N
        FormInput.add(jLabel15);
        jLabel15.setBounds(578, 40, 80, 23);

        TanggalAkhir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "22-09-2023" }));
        TanggalAkhir.setDisplayFormat("dd-MM-yyyy");
        TanggalAkhir.setName("TanggalAkhir"); // NOI18N
        FormInput.add(TanggalAkhir);
        TanggalAkhir.setBounds(662, 40, 80, 23);

        jLabel5.setText("Kota Tujuan :");
        jLabel5.setName("jLabel5"); // NOI18N
        FormInput.add(jLabel5);
        jLabel5.setBounds(216, 40, 70, 23);
        ...
        KeadaanPasien.setBounds(290, 40, 150, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(NoSurat.getText().trim().equals("")){
            ...
            Valid.textKosong(TNoRw,"Kota Tujuan");
        }else{
            if(Sequel.menyimpantf("surat_cuti_hamil","?,?,?,?,?","No.Surat",5,new String[]{
                TNoRw.getText(),KeadaanPasien.getText(),Valid.SetTgl(TanggalAwal.getSelectedItem()+""),Valid.SetTgl(TanggalAkhir.getSelectedItem()+""),NoSurat.getText(),
            })==true){
                tampil();
                emptTeks();
            }
        ...
        if(NoSurat.getText().trim().equals("")){
            ...
            if(tbObat.getSelectedRow()!= -1){
                if(Sequel.mengedittf("surat_cuti_hamil","no_surat=?","no_rawat=?,keterangan_hamil=?,terhitung_mulai=?,perkiraan_lahir=?,no_surat=?",6,new String[]{
                    TNoRw.getText(),KeadaanPasien.getText(),Valid.SetTgl(TanggalAwal.getSelectedItem()+""),Valid.SetTgl(TanggalAkhir.getSelectedItem()+""),NoSurat.getText(),tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
                })==true){
                    tampil();
                    emptTeks();
                }
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(TCari.getText().trim().equals("")){
                Valid.MyReportqry("rptDataSuratCutiHamil.jasper","report","::[ Data Surat Layak Terbang ]::",
    ...
    private void MnCetakSuratHamilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratHamilActionPerformed
       if(TPasien.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                ...
                param.put("logo",Sequel.cariGambar("select setting.logo from setting")); 
                Valid.MyReportqry("rptSuratCutiHamil.jasper","report","::[ Surat Layak Terbang ]::",
    ...
    */
    ...
    public void emptTeks() {
        ...
        nomorSurat();
//        Valid.autoNomer3("select ifnull(MAX(CONVERT(RIGHT(surat_cuti_hamil.no_surat,3),signed)),0) from surat_cuti_hamil inner join reg_periksa on surat_cuti_hamil.no_rawat=reg_periksa.no_rawat where reg_periksa.tgl_registrasi='"+Valid.SetTgl(TanggalAwal.getSelectedItem()+"")+"' ",
//                "SCH"+TanggalAwal.getSelectedItem().toString().substring(6,10)+TanggalAwal.getSelectedItem().toString().substring(3,5)+TanggalAwal.getSelectedItem().toString().substring(0,2),3,NoSurat); 
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            Valid.SetTgl(TanggalAwal,tbObat.getValueAt(tbObat.getSelectedRow(),7).toString());
            Valid.SetTgl(TanggalAkhir,tbObat.getValueAt(tbObat.getSelectedRow(),8).toString()); 
        }
    }
    ...
    private void nomorSurat() {
        ...
        Valid1.autoNomerSuratKhusus1("select ifnull(MAX(CONVERT(LEFT(no_surat,3),signed)),0), MONTH(terhitung_mulai) bln from surat_cuti_hamil inner join reg_periksa on surat_cuti_hamil.no_rawat=reg_periksa.no_rawat where terhitung_mulai='"
                + Valid.SetTgl(TanggalAwal.getSelectedItem() + "").substring(0, 7) + "%' ", "/MR-RSAJ/" + bln_romawi + "/" + TanggalAwal.getSelectedItem().toString().substring(6,10), 3, NoSurat);
        bln_angka = Sequel.cariIsi("SELECT MONTH(terhitung_mulai) bln FROM surat_cuti_hamil WHERE terhitung_mulai like '%" + Valid.SetTgl(TanggalAwal.getSelectedItem() + "").substring(0, 7) + "%'");
    }
}
